...
public:
	...
	struct FBodyInstance                          BodyInstance;                                      // 0x0048(0x0190)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	EHasCustomNavigableGeometry                   CustomNavigableGeometry;                           // 0x01D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLightingChannels                      LightingChannels;                                  // 0x01D9(0x0001)(Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DA[0x2];                                      // 0x01DA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bRenderCustomDepth : 1;                            // 0x01DC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1DD[0x3];                                      // 0x01DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	ERendererStencilMask                          CustomDepthStencilWriteMask;                       // 0x01E0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E1[0x3];                                      // 0x01E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CustomDepthStencilValue;                           // 0x01E4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TranslucencySortPriority;                          // 0x01E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnableDensityScaling : 1;                         // 0x01EC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1ED[0x3];                                      // 0x01ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class URuntimeVirtualTexture*>         RuntimeVirtualTextures;                            // 0x01F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	int32                                         VirtualTextureCullMips;                            // 0x0200(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERuntimeVirtualTextureMainPassType            VirtualTextureRenderPassType;                      // 0x0204(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHISMBuilderSettings) == 0x000208, "Wrong size on UHISMBuilderSettings");
...
static_assert(offsetof(UHISMBuilderSettings, LODDistanceScale) == 0x000034, "Member 'UHISMBuilderSettings::LODDistanceScale' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, OverriddenLightMapRes) == 0x00003C, "Member 'UHISMBuilderSettings::OverriddenLightMapRes' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, LightmapType) == 0x000040, "Member 'UHISMBuilderSettings::LightmapType' has a wrong offset!");
...
static_assert(offsetof(UHISMBuilderSettings, CustomNavigableGeometry) == 0x0001D8, "Member 'UHISMBuilderSettings::CustomNavigableGeometry' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, LightingChannels) == 0x0001D9, "Member 'UHISMBuilderSettings::LightingChannels' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, CustomDepthStencilWriteMask) == 0x0001E0, "Member 'UHISMBuilderSettings::CustomDepthStencilWriteMask' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, CustomDepthStencilValue) == 0x0001E4, "Member 'UHISMBuilderSettings::CustomDepthStencilValue' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, TranslucencySortPriority) == 0x0001E8, "Member 'UHISMBuilderSettings::TranslucencySortPriority' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, RuntimeVirtualTextures) == 0x0001F0, "Member 'UHISMBuilderSettings::RuntimeVirtualTextures' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, VirtualTextureCullMips) == 0x000200, "Member 'UHISMBuilderSettings::VirtualTextureCullMips' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, VirtualTextureRenderPassType) == 0x000204, "Member 'UHISMBuilderSettings::VirtualTextureRenderPassType' has a wrong offset!");
...
static_assert(sizeof(AProceduralGenerationBlockingVolume) == 0x0002D8, "Wrong size on AProceduralGenerationBlockingVolume");
static_assert(offsetof(AProceduralGenerationBlockingVolume, BlockedVolumes) == 0x0002C8, "Member 'AProceduralGenerationBlockingVolume::BlockedVolumes' has a wrong offset!");
...
static_assert(sizeof(AProceduralGenerationVolume) == 0x0002D0, "Wrong size on AProceduralGenerationVolume");
static_assert(offsetof(AProceduralGenerationVolume, ProceduralComponent) == 0x0002C8, "Member 'AProceduralGenerationVolume::ProceduralComponent' has a wrong offset!");
