...
static_assert(sizeof(UFortUIManagerComponent_VictoryCrowns) == 0x000158, "Wrong size on UFortUIManagerComponent_VictoryCrowns");
...
static_assert(sizeof(UVictoryCrownsBearerInfoBase) == 0x0002F8, "Wrong size on UVictoryCrownsBearerInfoBase");
static_assert(offsetof(UVictoryCrownsBearerInfoBase, WeakPSA) == 0x0002E8, "Member 'UVictoryCrownsBearerInfoBase::WeakPSA' has a wrong offset!");
static_assert(offsetof(UVictoryCrownsBearerInfoBase, Text_PlayerName) == 0x0002F0, "Member 'UVictoryCrownsBearerInfoBase::Text_PlayerName' has a wrong offset!");
...
static_assert(sizeof(UVictoryCrownsIndicator) == 0x0003F8, "Wrong size on UVictoryCrownsIndicator");
...
static_assert(sizeof(UVictoryCrownsPlacementOverlay) == 0x000348, "Wrong size on UVictoryCrownsPlacementOverlay");
...
static_assert(sizeof(UVictoryCrownsPlayerInfoWidget) == 0x000338, "Wrong size on UVictoryCrownsPlayerInfoWidget");
...
static_assert(sizeof(UVictoryCrownsPreGameWidget) == 0x000450, "Wrong size on UVictoryCrownsPreGameWidget");
static_assert(offsetof(UVictoryCrownsPreGameWidget, EntryBox_BearerList) == 0x000400, "Member 'UVictoryCrownsPreGameWidget::EntryBox_BearerList' has a wrong offset!");
static_assert(offsetof(UVictoryCrownsPreGameWidget, TipActionWidget) == 0x000408, "Member 'UVictoryCrownsPreGameWidget::TipActionWidget' has a wrong offset!");
static_assert(offsetof(UVictoryCrownsPreGameWidget, CloseObjectInputAction) == 0x000410, "Member 'UVictoryCrownsPreGameWidget::CloseObjectInputAction' has a wrong offset!");
