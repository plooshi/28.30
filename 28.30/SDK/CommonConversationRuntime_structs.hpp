...
static_assert(offsetof(FConversationContext, bServer_PRIVATE) == 0x000030, "Member 'FConversationContext::bServer_PRIVATE' has a wrong offset!");
static_assert(offsetof(FConversationContext, bClient_PRIVATE) == 0x000031, "Member 'FConversationContext::bClient_PRIVATE' has a wrong offset!");
