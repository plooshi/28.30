...
static_assert(sizeof(UInterchangeProjectSettings) == 0x000218, "Wrong size on UInterchangeProjectSettings");
static_assert(offsetof(UInterchangeProjectSettings, ContentImportSettings) == 0x000030, "Member 'UInterchangeProjectSettings::ContentImportSettings' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, SceneImportSettings) == 0x000150, "Member 'UInterchangeProjectSettings::SceneImportSettings' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, FilePickerClass) == 0x0001D0, "Member 'UInterchangeProjectSettings::FilePickerClass' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, bStaticMeshUseSmoothEdgesIfSmoothingInformationIsMissing) == 0x0001F0, "Member 'UInterchangeProjectSettings::bStaticMeshUseSmoothEdgesIfSmoothingInformationIsMissing' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, GenericPipelineClass) == 0x0001F8, "Member 'UInterchangeProjectSettings::GenericPipelineClass' has a wrong offset!");
...
static_assert(sizeof(UInterchangePythonPipelineBase) == 0x0000F8, "Wrong size on UInterchangePythonPipelineBase");
...
static_assert(sizeof(UInterchangePythonPipelineAsset) == 0x000060, "Wrong size on UInterchangePythonPipelineAsset");
...
static_assert(offsetof(UInterchangePythonPipelineAsset, GeneratedPipeline) == 0x000048, "Member 'UInterchangePythonPipelineAsset::GeneratedPipeline' has a wrong offset!");
static_assert(offsetof(UInterchangePythonPipelineAsset, JsonDefaultProperties) == 0x000050, "Member 'UInterchangePythonPipelineAsset::JsonDefaultProperties' has a wrong offset!");
...
static_assert(sizeof(UInterchangeAssetImportData) == 0x0000A8, "Wrong size on UInterchangeAssetImportData");
...
static_assert(offsetof(UInterchangeAssetImportData, NodeUniqueID) == 0x000040, "Member 'UInterchangeAssetImportData::NodeUniqueID' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, NodeContainer) == 0x000050, "Member 'UInterchangeAssetImportData::NodeContainer' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, Pipelines) == 0x000058, "Member 'UInterchangeAssetImportData::Pipelines' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, TransientNodeContainer) == 0x000068, "Member 'UInterchangeAssetImportData::TransientNodeContainer' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, TransientPipelines) == 0x000070, "Member 'UInterchangeAssetImportData::TransientPipelines' has a wrong offset!");
...
static_assert(sizeof(UInterchangeManager) == 0x000240, "Wrong size on UInterchangeManager");
