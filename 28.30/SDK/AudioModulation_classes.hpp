...
public:
	...
	static class USoundModulationWatcher* CreateModulationWatcher(class UObject* WorldContextObject, class FName Name_0, class USoundModulatorBase* Modulator);
...
// 0x0018 (0x0040 - 0x0028)
class USoundModulationWatcher final : public UObject
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"SoundModulationWatcher">();
	}
	static class USoundModulationWatcher* GetDefaultObj()
	{
		return GetDefaultObjImpl<USoundModulationWatcher>();
	}
};
static_assert(alignof(USoundModulationWatcher) == 0x000008, "Wrong alignment on USoundModulationWatcher");
static_assert(sizeof(USoundModulationWatcher) == 0x000040, "Wrong size on USoundModulationWatcher");
static_assert(offsetof(USoundModulationWatcher, Modulator) == 0x000028, "Member 'USoundModulationWatcher::Modulator' has a wrong offset!");
