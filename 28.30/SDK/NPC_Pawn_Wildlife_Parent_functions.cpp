...
void ANPC_Pawn_Wildlife_Parent_C::CE_UpdateSurfaceType(class UActorComponent* Component, bool bReset)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CE_UpdateSurfaceType");
...
void ANPC_Pawn_Wildlife_Parent_C::HideStatus()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HideStatus");
...
void ANPC_Pawn_Wildlife_Parent_C::NPCStatusWidget_UpdateKeepVisible(bool ShouldKeepVisible)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("NPCStatusWidget_UpdateKeepVisible");
...
void ANPC_Pawn_Wildlife_Parent_C::On_Pawn_Focused(class AFortPawn* FocusedPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On Pawn Focused");
...
void ANPC_Pawn_Wildlife_Parent_C::OnApplyEffectOptimization(const int32 NewBudgetValue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnApplyEffectOptimization");
...
struct FVector ANPC_Pawn_Wildlife_Parent_C::OnLaunchCharacter(const struct FVector& LaunchVelocity, bool bXYOverride, bool bZOverride)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLaunchCharacter");
...
void ANPC_Pawn_Wildlife_Parent_C::OnOutOfConvertResistanceServer(float ConvertDamageDone, const struct FGameplayTagContainer& SourceTags, const struct FGameplayEffectContextHandle& EffectContext, class AController* EffectInstigator, class AActor* EffectCauser)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnOutOfConvertResistanceServer");
...
void ANPC_Pawn_Wildlife_Parent_C::OnSlidingStateChanged(bool bNewSlidingState)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnSlidingStateChanged");
...
void ANPC_Pawn_Wildlife_Parent_C::RestoreConvertResistance()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RestoreConvertResistance");
