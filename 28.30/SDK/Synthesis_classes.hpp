...
public:
	...
	uint8                                         Pad_884[0x6EC];                                    // 0x0884(0x06EC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UModularSynthComponent) == 0x000F70, "Wrong size on UModularSynthComponent");
static_assert(offsetof(UModularSynthComponent, VoiceCount) == 0x000880, "Member 'UModularSynthComponent::VoiceCount' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_888[0x3E8];                                    // 0x0888(0x03E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGranularSynth) == 0x000C70, "Wrong size on UGranularSynth");
static_assert(offsetof(UGranularSynth, GranulatedSoundWave) == 0x000880, "Member 'UGranularSynth::GranulatedSoundWave' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_8A8[0x728];                                    // 0x08A8(0x0728)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthComponentMonoWaveTable) == 0x000FD0, "Wrong size on USynthComponentMonoWaveTable");
static_assert(offsetof(USynthComponentMonoWaveTable, OnTableAltered) == 0x000880, "Member 'USynthComponentMonoWaveTable::OnTableAltered' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, OnNumTablesChanged) == 0x000890, "Member 'USynthComponentMonoWaveTable::OnNumTablesChanged' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, CurrentPreset) == 0x0008A0, "Member 'USynthComponentMonoWaveTable::CurrentPreset' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_924[0x4C];                                     // 0x0924(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthComponentToneGenerator) == 0x000970, "Wrong size on USynthComponentToneGenerator");
static_assert(offsetof(USynthComponentToneGenerator, Frequency) == 0x000880, "Member 'USynthComponentToneGenerator::Frequency' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, Volume) == 0x000884, "Member 'USynthComponentToneGenerator::Volume' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, DistanceAttenuationCurve) == 0x000888, "Member 'USynthComponentToneGenerator::DistanceAttenuationCurve' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, DistanceRange) == 0x000910, "Member 'USynthComponentToneGenerator::DistanceRange' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, AttenuationDbAtMaxRange) == 0x000920, "Member 'USynthComponentToneGenerator::AttenuationDbAtMaxRange' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_8A8[0x108];                                    // 0x08A8(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthSamplePlayer) == 0x0009B0, "Wrong size on USynthSamplePlayer");
static_assert(offsetof(USynthSamplePlayer, SoundWave) == 0x000880, "Member 'USynthSamplePlayer::SoundWave' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSampleLoaded) == 0x000888, "Member 'USynthSamplePlayer::OnSampleLoaded' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSamplePlaybackProgress) == 0x000898, "Member 'USynthSamplePlayer::OnSamplePlaybackProgress' has a wrong offset!");
...
static_assert(sizeof(USynth2DSlider) == 0x000610, "Wrong size on USynth2DSlider");
...
static_assert(offsetof(USynth2DSlider, ValueYDelegate) == 0x00018C, "Member 'USynth2DSlider::ValueYDelegate' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, WidgetStyle) == 0x0001A0, "Member 'USynth2DSlider::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, SliderHandleColor) == 0x000580, "Member 'USynth2DSlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IndentHandle) == 0x000590, "Member 'USynth2DSlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, Locked) == 0x000591, "Member 'USynth2DSlider::Locked' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, StepSize) == 0x000594, "Member 'USynth2DSlider::StepSize' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IsFocusable) == 0x000598, "Member 'USynth2DSlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureBegin) == 0x0005A0, "Member 'USynth2DSlider::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureEnd) == 0x0005B0, "Member 'USynth2DSlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureBegin) == 0x0005C0, "Member 'USynth2DSlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureEnd) == 0x0005D0, "Member 'USynth2DSlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedX) == 0x0005E0, "Member 'USynth2DSlider::OnValueChangedX' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedY) == 0x0005F0, "Member 'USynth2DSlider::OnValueChangedY' has a wrong offset!");
...
static_assert(offsetof(USynthKnob, ParameterUnits) == 0x0001A8, "Member 'USynthKnob::ParameterUnits' has a wrong offset!");
