...
static_assert(sizeof(AReplicatedLevelSequenceActor) == 0x000330, "Wrong size on AReplicatedLevelSequenceActor");
...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x000388, "Wrong size on ULevelSequenceBurnIn");
...
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x000380, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4F8[0x110];                                    // 0x04F8(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
