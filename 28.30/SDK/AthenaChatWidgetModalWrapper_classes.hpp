...
static_assert(sizeof(UAthenaChatWidgetModalWrapper_C) == 0x000420, "Wrong size on UAthenaChatWidgetModalWrapper_C");
static_assert(offsetof(UAthenaChatWidgetModalWrapper_C, UberGraphFrame) == 0x000418, "Member 'UAthenaChatWidgetModalWrapper_C::UberGraphFrame' has a wrong offset!");
