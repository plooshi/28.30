...
void UStormCallerComponent::ApplyPOINamesToDataRegistry(const class UPlaylistUserOptions* UserOptions, const struct FGameplayTag& GameplayTagForPOI, const class FText& MapCenterText, const class FText& RandomText, const class FText& BeaconText)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ApplyPOINamesToDataRegistry");
...
void UStormCallerComponent::ApplySavedPoiOptions(const TArray<class FString>& PoiSavedOptionKeys, const TArray<class FText>& PoiSavedOptionName, class UFortActorOptionsComponent* ToyOptionsComponent)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ApplySavedPoiOptions");
...
class AFortPoiVolume* UStormCallerComponent::GetPoiVolumeFromOptionIndex(int32 OptionIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetPoiVolumeFromOptionIndex");
...
class AFortPoiVolume* UStormCallerComponent::GetRandomPoiVolume()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRandomPoiVolume");
...
void UStormCallerComponent::SpawnInitialSafeZone()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SpawnInitialSafeZone");
...
void UStormCallerComponent::UpdatePoiSavedOptions(TArray<class FString>& InOutPoiSavedOptionKeys, TArray<class FText>& InOutPoiSavedOptionNames, const class UPlaylistUserOptions* UserOptions, const struct FGameplayTag& GameplayTagForPOI)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdatePoiSavedOptions");
...
const TArray<struct FVector4> UStormCallerComponent::GetSafeZoneLocationBlockList() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSafeZoneLocationBlockList");
