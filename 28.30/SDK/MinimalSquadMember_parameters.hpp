...
static_assert(sizeof(MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember) == 0x000030, "Wrong size on MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember");
...
static_assert(offsetof(MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember, Temp_object_Variable) == 0x000010, "Member 'MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember, Temp_byte_Variable) == 0x000018, "Member 'MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember, K2Node_Select_Default) == 0x000020, "Member 'MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember, CallFunc_PlayAnimationForward_ReturnValue) == 0x000028, "Member 'MinimalSquadMember_C_ExecuteUbergraph_MinimalSquadMember::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
