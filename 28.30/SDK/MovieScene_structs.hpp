...
static_assert(sizeof(FMovieSceneBindingReference) == 0x000020, "Wrong size on FMovieSceneBindingReference");
...
static_assert(offsetof(FMovieSceneObjectPathChannelKeyValue, HardPtr) == 0x000020, "Member 'FMovieSceneObjectPathChannelKeyValue::HardPtr' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneObjectPathChannel, KeyHandles) == 0x0000A0, "Member 'FMovieSceneObjectPathChannel::KeyHandles' has a wrong offset!");
...
public:
	...
	TMap<struct FMovieSceneSequenceID, class UObject*> DirectorInstances;                                 // 0x0018(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMovieSceneRootEvaluationTemplateInstance) == 0x000070, "Wrong size on FMovieSceneRootEvaluationTemplateInstance");
...
static_assert(offsetof(FMovieSceneBindingOverrideData, bOverridesDefault) == 0x000038, "Member 'FMovieSceneBindingOverrideData::bOverridesDefault' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneDynamicBindingPayloadVariable, Value) == 0x000018, "Member 'FMovieSceneDynamicBindingPayloadVariable::Value' has a wrong offset!");
