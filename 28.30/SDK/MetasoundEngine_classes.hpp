...
public:
	...
	TArray<struct FMetaSoundQualitySettings>      QualitySettings;                                   // 0x0070(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMetaSoundSettings, QualitySettings) == 0x000070, "Member 'UMetaSoundSettings::QualitySettings' has a wrong offset!");
...
// Class MetasoundEngine.MetaSoundQuality
// 0x0000 (0x0028 - 0x0028)
class UMetaSoundQuality final : public UObject
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MetaSoundQuality">();
	}
	static class UMetaSoundQuality* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMetaSoundQuality>();
	}
};
static_assert(alignof(UMetaSoundQuality) == 0x000008, "Wrong alignment on UMetaSoundQuality");
static_assert(sizeof(UMetaSoundQuality) == 0x000028, "Wrong size on UMetaSoundQuality");
...
static_assert(sizeof(UMetaSoundPatch) == 0x000320, "Wrong size on UMetaSoundPatch");
static_assert(offsetof(UMetaSoundPatch, RootMetaSoundDocument) == 0x000058, "Member 'UMetaSoundPatch::RootMetaSoundDocument' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferencedAssetClassKeys) == 0x000218, "Member 'UMetaSoundPatch::ReferencedAssetClassKeys' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferencedAssetClassObjects) == 0x000268, "Member 'UMetaSoundPatch::ReferencedAssetClassObjects' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferenceAssetClassCache) == 0x0002B8, "Member 'UMetaSoundPatch::ReferenceAssetClassCache' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, AssetClassID) == 0x000308, "Member 'UMetaSoundPatch::AssetClassID' has a wrong offset!");
...
public:
	...
	class FName                                   QualitySetting;                                    // 0x0754(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPerPlatformFloat                      BlockRateOverride;                                 // 0x0758(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FPerPlatformInt                        SampleRateOverride;                                // 0x075C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FGuid                                  AssetClassID;                                      // 0x0760(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMetaSoundSource) == 0x000870, "Wrong size on UMetaSoundSource");
static_assert(offsetof(UMetaSoundSource, RootMetaSoundDocument) == 0x0004A0, "Member 'UMetaSoundSource::RootMetaSoundDocument' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, ReferencedAssetClassKeys) == 0x000660, "Member 'UMetaSoundSource::ReferencedAssetClassKeys' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, ReferencedAssetClassObjects) == 0x0006B0, "Member 'UMetaSoundSource::ReferencedAssetClassObjects' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, ReferenceAssetClassCache) == 0x000700, "Member 'UMetaSoundSource::ReferenceAssetClassCache' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, OutputFormat) == 0x000750, "Member 'UMetaSoundSource::OutputFormat' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, QualitySetting) == 0x000754, "Member 'UMetaSoundSource::QualitySetting' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, BlockRateOverride) == 0x000758, "Member 'UMetaSoundSource::BlockRateOverride' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, SampleRateOverride) == 0x00075C, "Member 'UMetaSoundSource::SampleRateOverride' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, AssetClassID) == 0x000760, "Member 'UMetaSoundSource::AssetClassID' has a wrong offset!");
