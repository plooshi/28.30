...
static_assert(alignof(UMissionGen_Athena_C) == 0x000010, "Wrong alignment on UMissionGen_Athena_C");
static_assert(sizeof(UMissionGen_Athena_C) == 0x000830, "Wrong size on UMissionGen_Athena_C");
