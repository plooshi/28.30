...
void UFortNevadaVehicleReticle::OnBatteryChanged(float BatteryLevel)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnBatteryChanged");
...
void UFortNevadaVehicleReticle::OnEnergyCannonEnabledChanged(const bool bEnabled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEnergyCannonEnabledChanged");
...
void UFortNevadaVehicleReticle::OnEnergyCanonFired(const float Cooldown)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEnergyCanonFired");
...
void UFortNevadaVehicleReticle::OnTractorBeamEnabledChanged(const bool bEnabled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnTractorBeamEnabledChanged");
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// ENevadaFlightStates                     VehicleState                                           (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UFortNevadaVehicleReticle::OnVehicleStateChanged(const ENevadaFlightStates VehicleState)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnVehicleStateChanged");
