...
static_assert(offsetof(UOctreeDynamicMeshComponent, MeshObject) == 0x000600, "Member 'UOctreeDynamicMeshComponent::MeshObject' has a wrong offset!");
...
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x000538, "Member 'ULineSetComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, Bounds) == 0x000540, "Member 'ULineSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(ULineSetComponent, bBoundsDirty) == 0x000578, "Member 'ULineSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(offsetof(UMeshWireframeComponent, LineDepthBias) == 0x000538, "Member 'UMeshWireframeComponent::LineDepthBias' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LineDepthBiasSizeScale) == 0x00053C, "Member 'UMeshWireframeComponent::LineDepthBiasSizeScale' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ThicknessScale) == 0x000540, "Member 'UMeshWireframeComponent::ThicknessScale' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableWireframe) == 0x000544, "Member 'UMeshWireframeComponent::bEnableWireframe' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, WireframeColor) == 0x000548, "Member 'UMeshWireframeComponent::WireframeColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, WireframeThickness) == 0x00054C, "Member 'UMeshWireframeComponent::WireframeThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableBoundaryEdges) == 0x000550, "Member 'UMeshWireframeComponent::bEnableBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeColor) == 0x000554, "Member 'UMeshWireframeComponent::BoundaryEdgeColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeThickness) == 0x000558, "Member 'UMeshWireframeComponent::BoundaryEdgeThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableUVSeams) == 0x00055C, "Member 'UMeshWireframeComponent::bEnableUVSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, UVSeamColor) == 0x000560, "Member 'UMeshWireframeComponent::UVSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, UVSeamThickness) == 0x000564, "Member 'UMeshWireframeComponent::UVSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableNormalSeams) == 0x000568, "Member 'UMeshWireframeComponent::bEnableNormalSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, NormalSeamColor) == 0x00056C, "Member 'UMeshWireframeComponent::NormalSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, NormalSeamThickness) == 0x000570, "Member 'UMeshWireframeComponent::NormalSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableTangentSeams) == 0x000574, "Member 'UMeshWireframeComponent::bEnableTangentSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, TangentSeamColor) == 0x000578, "Member 'UMeshWireframeComponent::TangentSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, TangentSeamThickness) == 0x00057C, "Member 'UMeshWireframeComponent::TangentSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, bEnableColorSeams) == 0x000580, "Member 'UMeshWireframeComponent::bEnableColorSeams' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ColorSeamColor) == 0x000584, "Member 'UMeshWireframeComponent::ColorSeamColor' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, ColorSeamThickness) == 0x000588, "Member 'UMeshWireframeComponent::ColorSeamThickness' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LineMaterial) == 0x000590, "Member 'UMeshWireframeComponent::LineMaterial' has a wrong offset!");
static_assert(offsetof(UMeshWireframeComponent, LocalBounds) == 0x000598, "Member 'UMeshWireframeComponent::LocalBounds' has a wrong offset!");
...
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x000538, "Member 'UPointSetComponent::PointMaterial' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, Bounds) == 0x000540, "Member 'UPointSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UPointSetComponent, bBoundsDirty) == 0x000578, "Member 'UPointSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(offsetof(UTriangleSetComponent, Bounds) == 0x000538, "Member 'UTriangleSetComponent::Bounds' has a wrong offset!");
static_assert(offsetof(UTriangleSetComponent, bBoundsDirty) == 0x000570, "Member 'UTriangleSetComponent::bBoundsDirty' has a wrong offset!");
...
static_assert(offsetof(UModelingComponentsSettings, bEnableRayTracingWhileEditing) == 0x000030, "Member 'UModelingComponentsSettings::bEnableRayTracingWhileEditing' has a wrong offset!");
static_assert(offsetof(UModelingComponentsSettings, bEnableRayTracing) == 0x000031, "Member 'UModelingComponentsSettings::bEnableRayTracing' has a wrong offset!");
static_assert(offsetof(UModelingComponentsSettings, bGenerateLightmapUVs) == 0x000032, "Member 'UModelingComponentsSettings::bGenerateLightmapUVs' has a wrong offset!");
static_assert(offsetof(UModelingComponentsSettings, bEnableCollision) == 0x000033, "Member 'UModelingComponentsSettings::bEnableCollision' has a wrong offset!");
static_assert(offsetof(UModelingComponentsSettings, CollisionMode) == 0x000034, "Member 'UModelingComponentsSettings::CollisionMode' has a wrong offset!");
...
static_assert(offsetof(UModelingComponentsEditorSettings, GridMode) == 0x000030, "Member 'UModelingComponentsEditorSettings::GridMode' has a wrong offset!");
static_assert(offsetof(UModelingComponentsEditorSettings, NumGridLines) == 0x000034, "Member 'UModelingComponentsEditorSettings::NumGridLines' has a wrong offset!");
static_assert(offsetof(UModelingComponentsEditorSettings, GridSpacing) == 0x000038, "Member 'UModelingComponentsEditorSettings::GridSpacing' has a wrong offset!");
static_assert(offsetof(UModelingComponentsEditorSettings, GridScale) == 0x00003C, "Member 'UModelingComponentsEditorSettings::GridScale' has a wrong offset!");
static_assert(offsetof(UModelingComponentsEditorSettings, GridSize) == 0x000040, "Member 'UModelingComponentsEditorSettings::GridSize' has a wrong offset!");
