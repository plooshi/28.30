...
static_assert(sizeof(UDataRegistrySource_CurveTable) == 0x000098, "Wrong size on UDataRegistrySource_CurveTable");
...
static_assert(offsetof(UDataRegistrySource_CurveTable, TableRules) == 0x000058, "Member 'UDataRegistrySource_CurveTable::TableRules' has a wrong offset!");
static_assert(offsetof(UDataRegistrySource_CurveTable, CachedTable) == 0x000060, "Member 'UDataRegistrySource_CurveTable::CachedTable' has a wrong offset!");
static_assert(offsetof(UDataRegistrySource_CurveTable, PreloadTable) == 0x000068, "Member 'UDataRegistrySource_CurveTable::PreloadTable' has a wrong offset!");
...
static_assert(sizeof(UDataRegistrySource_DataTable) == 0x000098, "Wrong size on UDataRegistrySource_DataTable");
...
static_assert(offsetof(UDataRegistrySource_DataTable, TableRules) == 0x000058, "Member 'UDataRegistrySource_DataTable::TableRules' has a wrong offset!");
static_assert(offsetof(UDataRegistrySource_DataTable, CachedTable) == 0x000060, "Member 'UDataRegistrySource_DataTable::CachedTable' has a wrong offset!");
static_assert(offsetof(UDataRegistrySource_DataTable, PreloadTable) == 0x000068, "Member 'UDataRegistrySource_DataTable::PreloadTable' has a wrong offset!");
