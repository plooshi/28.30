...
static_assert(sizeof(UJoinServer_C) == 0x0005E8, "Wrong size on UJoinServer_C");
static_assert(offsetof(UJoinServer_C, UberGraphFrame) == 0x0005D8, "Member 'UJoinServer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UJoinServer_C, BuildWatermark) == 0x0005E0, "Member 'UJoinServer_C::BuildWatermark' has a wrong offset!");
