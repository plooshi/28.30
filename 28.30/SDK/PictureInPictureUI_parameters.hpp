...
static_assert(offsetof(PictureInPicturePanelWidget_FlipPIPAudioSubmix, bForce) == 0x000070, "Member 'PictureInPicturePanelWidget_FlipPIPAudioSubmix::bForce' has a wrong offset!");
