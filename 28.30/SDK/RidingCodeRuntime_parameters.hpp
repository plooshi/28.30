...
static_assert(offsetof(RidableComponent_GetDismountLaunchVectorOverride, Rider) == 0x000000, "Member 'RidableComponent_GetDismountLaunchVectorOverride::Rider' has a wrong offset!");
static_assert(offsetof(RidableComponent_GetDismountLaunchVectorOverride, ReturnValue) == 0x000008, "Member 'RidableComponent_GetDismountLaunchVectorOverride::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(ControllableRidableComponent_OnCapsuleBeginOverlap) == 0x000108, "Wrong size on ControllableRidableComponent_OnCapsuleBeginOverlap");
...
static_assert(sizeof(RiderComponent_HandleRidableFound) == 0x0000E8, "Wrong size on RiderComponent_HandleRidableFound");
...
static_assert(offsetof(RiderComponent_HandleRidableMovementModeChanged, InCharacter) == 0x000000, "Member 'RiderComponent_HandleRidableMovementModeChanged::InCharacter' has a wrong offset!");
static_assert(offsetof(RiderComponent_HandleRidableMovementModeChanged, PrevMovementMode) == 0x000008, "Member 'RiderComponent_HandleRidableMovementModeChanged::PrevMovementMode' has a wrong offset!");
static_assert(offsetof(RiderComponent_HandleRidableMovementModeChanged, PreviousCustomMode) == 0x000009, "Member 'RiderComponent_HandleRidableMovementModeChanged::PreviousCustomMode' has a wrong offset!");
...
static_assert(offsetof(RiderComponent_SetRidingInputEnabled, bEnabled) == 0x000000, "Member 'RiderComponent_SetRidingInputEnabled::bEnabled' has a wrong offset!");
