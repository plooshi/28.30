...
void ULegacy_MovieWidget_C::ExecuteUbergraph_Legacy_MovieWidget(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Legacy_MovieWidget");
...
void ULegacy_MovieWidget_C::MediaDimensionsUpdated(float NewWidth, float NewHeight)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MediaDimensionsUpdated");
...
void ULegacy_MovieWidget_C::OnMediaLoaded()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnMediaLoaded");
...
void ULegacy_MovieWidget_C::SetDelayedContentValues()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetDelayedContentValues");
...
void ULegacy_MovieWidget_C::StopPlaying()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StopPlaying");
