...
public:
	...
	TDelegate<void(struct FActorInitStateChangedParams& Params)> Delegate;                                          // 0x0028(0x000C)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GameFrameworkComponentManager_RegisterAndCallForClassInitState) == 0x000038, "Wrong size on GameFrameworkComponentManager_RegisterAndCallForClassInitState");
...
static_assert(offsetof(GameFrameworkComponentManager_RegisterAndCallForClassInitState, FeatureName) == 0x000020, "Member 'GameFrameworkComponentManager_RegisterAndCallForClassInitState::FeatureName' has a wrong offset!");
static_assert(offsetof(GameFrameworkComponentManager_RegisterAndCallForClassInitState, RequiredState) == 0x000024, "Member 'GameFrameworkComponentManager_RegisterAndCallForClassInitState::RequiredState' has a wrong offset!");
static_assert(offsetof(GameFrameworkComponentManager_RegisterAndCallForClassInitState, Delegate) == 0x000028, "Member 'GameFrameworkComponentManager_RegisterAndCallForClassInitState::Delegate' has a wrong offset!");
static_assert(offsetof(GameFrameworkComponentManager_RegisterAndCallForClassInitState, bCallImmediately) == 0x000034, "Member 'GameFrameworkComponentManager_RegisterAndCallForClassInitState::bCallImmediately' has a wrong offset!");
static_assert(offsetof(GameFrameworkComponentManager_RegisterAndCallForClassInitState, ReturnValue) == 0x000035, "Member 'GameFrameworkComponentManager_RegisterAndCallForClassInitState::ReturnValue' has a wrong offset!");
...
public:
	TSoftClassPtr<class UClass>                   ActorClass;                                        // 0x0000(0x0020)(Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void(struct FActorInitStateChangedParams& Params)> DelegateToRemove;                                  // 0x0020(0x000C)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GameFrameworkComponentManager_UnregisterClassInitStateDelegate) == 0x000030, "Wrong size on GameFrameworkComponentManager_UnregisterClassInitStateDelegate");
...
static_assert(offsetof(GameFrameworkComponentManager_UnregisterClassInitStateDelegate, DelegateToRemove) == 0x000020, "Member 'GameFrameworkComponentManager_UnregisterClassInitStateDelegate::DelegateToRemove' has a wrong offset!");
static_assert(offsetof(GameFrameworkComponentManager_UnregisterClassInitStateDelegate, ReturnValue) == 0x00002C, "Member 'GameFrameworkComponentManager_UnregisterClassInitStateDelegate::ReturnValue' has a wrong offset!");
