...
void USocialPanel_C::BndEvt__SocialPanel_TopBarExtension_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(class UCommonButtonLegacy* Button)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BndEvt__SocialPanel_TopBarExtension_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
void USocialPanel_C::ClosePanel()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ClosePanel");
...
void USocialPanel_C::ClosePanelAfterAnimation()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ClosePanelAfterAnimation");
...
void USocialPanel_C::ExecuteUbergraph_SocialPanel(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_SocialPanel");
...
void USocialPanel_C::HandleIntroEnded()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleIntroEnded");
...
void USocialPanel_C::HandleOutroEnded()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleOutroEnded");
...
void USocialPanel_C::Play_Panel_Animation_Sound()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Play Panel Animation Sound");
