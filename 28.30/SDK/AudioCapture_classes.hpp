...
public:
	...
	uint8                                         Pad_884[0xBC];                                     // 0x0884(0x00BC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAudioCaptureComponent) == 0x000940, "Wrong size on UAudioCaptureComponent");
static_assert(offsetof(UAudioCaptureComponent, JitterLatencyFrames) == 0x000880, "Member 'UAudioCaptureComponent::JitterLatencyFrames' has a wrong offset!");
