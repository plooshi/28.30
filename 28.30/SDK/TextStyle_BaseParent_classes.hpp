...
static_assert(alignof(UTextStyle_BaseParent_C) == 0x000010, "Wrong alignment on UTextStyle_BaseParent_C");
static_assert(sizeof(UTextStyle_BaseParent_C) == 0x0001A0, "Wrong size on UTextStyle_BaseParent_C");
