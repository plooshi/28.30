...
public:
	struct FTargetingRequestHandle                TargetingHandle;                                   // 0x0000(0x0004)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTargetingDefaultResultData            TargetData;                                        // 0x0008(0x00F0)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(SimpleTargetingFilterTask_BP_ShouldFilterTarget) == 0x000100, "Wrong size on SimpleTargetingFilterTask_BP_ShouldFilterTarget");
...
static_assert(offsetof(SimpleTargetingFilterTask_BP_ShouldFilterTarget, ReturnValue) == 0x0000F8, "Member 'SimpleTargetingFilterTask_BP_ShouldFilterTarget::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(SimpleTargetingSelectionTask_AddHitResult) == 0x0000F8, "Wrong size on SimpleTargetingSelectionTask_AddHitResult");
...
static_assert(offsetof(SimpleTargetingSelectionTask_AddHitResult, ReturnValue) == 0x0000F0, "Member 'SimpleTargetingSelectionTask_AddHitResult::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(SimpleTargetingSortTask_BP_GetScoreForTarget) == 0x000100, "Wrong size on SimpleTargetingSortTask_BP_GetScoreForTarget");
...
static_assert(offsetof(SimpleTargetingSortTask_BP_GetScoreForTarget, ReturnValue) == 0x0000F8, "Member 'SimpleTargetingSortTask_BP_GetScoreForTarget::ReturnValue' has a wrong offset!");
