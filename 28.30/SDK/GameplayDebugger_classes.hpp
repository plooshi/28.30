...
static_assert(sizeof(AGameplayDebuggerCategoryReplicator) == 0x000348, "Wrong size on AGameplayDebuggerCategoryReplicator");
...
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, VisLogSync) == 0x0002C8, "Member 'AGameplayDebuggerCategoryReplicator::VisLogSync' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, RenderingComp) == 0x0002D8, "Member 'AGameplayDebuggerCategoryReplicator::RenderingComp' has a wrong offset!");
...
static_assert(sizeof(UGameplayDebuggerRenderingComponent) == 0x0005B0, "Wrong size on UGameplayDebuggerRenderingComponent");
