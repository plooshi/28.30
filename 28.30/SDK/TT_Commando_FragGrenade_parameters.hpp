...
static_assert(offsetof(TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000050, "Member 'TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000058, "Member 'TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal, K2Node_MakeStruct_FormatArgumentData) == 0x000060, "Member 'TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal, K2Node_MakeArray_Array) == 0x0000B0, "Member 'TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal, CallFunc_Format_ReturnValue) == 0x0000C0, "Member 'TT_Commando_FragGrenade_C_GetTextForTokenFromAbilityInstanceInternal::CallFunc_Format_ReturnValue' has a wrong offset!");
