...
static_assert(offsetof(FortConversationOption_GetUnlockLevel, ReturnValue) == 0x000000, "Member 'FortConversationOption_GetUnlockLevel::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FortConversationOption_IsLocked, ReturnValue) == 0x000000, "Member 'FortConversationOption_IsLocked::ReturnValue' has a wrong offset!");
