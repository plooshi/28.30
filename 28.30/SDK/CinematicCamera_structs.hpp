...
static_assert(offsetof(FCameraTrackingFocusSettings, RelativeOffset) == 0x000020, "Member 'FCameraTrackingFocusSettings::RelativeOffset' has a wrong offset!");
...
static_assert(sizeof(FCameraLookatTrackingSettings) == 0x000060, "Wrong size on FCameraLookatTrackingSettings");
