...
static_assert(sizeof(AMeshBeaconClient) == 0x0003A0, "Wrong size on AMeshBeaconClient");
static_assert(offsetof(AMeshBeaconClient, bConnectedToRoot) == 0x000360, "Member 'AMeshBeaconClient::bConnectedToRoot' has a wrong offset!");
static_assert(offsetof(AMeshBeaconClient, MeshPingTime) == 0x000368, "Member 'AMeshBeaconClient::MeshPingTime' has a wrong offset!");
static_assert(offsetof(AMeshBeaconClient, ParentIds) == 0x000370, "Member 'AMeshBeaconClient::ParentIds' has a wrong offset!");
static_assert(offsetof(AMeshBeaconClient, ClientId) == 0x000380, "Member 'AMeshBeaconClient::ClientId' has a wrong offset!");
...
static_assert(sizeof(AMeshBeaconHost) == 0x0003D8, "Wrong size on AMeshBeaconHost");
static_assert(offsetof(AMeshBeaconHost, MaxConnections) == 0x0003D0, "Member 'AMeshBeaconHost::MaxConnections' has a wrong offset!");
...
static_assert(sizeof(AMeshBeaconHostObject) == 0x0002D0, "Wrong size on AMeshBeaconHostObject");
...
static_assert(sizeof(UMeshConnection) == 0x001E90, "Wrong size on UMeshConnection");
...
public:
	...
	TArray<class AActor*>                         ClientDormantDynamicActors;                        // 0x0890(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMeshNetDriver) == 0x0008A0, "Wrong size on UMeshNetDriver");
static_assert(offsetof(UMeshNetDriver, ClientDormantDynamicActors) == 0x000890, "Member 'UMeshNetDriver::ClientDormantDynamicActors' has a wrong offset!");
