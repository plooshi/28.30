...
static_assert(sizeof(AFortAthenaMutator_WarEffort) == 0x0004F8, "Wrong size on AFortAthenaMutator_WarEffort");
static_assert(offsetof(AFortAthenaMutator_WarEffort, MeshNetworkMetadata) == 0x000498, "Member 'AFortAthenaMutator_WarEffort::MeshNetworkMetadata' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_WarEffort, WeaponChoices) == 0x0004B8, "Member 'AFortAthenaMutator_WarEffort::WeaponChoices' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_WarEffort, PreloadedItemList) == 0x0004C8, "Member 'AFortAthenaMutator_WarEffort::PreloadedItemList' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_WarEffort, bCanPreloadItems) == 0x0004D8, "Member 'AFortAthenaMutator_WarEffort::bCanPreloadItems' has a wrong offset!");
...
static_assert(sizeof(AWarEffortMeshActor) == 0x000318, "Wrong size on AWarEffortMeshActor");
static_assert(offsetof(AWarEffortMeshActor, MeshNetworkComponent) == 0x000290, "Member 'AWarEffortMeshActor::MeshNetworkComponent' has a wrong offset!");
static_assert(offsetof(AWarEffortMeshActor, ActiveFundedItems) == 0x000298, "Member 'AWarEffortMeshActor::ActiveFundedItems' has a wrong offset!");
static_assert(offsetof(AWarEffortMeshActor, ActiveTryBeforeYouBuyItems) == 0x0002A8, "Member 'AWarEffortMeshActor::ActiveTryBeforeYouBuyItems' has a wrong offset!");
static_assert(offsetof(AWarEffortMeshActor, CurrentFundingData) == 0x0002B8, "Member 'AWarEffortMeshActor::CurrentFundingData' has a wrong offset!");
