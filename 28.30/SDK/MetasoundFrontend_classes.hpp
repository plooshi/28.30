...
static_assert(sizeof(UMetaSoundBuilderDocument) == 0x0001F8, "Wrong size on UMetaSoundBuilderDocument");
...
static_assert(offsetof(UMetaSoundBuilderDocument, MetaSoundUClass) == 0x0001F0, "Member 'UMetaSoundBuilderDocument::MetaSoundUClass' has a wrong offset!");
