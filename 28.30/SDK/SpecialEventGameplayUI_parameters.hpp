...
static_assert(offsetof(SpecialEventPlayerInfoWidget_GetRepresentedPlayerState, ReturnValue) == 0x000000, "Member 'SpecialEventPlayerInfoWidget_GetRepresentedPlayerState::ReturnValue' has a wrong offset!");
