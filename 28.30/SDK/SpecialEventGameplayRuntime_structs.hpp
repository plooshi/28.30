...
static_assert(sizeof(FDestroyActorsAndComponentsMutator_ActorDefinition) == 0x000070, "Wrong size on FDestroyActorsAndComponentsMutator_ActorDefinition");
...
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, bStartEnabled) == 0x000040, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::bStartEnabled' has a wrong offset!");
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, bDestroyActorOnServer) == 0x000041, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::bDestroyActorOnServer' has a wrong offset!");
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, bDestroyActorOnClient) == 0x000042, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::bDestroyActorOnClient' has a wrong offset!");
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, bNetForceOnActorDestroy) == 0x000043, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::bNetForceOnActorDestroy' has a wrong offset!");
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, bShouldModifyLevelOnActorDestroy) == 0x000044, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::bShouldModifyLevelOnActorDestroy' has a wrong offset!");
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, ComponentDefinitions) == 0x000048, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::ComponentDefinitions' has a wrong offset!");
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, bCurrentlyEnabled) == 0x000058, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::bCurrentlyEnabled' has a wrong offset!");
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, bPermanentlyDisabled) == 0x000059, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::bPermanentlyDisabled' has a wrong offset!");
static_assert(offsetof(FDestroyActorsAndComponentsMutator_ActorDefinition, ActorsToProcess) == 0x000060, "Member 'FDestroyActorsAndComponentsMutator_ActorDefinition::ActorsToProcess' has a wrong offset!");
...
static_assert(sizeof(FSpecialEventCursorMode) == 0x0002E8, "Wrong size on FSpecialEventCursorMode");
...
static_assert(offsetof(FSpecialEventCursorMode, RecenterAfterNoInputDelay) == 0x000290, "Member 'FSpecialEventCursorMode::RecenterAfterNoInputDelay' has a wrong offset!");
static_assert(offsetof(FSpecialEventCursorMode, RecenterInterpSpeed) == 0x0002B8, "Member 'FSpecialEventCursorMode::RecenterInterpSpeed' has a wrong offset!");
...
static_assert(alignof(FPhaseLevelEntryBase) == 0x000008, "Wrong alignment on FPhaseLevelEntryBase");
static_assert(sizeof(FPhaseLevelEntryBase) == 0x000060, "Wrong size on FPhaseLevelEntryBase");
static_assert(offsetof(FPhaseLevelEntryBase, bLoadLevelOnScriptStart) == 0x000008, "Member 'FPhaseLevelEntryBase::bLoadLevelOnScriptStart' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntryBase, bLevelStartsVisible) == 0x000009, "Member 'FPhaseLevelEntryBase::bLevelStartsVisible' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntryBase, bUnloadLevelOnPhaseEnd) == 0x00000A, "Member 'FPhaseLevelEntryBase::bUnloadLevelOnPhaseEnd' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntryBase, bMakeVisibleOnPhaseStart) == 0x00000B, "Member 'FPhaseLevelEntryBase::bMakeVisibleOnPhaseStart' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntryBase, MakeVisibleAtPhaseTags) == 0x000010, "Member 'FPhaseLevelEntryBase::MakeVisibleAtPhaseTags' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntryBase, UnloadLevelAtPhaseTags) == 0x000030, "Member 'FPhaseLevelEntryBase::UnloadLevelAtPhaseTags' has a wrong offset!");
...
static_assert(sizeof(FPhaseLevelEntry) == 0x0000D0, "Wrong size on FPhaseLevelEntry");
static_assert(offsetof(FPhaseLevelEntry, LevelToLoad) == 0x000060, "Member 'FPhaseLevelEntry::LevelToLoad' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntry, LevelName) == 0x000080, "Member 'FPhaseLevelEntry::LevelName' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntry, bExcludeFromServerPreload) == 0x000090, "Member 'FPhaseLevelEntry::bExcludeFromServerPreload' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntry, Location) == 0x000098, "Member 'FPhaseLevelEntry::Location' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntry, Rotation) == 0x0000B0, "Member 'FPhaseLevelEntry::Rotation' has a wrong offset!");
static_assert(offsetof(FPhaseLevelEntry, LevelInstance) == 0x0000C8, "Member 'FPhaseLevelEntry::LevelInstance' has a wrong offset!");
...
static_assert(alignof(FPhaseDataLayerEntry) == 0x000008, "Wrong alignment on FPhaseDataLayerEntry");
static_assert(sizeof(FPhaseDataLayerEntry) == 0x000080, "Wrong size on FPhaseDataLayerEntry");
static_assert(offsetof(FPhaseDataLayerEntry, DataLayerAsset) == 0x000060, "Member 'FPhaseDataLayerEntry::DataLayerAsset' has a wrong offset!");
static_assert(offsetof(FPhaseDataLayerEntry, bIsRecursive) == 0x000068, "Member 'FPhaseDataLayerEntry::bIsRecursive' has a wrong offset!");
...
static_assert(offsetof(FPhaseInfo, PhaseTag) == 0x000000, "Member 'FPhaseInfo::PhaseTag' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, PhaseDuration) == 0x000004, "Member 'FPhaseInfo::PhaseDuration' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, bSetRelevancyMode) == 0x000008, "Member 'FPhaseInfo::bSetRelevancyMode' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, RelevancyMode) == 0x000009, "Member 'FPhaseInfo::RelevancyMode' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, NumOfSquadsInRelevancyGroup) == 0x00000C, "Member 'FPhaseInfo::NumOfSquadsInRelevancyGroup' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, RequireLevelsFromPhaseTags) == 0x000010, "Member 'FPhaseInfo::RequireLevelsFromPhaseTags' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, bStartNextPhaseOnPhaseFinished) == 0x000030, "Member 'FPhaseInfo::bStartNextPhaseOnPhaseFinished' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, bGarbageCollectAtPhaseStartOnServer) == 0x000031, "Member 'FPhaseInfo::bGarbageCollectAtPhaseStartOnServer' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, bGarbageCollectAtPhaseStartOnClient) == 0x000032, "Member 'FPhaseInfo::bGarbageCollectAtPhaseStartOnClient' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, PhaseActor) == 0x000038, "Member 'FPhaseInfo::PhaseActor' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, Levels) == 0x000040, "Member 'FPhaseInfo::Levels' has a wrong offset!");
static_assert(offsetof(FPhaseInfo, DataLayers) == 0x000050, "Member 'FPhaseInfo::DataLayers' has a wrong offset!");
