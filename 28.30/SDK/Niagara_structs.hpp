...
public:
	...
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   DisplayNameOverride;                               // 0x0008(0x0018)(Edit, NativeAccessSpecifierPublic)
	class UTexture2D*                             DisplayIcon;                                       // 0x0020(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWidgetSegmentValueOverride) == 0x000008, "Wrong alignment on FWidgetSegmentValueOverride");
static_assert(sizeof(FWidgetSegmentValueOverride) == 0x000028, "Wrong size on FWidgetSegmentValueOverride");
...
static_assert(offsetof(FWidgetSegmentValueOverride, DisplayIcon) == 0x000020, "Member 'FWidgetSegmentValueOverride::DisplayIcon' has a wrong offset!");
...
public:
	...
	struct FNiagaraInputParameterCustomization    WidgetCustomization;                               // 0x0128(0x0058)(Edit, NativeAccessSpecifierPublic)
	struct FGuid                                  VariableGuid;                                      // 0x0180(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsStaticSwitch;                                   // 0x0190(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_191[0x3];                                      // 0x0191(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         StaticSwitchDefaultValue;                          // 0x0194(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
static_assert(offsetof(FNiagaraVariableMetaData, WidgetCustomization) == 0x000128, "Member 'FNiagaraVariableMetaData::WidgetCustomization' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, VariableGuid) == 0x000180, "Member 'FNiagaraVariableMetaData::VariableGuid' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bIsStaticSwitch) == 0x000190, "Member 'FNiagaraVariableMetaData::bIsStaticSwitch' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, StaticSwitchDefaultValue) == 0x000194, "Member 'FNiagaraVariableMetaData::StaticSwitchDefaultValue' has a wrong offset!");
...
static_assert(sizeof(FNiagaraRendererMaterialStaticBoolParameter) == 0x000008, "Wrong size on FNiagaraRendererMaterialStaticBoolParameter");
...
static_assert(offsetof(FNiagaraRendererMaterialStaticBoolParameter, StaticVariableName) == 0x000004, "Member 'FNiagaraRendererMaterialStaticBoolParameter::StaticVariableName' has a wrong offset!");
...
static_assert(offsetof(FNiagaraFunctionSignature, MiscUsageBitMask) == 0x000034, "Member 'FNiagaraFunctionSignature::MiscUsageBitMask' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScriptUObjectCompileInfo) == 0x000040, "Wrong size on FNiagaraScriptUObjectCompileInfo");
...
static_assert(offsetof(FNiagaraScriptUObjectCompileInfo, Object) == 0x000008, "Member 'FNiagaraScriptUObjectCompileInfo::Object' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptUObjectCompileInfo, ObjectPath) == 0x000010, "Member 'FNiagaraScriptUObjectCompileInfo::ObjectPath' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptUObjectCompileInfo, RegisteredParameterMapRead) == 0x000028, "Member 'FNiagaraScriptUObjectCompileInfo::RegisteredParameterMapRead' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptUObjectCompileInfo, RegisteredParameterMapWrites) == 0x000030, "Member 'FNiagaraScriptUObjectCompileInfo::RegisteredParameterMapWrites' has a wrong offset!");
...
static_assert(sizeof(FNiagaraResolvedUObjectInfo) == 0x000018, "Wrong size on FNiagaraResolvedUObjectInfo");
...
static_assert(offsetof(FNiagaraResolvedUObjectInfo, ResolvedVariable) == 0x000004, "Member 'FNiagaraResolvedUObjectInfo::ResolvedVariable' has a wrong offset!");
static_assert(offsetof(FNiagaraResolvedUObjectInfo, Object) == 0x000010, "Member 'FNiagaraResolvedUObjectInfo::Object' has a wrong offset!");
...
static_assert(sizeof(FNiagaraExternalUObjectInfo) == 0x00000C, "Wrong size on FNiagaraExternalUObjectInfo");
...
static_assert(offsetof(FNiagaraExternalUObjectInfo, ExternalName) == 0x000008, "Member 'FNiagaraExternalUObjectInfo::ExternalName' has a wrong offset!");
...
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, CompileName) == 0x00000C, "Member 'FNiagaraScriptDataInterfaceInfo::CompileName' has a wrong offset!");
...
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, RegisteredParameterMapWrite) == 0x00002C, "Member 'FNiagaraScriptDataInterfaceInfo::RegisteredParameterMapWrite' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptDataInterfaceInfo, SourceEmitterName) == 0x000030, "Member 'FNiagaraScriptDataInterfaceInfo::SourceEmitterName' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScriptResolvedDataInterfaceInfo) == 0x000040, "Wrong size on FNiagaraScriptResolvedDataInterfaceInfo");
...
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, CompileName) == 0x000004, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::CompileName' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, ResolvedSourceEmitterName) == 0x000008, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::ResolvedSourceEmitterName' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, ResolvedVariable) == 0x000018, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::ResolvedVariable' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, ParameterStoreVariable) == 0x000020, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::ParameterStoreVariable' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, bIsInternal) == 0x000028, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::bIsInternal' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, ResolvedDataInterface) == 0x000030, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::ResolvedDataInterface' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptResolvedDataInterfaceInfo, UserPtrIdx) == 0x000038, "Member 'FNiagaraScriptResolvedDataInterfaceInfo::UserPtrIdx' has a wrong offset!");
...
static_assert(offsetof(FNiagaraScriptDataInterfaceCompileInfo, SourceEmitterName) == 0x000028, "Member 'FNiagaraScriptDataInterfaceCompileInfo::SourceEmitterName' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVariableAttributeBinding) == 0x000028, "Wrong size on FNiagaraVariableAttributeBinding");
...
static_assert(offsetof(FNiagaraVariableAttributeBinding, ParamMapVariable) == 0x000018, "Member 'FNiagaraVariableAttributeBinding::ParamMapVariable' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableAttributeBinding, DataSetName) == 0x000020, "Member 'FNiagaraVariableAttributeBinding::DataSetName' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableAttributeBinding, BindingSourceMode) == 0x000024, "Member 'FNiagaraVariableAttributeBinding::BindingSourceMode' has a wrong offset!");
...
public:
	...
	TArray<struct FNiagaraVariable>               RapidIterationParameters;                          // 0x00A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, class UNiagaraDataInterface*> NamedDataInterfaces;                               // 0x00B0(0x0050)(UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraScriptAsyncCompileData) == 0x000008, "Wrong alignment on FNiagaraScriptAsyncCompileData");
static_assert(sizeof(FNiagaraScriptAsyncCompileData) == 0x000100, "Wrong size on FNiagaraScriptAsyncCompileData");
static_assert(offsetof(FNiagaraScriptAsyncCompileData, RapidIterationParameters) == 0x0000A0, "Member 'FNiagaraScriptAsyncCompileData::RapidIterationParameters' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptAsyncCompileData, NamedDataInterfaces) == 0x0000B0, "Member 'FNiagaraScriptAsyncCompileData::NamedDataInterfaces' has a wrong offset!");
...
static_assert(sizeof(FNiagaraDynamicMeshMaterial) == 0x000020, "Wrong size on FNiagaraDynamicMeshMaterial");
...
static_assert(sizeof(FNiagaraParameterBinding) == 0x000008, "Wrong size on FNiagaraParameterBinding");
...
static_assert(sizeof(FNiagaraParameterBindingWithValue) == 0x000018, "Wrong size on FNiagaraParameterBindingWithValue");
static_assert(offsetof(FNiagaraParameterBindingWithValue, DefaultValue) == 0x000008, "Member 'FNiagaraParameterBindingWithValue::DefaultValue' has a wrong offset!");
...
static_assert(sizeof(FNiagaraComponentPropertyBinding) == 0x000098, "Wrong size on FNiagaraComponentPropertyBinding");
...
static_assert(offsetof(FNiagaraComponentPropertyBinding, PropertyName) == 0x000028, "Member 'FNiagaraComponentPropertyBinding::PropertyName' has a wrong offset!");
static_assert(offsetof(FNiagaraComponentPropertyBinding, PropertyType) == 0x000030, "Member 'FNiagaraComponentPropertyBinding::PropertyType' has a wrong offset!");
static_assert(offsetof(FNiagaraComponentPropertyBinding, MetadataSetterName) == 0x000040, "Member 'FNiagaraComponentPropertyBinding::MetadataSetterName' has a wrong offset!");
static_assert(offsetof(FNiagaraComponentPropertyBinding, PropertySetterParameterDefaults) == 0x000048, "Member 'FNiagaraComponentPropertyBinding::PropertySetterParameterDefaults' has a wrong offset!");
...
static_assert(offsetof(FNiagaraEmitterHandle, ID) == 0x000004, "Member 'FNiagaraEmitterHandle::ID' has a wrong offset!");
static_assert(offsetof(FNiagaraEmitterHandle, IdName) == 0x000014, "Member 'FNiagaraEmitterHandle::IdName' has a wrong offset!");
...
static_assert(offsetof(FNiagaraEmitterHandle, VersionedInstance) == 0x000020, "Member 'FNiagaraEmitterHandle::VersionedInstance' has a wrong offset!");
...
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, LODMode) == 0x000010, "Member 'FNiagaraMeshRendererMeshProperties::LODMode' has a wrong offset!");
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, LODLevel) == 0x000014, "Member 'FNiagaraMeshRendererMeshProperties::LODLevel' has a wrong offset!");
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, LODBias) == 0x000018, "Member 'FNiagaraMeshRendererMeshProperties::LODBias' has a wrong offset!");
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, LODDistanceFactor) == 0x00001C, "Member 'FNiagaraMeshRendererMeshProperties::LODDistanceFactor' has a wrong offset!");
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, bUseLODRange) == 0x000020, "Member 'FNiagaraMeshRendererMeshProperties::bUseLODRange' has a wrong offset!");
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, LODRange) == 0x000024, "Member 'FNiagaraMeshRendererMeshProperties::LODRange' has a wrong offset!");
...
static_assert(sizeof(FNiagaraBoundParameter) == 0x000010, "Wrong size on FNiagaraBoundParameter");
...
static_assert(offsetof(FNiagaraBoundParameter, SrcOffset) == 0x000008, "Member 'FNiagaraBoundParameter::SrcOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraBoundParameter, DestOffset) == 0x00000C, "Member 'FNiagaraBoundParameter::DestOffset' has a wrong offset!");
...
static_assert(sizeof(FNiagaraSimCacheDataBuffersLayout) == 0x0000B0, "Wrong size on FNiagaraSimCacheDataBuffersLayout");
...
static_assert(offsetof(FNiagaraSimCacheDataBuffersLayout, bAllowInterpolation) == 0x00001F, "Member 'FNiagaraSimCacheDataBuffersLayout::bAllowInterpolation' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheDataBuffersLayout, bAllowVelocityExtrapolation) == 0x000020, "Member 'FNiagaraSimCacheDataBuffersLayout::bAllowVelocityExtrapolation' has a wrong offset!");
...
static_assert(offsetof(FNiagaraSimCacheDataBuffersLayout, InterpVariableNames) == 0x000038, "Member 'FNiagaraSimCacheDataBuffersLayout::InterpVariableNames' has a wrong offset!");
static_assert(offsetof(FNiagaraSimCacheDataBuffersLayout, ComponentVelocity) == 0x000048, "Member 'FNiagaraSimCacheDataBuffersLayout::ComponentVelocity' has a wrong offset!");
...
static_assert(sizeof(FNiagaraSimCacheLayout) == 0x0000C0, "Wrong size on FNiagaraSimCacheLayout");
...
static_assert(offsetof(FNiagaraSimCacheLayout, EmitterLayouts) == 0x0000B0, "Member 'FNiagaraSimCacheLayout::EmitterLayouts' has a wrong offset!");
