...
static_assert(offsetof(FortComponent_Energy_HandleAbilitySystemComponentInitialized, AbilitySystemComponent) == 0x000000, "Member 'FortComponent_Energy_HandleAbilitySystemComponentInitialized::AbilitySystemComponent' has a wrong offset!");
static_assert(offsetof(FortComponent_Energy_HandleAbilitySystemComponentInitialized, PlayerPawn) == 0x000008, "Member 'FortComponent_Energy_HandleAbilitySystemComponentInitialized::PlayerPawn' has a wrong offset!");
