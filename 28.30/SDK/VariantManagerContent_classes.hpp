...
static_assert(sizeof(ALevelVariantSetsActor) == 0x0002F8, "Wrong size on ALevelVariantSetsActor");
...
static_assert(offsetof(ALevelVariantSetsActor, DirectorInstances) == 0x0002A8, "Member 'ALevelVariantSetsActor::DirectorInstances' has a wrong offset!");
...
static_assert(sizeof(UVariantObjectBinding) == 0x000088, "Wrong size on UVariantObjectBinding");
...
static_assert(offsetof(UVariantObjectBinding, CapturedProperties) == 0x000068, "Member 'UVariantObjectBinding::CapturedProperties' has a wrong offset!");
static_assert(offsetof(UVariantObjectBinding, FunctionCallers) == 0x000078, "Member 'UVariantObjectBinding::FunctionCallers' has a wrong offset!");
