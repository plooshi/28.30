...
static_assert(alignof(VerseColors::U_SolarisSignatureFunctionOuter) == 0x000008, "Wrong alignment on VerseColors::U_SolarisSignatureFunctionOuter");
static_assert(sizeof(VerseColors::U_SolarisSignatureFunctionOuter) == 0x000028, "Wrong size on VerseColors::U_SolarisSignatureFunctionOuter");
