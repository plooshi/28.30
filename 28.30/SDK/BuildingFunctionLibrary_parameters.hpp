...
public:
	...
	struct FHitResult                             CallFunc_Array_Get_Item;                           // 0x00C8(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class UClass*                                 CallFunc_Array_Get_Item_1;                         // 0x0298(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Greater_IntInt_ReturnValue_1;             // 0x02B4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UClass*                                 CallFunc_Array_Get_Item_2;                         // 0x02C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SphereTraceMultiForObjects_Radius_ImplicitCast; // 0x02CC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BuildingFunctionLibrary_C_SweepAgainstActorTypes) == 0x0002D0, "Wrong size on BuildingFunctionLibrary_C_SweepAgainstActorTypes");
...
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_Less_IntInt_ReturnValue_2) == 0x0001B0, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_bBlockingHit) == 0x0001B1, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_bInitialOverlap) == 0x0001B2, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_Time) == 0x0001B4, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_Distance) == 0x0001B8, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_Location) == 0x0001C0, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_ImpactPoint) == 0x0001D8, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_Normal) == 0x0001F0, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_ImpactNormal) == 0x000208, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_PhysMat) == 0x000220, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_HitActor) == 0x000228, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_HitComponent) == 0x000230, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_HitBoneName) == 0x000238, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_BoneName) == 0x00023C, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_BoneName' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_HitItem) == 0x000240, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_ElementIndex) == 0x000244, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_FaceIndex) == 0x000248, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_TraceStart) == 0x000250, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_BreakHitResult_TraceEnd) == 0x000268, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_IsValid_ReturnValue_1) == 0x000280, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_GetObjectClass_ReturnValue) == 0x000288, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_GetObjectClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_Add_IntInt_ReturnValue_2) == 0x000290, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, Temp_int_Array_Index_Variable_1) == 0x000294, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_Array_Get_Item_1) == 0x000298, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_GetOverlappingActors_OverlappingActors) == 0x0002A0, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_GetOverlappingActors_OverlappingActors' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_Array_Length_ReturnValue_4) == 0x0002B0, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_Array_Length_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_Greater_IntInt_ReturnValue_1) == 0x0002B4, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_Greater_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, Temp_int_Array_Index_Variable_2) == 0x0002B8, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::Temp_int_Array_Index_Variable_2' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_Array_Get_Item_2) == 0x0002C0, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_ClassIsChildOf_ReturnValue) == 0x0002C8, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_ClassIsChildOf_ReturnValue' has a wrong offset!");
static_assert(offsetof(BuildingFunctionLibrary_C_SweepAgainstActorTypes, CallFunc_SphereTraceMultiForObjects_Radius_ImplicitCast) == 0x0002CC, "Member 'BuildingFunctionLibrary_C_SweepAgainstActorTypes::CallFunc_SphereTraceMultiForObjects_Radius_ImplicitCast' has a wrong offset!");
