...
public:
	...
	struct FPerPlatformInt                        SampleRate;                                        // 0x0004(0x0004)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformFloat                      BlockRate;                                         // 0x0008(0x0004)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMetaSoundQualitySettings) == 0x000004, "Wrong alignment on FMetaSoundQualitySettings");
static_assert(sizeof(FMetaSoundQualitySettings) == 0x00000C, "Wrong size on FMetaSoundQualitySettings");
static_assert(offsetof(FMetaSoundQualitySettings, Name) == 0x000000, "Member 'FMetaSoundQualitySettings::Name' has a wrong offset!");
static_assert(offsetof(FMetaSoundQualitySettings, SampleRate) == 0x000004, "Member 'FMetaSoundQualitySettings::SampleRate' has a wrong offset!");
static_assert(offsetof(FMetaSoundQualitySettings, BlockRate) == 0x000008, "Member 'FMetaSoundQualitySettings::BlockRate' has a wrong offset!");
...
static_assert(offsetof(FMetaSoundBuilderOptions, bForceUniqueClassName) == 0x000004, "Member 'FMetaSoundBuilderOptions::bForceUniqueClassName' has a wrong offset!");
static_assert(offsetof(FMetaSoundBuilderOptions, bAddToRegistry) == 0x000005, "Member 'FMetaSoundBuilderOptions::bAddToRegistry' has a wrong offset!");
static_assert(offsetof(FMetaSoundBuilderOptions, ExistingMetaSound) == 0x000008, "Member 'FMetaSoundBuilderOptions::ExistingMetaSound' has a wrong offset!");
