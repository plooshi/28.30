...
public:
	...
	TArray<class FName> CreateControlsFromSkeletalMesh(class USkeletalMeshComponent* SkeletalMeshComponent, const TArray<class FName>& BoneNames, const EPhysicsControlType ControlType, const struct FPhysicsControlData& ControlData, const struct FPhysicsControlSettings& ControlSettings, const class FName Set);
...
static_assert(sizeof(UPhysicsControlComponent) == 0x000270, "Wrong size on UPhysicsControlComponent");
...
public:
	...
	float                                         TestValue;                                         // 0x0050(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPhysicsControlProfileAsset) == 0x000058, "Wrong size on UPhysicsControlProfileAsset");
static_assert(offsetof(UPhysicsControlProfileAsset, PreviewSkeletalMesh) == 0x000030, "Member 'UPhysicsControlProfileAsset::PreviewSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UPhysicsControlProfileAsset, TestValue) == 0x000050, "Member 'UPhysicsControlProfileAsset::TestValue' has a wrong offset!");
...
{
public:
	struct FInitialCharacterControls              InitialCharacterControls;                          // 0x0220(0x00D8)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TMap<class FName, struct FInitialPhysicsControl> InitialControls;                                   // 0x02F8(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TMap<class FName, struct FInitialBodyModifier> InitialBodyModifiers;                              // 0x0348(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bCreateControlsAtBeginPlay;                        // 0x0398(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPhysicsControlInitializerComponent) == 0x0003A0, "Wrong size on UPhysicsControlInitializerComponent");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialCharacterControls) == 0x000220, "Member 'UPhysicsControlInitializerComponent::InitialCharacterControls' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialControls) == 0x0002F8, "Member 'UPhysicsControlInitializerComponent::InitialControls' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialBodyModifiers) == 0x000348, "Member 'UPhysicsControlInitializerComponent::InitialBodyModifiers' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, bCreateControlsAtBeginPlay) == 0x000398, "Member 'UPhysicsControlInitializerComponent::bCreateControlsAtBeginPlay' has a wrong offset!");
