...
static_assert(offsetof(UDisplaceMeshCommonProperties, WeightMapsList) == 0x0000C0, "Member 'UDisplaceMeshCommonProperties::WeightMapsList' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshCommonProperties, bInvertWeightMap) == 0x0000D0, "Member 'UDisplaceMeshCommonProperties::bInvertWeightMap' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshCommonProperties, bShowWireframe) == 0x0000D1, "Member 'UDisplaceMeshCommonProperties::bShowWireframe' has a wrong offset!");
static_assert(offsetof(UDisplaceMeshCommonProperties, bDisableSizeWarning) == 0x0000D2, "Member 'UDisplaceMeshCommonProperties::bDisableSizeWarning' has a wrong offset!");
...
static_assert(offsetof(USelectiveTessellationProperties, MaterialIDList) == 0x0000B0, "Member 'USelectiveTessellationProperties::MaterialIDList' has a wrong offset!");
...
static_assert(sizeof(UDynamicMeshBrushTool) == 0x0002C8, "Wrong size on UDynamicMeshBrushTool");
static_assert(offsetof(UDynamicMeshBrushTool, PreviewMesh) == 0x000288, "Member 'UDynamicMeshBrushTool::PreviewMesh' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2D8[0x4E8];                                    // 0x02D8(0x04E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMeshAttributePaintTool, BrushActionProps) == 0x0002C8, "Member 'UMeshAttributePaintTool::BrushActionProps' has a wrong offset!");
static_assert(offsetof(UMeshAttributePaintTool, AttribProps) == 0x0002D0, "Member 'UMeshAttributePaintTool::AttribProps' has a wrong offset!");
...
static_assert(sizeof(UMeshSelectionTool) == 0x0006F0, "Wrong size on UMeshSelectionTool");
static_assert(offsetof(UMeshSelectionTool, SelectionProps) == 0x0002D0, "Member 'UMeshSelectionTool::SelectionProps' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SelectionActions) == 0x0002D8, "Member 'UMeshSelectionTool::SelectionActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, EditActions) == 0x0002E0, "Member 'UMeshSelectionTool::EditActions' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, MeshStatisticsProperties) == 0x0002E8, "Member 'UMeshSelectionTool::MeshStatisticsProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, MeshElementsDisplay) == 0x0002F0, "Member 'UMeshSelectionTool::MeshElementsDisplay' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, UVChannelProperties) == 0x0002F8, "Member 'UMeshSelectionTool::UVChannelProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, PolygroupLayerProperties) == 0x000300, "Member 'UMeshSelectionTool::PolygroupLayerProperties' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, Selection) == 0x000360, "Member 'UMeshSelectionTool::Selection' has a wrong offset!");
static_assert(offsetof(UMeshSelectionTool, SpawnedActors) == 0x000368, "Member 'UMeshSelectionTool::SpawnedActors' has a wrong offset!");
...
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, WeightMapsList) == 0x0000C0, "Member 'UMeshVertexPaintToolUtilityActions::WeightMapsList' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, TargetChannels) == 0x0000D0, "Member 'UMeshVertexPaintToolUtilityActions::TargetChannels' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, TargetChannel) == 0x0000D4, "Member 'UMeshVertexPaintToolUtilityActions::TargetChannel' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, bCopyToHiRes) == 0x0000D5, "Member 'UMeshVertexPaintToolUtilityActions::bCopyToHiRes' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, CopyToLODName) == 0x0000D8, "Member 'UMeshVertexPaintToolUtilityActions::CopyToLODName' has a wrong offset!");
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, LODNamesList) == 0x0000E8, "Member 'UMeshVertexPaintToolUtilityActions::LODNamesList' has a wrong offset!");
...
public:
	...
	ECollisionGeometryMode                        SetCollisionType;                                  // 0x00E4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUsingMultipleInputs;                              // 0x00E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_E9[0x7];                                       // 0x00E9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(USetCollisionGeometryToolProperties, SetCollisionType) == 0x0000E4, "Member 'USetCollisionGeometryToolProperties::SetCollisionType' has a wrong offset!");
static_assert(offsetof(USetCollisionGeometryToolProperties, bUsingMultipleInputs) == 0x0000E8, "Member 'USetCollisionGeometryToolProperties::bUsingMultipleInputs' has a wrong offset!");
...
static_assert(offsetof(USeamSculptTool, Settings) == 0x0002C8, "Member 'USeamSculptTool::Settings' has a wrong offset!");
static_assert(offsetof(USeamSculptTool, PreviewGeom) == 0x0002D0, "Member 'USeamSculptTool::PreviewGeom' has a wrong offset!");
