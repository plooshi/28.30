...
static_assert(sizeof(FEventModeFocusActor) == 0x000048, "Wrong size on FEventModeFocusActor");
static_assert(offsetof(FEventModeFocusActor, Target) == 0x000000, "Member 'FEventModeFocusActor::Target' has a wrong offset!");
static_assert(offsetof(FEventModeFocusActor, Distance) == 0x000020, "Member 'FEventModeFocusActor::Distance' has a wrong offset!");
static_assert(offsetof(FEventModeFocusActor, Offset) == 0x000028, "Member 'FEventModeFocusActor::Offset' has a wrong offset!");
static_assert(offsetof(FEventModeFocusActor, FOV) == 0x000040, "Member 'FEventModeFocusActor::FOV' has a wrong offset!");
