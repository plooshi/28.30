...
enum class EFortUIFeature : uint8
{
	...
	ShowSpatialUI                            = 43,
	ShowSocial                               = 44,
	ShowAccountBoosts                        = 45,
	ShowCustomerSupport                      = 46,
	ShowGlobalChat                           = 47,
	ShowEULA                                 = 48,
	ShowEndOfZoneCinematic                   = 49,
	ShowOnboardingCinematics                 = 50,
	ShowFounderBannerIcons                   = 51,
	ShowCurrentRegionInLobby                 = 52,
	ShowPrerollLlamas                        = 53,
	EnableFoundersDailyRewards               = 54,
	EnableMatchmakingRegionSetting           = 55,
	EnableLanguageSetting                    = 56,
	EnableFriendCodeSetting                  = 57,
	EnableEarlyAccessLoadingScreenBanner     = 58,
	EnableAlterationModifications            = 59,
	EnableSchematicRarityUpgrade             = 60,
	EnableMissionActivationVote              = 61,
	EnableLtmRetrieveTheData                 = 62,
	EnableUpgradesVideos                     = 63,
	ShowPreviewTestTab                       = 64,
	EnableSearchTabInTopNavigationBar        = 65,
	EnableDiscoverTabInTopNavigationBar      = 66,
	EnableLibraryTabInTopNavigationBar       = 67,
	PlaceholderUIFeature1                    = 68,
	PlaceholderUIFeature2                    = 69,
	PlaceholderUIFeature3                    = 70,
	PlaceholderUIFeature4                    = 71,
	PlaceholderUIFeature5                    = 72,
	Max_None                                 = 73,
};
...
// NumValues: 0x0003
enum class EFortSocialPlatformTagDisplayRule : uint32
{
	Never                                    = 0,
	OnlyIfDifferent                          = 1,
	Always                                   = 2,
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_Configuration) == 0x000140, "Wrong size on FFortItemCard_PowerRatingBlock_Configuration");
...
static_assert(offsetof(FFortItemCard_PowerRatingBlock_Configuration, ComparisonIndicatorSize) == 0x000130, "Member 'FFortItemCard_PowerRatingBlock_Configuration::ComparisonIndicatorSize' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration) == 0x000300, "Wrong size on FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, PersonnelPowerRatingIconBrush) == 0x000140, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::PersonnelPowerRatingIconBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, PersonnelPowerRatingTextStyle) == 0x000200, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::PersonnelPowerRatingTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, SchematicPowerRatingIconBrush) == 0x000220, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::SchematicPowerRatingIconBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration, SchematicPowerRatingTextStyle) == 0x0002E0, "Member 'FFortItemCard_PowerRatingBlock_PersonnelAndSchematics_Configuration::SchematicPowerRatingTextStyle' has a wrong offset!");
...
public:
	...
	ECosmeticCompatibleMode                       Context;                                           // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FFortItemShopCMSStackRank, Context) == 0x00000C, "Member 'FFortItemShopCMSStackRank::Context' has a wrong offset!");
...
public:
	...
	bool                                          bUseWidePreview;                                   // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortItemShopCMSOfferGroup) == 0x000028, "Wrong size on FFortItemShopCMSOfferGroup");
...
static_assert(offsetof(FFortItemShopCMSOfferGroup, bUseWidePreview) == 0x000010, "Member 'FFortItemShopCMSOfferGroup::bUseWidePreview' has a wrong offset!");
...
static_assert(sizeof(FFortItemShopCMSBackground) == 0x000020, "Wrong size on FFortItemShopCMSBackground");
...
static_assert(sizeof(FFortItemShopCMSSectionMetadata) == 0x000060, "Wrong size on FFortItemShopCMSSectionMetadata");
...
static_assert(offsetof(FFortItemShopCMSSectionMetadata, Subsections) == 0x000010, "Member 'FFortItemShopCMSSectionMetadata::Subsections' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSSectionMetadata, OfferGroups) == 0x000020, "Member 'FFortItemShopCMSSectionMetadata::OfferGroups' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSSectionMetadata, Background) == 0x000030, "Member 'FFortItemShopCMSSectionMetadata::Background' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSSectionMetadata, StackRanks) == 0x000050, "Member 'FFortItemShopCMSSectionMetadata::StackRanks' has a wrong offset!");
...
public:
	...
	struct FFortItemShopCMSSectionMetadata        MetaData;                                          // 0x0030(0x0060)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortItemShopCMSSection) == 0x000008, "Wrong alignment on FFortItemShopCMSSection");
static_assert(sizeof(FFortItemShopCMSSection) == 0x000090, "Wrong size on FFortItemShopCMSSection");
...
public:
	...
	TSoftObjectPtr<class UObject>                 IconResource;                                      // 0x00E0(0x0020)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortPrioritizedWidgetData             PriorityData;                                      // 0x0100(0x0002)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortTabButtonLabelInfo) == 0x000110, "Wrong size on FFortTabButtonLabelInfo");
...
static_assert(offsetof(FFortTabButtonLabelInfo, IconResource) == 0x0000E0, "Member 'FFortTabButtonLabelInfo::IconResource' has a wrong offset!");
static_assert(offsetof(FFortTabButtonLabelInfo, PriorityData) == 0x000100, "Member 'FFortTabButtonLabelInfo::PriorityData' has a wrong offset!");
...
public:
	...
	TSubclassOf<class UCommonButtonBase>          TabButtonType;                                     // 0x0120(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UCommonUserWidget>          TabContentType;                                    // 0x0128(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidget*                                CreatedTabContentWidget;                           // 0x0130(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortTabListRegistrationInfo) == 0x000140, "Wrong size on FFortTabListRegistrationInfo");
...
static_assert(offsetof(FFortTabListRegistrationInfo, TabButtonType) == 0x000120, "Member 'FFortTabListRegistrationInfo::TabButtonType' has a wrong offset!");
static_assert(offsetof(FFortTabListRegistrationInfo, TabContentType) == 0x000128, "Member 'FFortTabListRegistrationInfo::TabContentType' has a wrong offset!");
static_assert(offsetof(FFortTabListRegistrationInfo, CreatedTabContentWidget) == 0x000130, "Member 'FFortTabListRegistrationInfo::CreatedTabContentWidget' has a wrong offset!");
...
public:
	...
	class FName                                   InteractionNameID;                                 // 0x0040(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void()>                             InteractionDelegate;                               // 0x0044(0x000C)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FUIKitContextMenuActionInfo) == 0x000008, "Wrong alignment on FUIKitContextMenuActionInfo");
static_assert(sizeof(FUIKitContextMenuActionInfo) == 0x000050, "Wrong size on FUIKitContextMenuActionInfo");
...
static_assert(offsetof(FUIKitContextMenuActionInfo, IconTexture) == 0x000018, "Member 'FUIKitContextMenuActionInfo::IconTexture' has a wrong offset!");
static_assert(offsetof(FUIKitContextMenuActionInfo, SortPriority) == 0x000038, "Member 'FUIKitContextMenuActionInfo::SortPriority' has a wrong offset!");
static_assert(offsetof(FUIKitContextMenuActionInfo, bIsAvailable) == 0x00003C, "Member 'FUIKitContextMenuActionInfo::bIsAvailable' has a wrong offset!");
static_assert(offsetof(FUIKitContextMenuActionInfo, InteractionNameID) == 0x000040, "Member 'FUIKitContextMenuActionInfo::InteractionNameID' has a wrong offset!");
static_assert(offsetof(FUIKitContextMenuActionInfo, InteractionDelegate) == 0x000044, "Member 'FUIKitContextMenuActionInfo::InteractionDelegate' has a wrong offset!");
...
static_assert(sizeof(FAthenaCollectionScreenContainerTabInfo) == 0x000078, "Wrong size on FAthenaCollectionScreenContainerTabInfo");
...
static_assert(offsetof(FAthenaCollectionScreenContainerTabInfo, TabClass) == 0x000038, "Member 'FAthenaCollectionScreenContainerTabInfo::TabClass' has a wrong offset!");
static_assert(offsetof(FAthenaCollectionScreenContainerTabInfo, TabCategoryTags) == 0x000058, "Member 'FAthenaCollectionScreenContainerTabInfo::TabCategoryTags' has a wrong offset!");
...
static_assert(sizeof(FAthenaMapScreenContainerTabInfo) == 0x000048, "Wrong size on FAthenaMapScreenContainerTabInfo");
...
static_assert(offsetof(FAthenaMapScreenContainerTabInfo, Order) == 0x000038, "Member 'FAthenaMapScreenContainerTabInfo::Order' has a wrong offset!");
static_assert(offsetof(FAthenaMapScreenContainerTabInfo, bDefaultFrontendActiveTab) == 0x00003C, "Member 'FAthenaMapScreenContainerTabInfo::bDefaultFrontendActiveTab' has a wrong offset!");
static_assert(offsetof(FAthenaMapScreenContainerTabInfo, bDefaultInGameActiveTab) == 0x00003D, "Member 'FAthenaMapScreenContainerTabInfo::bDefaultInGameActiveTab' has a wrong offset!");
static_assert(offsetof(FAthenaMapScreenContainerTabInfo, bShowPlayerProfile) == 0x00003E, "Member 'FAthenaMapScreenContainerTabInfo::bShowPlayerProfile' has a wrong offset!");
static_assert(offsetof(FAthenaMapScreenContainerTabInfo, TabID) == 0x000040, "Member 'FAthenaMapScreenContainerTabInfo::TabID' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration) == 0x000220, "Wrong size on FFortItemCard_PowerRatingBlock_ItemInstance_Configuration");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration, PowerRatingIconBrush) == 0x000140, "Member 'FFortItemCard_PowerRatingBlock_ItemInstance_Configuration::PowerRatingIconBrush' has a wrong offset!");
static_assert(offsetof(FFortItemCard_PowerRatingBlock_ItemInstance_Configuration, PowerRatingTextStyle) == 0x000200, "Member 'FFortItemCard_PowerRatingBlock_ItemInstance_Configuration::PowerRatingTextStyle' has a wrong offset!");
...
static_assert(sizeof(FFortToastDisplayInfo) == 0x000058, "Wrong size on FFortToastDisplayInfo");
...
static_assert(offsetof(FFortToastDisplayInfo, Type) == 0x000050, "Member 'FFortToastDisplayInfo::Type' has a wrong offset!");
...
static_assert(sizeof(FAthenaVariantFilterTabInfo) == 0x000070, "Wrong size on FAthenaVariantFilterTabInfo");
...
static_assert(offsetof(FAthenaVariantFilterTabInfo, Label) == 0x000020, "Member 'FAthenaVariantFilterTabInfo::Label' has a wrong offset!");
static_assert(offsetof(FAthenaVariantFilterTabInfo, IncludedVariantChannels) == 0x000038, "Member 'FAthenaVariantFilterTabInfo::IncludedVariantChannels' has a wrong offset!");
static_assert(offsetof(FAthenaVariantFilterTabInfo, ForcedVariantSelections) == 0x000058, "Member 'FAthenaVariantFilterTabInfo::ForcedVariantSelections' has a wrong offset!");
static_assert(offsetof(FAthenaVariantFilterTabInfo, ZoomLevel) == 0x000068, "Member 'FAthenaVariantFilterTabInfo::ZoomLevel' has a wrong offset!");
static_assert(offsetof(FAthenaVariantFilterTabInfo, bDisableScrollBox) == 0x00006C, "Member 'FAthenaVariantFilterTabInfo::bDisableScrollBox' has a wrong offset!");
...
static_assert(sizeof(FAthenaVariantFilterTabInfo_Primary) == 0x000080, "Wrong size on FAthenaVariantFilterTabInfo_Primary");
...
static_assert(offsetof(FAthenaVariantFilterTabInfo_Primary, SubTabs) == 0x000070, "Member 'FAthenaVariantFilterTabInfo_Primary::SubTabs' has a wrong offset!");
...
static_assert(sizeof(FRadialOptionData) == 0x000100, "Wrong size on FRadialOptionData");
...
static_assert(offsetof(FBuildingOptionData, ClassSuffix) == 0x000100, "Member 'FBuildingOptionData::ClassSuffix' has a wrong offset!");
static_assert(offsetof(FBuildingOptionData, ClassMirrored) == 0x000110, "Member 'FBuildingOptionData::ClassMirrored' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_34[0x5C];                                      // 0x0034(0x005C)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bHasEtherealBackground;                            // 0x0090(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_91[0xF];                                       // 0x0091(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FVaultVariantOverrideOption>    VariantOverrides;                                  // 0x00A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class UFortItem*                              SourceItemInstance;                                // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B8[0x10];                                      // 0x00B8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FItemPreviewSettings) == 0x000008, "Wrong alignment on FItemPreviewSettings");
static_assert(sizeof(FItemPreviewSettings) == 0x0000C8, "Wrong size on FItemPreviewSettings");
...
static_assert(offsetof(FItemPreviewSettings, bHasEtherealBackground) == 0x000090, "Member 'FItemPreviewSettings::bHasEtherealBackground' has a wrong offset!");
static_assert(offsetof(FItemPreviewSettings, VariantOverrides) == 0x0000A0, "Member 'FItemPreviewSettings::VariantOverrides' has a wrong offset!");
static_assert(offsetof(FItemPreviewSettings, SourceItemInstance) == 0x0000B0, "Member 'FItemPreviewSettings::SourceItemInstance' has a wrong offset!");
...
public:
	...
	class UFortItemVM*                            ItemVM;                                            // 0x00A8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FItemPreviewSettings                   PreviewSettings;                                   // 0x00B0(0x00C8)(Transient, NativeAccessSpecifierPublic)
	class FString                                 TemplateId;                                        // 0x0178(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Quantity;                                          // 0x0188(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortReceivedItemLootInfo) == 0x000198, "Wrong size on FFortReceivedItemLootInfo");
...
static_assert(offsetof(FFortReceivedItemLootInfo, SourceItemInstance) == 0x000090, "Member 'FFortReceivedItemLootInfo::SourceItemInstance' has a wrong offset!");
...
static_assert(offsetof(FFortReceivedItemLootInfo, ItemVM) == 0x0000A8, "Member 'FFortReceivedItemLootInfo::ItemVM' has a wrong offset!");
static_assert(offsetof(FFortReceivedItemLootInfo, PreviewSettings) == 0x0000B0, "Member 'FFortReceivedItemLootInfo::PreviewSettings' has a wrong offset!");
static_assert(offsetof(FFortReceivedItemLootInfo, TemplateId) == 0x000178, "Member 'FFortReceivedItemLootInfo::TemplateId' has a wrong offset!");
static_assert(offsetof(FFortReceivedItemLootInfo, Quantity) == 0x000188, "Member 'FFortReceivedItemLootInfo::Quantity' has a wrong offset!");
...
static_assert(sizeof(FNPCServiceData) == 0x000038, "Wrong size on FNPCServiceData");
...
public:
	...
	bool                                          bShowForSpectators;                                // 0x003D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAthenaPostMatchScreenContainerTabInfo) == 0x000048, "Wrong size on FAthenaPostMatchScreenContainerTabInfo");
...
static_assert(offsetof(FAthenaPostMatchScreenContainerTabInfo, Order) == 0x000038, "Member 'FAthenaPostMatchScreenContainerTabInfo::Order' has a wrong offset!");
static_assert(offsetof(FAthenaPostMatchScreenContainerTabInfo, bDefaultInGameActiveTab) == 0x00003C, "Member 'FAthenaPostMatchScreenContainerTabInfo::bDefaultInGameActiveTab' has a wrong offset!");
static_assert(offsetof(FAthenaPostMatchScreenContainerTabInfo, bShowForSpectators) == 0x00003D, "Member 'FAthenaPostMatchScreenContainerTabInfo::bShowForSpectators' has a wrong offset!");
static_assert(offsetof(FAthenaPostMatchScreenContainerTabInfo, AutoAdvanceToTabID) == 0x000040, "Member 'FAthenaPostMatchScreenContainerTabInfo::AutoAdvanceToTabID' has a wrong offset!");
static_assert(offsetof(FAthenaPostMatchScreenContainerTabInfo, TabID) == 0x000044, "Member 'FAthenaPostMatchScreenContainerTabInfo::TabID' has a wrong offset!");
...
// ScriptStruct FortniteUI.GenericEmptyPayload
// 0x0001 (0x0001 - 0x0000)
struct FGenericEmptyPayload final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGenericEmptyPayload) == 0x000001, "Wrong alignment on FGenericEmptyPayload");
static_assert(sizeof(FGenericEmptyPayload) == 0x000001, "Wrong size on FGenericEmptyPayload");
...
static_assert(sizeof(FCreativeContentBrowserTabInitializer) == 0x000040, "Wrong size on FCreativeContentBrowserTabInitializer");
...
static_assert(offsetof(FCreativeContentBrowserTabInitializer, CreationCondition) == 0x000038, "Member 'FCreativeContentBrowserTabInitializer::CreationCondition' has a wrong offset!");
...
static_assert(sizeof(FMotdVideo) == 0x000028, "Wrong size on FMotdVideo");
...
static_assert(offsetof(FMotdVideo, bAutoPlay) == 0x000020, "Member 'FMotdVideo::bAutoPlay' has a wrong offset!");
static_assert(offsetof(FMotdVideo, bStreamingEnabled) == 0x000021, "Member 'FMotdVideo::bStreamingEnabled' has a wrong offset!");
...
static_assert(sizeof(FMotdButton) == 0x000028, "Wrong size on FMotdButton");
static_assert(offsetof(FMotdButton, Text) == 0x000000, "Member 'FMotdButton::Text' has a wrong offset!");
static_assert(offsetof(FMotdButton, style) == 0x000018, "Member 'FMotdButton::style' has a wrong offset!");
static_assert(offsetof(FMotdButton, Action) == 0x000020, "Member 'FMotdButton::Action' has a wrong offset!");
...
static_assert(sizeof(FMotdBackground) == 0x000040, "Wrong size on FMotdBackground");
...
{
public:
	class FName                                   FilterTabNameId;                                   // 0x0108(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowEmptySlotItem;                               // 0x010C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10D[0x3];                                      // 0x010D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   EmptyFilterDisplay;                                // 0x0110(0x0018)(Edit, NativeAccessSpecifierPublic)
	class FText                                   EmptyArchivedFilterDisplay;                        // 0x0128(0x0018)(Edit, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortAthenaItemManagementInventoryFilterTabLabelInfo) == 0x000140, "Wrong size on FFortAthenaItemManagementInventoryFilterTabLabelInfo");
static_assert(offsetof(FFortAthenaItemManagementInventoryFilterTabLabelInfo, FilterTabNameId) == 0x000108, "Member 'FFortAthenaItemManagementInventoryFilterTabLabelInfo::FilterTabNameId' has a wrong offset!");
static_assert(offsetof(FFortAthenaItemManagementInventoryFilterTabLabelInfo, bAllowEmptySlotItem) == 0x00010C, "Member 'FFortAthenaItemManagementInventoryFilterTabLabelInfo::bAllowEmptySlotItem' has a wrong offset!");
static_assert(offsetof(FFortAthenaItemManagementInventoryFilterTabLabelInfo, EmptyFilterDisplay) == 0x000110, "Member 'FFortAthenaItemManagementInventoryFilterTabLabelInfo::EmptyFilterDisplay' has a wrong offset!");
static_assert(offsetof(FFortAthenaItemManagementInventoryFilterTabLabelInfo, EmptyArchivedFilterDisplay) == 0x000128, "Member 'FFortAthenaItemManagementInventoryFilterTabLabelInfo::EmptyArchivedFilterDisplay' has a wrong offset!");
...
static_assert(sizeof(FCreativeDeviceSubscription) == 0x000070, "Wrong size on FCreativeDeviceSubscription");
...
static_assert(offsetof(FCreativeDeviceSubscription, ActorPtr) == 0x000050, "Member 'FCreativeDeviceSubscription::ActorPtr' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XL_PersonnelAndSchematics_Configuration) == 0x000510, "Wrong size on FFortItemCard_XL_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000310, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, Nameplate) == 0x000320, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ItemNameTextStyle) == 0x0003F0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ItemNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000410, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000420, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000430, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x000438, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000448, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x000458, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, RarityNameTextLeftPadding) == 0x00046C, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::RarityNameTextLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, RarityNameTextStyle) == 0x000470, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::RarityNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassIconImageLeftPadding) == 0x000490, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassIconImageLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x000498, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, PaddingBetweenClassIconAndName) == 0x0004A8, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::PaddingBetweenClassIconAndName' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, ClassNameTextStyle) == 0x0004B0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::ClassNameTextStyle' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x0004D0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, TierMeter) == 0x0004D8, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, IconSlotOverNameplatePadding) == 0x0004F0, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::IconSlotOverNameplatePadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_PersonnelAndSchematics_Configuration, IconSlotOverNameplateSize) == 0x000500, "Member 'FFortItemCard_XL_PersonnelAndSchematics_Configuration::IconSlotOverNameplateSize' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XL_ItemInstance_Configuration) == 0x0002F0, "Wrong size on FFortItemCard_XL_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, BookmarkImageSize) == 0x000240, "Member 'FFortItemCard_XL_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, StackCountBlock) == 0x000250, "Member 'FFortItemCard_XL_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TraitBoxPadding) == 0x000278, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, FirstTraitSize) == 0x000288, "Member 'FFortItemCard_XL_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000298, "Member 'FFortItemCard_XL_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, SecondTraitSize) == 0x0002A0, "Member 'FFortItemCard_XL_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TierMeterPadding) == 0x0002B0, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, TierMeter) == 0x0002C0, "Member 'FFortItemCard_XL_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XL_ItemInstance_Configuration, DurabilityMeter) == 0x0002D8, "Member 'FFortItemCard_XL_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_PersonnelAndSchematics_Configuration) == 0x000490, "Wrong size on FFortItemCard_L_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000310, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, Nameplate) == 0x000320, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x0003F0, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000400, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000410, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000420, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x000428, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000438, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x000448, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, LevelMeter) == 0x00045C, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000470, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_PersonnelAndSchematics_Configuration, TierMeter) == 0x000478, "Member 'FFortItemCard_L_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_L_ItemInstance_Configuration) == 0x0002F0, "Wrong size on FFortItemCard_L_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, BookmarkImageSize) == 0x000240, "Member 'FFortItemCard_L_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, StackCountBlock) == 0x000250, "Member 'FFortItemCard_L_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TraitBoxPadding) == 0x000278, "Member 'FFortItemCard_L_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, FirstTraitSize) == 0x000288, "Member 'FFortItemCard_L_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000298, "Member 'FFortItemCard_L_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, SecondTraitSize) == 0x0002A0, "Member 'FFortItemCard_L_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TierMeterPadding) == 0x0002B0, "Member 'FFortItemCard_L_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, TierMeter) == 0x0002C0, "Member 'FFortItemCard_L_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_L_ItemInstance_Configuration, DurabilityMeter) == 0x0002D8, "Member 'FFortItemCard_L_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_M_PersonnelAndSchematics_Configuration) == 0x000490, "Wrong size on FFortItemCard_M_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000310, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, Nameplate) == 0x000320, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x0003F0, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000400, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000410, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000420, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x000428, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000438, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x000448, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, LevelMeter) == 0x00045C, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000470, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_PersonnelAndSchematics_Configuration, TierMeter) == 0x000478, "Member 'FFortItemCard_M_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_M_ItemInstance_Configuration) == 0x0002F0, "Wrong size on FFortItemCard_M_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, BookmarkImageSize) == 0x000240, "Member 'FFortItemCard_M_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, StackCountBlock) == 0x000250, "Member 'FFortItemCard_M_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TraitBoxPadding) == 0x000278, "Member 'FFortItemCard_M_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, FirstTraitSize) == 0x000288, "Member 'FFortItemCard_M_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, PaddingBetweenTraitIcons) == 0x000298, "Member 'FFortItemCard_M_ItemInstance_Configuration::PaddingBetweenTraitIcons' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, SecondTraitSize) == 0x0002A0, "Member 'FFortItemCard_M_ItemInstance_Configuration::SecondTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TierMeterPadding) == 0x0002B0, "Member 'FFortItemCard_M_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, TierMeter) == 0x0002C0, "Member 'FFortItemCard_M_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_M_ItemInstance_Configuration, DurabilityMeter) == 0x0002D8, "Member 'FFortItemCard_M_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_S_PersonnelAndSchematics_Configuration) == 0x000490, "Wrong size on FFortItemCard_S_PersonnelAndSchematics_Configuration");
...
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, BookmarkImageSize) == 0x000310, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, Nameplate) == 0x000320, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::Nameplate' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, ClassIconSize) == 0x0003F0, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::ClassIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, LeadSurvivorTypeIconSize) == 0x000400, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::LeadSurvivorTypeIconSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, FirstIconSlotSize) == 0x000410, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::FirstIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, PaddingBetweenIconSlots) == 0x000420, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::PaddingBetweenIconSlots' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, SecondIconSlotSize) == 0x000428, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::SecondIconSlotSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, DefenderWeaponTypeIcon) == 0x000438, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::DefenderWeaponTypeIcon' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, DetailAreaBorder) == 0x000448, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::DetailAreaBorder' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, LevelMeter) == 0x00045C, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::LevelMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, TierMeterLeftPadding) == 0x000470, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::TierMeterLeftPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_PersonnelAndSchematics_Configuration, TierMeter) == 0x000478, "Member 'FFortItemCard_S_PersonnelAndSchematics_Configuration::TierMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_S_ItemInstance_Configuration) == 0x0002E0, "Wrong size on FFortItemCard_S_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, BookmarkImageSize) == 0x000240, "Member 'FFortItemCard_S_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, StackCountBlock) == 0x000250, "Member 'FFortItemCard_S_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TraitBoxPadding) == 0x000278, "Member 'FFortItemCard_S_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, FirstTraitSize) == 0x000288, "Member 'FFortItemCard_S_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TierMeterPadding) == 0x000298, "Member 'FFortItemCard_S_ItemInstance_Configuration::TierMeterPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, TierMeter) == 0x0002A8, "Member 'FFortItemCard_S_ItemInstance_Configuration::TierMeter' has a wrong offset!");
static_assert(offsetof(FFortItemCard_S_ItemInstance_Configuration, DurabilityMeter) == 0x0002C0, "Member 'FFortItemCard_S_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemCard_XS_ItemInstance_Configuration) == 0x0002B0, "Wrong size on FFortItemCard_XS_ItemInstance_Configuration");
...
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, BookmarkImageSize) == 0x000240, "Member 'FFortItemCard_XS_ItemInstance_Configuration::BookmarkImageSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, TraitBoxPadding) == 0x000250, "Member 'FFortItemCard_XS_ItemInstance_Configuration::TraitBoxPadding' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, FirstTraitSize) == 0x000260, "Member 'FFortItemCard_XS_ItemInstance_Configuration::FirstTraitSize' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, StackCountBlock) == 0x000270, "Member 'FFortItemCard_XS_ItemInstance_Configuration::StackCountBlock' has a wrong offset!");
static_assert(offsetof(FFortItemCard_XS_ItemInstance_Configuration, DurabilityMeter) == 0x000298, "Member 'FFortItemCard_XS_ItemInstance_Configuration::DurabilityMeter' has a wrong offset!");
...
static_assert(sizeof(FFortItemManagementInventoryFilterTabLabelInfo) == 0x000110, "Wrong size on FFortItemManagementInventoryFilterTabLabelInfo");
static_assert(offsetof(FFortItemManagementInventoryFilterTabLabelInfo, FilterTabNameId) == 0x000108, "Member 'FFortItemManagementInventoryFilterTabLabelInfo::FilterTabNameId' has a wrong offset!");
...
static_assert(sizeof(FGameSelectionButtonInfo) == 0x000038, "Wrong size on FGameSelectionButtonInfo");
...
static_assert(offsetof(FGameSelectionButtonInfo, SecondaryText) == 0x000018, "Member 'FGameSelectionButtonInfo::SecondaryText' has a wrong offset!");
static_assert(offsetof(FGameSelectionButtonInfo, bIsEnabled) == 0x000030, "Member 'FGameSelectionButtonInfo::bIsEnabled' has a wrong offset!");
...
static_assert(sizeof(FInteractionVisibility) == 0x000002, "Wrong size on FInteractionVisibility");
...
static_assert(sizeof(FSqueegeeData) == 0x000018, "Wrong size on FSqueegeeData");
...
public:
	...
	EFortUIFeature                                ForwardOnRemoval;                                  // 0x00F1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortBangType                                 BangType;                                          // 0x00F2(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSubclassOf<class UCommonButtonBase>          OverrideTabWidget;                                 // 0x0100(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TSoftClassPtr<class UClass>>           PersistentTabObjects;                              // 0x0108(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	bool                                          bIsDynamicTab;                                     // 0x0118(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortTopBarTabButtonGroup                     ButtonGroup;                                       // 0x0119(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11A[0x6];                                      // 0x011A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UFortTabViewModel>          ViewModel;                                         // 0x0120(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FFortTopBarTabButtonInfo, ForwardOnRemoval) == 0x0000F1, "Member 'FFortTopBarTabButtonInfo::ForwardOnRemoval' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, BangType) == 0x0000F2, "Member 'FFortTopBarTabButtonInfo::BangType' has a wrong offset!");
...
static_assert(offsetof(FFortTopBarTabButtonInfo, PersistentTabObjects) == 0x000108, "Member 'FFortTopBarTabButtonInfo::PersistentTabObjects' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, bIsDynamicTab) == 0x000118, "Member 'FFortTopBarTabButtonInfo::bIsDynamicTab' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, ButtonGroup) == 0x000119, "Member 'FFortTopBarTabButtonInfo::ButtonGroup' has a wrong offset!");
static_assert(offsetof(FFortTopBarTabButtonInfo, ViewModel) == 0x000120, "Member 'FFortTopBarTabButtonInfo::ViewModel' has a wrong offset!");
...
public:
	...
	struct FFortTopBarTabButtonInfo               TabButtonInfo;                                     // 0x0020(0x0130)(Edit, NativeAccessSpecifierPublic)
	bool                                          bIsMobileOverride;                                 // 0x0150(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FExternalDynamicTabParams, bIsMobileOverride) == 0x000150, "Member 'FExternalDynamicTabParams::bIsMobileOverride' has a wrong offset!");
...
static_assert(sizeof(FFrontendExperienceFlowParams) == 0x000030, "Wrong size on FFrontendExperienceFlowParams");
...
// ScriptStruct FortniteUI.OpenCustomUIContext
// 0x0008 (0x0008 - 0x0000)
struct FOpenCustomUIContext final
{
public:
	class UUserWidget*                            ContextWidget;                                     // 0x0000(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FOpenCustomUIContext) == 0x000008, "Wrong alignment on FOpenCustomUIContext");
static_assert(sizeof(FOpenCustomUIContext) == 0x000008, "Wrong size on FOpenCustomUIContext");
static_assert(offsetof(FOpenCustomUIContext, ContextWidget) == 0x000000, "Member 'FOpenCustomUIContext::ContextWidget' has a wrong offset!");
...
public:
	...
	TArray<class UInputModifier*>                 Modifiers;                                         // 0x0020(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class UInputTrigger*>                  Triggers;                                          // 0x0030(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMobileEnhancedInputData) == 0x000008, "Wrong alignment on FMobileEnhancedInputData");
static_assert(sizeof(FMobileEnhancedInputData) == 0x000040, "Wrong size on FMobileEnhancedInputData");
...
static_assert(offsetof(FMobileEnhancedInputData, Modifiers) == 0x000020, "Member 'FMobileEnhancedInputData::Modifiers' has a wrong offset!");
static_assert(offsetof(FMobileEnhancedInputData, Triggers) == 0x000030, "Member 'FMobileEnhancedInputData::Triggers' has a wrong offset!");
...
static_assert(sizeof(FMotdInteraction) == 0x000030, "Wrong size on FMotdInteraction");
...
static_assert(sizeof(FMotdButtonInteraction) == 0x000048, "Wrong size on FMotdButtonInteraction");
...
public:
	...
	uint8                                         Pad_18[0x8];                                       // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortTabButtonLabelInfo                TabButtonLabel;                                    // 0x0020(0x0110)(Edit, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FSettingsScreenTabSchema) == 0x000010, "Wrong alignment on FSettingsScreenTabSchema");
static_assert(sizeof(FSettingsScreenTabSchema) == 0x000130, "Wrong size on FSettingsScreenTabSchema");
...
static_assert(alignof(FQuestEntryVisualData) == 0x000008, "Wrong alignment on FQuestEntryVisualData");
static_assert(sizeof(FQuestEntryVisualData) == 0x000010, "Wrong size on FQuestEntryVisualData");
static_assert(offsetof(FQuestEntryVisualData, EntryClass) == 0x000000, "Member 'FQuestEntryVisualData::EntryClass' has a wrong offset!");
static_assert(offsetof(FQuestEntryVisualData, PreAllocationCount) == 0x000008, "Member 'FQuestEntryVisualData::PreAllocationCount' has a wrong offset!");
...
static_assert(sizeof(FBattleLabDisplayData) == 0x000060, "Wrong size on FBattleLabDisplayData");
...
static_assert(sizeof(FAthenaTeamDisplayInfo) == 0x000078, "Wrong size on FAthenaTeamDisplayInfo");
...
static_assert(offsetof(FAthenaTeamDisplayInfo, TextColor) == 0x000058, "Member 'FAthenaTeamDisplayInfo::TextColor' has a wrong offset!");
static_assert(offsetof(FAthenaTeamDisplayInfo, PedestalColor) == 0x000068, "Member 'FAthenaTeamDisplayInfo::PedestalColor' has a wrong offset!");
...
static_assert(offsetof(FSquadChatOptionData, ChatText) == 0x000100, "Member 'FSquadChatOptionData::ChatText' has a wrong offset!");
...
static_assert(offsetof(FItemCategoryOptionData, TemplatePrefix) == 0x000100, "Member 'FItemCategoryOptionData::TemplatePrefix' has a wrong offset!");
static_assert(offsetof(FItemCategoryOptionData, BuildingAttachmentType) == 0x000110, "Member 'FItemCategoryOptionData::BuildingAttachmentType' has a wrong offset!");
...
static_assert(alignof(FOnVirtualJoysticksTouchStartedData) == 0x000008, "Wrong alignment on FOnVirtualJoysticksTouchStartedData");
static_assert(sizeof(FOnVirtualJoysticksTouchStartedData) == 0x000078, "Wrong size on FOnVirtualJoysticksTouchStartedData");
...
static_assert(offsetof(FEmoteOptionData, EmoteCommand) == 0x000100, "Member 'FEmoteOptionData::EmoteCommand' has a wrong offset!");
...
static_assert(offsetof(FBuildingCategoryOptionData, BuildingType) == 0x000100, "Member 'FBuildingCategoryOptionData::BuildingType' has a wrong offset!");
...
static_assert(sizeof(FNPCServiceWidgetData) == 0x000058, "Wrong size on FNPCServiceWidgetData");
...
static_assert(offsetof(FNPCServiceWidgetData, CostResource) == 0x000038, "Member 'FNPCServiceWidgetData::CostResource' has a wrong offset!");
static_assert(offsetof(FNPCServiceWidgetData, CostAmountMin) == 0x000040, "Member 'FNPCServiceWidgetData::CostAmountMin' has a wrong offset!");
static_assert(offsetof(FNPCServiceWidgetData, CostAmountMax) == 0x000044, "Member 'FNPCServiceWidgetData::CostAmountMax' has a wrong offset!");
static_assert(offsetof(FNPCServiceWidgetData, bIsLocked) == 0x000048, "Member 'FNPCServiceWidgetData::bIsLocked' has a wrong offset!");
static_assert(offsetof(FNPCServiceWidgetData, MinRequiredBenefitLevel) == 0x00004C, "Member 'FNPCServiceWidgetData::MinRequiredBenefitLevel' has a wrong offset!");
static_assert(offsetof(FNPCServiceWidgetData, Priority) == 0x000050, "Member 'FNPCServiceWidgetData::Priority' has a wrong offset!");
...
static_assert(sizeof(FNPCServiceDataRow) == 0x000068, "Wrong size on FNPCServiceDataRow");
...
static_assert(sizeof(FNPCSpecializationDataRow) == 0x000048, "Wrong size on FNPCSpecializationDataRow");
...
static_assert(sizeof(FCrewTileDataTemporaryItems) == 0x000080, "Wrong size on FCrewTileDataTemporaryItems");
...
static_assert(sizeof(FCrewItemShopTileEntry) == 0x000068, "Wrong size on FCrewItemShopTileEntry");
...
public:
	...
	struct FAthenaSubscriptionProgressiveInfo     ProgressiveInfo;                                   // 0x00A8(0x0028)(NativeAccessSpecifierPublic)
	struct FAthenaSubscriptionTemporaryItemsInfo  TemporaryItemsInfo;                                // 0x00D0(0x0010)(NativeAccessSpecifierPublic)
	struct FSubscriptionModals                    SubModals;                                         // 0x00E0(0x0010)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FCrewScreenData) == 0x000008, "Wrong alignment on FCrewScreenData");
static_assert(sizeof(FCrewScreenData) == 0x0000F0, "Wrong size on FCrewScreenData");
...
static_assert(offsetof(FCrewScreenData, ItemShopData) == 0x000098, "Member 'FCrewScreenData::ItemShopData' has a wrong offset!");
static_assert(offsetof(FCrewScreenData, ProgressiveInfo) == 0x0000A8, "Member 'FCrewScreenData::ProgressiveInfo' has a wrong offset!");
static_assert(offsetof(FCrewScreenData, TemporaryItemsInfo) == 0x0000D0, "Member 'FCrewScreenData::TemporaryItemsInfo' has a wrong offset!");
static_assert(offsetof(FCrewScreenData, SubModals) == 0x0000E0, "Member 'FCrewScreenData::SubModals' has a wrong offset!");
...
{
public:
	class FText                                   FormatedText;                                      // 0x0008(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FNavigateToBattlePassSubPageMOTD) == 0x000108, "Wrong size on FNavigateToBattlePassSubPageMOTD");
...
static_assert(alignof(FFortItemShopCMSMaterialParameterData) == 0x000010, "Wrong alignment on FFortItemShopCMSMaterialParameterData");
static_assert(sizeof(FFortItemShopCMSMaterialParameterData) == 0x000050, "Wrong size on FFortItemShopCMSMaterialParameterData");
static_assert(offsetof(FFortItemShopCMSMaterialParameterData, Name) == 0x000000, "Member 'FFortItemShopCMSMaterialParameterData::Name' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSMaterialParameterData, Type) == 0x000010, "Member 'FFortItemShopCMSMaterialParameterData::Type' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSMaterialParameterData, TextureValue) == 0x000018, "Member 'FFortItemShopCMSMaterialParameterData::TextureValue' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSMaterialParameterData, ScalarValue) == 0x000028, "Member 'FFortItemShopCMSMaterialParameterData::ScalarValue' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSMaterialParameterData, VectorValue) == 0x000030, "Member 'FFortItemShopCMSMaterialParameterData::VectorValue' has a wrong offset!");
...
static_assert(alignof(FFortItemShopCMSMaterialData) == 0x000008, "Wrong alignment on FFortItemShopCMSMaterialData");
static_assert(sizeof(FFortItemShopCMSMaterialData) == 0x000020, "Wrong size on FFortItemShopCMSMaterialData");
static_assert(offsetof(FFortItemShopCMSMaterialData, ParentMaterialDataPath) == 0x000000, "Member 'FFortItemShopCMSMaterialData::ParentMaterialDataPath' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSMaterialData, Parameters) == 0x000010, "Member 'FFortItemShopCMSMaterialData::Parameters' has a wrong offset!");
...
static_assert(sizeof(FPreviewRewardData) == 0x000060, "Wrong size on FPreviewRewardData");
...
static_assert(alignof(FExpandedItemVM) == 0x000008, "Wrong alignment on FExpandedItemVM");
static_assert(sizeof(FExpandedItemVM) == 0x000010, "Wrong size on FExpandedItemVM");
static_assert(offsetof(FExpandedItemVM, BRItemVM) == 0x000000, "Member 'FExpandedItemVM::BRItemVM' has a wrong offset!");
static_assert(offsetof(FExpandedItemVM, JunoItemVM) == 0x000008, "Member 'FExpandedItemVM::JunoItemVM' has a wrong offset!");
...
static_assert(offsetof(FFortShowdownScoringRuleDisplayInfo, bShowScoreToastNotifications) == 0x000070, "Member 'FFortShowdownScoringRuleDisplayInfo::bShowScoreToastNotifications' has a wrong offset!");
...
static_assert(sizeof(FTrackCategoryUI) == 0x000048, "Wrong size on FTrackCategoryUI");
static_assert(offsetof(FTrackCategoryUI, TrackData) == 0x000000, "Member 'FTrackCategoryUI::TrackData' has a wrong offset!");
static_assert(offsetof(FTrackCategoryUI, LastSelectedIndex) == 0x000040, "Member 'FTrackCategoryUI::LastSelectedIndex' has a wrong offset!");
...
static_assert(alignof(FOnVirtualJoysticksTouchEndedData) == 0x000008, "Wrong alignment on FOnVirtualJoysticksTouchEndedData");
static_assert(sizeof(FOnVirtualJoysticksTouchEndedData) == 0x000078, "Wrong size on FOnVirtualJoysticksTouchEndedData");
...
static_assert(offsetof(FSquadQuickChatOptionData, ChatEntry) == 0x000100, "Member 'FSquadQuickChatOptionData::ChatEntry' has a wrong offset!");
static_assert(offsetof(FSquadQuickChatOptionData, bEnabled) == 0x000114, "Member 'FSquadQuickChatOptionData::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FProgressiveStageItemInfo) == 0x000068, "Wrong size on FProgressiveStageItemInfo");
...
static_assert(offsetof(FProgressiveStageItemInfo, bHidden) == 0x000058, "Member 'FProgressiveStageItemInfo::bHidden' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, bAllowPreviewStyles) == 0x000059, "Member 'FProgressiveStageItemInfo::bAllowPreviewStyles' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, bIsLocked) == 0x00005A, "Member 'FProgressiveStageItemInfo::bIsLocked' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, AdditionalMonthsRequired) == 0x00005C, "Member 'FProgressiveStageItemInfo::AdditionalMonthsRequired' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, StageIndex) == 0x000060, "Member 'FProgressiveStageItemInfo::StageIndex' has a wrong offset!");
...
static_assert(offsetof(FFortMissionDetails, RatingsEnforcement) == 0x0000F8, "Member 'FFortMissionDetails::RatingsEnforcement' has a wrong offset!");
static_assert(offsetof(FFortMissionDetails, RequiredBaseRating) == 0x0000FC, "Member 'FFortMissionDetails::RequiredBaseRating' has a wrong offset!");
static_assert(offsetof(FFortMissionDetails, RecommendedBaseRating) == 0x000100, "Member 'FFortMissionDetails::RecommendedBaseRating' has a wrong offset!");
static_assert(offsetof(FFortMissionDetails, MaxBaseRating) == 0x000104, "Member 'FFortMissionDetails::MaxBaseRating' has a wrong offset!");
...
static_assert(offsetof(FFortMissionDetails, bIsOnboarding) == 0x00010C, "Member 'FFortMissionDetails::bIsOnboarding' has a wrong offset!");
...
static_assert(offsetof(FStoreCallout, ItemName) == 0x000058, "Member 'FStoreCallout::ItemName' has a wrong offset!");
static_assert(offsetof(FStoreCallout, ItemSet) == 0x000070, "Member 'FStoreCallout::ItemSet' has a wrong offset!");
static_assert(offsetof(FStoreCallout, OfferDisplayAssetPath) == 0x000088, "Member 'FStoreCallout::OfferDisplayAssetPath' has a wrong offset!");
static_assert(offsetof(FStoreCallout, LayoutId) == 0x000098, "Member 'FStoreCallout::LayoutId' has a wrong offset!");
...
static_assert(sizeof(FCreativeDeviceCached) == 0x000040, "Wrong size on FCreativeDeviceCached");
...
static_assert(offsetof(FCreativeDeviceCached, NumBoundEvents) == 0x000018, "Member 'FCreativeDeviceCached::NumBoundEvents' has a wrong offset!");
static_assert(offsetof(FCreativeDeviceCached, NumBoundFunctions) == 0x00001C, "Member 'FCreativeDeviceCached::NumBoundFunctions' has a wrong offset!");
static_assert(offsetof(FCreativeDeviceCached, ActorPtr) == 0x000020, "Member 'FCreativeDeviceCached::ActorPtr' has a wrong offset!");
...
static_assert(sizeof(FCachedSurfaceData) == 0x000020, "Wrong size on FCachedSurfaceData");
...
static_assert(offsetof(FCachedSurfaceData, bIsDirty) == 0x000018, "Member 'FCachedSurfaceData::bIsDirty' has a wrong offset!");
...
static_assert(offsetof(FFortCreativeItemListCategoryData, bUseLegacyItemDetailsPanel) == 0x00000B, "Member 'FFortCreativeItemListCategoryData::bUseLegacyItemDetailsPanel' has a wrong offset!");
...
static_assert(offsetof(FChatOptionData, ChatText) == 0x000100, "Member 'FChatOptionData::ChatText' has a wrong offset!");
...
static_assert(offsetof(FMapNoteOptionData, MapNoteText) == 0x000100, "Member 'FMapNoteOptionData::MapNoteText' has a wrong offset!");
...
static_assert(offsetof(FItemDefOptionData, ItemDef) == 0x000100, "Member 'FItemDefOptionData::ItemDef' has a wrong offset!");
...
static_assert(sizeof(FStandaloneItemShopTabInfo) == 0x000038, "Wrong size on FStandaloneItemShopTabInfo");
...
static_assert(offsetof(FStandaloneItemShopTabInfo, UIFeature) == 0x000030, "Member 'FStandaloneItemShopTabInfo::UIFeature' has a wrong offset!");
...
static_assert(alignof(FOnVirtualJoysticksTouchMovedData) == 0x000008, "Wrong alignment on FOnVirtualJoysticksTouchMovedData");
static_assert(sizeof(FOnVirtualJoysticksTouchMovedData) == 0x000078, "Wrong size on FOnVirtualJoysticksTouchMovedData");
...
{
public:
	class FText                                   LegendEntryText;                                   // 0x0000(0x0018)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<TSoftObjectPtr<class UTexture2D>>      LegendEntryTextures;                               // 0x0018(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAthenaMapLegendEntryData) == 0x000008, "Wrong alignment on FAthenaMapLegendEntryData");
static_assert(sizeof(FAthenaMapLegendEntryData) == 0x000028, "Wrong size on FAthenaMapLegendEntryData");
static_assert(offsetof(FAthenaMapLegendEntryData, LegendEntryText) == 0x000000, "Member 'FAthenaMapLegendEntryData::LegendEntryText' has a wrong offset!");
...
static_assert(sizeof(FFortSwipeDetector) == 0x000098, "Wrong size on FFortSwipeDetector");
...
static_assert(sizeof(FItemPresentationRestrictionData) == 0x000038, "Wrong size on FItemPresentationRestrictionData");
...
static_assert(alignof(FFortItemShopCMSOfferVisualData) == 0x000008, "Wrong alignment on FFortItemShopCMSOfferVisualData");
static_assert(sizeof(FFortItemShopCMSOfferVisualData) == 0x000020, "Wrong size on FFortItemShopCMSOfferVisualData");
static_assert(offsetof(FFortItemShopCMSOfferVisualData, VisualId) == 0x000000, "Member 'FFortItemShopCMSOfferVisualData::VisualId' has a wrong offset!");
static_assert(offsetof(FFortItemShopCMSOfferVisualData, Materials) == 0x000010, "Member 'FFortItemShopCMSOfferVisualData::Materials' has a wrong offset!");
...
static_assert(sizeof(FCycledItemPreviewSettings) == 0x0000D0, "Wrong size on FCycledItemPreviewSettings");
...
static_assert(sizeof(FProgressiveSetInfo) == 0x000060, "Wrong size on FProgressiveSetInfo");
...
static_assert(offsetof(FProgressiveSetInfo, SetProgress) == 0x000038, "Member 'FProgressiveSetInfo::SetProgress' has a wrong offset!");
static_assert(offsetof(FProgressiveSetInfo, UnlockedStagesCount) == 0x00003C, "Member 'FProgressiveSetInfo::UnlockedStagesCount' has a wrong offset!");
static_assert(offsetof(FProgressiveSetInfo, TotalStagesCount) == 0x000040, "Member 'FProgressiveSetInfo::TotalStagesCount' has a wrong offset!");
