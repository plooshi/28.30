...
static_assert(sizeof(FAthenaRadioStation) == 0x000058, "Wrong size on FAthenaRadioStation");
...
static_assert(offsetof(FAthenaRadioStation, GameplayTagDenylist) == 0x000038, "Member 'FAthenaRadioStation::GameplayTagDenylist' has a wrong offset!");
static_assert(offsetof(FAthenaRadioStation, GameplayTagAllowlist) == 0x000048, "Member 'FAthenaRadioStation::GameplayTagAllowlist' has a wrong offset!");
...
static_assert(sizeof(FStreamingRadioSourceData) == 0x000068, "Wrong size on FStreamingRadioSourceData");
