...
void UNPCStatusWidgetBar_C::ExecuteUbergraph_NPCStatusWidgetBar(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_NPCStatusWidgetBar");
...
void UNPCStatusWidgetBar_C::SetHealthBarColorDependingHealth(double CurrentPercentage)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetHealthBarColorDependingHealth");
...
void UNPCStatusWidgetBar_C::SetNumPips(int32 NumPips)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetNumPips");
...
void UNPCStatusWidgetBar_C::SetPercentInstant(double Value)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetPercentInstant");
