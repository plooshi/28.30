...
public:
	...
	TArray<class UStaticMesh*>                    StaticMeshAlternateArray;                          // 0x0D50(0x0010)(Edit, BlueprintVisible)
...
static_assert(sizeof(APBW_BP_Parent_C) == 0x000D60, "Wrong size on APBW_BP_Parent_C");
static_assert(offsetof(APBW_BP_Parent_C, UberGraphFrame) == 0x000D48, "Member 'APBW_BP_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(APBW_BP_Parent_C, StaticMeshAlternateArray) == 0x000D50, "Member 'APBW_BP_Parent_C::StaticMeshAlternateArray' has a wrong offset!");
