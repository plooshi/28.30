...
void UXpEverywhereAccoladesWidget::AccoladeTriggered(const int32 XpValue, const class FText& SimulatedName, const class FText& SimulatedText, const TSoftObjectPtr<class UTexture2D>& PreviewImage, const EFortSimulatedXPSize SimulatedXpSize, const EFortAccoladeType AccoladeType, const TSoftObjectPtr<class USoundCue>& SoundCue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("AccoladeTriggered");
...
bool UXpEverywhereAccoladesWidget::HasMoreXPEvents() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HasMoreXPEvents");
...
void UXpEverywhereBar::DoneUpdatingXpBar()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DoneUpdatingXpBar");
...
void UXpEverywhereBar::OnXpBarInitialized(int32 CurrentXP, int32 CurrentLevel, int32 CurrentRemainingRestXP)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnXpBarInitialized");
...
void UXpEverywhereBar::OnXpBarUpdated(int32 ShownXP, int32 ShownLevel, int32 NewDesiredXP, int32 NewDesiredLevel, int32 NewRemainingRestXP)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnXpBarUpdated");
...
int32 UXpEverywhereBar::GetTotalXpRequiredForLevel(const int32 InLevel) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetTotalXpRequiredForLevel");
...
void UXpEverywhereLevelUpWidget::DoneLevelingUp()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DoneLevelingUp");
...
void UXpEverywhereLevelUpWidget::OnShowWidget(const int32 NewLevel)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnShowWidget");
...
void UXpEverywhereLevelUpWidget::DisplayLevelUpRewards() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DisplayLevelUpRewards");
...
void UXpEverywhereReticleWidget::ForwardEvents()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ForwardEvents");
...
void UXpEverywhereReticleWidget::HandleProfileUpdated()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleProfileUpdated");
...
void UXpEverywhereReticleWidget::UpdateRestXP(int32 RestXpRemaining)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateRestXP");
...
void UXpEverywhereReticleWidget::UpdateXPAmount(int32 NewAmount, class USoundCue* Cue, const EFortSimulatedXPSize SimulatedXpSize)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateXPAmount");
...
void UXpEverywhereReticleWidget::UpdateXPSource(const class FText& NewSourceText)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateXPSource");
...
void UXpEverywhereRewardWidget::HandleNotificationUpdateFinished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleNotificationUpdateFinished");
...
void UXpEverywhereUIComponent::HandleControllerComponentAdded(class AFortPlayerController* OwnerController, class UFortControllerComponent* AttachedComponent)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleControllerComponentAdded");
