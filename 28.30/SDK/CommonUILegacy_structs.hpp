...
static_assert(sizeof(FCommonInputActionData) == 0x000950, "Wrong size on FCommonInputActionData");
static_assert(offsetof(FCommonInputActionData, GamepadInputTypeInfoOverrides) == 0x000360, "Member 'FCommonInputActionData::GamepadInputTypeInfoOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionData, GamepadInputTypeInfos) == 0x0003B0, "Member 'FCommonInputActionData::GamepadInputTypeInfos' has a wrong offset!");
