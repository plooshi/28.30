...
public:
	...
	uint8                                         Pad_88C[0x194];                                    // 0x088C(0x0194)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthComponentMoto) == 0x000A20, "Wrong size on USynthComponentMoto");
static_assert(offsetof(USynthComponentMoto, MotoSynthPreset) == 0x000880, "Member 'USynthComponentMoto::MotoSynthPreset' has a wrong offset!");
static_assert(offsetof(USynthComponentMoto, RPM) == 0x000888, "Member 'USynthComponentMoto::RPM' has a wrong offset!");
