...
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS, CallFunc_PlayAnimation_ReturnValue_1) == 0x000010, "Member 'InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS, K2Node_ComponentBoundEvent_bIsOpen) == 0x000018, "Member 'InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS::K2Node_ComponentBoundEvent_bIsOpen' has a wrong offset!");
...
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS, CallFunc_PlayAnimation_ReturnValue_3) == 0x000028, "Member 'InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS::CallFunc_PlayAnimation_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS, CallFunc_IsAnimationPlaying_ReturnValue) == 0x000030, "Member 'InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS::CallFunc_IsAnimationPlaying_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView) == 0x000054, "Wrong size on InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView");
...
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView, Temp_struct_Variable) == 0x000004, "Member 'InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView, Temp_struct_Variable_1) == 0x000014, "Member 'InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView::Temp_struct_Variable_1' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView, Temp_struct_Variable_2) == 0x000024, "Member 'InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView::Temp_struct_Variable_2' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView, Temp_struct_Variable_3) == 0x000034, "Member 'InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView::Temp_struct_Variable_3' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView, K2Node_Select_Default) == 0x000044, "Member 'InviteListEntry_FriendInvite_XS_C_HandleOnlineIndicatorView::K2Node_Select_Default' has a wrong offset!");
