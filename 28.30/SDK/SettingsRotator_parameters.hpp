...
static_assert(sizeof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator) == 0x000060, "Wrong size on SettingsRotator_C_ExecuteUbergraph_SettingsRotator");
...
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000020, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, K2Node_Event_Index) == 0x000028, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::K2Node_Event_Index' has a wrong offset!");
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, CallFunc_Conv_IntToDouble_ReturnValue_1) == 0x000030, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::CallFunc_Conv_IntToDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, K2Node_Event_DefaultOptionIndex) == 0x000038, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::K2Node_Event_DefaultOptionIndex' has a wrong offset!");
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, CallFunc_GetDynamicMaterial_ReturnValue_2) == 0x000040, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::CallFunc_GetDynamicMaterial_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, CallFunc_Conv_IntToDouble_ReturnValue_2) == 0x000048, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::CallFunc_Conv_IntToDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, CallFunc_SetScalarParameterValue_Value_ImplicitCast) == 0x000050, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::CallFunc_SetScalarParameterValue_Value_ImplicitCast' has a wrong offset!");
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, CallFunc_SetScalarParameterValue_Value_ImplicitCast_1) == 0x000054, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::CallFunc_SetScalarParameterValue_Value_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(SettingsRotator_C_ExecuteUbergraph_SettingsRotator, CallFunc_SetScalarParameterValue_Value_ImplicitCast_2) == 0x000058, "Member 'SettingsRotator_C_ExecuteUbergraph_SettingsRotator::CallFunc_SetScalarParameterValue_Value_ImplicitCast_2' has a wrong offset!");
