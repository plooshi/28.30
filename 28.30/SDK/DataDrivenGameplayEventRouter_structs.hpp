...
static_assert(sizeof(FGameplayEventSubscription) == 0x000070, "Wrong size on FGameplayEventSubscription");
...
static_assert(offsetof(FGameplayEventSubscription, EventDescriptor) == 0x000020, "Member 'FGameplayEventSubscription::EventDescriptor' has a wrong offset!");
static_assert(offsetof(FGameplayEventSubscription, EventHandle) == 0x000050, "Member 'FGameplayEventSubscription::EventHandle' has a wrong offset!");
