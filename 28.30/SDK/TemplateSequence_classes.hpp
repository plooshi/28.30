...
static_assert(sizeof(UTemplateSequence) == 0x0000E0, "Wrong size on UTemplateSequence");
...
static_assert(offsetof(UTemplateSequence, BoundActorComponents) == 0x000090, "Member 'UTemplateSequence::BoundActorComponents' has a wrong offset!");
...
static_assert(sizeof(UCameraAnimationSequence) == 0x0000E0, "Wrong size on UCameraAnimationSequence");
...
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentFocalLength) == 0x0007A8, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentAperture) == 0x0007AC, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentAperture' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, CurrentFocusDistance) == 0x0007B0, "Member 'UCameraAnimationSequenceCameraStandIn::CurrentFocusDistance' has a wrong offset!");
...
public:
	...
	class UObject*                                BoundObjectOverride;                               // 0x02B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieSceneSequence*                    Sequence;                                          // 0x02B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                              // 0x02C0(0x0070)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UCameraAnimationSequencePlayer, BoundObjectOverride) == 0x0002B0, "Member 'UCameraAnimationSequencePlayer::BoundObjectOverride' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequencePlayer, Sequence) == 0x0002B8, "Member 'UCameraAnimationSequencePlayer::Sequence' has a wrong offset!");
static_assert(offsetof(UCameraAnimationSequencePlayer, RootTemplateInstance) == 0x0002C0, "Member 'UCameraAnimationSequencePlayer::RootTemplateInstance' has a wrong offset!");
...
static_assert(sizeof(UCameraAnimationEntitySystemLinker) == 0x000740, "Wrong size on UCameraAnimationEntitySystemLinker");
