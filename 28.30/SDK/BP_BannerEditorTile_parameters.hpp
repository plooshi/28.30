...
static_assert(sizeof(BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile) == 0x0000E0, "Wrong size on BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile");
...
static_assert(offsetof(BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile, K2Node_DynamicCast_bSuccess_3) == 0x000088, "Member 'BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile, CallFunc_GetListItemObject_ReturnValue_2) == 0x000090, "Member 'BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile::CallFunc_GetListItemObject_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile, K2Node_DynamicCast_AsFort_Homebase_Banner_Color_Item_1) == 0x000098, "Member 'BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile::K2Node_DynamicCast_AsFort_Homebase_Banner_Color_Item_1' has a wrong offset!");
static_assert(offsetof(BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile, K2Node_DynamicCast_bSuccess_4) == 0x0000A0, "Member 'BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile::K2Node_DynamicCast_bSuccess_4' has a wrong offset!");
...
static_assert(offsetof(BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile, K2Node_Event_ListItemObject) == 0x0000D8, "Member 'BP_BannerEditorTile_C_ExecuteUbergraph_BP_BannerEditorTile::K2Node_Event_ListItemObject' has a wrong offset!");
