...
static_assert(sizeof(ChaosCacheManager_EnablePlaybackByCache) == 0x000008, "Wrong size on ChaosCacheManager_EnablePlaybackByCache");
...
static_assert(offsetof(ChaosCacheManager_EnablePlaybackByCache, bEnable) == 0x000004, "Member 'ChaosCacheManager_EnablePlaybackByCache::bEnable' has a wrong offset!");
