...
void AGCN_RezOut_C::Dissolve_Material_Setup()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Dissolve Material Setup");
...
void AGCN_RezOut_C::ExecuteUbergraph_GCN_RezOut(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_GCN_RezOut");
...
void AGCN_RezOut_C::Set_Additional_Niagara_Parameters_on_Drone_FX(class UNiagaraComponent* Drone_FX)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Set Additional Niagara Parameters on Drone FX");
...
void AGCN_RezOut_C::Set_Timeline_Playrates()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Set Timeline Playrates");
...
void AGCN_RezOut_C::Spawn_Dissolve_VFX()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Spawn Dissolve VFX");
