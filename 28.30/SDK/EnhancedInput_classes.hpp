...
static_assert(sizeof(UEnhancedInputDeveloperSettings) == 0x0000C8, "Wrong size on UEnhancedInputDeveloperSettings");
...
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultPlayerMappableKeyProfileClass) == 0x000080, "Member 'UEnhancedInputDeveloperSettings::DefaultPlayerMappableKeyProfileClass' has a wrong offset!");
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultWorldInputClass) == 0x0000A0, "Member 'UEnhancedInputDeveloperSettings::DefaultWorldInputClass' has a wrong offset!");
...
static_assert(sizeof(UEnhancedPlayerInput) == 0x0007E8, "Wrong size on UEnhancedPlayerInput");
