...
static_assert(alignof(IMassActorPoolableInterface) == 0x000008, "Wrong alignment on IMassActorPoolableInterface");
static_assert(sizeof(IMassActorPoolableInterface) == 0x000028, "Wrong size on IMassActorPoolableInterface");
