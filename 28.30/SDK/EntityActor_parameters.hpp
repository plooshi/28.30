...
static_assert(sizeof(EntityActorCollisionComponent_OnNativeComponentBeginOverlap) == 0x000108, "Wrong size on EntityActorCollisionComponent_OnNativeComponentBeginOverlap");
...
static_assert(sizeof(EntityActorCollisionComponent_OnNativeComponentHit) == 0x000118, "Wrong size on EntityActorCollisionComponent_OnNativeComponentHit");
