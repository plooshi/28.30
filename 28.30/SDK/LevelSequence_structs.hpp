...
static_assert(offsetof(FLevelSequencePlayerSnapshot, ActiveShot) == 0x000090, "Member 'FLevelSequencePlayerSnapshot::ActiveShot' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, ShotID) == 0x000098, "Member 'FLevelSequencePlayerSnapshot::ShotID' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, MasterName) == 0x0000A0, "Member 'FLevelSequencePlayerSnapshot::MasterName' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, MasterTime) == 0x0000B0, "Member 'FLevelSequencePlayerSnapshot::MasterTime' has a wrong offset!");
