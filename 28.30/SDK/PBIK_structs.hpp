...
{
public:
	class FName                                   Root;                                              // 0x01D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FPBIKSolverSettings                    Settings;                                          // 0x0218(0x003C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FPBIKDebug                             Debug;                                             // 0x0254(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_25C[0x4];                                      // 0x025C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPBIKWorkData                          WorkData;                                          // 0x0260(0x0090)(Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigUnit_PBIK) == 0x000010, "Wrong alignment on FRigUnit_PBIK");
static_assert(sizeof(FRigUnit_PBIK) == 0x0002F0, "Wrong size on FRigUnit_PBIK");
...
static_assert(offsetof(FRigUnit_PBIK, Debug) == 0x000254, "Member 'FRigUnit_PBIK::Debug' has a wrong offset!");
