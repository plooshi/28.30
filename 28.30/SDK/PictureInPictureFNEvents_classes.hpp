...
static_assert(sizeof(ULiveEventHUDAd) == 0x0002C0, "Wrong size on ULiveEventHUDAd");
...
static_assert(sizeof(UPictureInPictureFNEventsController) == 0x000718, "Wrong size on UPictureInPictureFNEventsController");
static_assert(offsetof(UPictureInPictureFNEventsController, FNEventsClient) == 0x0006E8, "Member 'UPictureInPictureFNEventsController::FNEventsClient' has a wrong offset!");
static_assert(offsetof(UPictureInPictureFNEventsController, HUDAdvertWidget) == 0x0006F0, "Member 'UPictureInPictureFNEventsController::HUDAdvertWidget' has a wrong offset!");
