...
public:
	...
	struct FRigVMMemoryStorageStruct              WorkMemoryStorage;                                 // 0x0010(0x0050)(Transient, NativeAccessSpecifierPublic)
	struct FRigVMMemoryStorageStruct              DebugMemoryStorage;                                // 0x0060(0x0050)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_B0[0x178];                                     // 0x00B0(0x0178)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FRigVMExtendedExecuteContext, WorkMemoryStorage) == 0x000010, "Member 'FRigVMExtendedExecuteContext::WorkMemoryStorage' has a wrong offset!");
static_assert(offsetof(FRigVMExtendedExecuteContext, DebugMemoryStorage) == 0x000060, "Member 'FRigVMExtendedExecuteContext::DebugMemoryStorage' has a wrong offset!");
...
static_assert(offsetof(FRigVMDrawInstruction, PrimitiveType) == 0x000004, "Member 'FRigVMDrawInstruction::PrimitiveType' has a wrong offset!");
static_assert(offsetof(FRigVMDrawInstruction, Positions) == 0x000008, "Member 'FRigVMDrawInstruction::Positions' has a wrong offset!");
static_assert(offsetof(FRigVMDrawInstruction, Color) == 0x000018, "Member 'FRigVMDrawInstruction::Color' has a wrong offset!");
static_assert(offsetof(FRigVMDrawInstruction, Thickness) == 0x000028, "Member 'FRigVMDrawInstruction::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMDrawInstruction, Transform) == 0x000030, "Member 'FRigVMDrawInstruction::Transform' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_NameTruncate, Count) == 0x00000C, "Member 'FRigVMFunction_NameTruncate::Count' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameTruncate, FromEnd) == 0x000010, "Member 'FRigVMFunction_NameTruncate::FromEnd' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameTruncate, Remainder) == 0x000014, "Member 'FRigVMFunction_NameTruncate::Remainder' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameTruncate, Chopped) == 0x000018, "Member 'FRigVMFunction_NameTruncate::Chopped' has a wrong offset!");
...
static_assert(offsetof(FRigVMGraphFunctionIdentifier, HostObject) == 0x000018, "Member 'FRigVMGraphFunctionIdentifier::HostObject' has a wrong offset!");
...
static_assert(offsetof(FRigVMGraphFunctionArgument, DisplayName) == 0x000004, "Member 'FRigVMGraphFunctionArgument::DisplayName' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, CPPType) == 0x000008, "Member 'FRigVMGraphFunctionArgument::CPPType' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, CPPTypeObject) == 0x000010, "Member 'FRigVMGraphFunctionArgument::CPPTypeObject' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, bIsArray) == 0x000030, "Member 'FRigVMGraphFunctionArgument::bIsArray' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, Direction) == 0x000031, "Member 'FRigVMGraphFunctionArgument::Direction' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, DefaultValue) == 0x000038, "Member 'FRigVMGraphFunctionArgument::DefaultValue' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, bIsConst) == 0x000048, "Member 'FRigVMGraphFunctionArgument::bIsConst' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, PathToTooltip) == 0x000050, "Member 'FRigVMGraphFunctionArgument::PathToTooltip' has a wrong offset!");
...
static_assert(sizeof(FRigVMGraphFunctionHeader) == 0x000100, "Wrong size on FRigVMGraphFunctionHeader");
...
static_assert(offsetof(FRigVMGraphFunctionHeader, Name) == 0x000030, "Member 'FRigVMGraphFunctionHeader::Name' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeTitle) == 0x000038, "Member 'FRigVMGraphFunctionHeader::NodeTitle' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeColor) == 0x000048, "Member 'FRigVMGraphFunctionHeader::NodeColor' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, ToolTip) == 0x000058, "Member 'FRigVMGraphFunctionHeader::ToolTip' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Category) == 0x000070, "Member 'FRigVMGraphFunctionHeader::Category' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Keywords) == 0x000080, "Member 'FRigVMGraphFunctionHeader::Keywords' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Arguments) == 0x000090, "Member 'FRigVMGraphFunctionHeader::Arguments' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Dependencies) == 0x0000A0, "Member 'FRigVMGraphFunctionHeader::Dependencies' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, ExternalVariables) == 0x0000F0, "Member 'FRigVMGraphFunctionHeader::ExternalVariables' has a wrong offset!");
...
static_assert(offsetof(FRigVMBranchInfo, InstructionIndex) == 0x000008, "Member 'FRigVMBranchInfo::InstructionIndex' has a wrong offset!");
static_assert(offsetof(FRigVMBranchInfo, ArgumentIndex) == 0x00000C, "Member 'FRigVMBranchInfo::ArgumentIndex' has a wrong offset!");
static_assert(offsetof(FRigVMBranchInfo, FirstInstruction) == 0x000010, "Member 'FRigVMBranchInfo::FirstInstruction' has a wrong offset!");
static_assert(offsetof(FRigVMBranchInfo, LastInstruction) == 0x000012, "Member 'FRigVMBranchInfo::LastInstruction' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunctionCompilationPropertyDescription, DefaultValue) == 0x000038, "Member 'FRigVMFunctionCompilationPropertyDescription::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunctionCompilationData, bEncounteredSurpressedErrors) == 0x0001D4, "Member 'FRigVMFunctionCompilationData::bEncounteredSurpressedErrors' has a wrong offset!");
...
static_assert(sizeof(FRigVMGraphFunctionData) == 0x000338, "Wrong size on FRigVMGraphFunctionData");
static_assert(offsetof(FRigVMGraphFunctionData, Header) == 0x000000, "Member 'FRigVMGraphFunctionData::Header' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionData, CompilationData) == 0x000100, "Member 'FRigVMGraphFunctionData::CompilationData' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionData, SerializedCollapsedNode) == 0x000328, "Member 'FRigVMGraphFunctionData::SerializedCollapsedNode' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_Contains, Search) == 0x00000C, "Member 'FRigVMFunction_Contains::Search' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_Contains, Result) == 0x000010, "Member 'FRigVMFunction_Contains::Result' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_EndsWith, Ending) == 0x00000C, "Member 'FRigVMFunction_EndsWith::Ending' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_EndsWith, Result) == 0x000010, "Member 'FRigVMFunction_EndsWith::Result' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_DebugPoint, bEnabled) == 0x0000A0, "Member 'FRigVMFunction_DebugPoint::bEnabled' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_ForLoopCount, Count) == 0x000104, "Member 'FRigVMFunction_ForLoopCount::Count' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Index) == 0x000108, "Member 'FRigVMFunction_ForLoopCount::Index' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Ratio) == 0x00010C, "Member 'FRigVMFunction_ForLoopCount::Ratio' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Completed) == 0x000110, "Member 'FRigVMFunction_ForLoopCount::Completed' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_NameConcat, B) == 0x00000C, "Member 'FRigVMFunction_NameConcat::B' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameConcat, Result) == 0x000010, "Member 'FRigVMFunction_NameConcat::Result' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_NameReplace, Old) == 0x00000C, "Member 'FRigVMFunction_NameReplace::Old' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameReplace, New) == 0x000010, "Member 'FRigVMFunction_NameReplace::New' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_NameReplace, Result) == 0x000014, "Member 'FRigVMFunction_NameReplace::Result' has a wrong offset!");
...
static_assert(offsetof(FRigVMFunction_StartsWith, Start) == 0x00000C, "Member 'FRigVMFunction_StartsWith::Start' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_StartsWith, Result) == 0x000010, "Member 'FRigVMFunction_StartsWith::Result' has a wrong offset!");
