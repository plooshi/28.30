...
static_assert(offsetof(FortMovementMode_ELTacSprint_HandleMovementModeChanged, Character) == 0x000000, "Member 'FortMovementMode_ELTacSprint_HandleMovementModeChanged::Character' has a wrong offset!");
static_assert(offsetof(FortMovementMode_ELTacSprint_HandleMovementModeChanged, PreviousMovementMode) == 0x000008, "Member 'FortMovementMode_ELTacSprint_HandleMovementModeChanged::PreviousMovementMode' has a wrong offset!");
static_assert(offsetof(FortMovementMode_ELTacSprint_HandleMovementModeChanged, PreviousCustomMode) == 0x000009, "Member 'FortMovementMode_ELTacSprint_HandleMovementModeChanged::PreviousCustomMode' has a wrong offset!");
...
static_assert(offsetof(FortMovementMode_ELTacSprint_HandleOnEnergyDrained, EnergyComp) == 0x000000, "Member 'FortMovementMode_ELTacSprint_HandleOnEnergyDrained::EnergyComp' has a wrong offset!");
...
static_assert(offsetof(FortMovementMode_ELTacSprint_HandleOnPlayerWeaponChanged, InPawn) == 0x000000, "Member 'FortMovementMode_ELTacSprint_HandleOnPlayerWeaponChanged::InPawn' has a wrong offset!");
static_assert(offsetof(FortMovementMode_ELTacSprint_HandleOnPlayerWeaponChanged, InNewWeapon) == 0x000008, "Member 'FortMovementMode_ELTacSprint_HandleOnPlayerWeaponChanged::InNewWeapon' has a wrong offset!");
static_assert(offsetof(FortMovementMode_ELTacSprint_HandleOnPlayerWeaponChanged, InPlayerWeapon) == 0x000010, "Member 'FortMovementMode_ELTacSprint_HandleOnPlayerWeaponChanged::InPlayerWeapon' has a wrong offset!");
...
static_assert(offsetof(FortPlayerControllerComponent_TacticalSprint_AddCustomSprintMMEClass, SprintMMEClassToAdd) == 0x000000, "Member 'FortPlayerControllerComponent_TacticalSprint_AddCustomSprintMMEClass::SprintMMEClassToAdd' has a wrong offset!");
...
static_assert(offsetof(FortPlayerControllerComponent_TacticalSprint_RemoveCustomSprintMMEClass, SprintMMEClassToRemove) == 0x000000, "Member 'FortPlayerControllerComponent_TacticalSprint_RemoveCustomSprintMMEClass::SprintMMEClassToRemove' has a wrong offset!");
