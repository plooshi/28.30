...
static_assert(offsetof(FortBattlePassCustomSkinTab_BP_ShowBang, bShow) == 0x000000, "Member 'FortBattlePassCustomSkinTab_BP_ShowBang::bShow' has a wrong offset!");
...
static_assert(offsetof(FortBattlePassCustomSkinTab_SetIcon, LazyObject) == 0x000000, "Member 'FortBattlePassCustomSkinTab_SetIcon::LazyObject' has a wrong offset!");
