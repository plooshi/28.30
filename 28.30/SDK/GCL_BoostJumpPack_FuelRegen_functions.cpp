...
void AGCL_BoostJumpPack_FuelRegen_C::ExecuteUbergraph_GCL_BoostJumpPack_FuelRegen(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_GCL_BoostJumpPack_FuelRegen");
...
void AGCL_BoostJumpPack_FuelRegen_C::FullBlinkTimeline__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FullBlinkTimeline__FinishedFunc");
...
void AGCL_BoostJumpPack_FuelRegen_C::FullBlinkTimeline__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FullBlinkTimeline__UpdateFunc");
...
void AGCL_BoostJumpPack_FuelRegen_C::ResetBlink(class AFortPlayerPawn* PlayerPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ResetBlink");
