...
void UTabGamePadConfig_v3_C::AreWeOkayWithThisChange(class FName ActionName, const struct FKey& Key, bool* IsOkay)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("AreWeOkayWithThisChange");
...
void UTabGamePadConfig_v3_C::ChangeCustomClearVisibilityForInputType(ECommonInputType InputType)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ChangeCustomClearVisibilityForInputType");
...
void UTabGamePadConfig_v3_C::ChangeCustomResetVisibilityForInputType(ECommonInputType InputType)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ChangeCustomResetVisibilityForInputType");
...
void UTabGamePadConfig_v3_C::ChangeCustomTabListVisibilityForInputType(ECommonInputType Selection)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ChangeCustomTabListVisibilityForInputType");
...
void UTabGamePadConfig_v3_C::CloseCustomActionsPanel(bool FocusLastButton)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CloseCustomActionsPanel");
...
TArray<struct FConfirmationDialogAction> UTabGamePadConfig_v3_C::CreateCustomResetToDefaultList()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CreateCustomResetToDefaultList");
...
void UTabGamePadConfig_v3_C::CustomActionSelected_Bind(int32 SelectedIndex, class FName ActionName)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CustomActionSelected_Bind");
...
void UTabGamePadConfig_v3_C::CustomClearButton_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CustomClearButton_Bind");
...
void UTabGamePadConfig_v3_C::CustomClosedUsingBack_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CustomClosedUsingBack_Bind");
...
void UTabGamePadConfig_v3_C::CustomDoResetToDefault()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CustomDoResetToDefault");
...
void UTabGamePadConfig_v3_C::CustomKeySelected_Bind(const struct FKey& Key)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CustomKeySelected_Bind");
...
void UTabGamePadConfig_v3_C::DeadZoneLookSettingValueChanged_Bind(float Value)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DeadZoneLookSettingValueChanged_Bind");
...
void UTabGamePadConfig_v3_C::DeadZoneMoveSettingValueChanged_Bind(float Value)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DeadZoneMoveSettingValueChanged_Bind");
...
void UTabGamePadConfig_v3_C::DialogResult_017CD690454514A07B4DE5BE109AEC6E(EFortDialogResult Result, class FName ResultName)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DialogResult_017CD690454514A07B4DE5BE109AEC6E");
...
void UTabGamePadConfig_v3_C::DialogResult_7D7E06D747FFEF9849D3CAA2D3D91717(EFortDialogResult Result, class FName ResultName)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DialogResult_7D7E06D747FFEF9849D3CAA2D3D91717");
...
void UTabGamePadConfig_v3_C::ExecuteUbergraph_TabGamePadConfig_v3(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_TabGamePadConfig_v3");
...
void UTabGamePadConfig_v3_C::Gamepad_Config_Changed(class UCommonButtonLegacy* AssociatedButton, int32 ButtonIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Gamepad Config Changed");
...
void UTabGamePadConfig_v3_C::GamepadInfoSelectorNavRight()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GamepadInfoSelectorNavRight");
...
void UTabGamePadConfig_v3_C::GamepadPlatformConfigChanged(class UCommonButtonLegacy* AssociatedButton, int32 ButtonIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GamepadPlatformConfigChanged");
...
void UTabGamePadConfig_v3_C::GetCurrentPlatformIndex(int32* PlatformIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetCurrentPlatformIndex");
...
void UTabGamePadConfig_v3_C::HandleGamepadInfoSelectorApply()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleGamepadInfoSelectorApply");
...
void UTabGamePadConfig_v3_C::HandleGamepadInfoSelectorBack()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleGamepadInfoSelectorBack");
...
void UTabGamePadConfig_v3_C::HandleGamepadInfoSelectorFocus()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleGamepadInfoSelectorFocus");
...
void UTabGamePadConfig_v3_C::HandleGamepadMappingInfoChange()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleGamepadMappingInfoChange");
...
void UTabGamePadConfig_v3_C::HandleUsingGamepadChanged(ECommonInputType NewInputType)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleUsingGamepadChanged");
...
void UTabGamePadConfig_v3_C::InitializeData()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeData");
...
bool UTabGamePadConfig_v3_C::IsCustomConfig(int32 PresetIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("IsCustomConfig");
...
void UTabGamePadConfig_v3_C::ModesTabSelected_Bind(class FName TabID)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ModesTabSelected_Bind");
...
void UTabGamePadConfig_v3_C::NavigateToSelectedConfig()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("NavigateToSelectedConfig");
...
void UTabGamePadConfig_v3_C::OnTabActivated_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnTabActivated_Bind");
...
void UTabGamePadConfig_v3_C::OnTabDeactivated_Bind()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnTabDeactivated_Bind");
...
void UTabGamePadConfig_v3_C::PreConstructData()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PreConstructData");
...
void UTabGamePadConfig_v3_C::SelectSameItemInActionsList()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SelectSameItemInActionsList");
...
void UTabGamePadConfig_v3_C::SetupDisplayObject(class FName ActionName, const struct FKey& Key, class UGamepadKeyTextButton_C** DisplayObject_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetupDisplayObject");
...
void UTabGamePadConfig_v3_C::UpdateOptionsTab()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateOptionsTab");
