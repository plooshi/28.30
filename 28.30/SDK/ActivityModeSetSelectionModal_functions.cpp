...
void UActivityModeSetSelectionModal_C::BndEvt__ActivityModeSetSelectionModal_ActivityPrivacyButton_K2Node_ComponentBoundEvent_4_OnPrivacyAvailableChanged__DelegateSignature(bool IsAvailable)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BndEvt__ActivityModeSetSelectionModal_ActivityPrivacyButton_K2Node_ComponentBoundEvent_4_OnPrivacyAvailableChanged__DelegateSignature");
...
void UActivityModeSetSelectionModal_C::ExecuteUbergraph_ActivityModeSetSelectionModal(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_ActivityModeSetSelectionModal");
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bIsRankedSwitchAvailable                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
