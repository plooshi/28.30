...
public:
	...
	bool                                          CallFunc_GetSelected_ReturnValue;                  // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetSelected_ReturnValue_1;                // 0x0131(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton) == 0x000140, "Wrong size on AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton");
...
static_assert(offsetof(AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton, CallFunc_GetSelected_ReturnValue) == 0x000130, "Member 'AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton::CallFunc_GetSelected_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton, CallFunc_GetSelected_ReturnValue_1) == 0x000131, "Member 'AthenaLeaderboardTabButton_C_ExecuteUbergraph_AthenaLeaderboardTabButton::CallFunc_GetSelected_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(AthenaLeaderboardTabButton_C_SetTabLabelInfo) == 0x000110, "Wrong size on AthenaLeaderboardTabButton_C_SetTabLabelInfo");
