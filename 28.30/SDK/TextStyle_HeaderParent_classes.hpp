...
static_assert(alignof(UTextStyle_HeaderParent_C) == 0x000010, "Wrong alignment on UTextStyle_HeaderParent_C");
static_assert(sizeof(UTextStyle_HeaderParent_C) == 0x0001A0, "Wrong size on UTextStyle_HeaderParent_C");
