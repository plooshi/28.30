...
public:
	...
	uint8                                         Pad_889[0x13F];                                    // 0x0889(0x013F)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigModuleSettings                     RigModuleSettings;                                 // 0x09C8(0x0048)(NativeAccessSpecifierPrivate)
	class FString                                 RigModuleNameSpace;                                // 0x0A10(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UControlRig) == 0x000A20, "Wrong size on UControlRig");
...
static_assert(offsetof(UControlRig, RigModuleSettings) == 0x0009C8, "Member 'UControlRig::RigModuleSettings' has a wrong offset!");
static_assert(offsetof(UControlRig, RigModuleNameSpace) == 0x000A10, "Member 'UControlRig::RigModuleNameSpace' has a wrong offset!");

// Class ControlRig.ModularRig
// 0x0140 (0x0B60 - 0x0A20)
class UModularRig final : public UControlRig
{
public:
	TArray<struct FRigModuleInstance>             Modules;                                           // 0x0A20(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_A30[0x20];                                     // 0x0A30(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	struct FModularRigSettings                    ModularRigSettings;                                // 0x0A50(0x0001)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_A51[0x7];                                      // 0x0A51(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FModularRigModel                       ModularRigModel;                                   // 0x0A58(0x00A0)(NativeAccessSpecifierPublic)
	TArray<struct FRigModuleExecutionElement>     ExecutionQueue;                                    // 0x0AF8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B08[0x58];                                     // 0x0B08(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UModularRig) == 0x000B60, "Wrong size on UModularRig");
static_assert(offsetof(UModularRig, Modules) == 0x000A20, "Member 'UModularRig::Modules' has a wrong offset!");
static_assert(offsetof(UModularRig, ModularRigSettings) == 0x000A50, "Member 'UModularRig::ModularRigSettings' has a wrong offset!");
static_assert(offsetof(UModularRig, ModularRigModel) == 0x000A58, "Member 'UModularRig::ModularRigModel' has a wrong offset!");
static_assert(offsetof(UModularRig, ExecutionQueue) == 0x000AF8, "Member 'UModularRig::ExecutionQueue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_300[0xF8];                                     // 0x0300(0x00F8)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URigHierarchy) == 0x0004C0, "Wrong size on URigHierarchy");
...
static_assert(offsetof(URigHierarchy, HierarchyController) == 0x000248, "Member 'URigHierarchy::HierarchyController' has a wrong offset!");
static_assert(offsetof(URigHierarchy, RuleManager) == 0x000258, "Member 'URigHierarchy::RuleManager' has a wrong offset!");
static_assert(offsetof(URigHierarchy, PreviousNameMap) == 0x0002B0, "Member 'URigHierarchy::PreviousNameMap' has a wrong offset!");
static_assert(offsetof(URigHierarchy, HierarchyForCacheValidation) == 0x0003F8, "Member 'URigHierarchy::HierarchyForCacheValidation' has a wrong offset!");
...
static_assert(sizeof(UTransformableControlHandle) == 0x000080, "Wrong size on UTransformableControlHandle");
...
static_assert(offsetof(UTransformableControlHandle, ControlName) == 0x000078, "Member 'UTransformableControlHandle::ControlName' has a wrong offset!");
...
{
public:
	TSubclassOf<class UControlRig>                ControlRigClass;                                   // 0x0500(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreInitializeDelegate;                           // 0x0508(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreConstructionDelegate;                         // 0x0528(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostConstructionDelegate;                        // 0x0538(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreForwardsSolveDelegate;                        // 0x0548(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostForwardsSolveDelegate;                       // 0x0558(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<struct FControlRigComponentMappedElement> UserDefinedElements;                               // 0x0568(0x0010)(Edit, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<struct FControlRigComponentMappedElement> MappedElements;                                    // 0x0578(0x0010)(Edit, ZeroConstructor, EditConst, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bEnableLazyEvaluation;                             // 0x0588(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_589[0x3];                                      // 0x0589(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         LazyEvaluationPositionThreshold;                   // 0x058C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LazyEvaluationRotationThreshold;                   // 0x0590(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LazyEvaluationScaleThreshold;                      // 0x0594(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bResetTransformBeforeTick;                         // 0x0598(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bResetInitialsBeforeConstruction;                  // 0x0599(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateRigOnTick;                                  // 0x059A(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateInEditor;                                   // 0x059B(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawBones;                                        // 0x059C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowDebugDrawing;                                 // 0x059D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59E[0x2];                                      // 0x059E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UControlRig*                            ControlRig;                                        // 0x05A0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5A8[0xB8];                                     // 0x05A8(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UControlRigComponent) == 0x000660, "Wrong size on UControlRigComponent");
...
static_assert(offsetof(UControlRigComponent, OnPreInitializeDelegate) == 0x000508, "Member 'UControlRigComponent::OnPreInitializeDelegate' has a wrong offset!");
...
static_assert(offsetof(UControlRigComponent, OnPreConstructionDelegate) == 0x000528, "Member 'UControlRigComponent::OnPreConstructionDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostConstructionDelegate) == 0x000538, "Member 'UControlRigComponent::OnPostConstructionDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreForwardsSolveDelegate) == 0x000548, "Member 'UControlRigComponent::OnPreForwardsSolveDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostForwardsSolveDelegate) == 0x000558, "Member 'UControlRigComponent::OnPostForwardsSolveDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, UserDefinedElements) == 0x000568, "Member 'UControlRigComponent::UserDefinedElements' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, MappedElements) == 0x000578, "Member 'UControlRigComponent::MappedElements' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bEnableLazyEvaluation) == 0x000588, "Member 'UControlRigComponent::bEnableLazyEvaluation' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationPositionThreshold) == 0x00058C, "Member 'UControlRigComponent::LazyEvaluationPositionThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationRotationThreshold) == 0x000590, "Member 'UControlRigComponent::LazyEvaluationRotationThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationScaleThreshold) == 0x000594, "Member 'UControlRigComponent::LazyEvaluationScaleThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetTransformBeforeTick) == 0x000598, "Member 'UControlRigComponent::bResetTransformBeforeTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetInitialsBeforeConstruction) == 0x000599, "Member 'UControlRigComponent::bResetInitialsBeforeConstruction' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateRigOnTick) == 0x00059A, "Member 'UControlRigComponent::bUpdateRigOnTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateInEditor) == 0x00059B, "Member 'UControlRigComponent::bUpdateInEditor' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bDrawBones) == 0x00059C, "Member 'UControlRigComponent::bDrawBones' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bShowDebugDrawing) == 0x00059D, "Member 'UControlRigComponent::bShowDebugDrawing' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x0005A0, "Member 'UControlRigComponent::ControlRig' has a wrong offset!");
...
static_assert(sizeof(AControlRigShapeActor) == 0x000340, "Wrong size on AControlRigShapeActor");
...
static_assert(offsetof(AControlRigShapeActor, ShapeName) == 0x0002B0, "Member 'AControlRigShapeActor::ShapeName' has a wrong offset!");
static_assert(offsetof(AControlRigShapeActor, ColorParameterName) == 0x0002B4, "Member 'AControlRigShapeActor::ColorParameterName' has a wrong offset!");
...
static_assert(offsetof(UControlRigShapeLibrary, XRayMaterial) == 0x0000F0, "Member 'UControlRigShapeLibrary::XRayMaterial' has a wrong offset!");
...
static_assert(sizeof(UControlRigTestData) == 0x000148, "Wrong size on UControlRigTestData");
...
static_assert(offsetof(UControlRigTestData, Initial) == 0x000040, "Member 'UControlRigTestData::Initial' has a wrong offset!");
static_assert(offsetof(UControlRigTestData, InputFrames) == 0x0000D0, "Member 'UControlRigTestData::InputFrames' has a wrong offset!");
static_assert(offsetof(UControlRigTestData, OutputFrames) == 0x0000E0, "Member 'UControlRigTestData::OutputFrames' has a wrong offset!");
static_assert(offsetof(UControlRigTestData, FramesToSkip) == 0x0000F0, "Member 'UControlRigTestData::FramesToSkip' has a wrong offset!");
static_assert(offsetof(UControlRigTestData, Tolerance) == 0x000100, "Member 'UControlRigTestData::Tolerance' has a wrong offset!");
...
public:
	...
	bool ConnectConnectorToElement(const struct FRigElementKey& InConnectorKey, const struct FRigElementKey& InTargetKey, bool bSetupUndo, bool bAutoResolveOtherConnectors);
	bool DeleteModule(const class FString& InModulePath, bool bSetupUndo);
	bool DisconnectConnector(const struct FRigElementKey& InConnectorKey, bool bSetupUndo);
...
static_assert(sizeof(UAdditiveControlRig) == 0x000A30, "Wrong size on UAdditiveControlRig");
...
{
public:
	TArray<bool>                                  IsControlActive;                                   // 0x0A20(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	EControlRigFKRigExecuteMode                   ApplyMode;                                         // 0x0A30(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A31[0x2F];                                     // 0x0A31(0x002F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFKControlRig) == 0x000A60, "Wrong size on UFKControlRig");
static_assert(offsetof(UFKControlRig, IsControlActive) == 0x000A20, "Member 'UFKControlRig::IsControlActive' has a wrong offset!");
static_assert(offsetof(UFKControlRig, ApplyMode) == 0x000A30, "Member 'UFKControlRig::ApplyMode' has a wrong offset!");
...
public:
	...
	TWeakObjectPtr<class URigHierarchy>           WeakHierarchy;                                     // 0x002C(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(URigHierarchyController, WeakHierarchy) == 0x00002C, "Member 'URigHierarchyController::WeakHierarchy' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneControlRigParameterTrack) == 0x000158, "Wrong size on UMovieSceneControlRigParameterTrack");
