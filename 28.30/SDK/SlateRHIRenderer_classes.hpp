...
static_assert(sizeof(USlateRHIRendererSettings) == 0x000080, "Wrong size on USlateRHIRendererSettings");
static_assert(offsetof(USlateRHIRendererSettings, SlatePostSettings) == 0x000030, "Member 'USlateRHIRendererSettings::SlatePostSettings' has a wrong offset!");
