...
static_assert(offsetof(FInterchangeTranslatorPipelines, Pipelines) == 0x000020, "Member 'FInterchangeTranslatorPipelines::Pipelines' has a wrong offset!");
...
static_assert(offsetof(FInterchangeImportSettings, bShowPipelineStacksConfigurationDialog) == 0x000078, "Member 'FInterchangeImportSettings::bShowPipelineStacksConfigurationDialog' has a wrong offset!");
...
static_assert(offsetof(FInterchangeContentImportSettings, DefaultPipelineStackOverride) == 0x000080, "Member 'FInterchangeContentImportSettings::DefaultPipelineStackOverride' has a wrong offset!");
static_assert(offsetof(FInterchangeContentImportSettings, ShowPipelineStacksConfigurationDialogOverride) == 0x0000D0, "Member 'FInterchangeContentImportSettings::ShowPipelineStacksConfigurationDialogOverride' has a wrong offset!");
...
static_assert(offsetof(FImportAssetParameters, OnAssetsImportDone) == 0x000058, "Member 'FImportAssetParameters::OnAssetsImportDone' has a wrong offset!");
static_assert(offsetof(FImportAssetParameters, OnSceneObjectDone) == 0x000078, "Member 'FImportAssetParameters::OnSceneObjectDone' has a wrong offset!");
