...
static_assert(sizeof(FPiPPartnerSource) == 0x0001F0, "Wrong size on FPiPPartnerSource");
...
static_assert(offsetof(FPiPPartnerSource, EventIconUrl) == 0x0000D8, "Member 'FPiPPartnerSource::EventIconUrl' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, CMSImage) == 0x0000E8, "Member 'FPiPPartnerSource::CMSImage' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, ActionData) == 0x0000F0, "Member 'FPiPPartnerSource::ActionData' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, PlatformDenylist) == 0x0000F8, "Member 'FPiPPartnerSource::PlatformDenylist' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, GameplayTagDenylist) == 0x000148, "Member 'FPiPPartnerSource::GameplayTagDenylist' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, GameplayTagAllowlist) == 0x000198, "Member 'FPiPPartnerSource::GameplayTagAllowlist' has a wrong offset!");
static_assert(offsetof(FPiPPartnerSource, bManual) == 0x0001E8, "Member 'FPiPPartnerSource::bManual' has a wrong offset!");
