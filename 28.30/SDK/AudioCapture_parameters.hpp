...
static_assert(sizeof(AudioCapture_GetAudioCaptureDeviceInfo) == 0x000010, "Wrong size on AudioCapture_GetAudioCaptureDeviceInfo");
...
static_assert(offsetof(AudioCapture_GetAudioCaptureDeviceInfo, ReturnValue) == 0x00000C, "Member 'AudioCapture_GetAudioCaptureDeviceInfo::ReturnValue' has a wrong offset!");
...
public:
	...
	TDelegate<void(TArray<struct FAudioInputDeviceInfo>& AvailableDevices)> OnObtainDevicesEvent;                              // 0x0008(0x000C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
