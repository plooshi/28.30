...
public:
	...
	uint8                                         Pad_88[0xF8];                                      // 0x0088(0x00F8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FObservedComponent, bIsSimulating) == 0x000070, "Member 'FObservedComponent::bIsSimulating' has a wrong offset!");
static_assert(offsetof(FObservedComponent, bPlaybackEnabled) == 0x000071, "Member 'FObservedComponent::bPlaybackEnabled' has a wrong offset!");
static_assert(offsetof(FObservedComponent, USDCacheDirectory) == 0x000078, "Member 'FObservedComponent::USDCacheDirectory' has a wrong offset!");
