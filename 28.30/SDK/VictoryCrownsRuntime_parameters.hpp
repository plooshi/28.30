...
static_assert(offsetof(FortControllerComponent_VictoryCrowns_OnEnterAircraft, EnteringController) == 0x000000, "Member 'FortControllerComponent_VictoryCrowns_OnEnterAircraft::EnteringController' has a wrong offset!");
