...
static_assert(offsetof(FAthenaAIBehaviorInjectionManager, ItemBehaviorsRegistry) == 0x000000, "Member 'FAthenaAIBehaviorInjectionManager::ItemBehaviorsRegistry' has a wrong offset!");
static_assert(offsetof(FAthenaAIBehaviorInjectionManager, InjectionSupportingBehaviors) == 0x000008, "Member 'FAthenaAIBehaviorInjectionManager::InjectionSupportingBehaviors' has a wrong offset!");
static_assert(offsetof(FAthenaAIBehaviorInjectionManager, InjectionBlackboard) == 0x000018, "Member 'FAthenaAIBehaviorInjectionManager::InjectionBlackboard' has a wrong offset!");
static_assert(offsetof(FAthenaAIBehaviorInjectionManager, BehaviorToRuntimeBehavior) == 0x000020, "Member 'FAthenaAIBehaviorInjectionManager::BehaviorToRuntimeBehavior' has a wrong offset!");
...
static_assert(offsetof(FFortSmartObjectRuntimeConfigForResult, OverridenFilterClassForEntryPoints) == 0x000008, "Member 'FFortSmartObjectRuntimeConfigForResult::OverridenFilterClassForEntryPoints' has a wrong offset!");
...
static_assert(offsetof(FFortSmartObjectEvaluationResult, PickedSmartObjectComponent) == 0x000078, "Member 'FFortSmartObjectEvaluationResult::PickedSmartObjectComponent' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationResult, ActiveGameplayInteractionContext) == 0x0000D8, "Member 'FFortSmartObjectEvaluationResult::ActiveGameplayInteractionContext' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationResult, ActiveBehaviorConfig) == 0x000140, "Member 'FFortSmartObjectEvaluationResult::ActiveBehaviorConfig' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationResult, ActiveGameplayBehavior) == 0x000148, "Member 'FFortSmartObjectEvaluationResult::ActiveGameplayBehavior' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationResult, ActiveSmartObjectInteractionBehaviorDefinition) == 0x000150, "Member 'FFortSmartObjectEvaluationResult::ActiveSmartObjectInteractionBehaviorDefinition' has a wrong offset!");
...
static_assert(offsetof(FFortSmartObjectEvaluationRequest, OptionalApprovedList) == 0x000000, "Member 'FFortSmartObjectEvaluationRequest::OptionalApprovedList' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationRequest, DistanceToWeightCurveForSlotPicking) == 0x000030, "Member 'FFortSmartObjectEvaluationRequest::DistanceToWeightCurveForSlotPicking' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationRequest, OverridenFilterClassForEntryPoints) == 0x000038, "Member 'FFortSmartObjectEvaluationRequest::OverridenFilterClassForEntryPoints' has a wrong offset!");
...
static_assert(offsetof(FFortAISmartObjectEvaluationRequestInternalData, Request) == 0x000000, "Member 'FFortAISmartObjectEvaluationRequestInternalData::Request' has a wrong offset!");
...
static_assert(offsetof(FFortAICommandSOUsageDataBase, RequestDuration) == 0x000000, "Member 'FFortAICommandSOUsageDataBase::RequestDuration' has a wrong offset!");
static_assert(offsetof(FFortAICommandSOUsageDataBase, bIgnoreCooldowns) == 0x000004, "Member 'FFortAICommandSOUsageDataBase::bIgnoreCooldowns' has a wrong offset!");
...
static_assert(offsetof(FFortAICommandSOUsageData, SOActor) == 0x000008, "Member 'FFortAICommandSOUsageData::SOActor' has a wrong offset!");
...
static_assert(offsetof(FFortAIActiveCommandSOUsageData, SOComponent) == 0x000000, "Member 'FFortAIActiveCommandSOUsageData::SOComponent' has a wrong offset!");
...
static_assert(sizeof(FFortAISpawnGroupUpgradeUIData) == 0x000068, "Wrong size on FFortAISpawnGroupUpgradeUIData");
...
static_assert(offsetof(FFortAISpawnGroupUpgradeUIData, UpgradeIconTintColor) == 0x000028, "Member 'FFortAISpawnGroupUpgradeUIData::UpgradeIconTintColor' has a wrong offset!");
static_assert(offsetof(FFortAISpawnGroupUpgradeUIData, HealthBarColorOverride) == 0x00003C, "Member 'FFortAISpawnGroupUpgradeUIData::HealthBarColorOverride' has a wrong offset!");
static_assert(offsetof(FFortAISpawnGroupUpgradeUIData, UpgradeName) == 0x000050, "Member 'FFortAISpawnGroupUpgradeUIData::UpgradeName' has a wrong offset!");
...
static_assert(offsetof(FAIVisibilityRangeSettings, VisibilitySettings) == 0x000001, "Member 'FAIVisibilityRangeSettings::VisibilitySettings' has a wrong offset!");
static_assert(offsetof(FAIVisibilityRangeSettings, Range) == 0x000004, "Member 'FAIVisibilityRangeSettings::Range' has a wrong offset!");
static_assert(offsetof(FAIVisibilityRangeSettings, IdleTime) == 0x000008, "Member 'FAIVisibilityRangeSettings::IdleTime' has a wrong offset!");
...
static_assert(offsetof(FFortAIVisibilityDataTableRow, VisibilityTagQuery) == 0x000008, "Member 'FFortAIVisibilityDataTableRow::VisibilityTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAIVisibilityDataTableRow, RangeSettings) == 0x000050, "Member 'FFortAIVisibilityDataTableRow::RangeSettings' has a wrong offset!");
...
static_assert(offsetof(FFortAIWeaponModDataTableRow, WeaponModTagQuery) == 0x000008, "Member 'FFortAIWeaponModDataTableRow::WeaponModTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAIWeaponModDataTableRow, LootScore) == 0x000054, "Member 'FFortAIWeaponModDataTableRow::LootScore' has a wrong offset!");
static_assert(offsetof(FFortAIWeaponModDataTableRow, AccuracyModifier) == 0x000058, "Member 'FFortAIWeaponModDataTableRow::AccuracyModifier' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValueBase, Name) == 0x000000, "Member 'FFortBehaviorValueBase::Name' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Bool, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Bool::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Class, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Class::DefaultValue' has a wrong offset!");
static_assert(offsetof(FFortBehaviorValue_Class, BaseClass) == 0x000010, "Member 'FFortBehaviorValue_Class::BaseClass' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Enum, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Enum::DefaultValue' has a wrong offset!");
static_assert(offsetof(FFortBehaviorValue_Enum, EnumType) == 0x000010, "Member 'FFortBehaviorValue_Enum::EnumType' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Float, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Float::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_GameplayTagContainer, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_GameplayTagContainer::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Int32, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Int32::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Name, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Name::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_String, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_String::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Object, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Object::DefaultValue' has a wrong offset!");
static_assert(offsetof(FFortBehaviorValue_Object, BaseClass) == 0x000010, "Member 'FFortBehaviorValue_Object::BaseClass' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Rotator, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Rotator::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FFortBehaviorValue_Vector, DefaultValue) == 0x000008, "Member 'FFortBehaviorValue_Vector::DefaultValue' has a wrong offset!");
...
static_assert(offsetof(FFortBlackboardParameterManager, ParameterKeyValues) == 0x000000, "Member 'FFortBlackboardParameterManager::ParameterKeyValues' has a wrong offset!");
...
static_assert(offsetof(FFortItemInjectedBehaviorsDataTableRow, ItemGameplayTagQuery) == 0x000028, "Member 'FFortItemInjectedBehaviorsDataTableRow::ItemGameplayTagQuery' has a wrong offset!");
static_assert(offsetof(FFortItemInjectedBehaviorsDataTableRow, InjectedBehaviorsByTagQuery) == 0x000070, "Member 'FFortItemInjectedBehaviorsDataTableRow::InjectedBehaviorsByTagQuery' has a wrong offset!");
...
static_assert(offsetof(FFortNPCVerbReactionTableRow, VerbFilters) == 0x000008, "Member 'FFortNPCVerbReactionTableRow::VerbFilters' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, EmoteReaction) == 0x000018, "Member 'FFortNPCVerbReactionTableRow::EmoteReaction' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, GameplayEffectReaction) == 0x000020, "Member 'FFortNPCVerbReactionTableRow::GameplayEffectReaction' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, ConditionalQuery) == 0x000028, "Member 'FFortNPCVerbReactionTableRow::ConditionalQuery' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, bOncePerWorld) == 0x000070, "Member 'FFortNPCVerbReactionTableRow::bOncePerWorld' has a wrong offset!");
...
static_assert(sizeof(FPendingSpawnInfo) == 0x000140, "Wrong size on FPendingSpawnInfo");
...
static_assert(offsetof(FPendingSpawnInfo, LootDropData) == 0x000130, "Member 'FPendingSpawnInfo::LootDropData' has a wrong offset!");
...
static_assert(offsetof(FFortWorldConditionCheckSmartObjectState, SmartObjectActorRef) == 0x000010, "Member 'FFortWorldConditionCheckSmartObjectState::SmartObjectActorRef' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionCheckSmartObjectState, UserActorRef) == 0x000018, "Member 'FFortWorldConditionCheckSmartObjectState::UserActorRef' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionCheckSmartObjectState, OptionalSlotHandleRef) == 0x000020, "Member 'FFortWorldConditionCheckSmartObjectState::OptionalSlotHandleRef' has a wrong offset!");
...
static_assert(offsetof(FNPCCustomEffect, EffectTag) == 0x000000, "Member 'FNPCCustomEffect::EffectTag' has a wrong offset!");
static_assert(offsetof(FNPCCustomEffect, VisualEffect) == 0x000008, "Member 'FNPCCustomEffect::VisualEffect' has a wrong offset!");
static_assert(offsetof(FNPCCustomEffect, VisualEffectSocket) == 0x000028, "Member 'FNPCCustomEffect::VisualEffectSocket' has a wrong offset!");
static_assert(offsetof(FNPCCustomEffect, SoundEffect) == 0x000030, "Member 'FNPCCustomEffect::SoundEffect' has a wrong offset!");
static_assert(offsetof(FNPCCustomEffect, SoundEffectSocket) == 0x000050, "Member 'FNPCCustomEffect::SoundEffectSocket' has a wrong offset!");
...
static_assert(sizeof(FSpawnGroupInstanceInfo) == 0x000100, "Wrong size on FSpawnGroupInstanceInfo");
...
static_assert(offsetof(FSpawnGroupInstanceInfo, PawnUpgrades) == 0x0000C0, "Member 'FSpawnGroupInstanceInfo::PawnUpgrades' has a wrong offset!");
static_assert(offsetof(FSpawnGroupInstanceInfo, ModifiersForAllPawns) == 0x0000D0, "Member 'FSpawnGroupInstanceInfo::ModifiersForAllPawns' has a wrong offset!");
static_assert(offsetof(FSpawnGroupInstanceInfo, PawnList) == 0x0000E0, "Member 'FSpawnGroupInstanceInfo::PawnList' has a wrong offset!");
static_assert(offsetof(FSpawnGroupInstanceInfo, LifespanExpiredList) == 0x0000F0, "Member 'FSpawnGroupInstanceInfo::LifespanExpiredList' has a wrong offset!");
...
static_assert(offsetof(FFortAIPawnMaterialDefinition, bRequireDynamicInstance) == 0x000020, "Member 'FFortAIPawnMaterialDefinition::bRequireDynamicInstance' has a wrong offset!");
...
static_assert(offsetof(FFortBotInventoryInfo, WeaponDefinitionCache) == 0x000030, "Member 'FFortBotInventoryInfo::WeaponDefinitionCache' has a wrong offset!");
static_assert(offsetof(FFortBotInventoryInfo, MultiItemDefinitionCache) == 0x000038, "Member 'FFortBotInventoryInfo::MultiItemDefinitionCache' has a wrong offset!");
static_assert(offsetof(FFortBotInventoryInfo, BotController) == 0x000060, "Member 'FFortBotInventoryInfo::BotController' has a wrong offset!");
...
{
public:
	TStructCycleFixup<struct FFortAthenaLoadout, 0x0170, 0x08> CosmeticLoadout;                                   // 0x0000(0x0170)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         Weight;                                            // 0x0170(0x0028)(Edit, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortAthenaAIWeightedCosmeticLoadout) == 0x000198, "Wrong size on FFortAthenaAIWeightedCosmeticLoadout");
...
static_assert(offsetof(FFortAthenaAIWeightedCosmeticLoadout, Weight) == 0x000170, "Member 'FFortAthenaAIWeightedCosmeticLoadout::Weight' has a wrong offset!");
...
public:
	...
	TArray<TSubclassOf<class UFortItemDefinition>> ItemClassToDropOnDeathInsteadOfGrant;              // 0x0060(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<TSoftObjectPtr<class UFortItemDefinition>> ItemToDropOnDeathInsteadOfGrant;                   // 0x0070(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAILootInfoRowEntry) == 0x000008, "Wrong alignment on FAILootInfoRowEntry");
static_assert(sizeof(FAILootInfoRowEntry) == 0x000080, "Wrong size on FAILootInfoRowEntry");
...
static_assert(offsetof(FAILootInfoRowEntry, ItemClassToDropOnDeathInsteadOfGrant) == 0x000060, "Member 'FAILootInfoRowEntry::ItemClassToDropOnDeathInsteadOfGrant' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, ItemToDropOnDeathInsteadOfGrant) == 0x000070, "Member 'FAILootInfoRowEntry::ItemToDropOnDeathInsteadOfGrant' has a wrong offset!");
...
static_assert(offsetof(FNavDataSetVariantSettings, OceanFloodLevel) == 0x000020, "Member 'FNavDataSetVariantSettings::OceanFloodLevel' has a wrong offset!");
...
static_assert(offsetof(FClimbLinkData, UniqueLinkId) == 0x000028, "Member 'FClimbLinkData::UniqueLinkId' has a wrong offset!");
...
static_assert(offsetof(FTokenType, TagContainer) == 0x000000, "Member 'FTokenType::TagContainer' has a wrong offset!");
static_assert(offsetof(FTokenType, NumberOfTokens) == 0x000020, "Member 'FTokenType::NumberOfTokens' has a wrong offset!");
static_assert(offsetof(FTokenType, Tokens) == 0x000048, "Member 'FTokenType::Tokens' has a wrong offset!");
...
public:
	...
	bool                                          bOwnerRelativePositions;                           // 0x0078(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           RunQueryHandle;                                    // 0x0080(0x0008)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                LastQueryLocation;                                 // 0x0088(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FTokenProviderPositioningData) == 0x0000D8, "Wrong size on FTokenProviderPositioningData");
static_assert(offsetof(FTokenProviderPositioningData, TagContainer) == 0x000000, "Member 'FTokenProviderPositioningData::TagContainer' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, QueryTemplate) == 0x000020, "Member 'FTokenProviderPositioningData::QueryTemplate' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, QueryUpdateFrequency) == 0x000028, "Member 'FTokenProviderPositioningData::QueryUpdateFrequency' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, DistanceForResultsInvalidation) == 0x000050, "Member 'FTokenProviderPositioningData::DistanceForResultsInvalidation' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, bOwnerRelativePositions) == 0x000078, "Member 'FTokenProviderPositioningData::bOwnerRelativePositions' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, RunQueryHandle) == 0x000080, "Member 'FTokenProviderPositioningData::RunQueryHandle' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, LastQueryLocation) == 0x000088, "Member 'FTokenProviderPositioningData::LastQueryLocation' has a wrong offset!");
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TStructCycleFixup<struct FFortWorldMarkerData, 0x0180, 0x08> MarkerData;                                        // 0x0008(0x0180)(Transient, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FDigestedAimingCircleSettings, ExtraClampingDistance) == 0x000104, "Member 'FDigestedAimingCircleSettings::ExtraClampingDistance' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, bPreventHeadshots) == 0x000108, "Member 'FDigestedAimingCircleSettings::bPreventHeadshots' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, WeaponSpreadContributionToClampCurve) == 0x000110, "Member 'FDigestedAimingCircleSettings::WeaponSpreadContributionToClampCurve' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, KillingBlowGracePeriodAtMinRange) == 0x000138, "Member 'FDigestedAimingCircleSettings::KillingBlowGracePeriodAtMinRange' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, KillingBlowGracePeriodAtMaxRange) == 0x00013C, "Member 'FDigestedAimingCircleSettings::KillingBlowGracePeriodAtMaxRange' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, ExtraHitOddsCurve) == 0x000140, "Member 'FDigestedAimingCircleSettings::ExtraHitOddsCurve' has a wrong offset!");
...
static_assert(sizeof(FAimingCircleSettings) == 0x000410, "Wrong size on FAimingCircleSettings");
...
static_assert(offsetof(FAimingCircleSettings, ExtraClampingDistance) == 0x000320, "Member 'FAimingCircleSettings::ExtraClampingDistance' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, PreventHeadshots) == 0x000348, "Member 'FAimingCircleSettings::PreventHeadshots' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, WeaponSpreadContributionToClampCurve) == 0x000370, "Member 'FAimingCircleSettings::WeaponSpreadContributionToClampCurve' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, KillingBlowGracePeriodAtMinRange) == 0x000398, "Member 'FAimingCircleSettings::KillingBlowGracePeriodAtMinRange' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, KillingBlowGracePeriodAtMaxRange) == 0x0003C0, "Member 'FAimingCircleSettings::KillingBlowGracePeriodAtMaxRange' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, ExtraHitOddsCurve) == 0x0003E8, "Member 'FAimingCircleSettings::ExtraHitOddsCurve' has a wrong offset!");
...
static_assert(sizeof(FWeaponAccuracy) == 0x000760, "Wrong size on FWeaponAccuracy");
...
static_assert(sizeof(FWeaponAccuracyCategorySpecialization) == 0x000780, "Wrong size on FWeaponAccuracyCategorySpecialization");
...
static_assert(offsetof(FFortBotPOIExcludedZoneDataTableRow, MapPath) == 0x000088, "Member 'FFortBotPOIExcludedZoneDataTableRow::MapPath' has a wrong offset!");
static_assert(offsetof(FFortBotPOIExcludedZoneDataTableRow, bEnabled) == 0x000098, "Member 'FFortBotPOIExcludedZoneDataTableRow::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FWeaponAccuracyCategory) == 0x000790, "Wrong size on FWeaponAccuracyCategory");
...
static_assert(offsetof(FWeaponAccuracyCategory, Specializations) == 0x000780, "Member 'FWeaponAccuracyCategory::Specializations' has a wrong offset!");
...
static_assert(offsetof(FDigestedWeaponAccuracyCategory, Specializations) == 0x000348, "Member 'FDigestedWeaponAccuracyCategory::Specializations' has a wrong offset!");
...
static_assert(offsetof(FMeleeWeaponSkill, IdealAttackDistance) == 0x000000, "Member 'FMeleeWeaponSkill::IdealAttackDistance' has a wrong offset!");
static_assert(offsetof(FMeleeWeaponSkill, IdealAttackDistanceTolerance) == 0x000028, "Member 'FMeleeWeaponSkill::IdealAttackDistanceTolerance' has a wrong offset!");
static_assert(offsetof(FMeleeWeaponSkill, MinCooldownDelayBetweenMeleeAttackAttempts) == 0x000050, "Member 'FMeleeWeaponSkill::MinCooldownDelayBetweenMeleeAttackAttempts' has a wrong offset!");
static_assert(offsetof(FMeleeWeaponSkill, MaxCooldownDelayBetweenMeleeAttackAttempts) == 0x000078, "Member 'FMeleeWeaponSkill::MaxCooldownDelayBetweenMeleeAttackAttempts' has a wrong offset!");
static_assert(offsetof(FMeleeWeaponSkill, MaxHeightDifferenceExtentMultiplierToAttemptMeleeAttack) == 0x0000A0, "Member 'FMeleeWeaponSkill::MaxHeightDifferenceExtentMultiplierToAttemptMeleeAttack' has a wrong offset!");
...
static_assert(offsetof(FMeleeWeaponSkillCategory, Tags) == 0x000000, "Member 'FMeleeWeaponSkillCategory::Tags' has a wrong offset!");
static_assert(offsetof(FMeleeWeaponSkillCategory, WeaponSkill) == 0x000020, "Member 'FMeleeWeaponSkillCategory::WeaponSkill' has a wrong offset!");
...
static_assert(offsetof(FDigestedMeleeWeaponSkill, IdealAttackDistance) == 0x000000, "Member 'FDigestedMeleeWeaponSkill::IdealAttackDistance' has a wrong offset!");
static_assert(offsetof(FDigestedMeleeWeaponSkill, IdealAttackDistanceTolerance) == 0x000004, "Member 'FDigestedMeleeWeaponSkill::IdealAttackDistanceTolerance' has a wrong offset!");
static_assert(offsetof(FDigestedMeleeWeaponSkill, MinCooldownDelayBetweenMeleeAttackAttempts) == 0x000008, "Member 'FDigestedMeleeWeaponSkill::MinCooldownDelayBetweenMeleeAttackAttempts' has a wrong offset!");
static_assert(offsetof(FDigestedMeleeWeaponSkill, MaxCooldownDelayBetweenMeleeAttackAttempts) == 0x00000C, "Member 'FDigestedMeleeWeaponSkill::MaxCooldownDelayBetweenMeleeAttackAttempts' has a wrong offset!");
static_assert(offsetof(FDigestedMeleeWeaponSkill, MaxHeightDifferenceExtentMultiplierToAttemptMeleeAttack) == 0x000010, "Member 'FDigestedMeleeWeaponSkill::MaxHeightDifferenceExtentMultiplierToAttemptMeleeAttack' has a wrong offset!");
...
static_assert(offsetof(FDigestedMeleeWeaponSkillCategory, Tags) == 0x000000, "Member 'FDigestedMeleeWeaponSkillCategory::Tags' has a wrong offset!");
static_assert(offsetof(FDigestedMeleeWeaponSkillCategory, WeaponSkill) == 0x000020, "Member 'FDigestedMeleeWeaponSkillCategory::WeaponSkill' has a wrong offset!");
...
static_assert(offsetof(FFortBotHealingItems, ItemTagQuery) == 0x000028, "Member 'FFortBotHealingItems::ItemTagQuery' has a wrong offset!");
...
static_assert(offsetof(FFortBotDigestedHealingItems, ItemTagQuery) == 0x000008, "Member 'FFortBotDigestedHealingItems::ItemTagQuery' has a wrong offset!");
...
static_assert(offsetof(FFortSmartObjectSlotDefinitionData, Urgency) == 0x00001D, "Member 'FFortSmartObjectSlotDefinitionData::Urgency' has a wrong offset!");
...
static_assert(offsetof(FLeashInfoOverride, LeashInnerRadius) == 0x000000, "Member 'FLeashInfoOverride::LeashInnerRadius' has a wrong offset!");
static_assert(offsetof(FLeashInfoOverride, LeashOuterRadius) == 0x000004, "Member 'FLeashInfoOverride::LeashOuterRadius' has a wrong offset!");
...
static_assert(offsetof(FBotPOIDebugInfo, DebugInfo) == 0x000050, "Member 'FBotPOIDebugInfo::DebugInfo' has a wrong offset!");
