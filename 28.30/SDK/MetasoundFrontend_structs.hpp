...
static_assert(offsetof(FMetasoundFrontendInterfaceVertexBinding, InputName) == 0x000004, "Member 'FMetasoundFrontendInterfaceVertexBinding::InputName' has a wrong offset!");
...
static_assert(offsetof(FMetasoundFrontendInterfaceBinding, InputInterfaceVersion) == 0x00000C, "Member 'FMetasoundFrontendInterfaceBinding::InputInterfaceVersion' has a wrong offset!");
static_assert(offsetof(FMetasoundFrontendInterfaceBinding, BindingPriority) == 0x000018, "Member 'FMetasoundFrontendInterfaceBinding::BindingPriority' has a wrong offset!");
static_assert(offsetof(FMetasoundFrontendInterfaceBinding, VertexBindings) == 0x000020, "Member 'FMetasoundFrontendInterfaceBinding::VertexBindings' has a wrong offset!");
...
static_assert(offsetof(FMetasoundFrontendInterfaceUClassOptions, bIsModifiable) == 0x000008, "Member 'FMetasoundFrontendInterfaceUClassOptions::bIsModifiable' has a wrong offset!");
static_assert(offsetof(FMetasoundFrontendInterfaceUClassOptions, bIsDefault) == 0x000009, "Member 'FMetasoundFrontendInterfaceUClassOptions::bIsDefault' has a wrong offset!");
