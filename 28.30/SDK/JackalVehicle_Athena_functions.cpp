...
void AJackalVehicle_Athena_C::BndEvt__SkeletalMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BndEvt__SkeletalMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature");
...
void AJackalVehicle_Athena_C::ChangeOutMaterials()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ChangeOutMaterials");
...
void AJackalVehicle_Athena_C::CurrentBoostCharge(double* Charge_Value)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CurrentBoostCharge");
...
void AJackalVehicle_Athena_C::DestroyBuildingPiece(class ABuildingActor* BuildingActor, double DestroyThreshold)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DestroyBuildingPiece");
...
void AJackalVehicle_Athena_C::ExecuteUbergraph_JackalVehicle_Athena(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_JackalVehicle_Athena");
...
void AJackalVehicle_Athena_C::HapticsOnHit(double HitMagnitude)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HapticsOnHit");
...
void AJackalVehicle_Athena_C::HideQuickBarForSecondaryAbility(bool Hide)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HideQuickBarForSecondaryAbility");
...
void AJackalVehicle_Athena_C::IsBoostCharging(bool* Is_Charging)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("IsBoostCharging");
...
// Parameters:
// class UAthenaItemWrapDefinition*        LoadedWrap                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void AJackalVehicle_Athena_C::K2_ApplyCosmeticWrap(const class UAthenaItemWrapDefinition* LoadedWrap)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("K2_ApplyCosmeticWrap");
...
void AJackalVehicle_Athena_C::OnHoldExitStarted(class AFortPawn* ExitingPawn, const float ExitDuration)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnHoldExitStarted");
...
void AJackalVehicle_Athena_C::OnHoldExitStopped(class AFortPawn* ExitingPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnHoldExitStopped");
...
void AJackalVehicle_Athena_C::OnIsSprintingChanged()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnIsSprintingChanged");
...
void AJackalVehicle_Athena_C::OnJumpChargeBegin()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnJumpChargeBegin");
...
void AJackalVehicle_Athena_C::OnJumpChargeEnd(float Charge)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnJumpChargeEnd");
...
void AJackalVehicle_Athena_C::OnRep_bUseAudio()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRep_bUseAudio");
...
void AJackalVehicle_Athena_C::OnStopTick()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnStopTick");
...
void AJackalVehicle_Athena_C::RemoveCooldownCueEvent(class AFortPlayerPawn* PlayerPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RemoveCooldownCueEvent");
...
void AJackalVehicle_Athena_C::SendBoostTimeToMaterials(double ParameterValue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SendBoostTimeToMaterials");
...
void AJackalVehicle_Athena_C::SendDamageValueToMaterials(double ParameterValue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SendDamageValueToMaterials");
...
void AJackalVehicle_Athena_C::SendHeadlightValueToMaterials(double ParameterValue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SendHeadlightValueToMaterials");
...
void AJackalVehicle_Athena_C::ShouldBump(const struct FVector& Hit_Normal, class AFortPlayerPawn* PlayerPawn, bool* Bump)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldBump");
...
bool AJackalVehicle_Athena_C::ShouldDestroyProp_(const struct FVector& HitNormal)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldDestroyProp?");
...
void AJackalVehicle_Athena_C::SlipStreamCheck()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SlipStreamCheck");
...
void AJackalVehicle_Athena_C::StartDriverCameraShake()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartDriverCameraShake");
