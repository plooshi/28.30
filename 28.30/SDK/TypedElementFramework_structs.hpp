...
static_assert(sizeof(FTypedElementWidgetConstructor) == 0x000020, "Wrong size on FTypedElementWidgetConstructor");
...
static_assert(sizeof(FTypedElementPackageUnresolvedReference) == 0x000008, "Wrong size on FTypedElementPackageUnresolvedReference");
...
static_assert(sizeof(FTypedElementPackageLoadedPathColumn) == 0x000008, "Wrong size on FTypedElementPackageLoadedPathColumn");
...
static_assert(sizeof(FTypedElementSelectionColumn) == 0x000004, "Wrong size on FTypedElementSelectionColumn");
