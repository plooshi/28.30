...
static_assert(sizeof(FTargetingDefaultResultData) == 0x0000F0, "Wrong size on FTargetingDefaultResultData");
...
static_assert(offsetof(FTargetingDefaultResultData, Score) == 0x0000E8, "Member 'FTargetingDefaultResultData::Score' has a wrong offset!");
