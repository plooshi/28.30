...
static_assert(offsetof(FObjectReplicationBridgePollConfig, PollFrequency) == 0x000004, "Member 'FObjectReplicationBridgePollConfig::PollFrequency' has a wrong offset!");
...
static_assert(sizeof(FObjectReplicationBridgePrioritizerConfig) == 0x00000C, "Wrong size on FObjectReplicationBridgePrioritizerConfig");
...
static_assert(offsetof(FObjectReplicationBridgePrioritizerConfig, bForceEnableOnAllInstances) == 0x000008, "Member 'FObjectReplicationBridgePrioritizerConfig::bForceEnableOnAllInstances' has a wrong offset!");
...
static_assert(sizeof(FObjectReplicatedBridgeCriticalClassConfig) == 0x000008, "Wrong size on FObjectReplicatedBridgeCriticalClassConfig");
...
static_assert(offsetof(FObjectReplicatedBridgeCriticalClassConfig, bDisconnectOnProtocolMismatch) == 0x000004, "Member 'FObjectReplicatedBridgeCriticalClassConfig::bDisconnectOnProtocolMismatch' has a wrong offset!");
...
static_assert(sizeof(FObjectReplicationBridgeTypeStatsConfig) == 0x00000C, "Wrong size on FObjectReplicationBridgeTypeStatsConfig");
...
static_assert(offsetof(FObjectReplicationBridgeTypeStatsConfig, TypeStatsName) == 0x000004, "Member 'FObjectReplicationBridgeTypeStatsConfig::TypeStatsName' has a wrong offset!");
static_assert(offsetof(FObjectReplicationBridgeTypeStatsConfig, bIncludeInMinimalCSVStats) == 0x000008, "Member 'FObjectReplicationBridgeTypeStatsConfig::bIncludeInMinimalCSVStats' has a wrong offset!");
