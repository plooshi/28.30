...
static_assert(offsetof(FSimulationStageMetaData, ElementCount) == 0x000008, "Member 'FSimulationStageMetaData::ElementCount' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ElementCountXBinding) == 0x000014, "Member 'FSimulationStageMetaData::ElementCountXBinding' has a wrong offset!");
...
static_assert(offsetof(FSimulationStageMetaData, ElementCountZBinding) == 0x00001C, "Member 'FSimulationStageMetaData::ElementCountZBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationSourceType) == 0x000020, "Member 'FSimulationStageMetaData::IterationSourceType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationDataInterface) == 0x000024, "Member 'FSimulationStageMetaData::IterationDataInterface' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationDirectBinding) == 0x000028, "Member 'FSimulationStageMetaData::IterationDirectBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ExecuteBehavior) == 0x00002C, "Member 'FSimulationStageMetaData::ExecuteBehavior' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ParticleIterationStateBinding) == 0x000034, "Member 'FSimulationStageMetaData::ParticleIterationStateBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ParticleIterationStateRange) == 0x00003C, "Member 'FSimulationStageMetaData::ParticleIterationStateRange' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, OutputDestinations) == 0x000048, "Member 'FSimulationStageMetaData::OutputDestinations' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, InputDataInterfaces) == 0x000058, "Member 'FSimulationStageMetaData::InputDataInterfaces' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, NumIterations) == 0x000068, "Member 'FSimulationStageMetaData::NumIterations' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, NumIterationsBinding) == 0x00006C, "Member 'FSimulationStageMetaData::NumIterationsBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDispatchType) == 0x000070, "Member 'FSimulationStageMetaData::GpuDispatchType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDirectDispatchElementType) == 0x000071, "Member 'FSimulationStageMetaData::GpuDirectDispatchElementType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDispatchNumThreads) == 0x000074, "Member 'FSimulationStageMetaData::GpuDispatchNumThreads' has a wrong offset!");
