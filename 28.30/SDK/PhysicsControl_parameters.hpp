...
{
public:
	struct FPhysicsControlControlAndModifierParameters InParameters;                                      // 0x0000(0x0020)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlControlAndModifierParameters OutParameters;                                     // 0x0020(0x0020)(Parm, OutParm, NativeAccessSpecifierPublic)
	class FName                                   Name_0;                                            // 0x0040(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPhysicsControlSparseData              ControlData;                                       // 0x0044(0x002C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PhysicsControlBPLibrary_AddControlParameters) == 0x000070, "Wrong size on PhysicsControlBPLibrary_AddControlParameters");
...
static_assert(offsetof(PhysicsControlBPLibrary_AddControlParameters, OutParameters) == 0x000020, "Member 'PhysicsControlBPLibrary_AddControlParameters::OutParameters' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_AddControlParameters, Name_0) == 0x000040, "Member 'PhysicsControlBPLibrary_AddControlParameters::Name_0' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_AddControlParameters, ControlData) == 0x000044, "Member 'PhysicsControlBPLibrary_AddControlParameters::ControlData' has a wrong offset!");
...
public:
	...
	struct FPhysicsControlControlAndModifierParameters OutParameters;                                     // 0x0020(0x0020)(Parm, OutParm, NativeAccessSpecifierPublic)
	class FName                                   Name_0;                                            // 0x0040(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPhysicsControlModifierSparseData      ModifierData;                                      // 0x0044(0x000C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PhysicsControlBPLibrary_AddModifierParameters) == 0x000050, "Wrong size on PhysicsControlBPLibrary_AddModifierParameters");
...
static_assert(offsetof(PhysicsControlBPLibrary_AddModifierParameters, OutParameters) == 0x000020, "Member 'PhysicsControlBPLibrary_AddModifierParameters::OutParameters' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_AddModifierParameters, Name_0) == 0x000040, "Member 'PhysicsControlBPLibrary_AddModifierParameters::Name_0' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_AddModifierParameters, ModifierData) == 0x000044, "Member 'PhysicsControlBPLibrary_AddModifierParameters::ModifierData' has a wrong offset!");
...
public:
	struct FPhysicsControlControlAndModifierParameters InParameters;                                      // 0x0000(0x0020)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlControlAndModifierParameters OutParameters;                                     // 0x0020(0x0020)(Parm, OutParm, NativeAccessSpecifierPublic)
	TArray<class FName>                           Names;                                             // 0x0040(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlSparseData              ControlData;                                       // 0x0050(0x002C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(PhysicsControlBPLibrary_AddMultipleControlParameters) == 0x000080, "Wrong size on PhysicsControlBPLibrary_AddMultipleControlParameters");
...
static_assert(offsetof(PhysicsControlBPLibrary_AddMultipleControlParameters, OutParameters) == 0x000020, "Member 'PhysicsControlBPLibrary_AddMultipleControlParameters::OutParameters' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_AddMultipleControlParameters, Names) == 0x000040, "Member 'PhysicsControlBPLibrary_AddMultipleControlParameters::Names' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_AddMultipleControlParameters, ControlData) == 0x000050, "Member 'PhysicsControlBPLibrary_AddMultipleControlParameters::ControlData' has a wrong offset!");
...
public:
	...
	struct FPhysicsControlControlAndModifierParameters OutParameters;                                     // 0x0020(0x0020)(Parm, OutParm, NativeAccessSpecifierPublic)
	TArray<class FName>                           Names;                                             // 0x0040(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlModifierSparseData      ModifierData;                                      // 0x0050(0x000C)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(PhysicsControlBPLibrary_AddMultipleModifierParameters) == 0x000060, "Wrong size on PhysicsControlBPLibrary_AddMultipleModifierParameters");
...
static_assert(offsetof(PhysicsControlBPLibrary_AddMultipleModifierParameters, OutParameters) == 0x000020, "Member 'PhysicsControlBPLibrary_AddMultipleModifierParameters::OutParameters' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_AddMultipleModifierParameters, Names) == 0x000040, "Member 'PhysicsControlBPLibrary_AddMultipleModifierParameters::Names' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_AddMultipleModifierParameters, ModifierData) == 0x000050, "Member 'PhysicsControlBPLibrary_AddMultipleModifierParameters::ModifierData' has a wrong offset!");
...
public:
	struct FPhysicsControlControlAndModifierParameters InParameters;                                      // 0x0000(0x0020)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlNamedControlParameters  InStartControlParameters;                          // 0x0020(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	struct FPhysicsControlNamedControlParameters  InEndControlParameters;                            // 0x0050(0x0030)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           ControlNames;                                      // 0x0080(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlControlAndModifierParameters OutParameters;                                     // 0x0090(0x0020)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PhysicsControlBPLibrary_BlendControlParametersThroughSet) == 0x0000B0, "Wrong size on PhysicsControlBPLibrary_BlendControlParametersThroughSet");
...
static_assert(offsetof(PhysicsControlBPLibrary_BlendControlParametersThroughSet, InStartControlParameters) == 0x000020, "Member 'PhysicsControlBPLibrary_BlendControlParametersThroughSet::InStartControlParameters' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_BlendControlParametersThroughSet, InEndControlParameters) == 0x000050, "Member 'PhysicsControlBPLibrary_BlendControlParametersThroughSet::InEndControlParameters' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_BlendControlParametersThroughSet, ControlNames) == 0x000080, "Member 'PhysicsControlBPLibrary_BlendControlParametersThroughSet::ControlNames' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_BlendControlParametersThroughSet, OutParameters) == 0x000090, "Member 'PhysicsControlBPLibrary_BlendControlParametersThroughSet::OutParameters' has a wrong offset!");
...
public:
	struct FPhysicsControlControlAndModifierParameters InParameters;                                      // 0x0000(0x0020)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlNamedModifierParameters InStartModifierParameters;                         // 0x0020(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	struct FPhysicsControlNamedModifierParameters InEndModifierParameters;                           // 0x0030(0x0010)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           ModifierNames;                                     // 0x0040(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlControlAndModifierParameters OutParameters;                                     // 0x0050(0x0020)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PhysicsControlBPLibrary_BlendModifierParametersThroughSet) == 0x000070, "Wrong size on PhysicsControlBPLibrary_BlendModifierParametersThroughSet");
...
static_assert(offsetof(PhysicsControlBPLibrary_BlendModifierParametersThroughSet, InStartModifierParameters) == 0x000020, "Member 'PhysicsControlBPLibrary_BlendModifierParametersThroughSet::InStartModifierParameters' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_BlendModifierParametersThroughSet, InEndModifierParameters) == 0x000030, "Member 'PhysicsControlBPLibrary_BlendModifierParametersThroughSet::InEndModifierParameters' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_BlendModifierParametersThroughSet, ModifierNames) == 0x000040, "Member 'PhysicsControlBPLibrary_BlendModifierParametersThroughSet::ModifierNames' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_BlendModifierParametersThroughSet, OutParameters) == 0x000050, "Member 'PhysicsControlBPLibrary_BlendModifierParametersThroughSet::OutParameters' has a wrong offset!");
...
{
public:
	struct FPhysicsControlControlAndModifierParameters InParametersA;                                     // 0x0000(0x0020)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPhysicsControlControlAndModifierParameters InParametersB;                                     // 0x0020(0x0020)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	float                                         InInterpolationWeight;                             // 0x0040(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPhysicsControlControlAndModifierParameters OutParameters;                                     // 0x0048(0x0020)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(PhysicsControlBPLibrary_BlendParameters) == 0x000068, "Wrong size on PhysicsControlBPLibrary_BlendParameters");
...
static_assert(offsetof(PhysicsControlBPLibrary_BlendParameters, InParametersB) == 0x000020, "Member 'PhysicsControlBPLibrary_BlendParameters::InParametersB' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_BlendParameters, InInterpolationWeight) == 0x000040, "Member 'PhysicsControlBPLibrary_BlendParameters::InInterpolationWeight' has a wrong offset!");
static_assert(offsetof(PhysicsControlBPLibrary_BlendParameters, OutParameters) == 0x000048, "Member 'PhysicsControlBPLibrary_BlendParameters::OutParameters' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_AddBodyModifierToSet, Set) == 0x000014, "Member 'PhysicsControlComponent_AddBodyModifierToSet::Set' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_AddControlToSet, Set) == 0x000014, "Member 'PhysicsControlComponent_AddControlToSet::Set' has a wrong offset!");
...
public:
	...
	ECollisionEnabled                             CollisionType;                                     // 0x0011(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_12[0x2];                                       // 0x0012(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GravityMultiplier;                                 // 0x0014(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PhysicsBlendWeight;                                // 0x0018(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseSkeletalAnimation;                             // 0x001C(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateKinematicFromSimulation;                    // 0x001D(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifier, Set) == 0x00000C, "Member 'PhysicsControlComponent_CreateBodyModifier::Set' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifier, MovementType) == 0x000010, "Member 'PhysicsControlComponent_CreateBodyModifier::MovementType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifier, CollisionType) == 0x000011, "Member 'PhysicsControlComponent_CreateBodyModifier::CollisionType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifier, GravityMultiplier) == 0x000014, "Member 'PhysicsControlComponent_CreateBodyModifier::GravityMultiplier' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifier, PhysicsBlendWeight) == 0x000018, "Member 'PhysicsControlComponent_CreateBodyModifier::PhysicsBlendWeight' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifier, bUseSkeletalAnimation) == 0x00001C, "Member 'PhysicsControlComponent_CreateBodyModifier::bUseSkeletalAnimation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifier, bUpdateKinematicFromSimulation) == 0x00001D, "Member 'PhysicsControlComponent_CreateBodyModifier::bUpdateKinematicFromSimulation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifier, ReturnValue) == 0x000020, "Member 'PhysicsControlComponent_CreateBodyModifier::ReturnValue' has a wrong offset!");
...
public:
	...
	EPhysicsMovementType                          MovementType;                                      // 0x0014(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECollisionEnabled                             CollisionType;                                     // 0x0015(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_16[0x2];                                       // 0x0016(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GravityMultiplier;                                 // 0x0018(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PhysicsBlendWeight;                                // 0x001C(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseSkeletalAnimation;                             // 0x0020(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateKinematicFromSimulation;                    // 0x0021(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, bIncludeSelf) == 0x00000C, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::bIncludeSelf' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, Set) == 0x000010, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::Set' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, MovementType) == 0x000014, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::MovementType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, CollisionType) == 0x000015, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::CollisionType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, GravityMultiplier) == 0x000018, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::GravityMultiplier' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, PhysicsBlendWeight) == 0x00001C, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::PhysicsBlendWeight' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, bUseSkeletalAnimation) == 0x000020, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::bUseSkeletalAnimation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, bUpdateKinematicFromSimulation) == 0x000021, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::bUpdateKinematicFromSimulation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow, ReturnValue) == 0x000028, "Member 'PhysicsControlComponent_CreateBodyModifiersFromSkeletalMeshBelow::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPhysicsControlData                    ControlData;                                       // 0x001C(0x002C)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FPhysicsControlTarget                  ControlTarget;                                     // 0x0048(0x0068)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FPhysicsControlSettings                ControlSettings;                                   // 0x00B0(0x0028)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateControl, ControlData) == 0x00001C, "Member 'PhysicsControlComponent_CreateControl::ControlData' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControl, ControlTarget) == 0x000048, "Member 'PhysicsControlComponent_CreateControl::ControlTarget' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControl, ControlSettings) == 0x0000B0, "Member 'PhysicsControlComponent_CreateControl::ControlSettings' has a wrong offset!");
...
public:
	...
	struct FPhysicsControlData                    WorldSpaceControlData;                             // 0x0138(0x002C)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_164[0x4];                                      // 0x0164(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPhysicsControlSettings                WorldSpaceControlSettings;                         // 0x0168(0x0028)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FPhysicsControlData                    ParentSpaceControlData;                            // 0x0190(0x002C)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1BC[0x4];                                      // 0x01BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPhysicsControlSettings                ParentSpaceControlSettings;                        // 0x01C0(0x0028)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	EPhysicsMovementType                          PhysicsMovementType;                               // 0x01E8(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E9[0x3];                                      // 0x01E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         GravityMultiplier;                                 // 0x01EC(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PhysicsBlendWeight;                                // 0x01F0(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1F4[0x4];                                      // 0x01F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshComponent*                         WorldComponent;                                    // 0x01F8(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   WorldBoneName;                                     // 0x0200(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones) == 0x000208, "Wrong size on PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones");
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones, WorldSpaceControlSettings) == 0x000168, "Member 'PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones::WorldSpaceControlSettings' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones, ParentSpaceControlData) == 0x000190, "Member 'PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones::ParentSpaceControlData' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones, ParentSpaceControlSettings) == 0x0001C0, "Member 'PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones::ParentSpaceControlSettings' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones, PhysicsMovementType) == 0x0001E8, "Member 'PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones::PhysicsMovementType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones, GravityMultiplier) == 0x0001EC, "Member 'PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones::GravityMultiplier' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones, PhysicsBlendWeight) == 0x0001F0, "Member 'PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones::PhysicsBlendWeight' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones, WorldComponent) == 0x0001F8, "Member 'PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones::WorldComponent' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones, WorldBoneName) == 0x000200, "Member 'PhysicsControlComponent_CreateControlsAndBodyModifiersFromLimbBones::WorldBoneName' has a wrong offset!");
...
public:
	...
	struct FPhysicsControlData                    ControlData;                                       // 0x0064(0x002C)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FPhysicsControlSettings                ControlSettings;                                   // 0x0090(0x0028)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromLimbBones, ControlSettings) == 0x000090, "Member 'PhysicsControlComponent_CreateControlsFromLimbBones::ControlSettings' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromLimbBonesAndConstraintProfile, bEnabled) == 0x000064, "Member 'PhysicsControlComponent_CreateControlsFromLimbBonesAndConstraintProfile::bEnabled' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromLimbBonesAndConstraintProfile, ReturnValue) == 0x000068, "Member 'PhysicsControlComponent_CreateControlsFromLimbBonesAndConstraintProfile::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPhysicsControlData                    ControlData;                                       // 0x001C(0x002C)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	struct FPhysicsControlSettings                ControlSettings;                                   // 0x0048(0x0028)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMesh, ControlSettings) == 0x000048, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMesh::ControlSettings' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfile, Set) == 0x00001C, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfile::Set' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfile, bEnabled) == 0x000020, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfile::bEnabled' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfile, ReturnValue) == 0x000028, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfile::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow, bIncludeSelf) == 0x00000C, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow::bIncludeSelf' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow, ConstraintProfile) == 0x000010, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow::ConstraintProfile' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow, Set) == 0x000014, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow::Set' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow, bEnabled) == 0x000018, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow::bEnabled' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow, ReturnValue) == 0x000020, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshAndConstraintProfileBelow::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPhysicsControlData                    ControlData;                                       // 0x0010(0x002C)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
	...
	class FName                                   Set;                                               // 0x0068(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow, bIncludeSelf) == 0x00000C, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow::bIncludeSelf' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow, ControlType) == 0x00000D, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow::ControlType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow, ControlData) == 0x000010, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow::ControlData' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow, ControlSettings) == 0x000040, "Member 'PhysicsControlComponent_CreateControlsFromSkeletalMeshBelow::ControlSettings' has a wrong offset!");
...
static_assert(sizeof(PhysicsControlComponent_CreateNamedBodyModifier) == 0x000028, "Wrong size on PhysicsControlComponent_CreateNamedBodyModifier");
...
static_assert(offsetof(PhysicsControlComponent_CreateNamedBodyModifier, Set) == 0x000014, "Member 'PhysicsControlComponent_CreateNamedBodyModifier::Set' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedBodyModifier, MovementType) == 0x000018, "Member 'PhysicsControlComponent_CreateNamedBodyModifier::MovementType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedBodyModifier, CollisionType) == 0x000019, "Member 'PhysicsControlComponent_CreateNamedBodyModifier::CollisionType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedBodyModifier, GravityMultiplier) == 0x00001C, "Member 'PhysicsControlComponent_CreateNamedBodyModifier::GravityMultiplier' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedBodyModifier, PhysicsBlendWeight) == 0x000020, "Member 'PhysicsControlComponent_CreateNamedBodyModifier::PhysicsBlendWeight' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedBodyModifier, bUseSkeletalAnimation) == 0x000024, "Member 'PhysicsControlComponent_CreateNamedBodyModifier::bUseSkeletalAnimation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedBodyModifier, bUpdateKinematicFromSimulation) == 0x000025, "Member 'PhysicsControlComponent_CreateNamedBodyModifier::bUpdateKinematicFromSimulation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedBodyModifier, ReturnValue) == 0x000026, "Member 'PhysicsControlComponent_CreateNamedBodyModifier::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPhysicsControlData                    ControlData;                                       // 0x0024(0x002C)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PhysicsControlComponent_CreateNamedControl, ControlData) == 0x000024, "Member 'PhysicsControlComponent_CreateNamedControl::ControlData' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedControl, ControlTarget) == 0x000050, "Member 'PhysicsControlComponent_CreateNamedControl::ControlTarget' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_CreateNamedControl, ControlSettings) == 0x0000B8, "Member 'PhysicsControlComponent_CreateNamedControl::ControlSettings' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_CreateNamedControl, ReturnValue) == 0x0000E4, "Member 'PhysicsControlComponent_CreateNamedControl::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_DestroyBodyModifier, ReturnValue) == 0x000004, "Member 'PhysicsControlComponent_DestroyBodyModifier::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_DestroyControl, ReturnValue) == 0x000004, "Member 'PhysicsControlComponent_DestroyControl::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_ResetBodyModifiersInSetToCachedBoneTransforms, Behavior) == 0x000004, "Member 'PhysicsControlComponent_ResetBodyModifiersInSetToCachedBoneTransforms::Behavior' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_ResetBodyModifierToCachedBoneTransform, Behavior) == 0x000004, "Member 'PhysicsControlComponent_ResetBodyModifierToCachedBoneTransform::Behavior' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_ResetBodyModifierToCachedBoneTransform, ReturnValue) == 0x000005, "Member 'PhysicsControlComponent_ResetBodyModifierToCachedBoneTransform::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_ResetControlPoint, ReturnValue) == 0x000004, "Member 'PhysicsControlComponent_ResetControlPoint::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierCollisionType, CollisionType) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifierCollisionType::CollisionType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierCollisionType, ReturnValue) == 0x000005, "Member 'PhysicsControlComponent_SetBodyModifierCollisionType::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierGravityMultiplier, GravityMultiplier) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifierGravityMultiplier::GravityMultiplier' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierGravityMultiplier, ReturnValue) == 0x000008, "Member 'PhysicsControlComponent_SetBodyModifierGravityMultiplier::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierMovementType, MovementType) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifierMovementType::MovementType' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierMovementType, ReturnValue) == 0x000005, "Member 'PhysicsControlComponent_SetBodyModifierMovementType::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierPhysicsBlendWeight, PhysicsBlendWeight) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifierPhysicsBlendWeight::PhysicsBlendWeight' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierPhysicsBlendWeight, ReturnValue) == 0x000008, "Member 'PhysicsControlComponent_SetBodyModifierPhysicsBlendWeight::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifiersInSetCollisionType, CollisionType) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifiersInSetCollisionType::CollisionType' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifiersInSetGravityMultiplier, GravityMultiplier) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifiersInSetGravityMultiplier::GravityMultiplier' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifiersInSetMovementType, MovementType) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifiersInSetMovementType::MovementType' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifiersInSetPhysicsBlendWeight, PhysicsBlendWeight) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifiersInSetPhysicsBlendWeight::PhysicsBlendWeight' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifiersInSetUpdateKinematicFromSimulation, bUpdateKinematicFromSimulation) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifiersInSetUpdateKinematicFromSimulation::bUpdateKinematicFromSimulation' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifiersInSetUseSkeletalAnimation, bUseSkeletalAnimation) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifiersInSetUseSkeletalAnimation::bUseSkeletalAnimation' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierUpdateKinematicFromSimulation, bUpdateKinematicFromSimulation) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifierUpdateKinematicFromSimulation::bUpdateKinematicFromSimulation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierUpdateKinematicFromSimulation, ReturnValue) == 0x000005, "Member 'PhysicsControlComponent_SetBodyModifierUpdateKinematicFromSimulation::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierUseSkeletalAnimation, bUseSkeletalAnimation) == 0x000004, "Member 'PhysicsControlComponent_SetBodyModifierUseSkeletalAnimation::bUseSkeletalAnimation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetBodyModifierUseSkeletalAnimation, ReturnValue) == 0x000005, "Member 'PhysicsControlComponent_SetBodyModifierUseSkeletalAnimation::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlAngularData, Strength) == 0x000004, "Member 'PhysicsControlComponent_SetControlAngularData::Strength' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlAngularData, DampingRatio) == 0x000008, "Member 'PhysicsControlComponent_SetControlAngularData::DampingRatio' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlAngularData, ExtraDamping) == 0x00000C, "Member 'PhysicsControlComponent_SetControlAngularData::ExtraDamping' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlAngularData, MaxTorque) == 0x000010, "Member 'PhysicsControlComponent_SetControlAngularData::MaxTorque' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlAngularData, bEnableControl) == 0x000014, "Member 'PhysicsControlComponent_SetControlAngularData::bEnableControl' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlAngularData, ReturnValue) == 0x000015, "Member 'PhysicsControlComponent_SetControlAngularData::ReturnValue' has a wrong offset!");
...
public:
	class FName                                   Name_0;                                            // 0x0000(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPhysicsControlData                    ControlData;                                       // 0x0004(0x002C)(ConstParm, Parm, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(PhysicsControlComponent_SetControlData) == 0x000034, "Wrong size on PhysicsControlComponent_SetControlData");
...
static_assert(offsetof(PhysicsControlComponent_SetControlData, ControlData) == 0x000004, "Member 'PhysicsControlComponent_SetControlData::ControlData' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlData, ReturnValue) == 0x000030, "Member 'PhysicsControlComponent_SetControlData::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(PhysicsControlComponent_SetControlDatas) == 0x000040, "Wrong size on PhysicsControlComponent_SetControlDatas");
...
static_assert(offsetof(PhysicsControlComponent_SetControlDatasInSet, ControlData) == 0x000004, "Member 'PhysicsControlComponent_SetControlDatasInSet::ControlData' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlDisableCollision, bDisableCollision) == 0x000004, "Member 'PhysicsControlComponent_SetControlDisableCollision::bDisableCollision' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlDisableCollision, ReturnValue) == 0x000005, "Member 'PhysicsControlComponent_SetControlDisableCollision::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlEnabled, bEnable) == 0x000004, "Member 'PhysicsControlComponent_SetControlEnabled::bEnable' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlEnabled, ReturnValue) == 0x000005, "Member 'PhysicsControlComponent_SetControlEnabled::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlLinearData, Strength) == 0x000004, "Member 'PhysicsControlComponent_SetControlLinearData::Strength' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlLinearData, DampingRatio) == 0x000008, "Member 'PhysicsControlComponent_SetControlLinearData::DampingRatio' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlLinearData, ExtraDamping) == 0x00000C, "Member 'PhysicsControlComponent_SetControlLinearData::ExtraDamping' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlLinearData, MaxForce) == 0x000010, "Member 'PhysicsControlComponent_SetControlLinearData::MaxForce' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlLinearData, bEnableControl) == 0x000014, "Member 'PhysicsControlComponent_SetControlLinearData::bEnableControl' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlLinearData, ReturnValue) == 0x000015, "Member 'PhysicsControlComponent_SetControlLinearData::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlParent, ReturnValue) == 0x000014, "Member 'PhysicsControlComponent_SetControlParent::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlsInSetDisableCollision, bDisableCollision) == 0x000004, "Member 'PhysicsControlComponent_SetControlsInSetDisableCollision::bDisableCollision' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlsInSetEnabled, bEnable) == 0x000004, "Member 'PhysicsControlComponent_SetControlsInSetEnabled::bEnable' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlsInSetUseSkeletalAnimation, bUseSkeletalAnimation) == 0x000004, "Member 'PhysicsControlComponent_SetControlsInSetUseSkeletalAnimation::bUseSkeletalAnimation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlsInSetUseSkeletalAnimation, SkeletalAnimationVelocityMultiplier) == 0x000008, "Member 'PhysicsControlComponent_SetControlsInSetUseSkeletalAnimation::SkeletalAnimationVelocityMultiplier' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_SetControlUseSkeletalAnimation, bUseSkeletalAnimation) == 0x000004, "Member 'PhysicsControlComponent_SetControlUseSkeletalAnimation::bUseSkeletalAnimation' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlUseSkeletalAnimation, SkeletalAnimationVelocityMultiplier) == 0x000008, "Member 'PhysicsControlComponent_SetControlUseSkeletalAnimation::SkeletalAnimationVelocityMultiplier' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_SetControlUseSkeletalAnimation, ReturnValue) == 0x00000C, "Member 'PhysicsControlComponent_SetControlUseSkeletalAnimation::ReturnValue' has a wrong offset!");
...
public:
	class FName                                   Name_0;                                            // 0x0000(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPhysicsControlData                    ControlData;                                       // 0x0004(0x002C)(Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0030(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(PhysicsControlComponent_GetControlData) == 0x000034, "Wrong size on PhysicsControlComponent_GetControlData");
...
static_assert(offsetof(PhysicsControlComponent_GetControlData, ControlData) == 0x000004, "Member 'PhysicsControlComponent_GetControlData::ControlData' has a wrong offset!");
static_assert(offsetof(PhysicsControlComponent_GetControlData, ReturnValue) == 0x000030, "Member 'PhysicsControlComponent_GetControlData::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(PhysicsControlComponent_GetControlEnabled, ReturnValue) == 0x000004, "Member 'PhysicsControlComponent_GetControlEnabled::ReturnValue' has a wrong offset!");
