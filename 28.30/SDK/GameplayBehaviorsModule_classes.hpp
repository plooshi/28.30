...
static_assert(sizeof(UGameplayBehaviorConfig_BehaviorTree) == 0x000058, "Wrong size on UGameplayBehaviorConfig_BehaviorTree");
...
static_assert(sizeof(UGameplayBehaviorConfig_Animation) == 0x000060, "Wrong size on UGameplayBehaviorConfig_Animation");
...
static_assert(offsetof(UGameplayBehaviorConfig_Animation, PlayRate) == 0x000050, "Member 'UGameplayBehaviorConfig_Animation::PlayRate' has a wrong offset!");
static_assert(offsetof(UGameplayBehaviorConfig_Animation, StartSectionName) == 0x000054, "Member 'UGameplayBehaviorConfig_Animation::StartSectionName' has a wrong offset!");
