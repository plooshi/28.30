...
static_assert(sizeof(FSmartObjectEventData) == 0x000030, "Wrong size on FSmartObjectEventData");
...
static_assert(sizeof(FSmartObjectDefinitionPreviewData) == 0x000078, "Wrong size on FSmartObjectDefinitionPreviewData");
...
static_assert(offsetof(FSmartObjectDefinitionPreviewData, ObjectMeshPath) == 0x000020, "Member 'FSmartObjectDefinitionPreviewData::ObjectMeshPath' has a wrong offset!");
static_assert(offsetof(FSmartObjectDefinitionPreviewData, UserActorClass) == 0x000038, "Member 'FSmartObjectDefinitionPreviewData::UserActorClass' has a wrong offset!");
static_assert(offsetof(FSmartObjectDefinitionPreviewData, UserValidationFilterClass) == 0x000058, "Member 'FSmartObjectDefinitionPreviewData::UserValidationFilterClass' has a wrong offset!");
...
static_assert(sizeof(FSmartObjectTraceParams) == 0x000020, "Wrong size on FSmartObjectTraceParams");
...
static_assert(offsetof(FSmartObjectTraceParams, bTraceComplex) == 0x00001C, "Member 'FSmartObjectTraceParams::bTraceComplex' has a wrong offset!");
...
public:
	...
	TSubclassOf<class USmartObjectBehaviorDefinition> BehaviorDefinitionClass;                           // 0x0078(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TSubclassOf<class USmartObjectBehaviorDefinition>> BehaviorDefinitionClasses;                         // 0x0080(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	bool                                          bShouldEvaluateConditions;                         // 0x0090(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldIncludeClaimedSlots;                        // 0x0091(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldIncludeDisabledSlots;                       // 0x0092(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_93[0x6D];                                      // 0x0093(0x006D)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSmartObjectRequestFilter) == 0x000010, "Wrong alignment on FSmartObjectRequestFilter");
static_assert(sizeof(FSmartObjectRequestFilter) == 0x000100, "Wrong size on FSmartObjectRequestFilter");
...
static_assert(offsetof(FSmartObjectRequestFilter, BehaviorDefinitionClass) == 0x000078, "Member 'FSmartObjectRequestFilter::BehaviorDefinitionClass' has a wrong offset!");
static_assert(offsetof(FSmartObjectRequestFilter, BehaviorDefinitionClasses) == 0x000080, "Member 'FSmartObjectRequestFilter::BehaviorDefinitionClasses' has a wrong offset!");
static_assert(offsetof(FSmartObjectRequestFilter, bShouldEvaluateConditions) == 0x000090, "Member 'FSmartObjectRequestFilter::bShouldEvaluateConditions' has a wrong offset!");
static_assert(offsetof(FSmartObjectRequestFilter, bShouldIncludeClaimedSlots) == 0x000091, "Member 'FSmartObjectRequestFilter::bShouldIncludeClaimedSlots' has a wrong offset!");
static_assert(offsetof(FSmartObjectRequestFilter, bShouldIncludeDisabledSlots) == 0x000092, "Member 'FSmartObjectRequestFilter::bShouldIncludeDisabledSlots' has a wrong offset!");
...
public:
	...
	struct FTransform                             Transform;                                         // 0x0050(0x0060)(Edit, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGameplayTagContainer                  Tags;                                              // 0x00B0(0x0020)(Edit, Transient, EditConst, NativeAccessSpecifierPrivate)
	uint8                                         Pad_D0[0x28];                                      // 0x00D0(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSmartObjectHandle                     RegisteredHandle;                                  // 0x00F8(0x0008)(Edit, Transient, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FInstancedStruct                       SpatialEntryData;                                  // 0x0100(0x0010)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	uint16                                        DisableFlags;                                      // 0x0110(0x0002)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FSmartObjectRuntime, Transform) == 0x000050, "Member 'FSmartObjectRuntime::Transform' has a wrong offset!");
static_assert(offsetof(FSmartObjectRuntime, Tags) == 0x0000B0, "Member 'FSmartObjectRuntime::Tags' has a wrong offset!");
static_assert(offsetof(FSmartObjectRuntime, RegisteredHandle) == 0x0000F8, "Member 'FSmartObjectRuntime::RegisteredHandle' has a wrong offset!");
...
static_assert(offsetof(FSmartObjectRuntime, DisableFlags) == 0x000110, "Member 'FSmartObjectRuntime::DisableFlags' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSmartObjectRequestFilter              Filter;                                            // 0x0040(0x0100)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSmartObjectRequest) == 0x000010, "Wrong alignment on FSmartObjectRequest");
static_assert(sizeof(FSmartObjectRequest) == 0x000140, "Wrong size on FSmartObjectRequest");
...
static_assert(sizeof(FSmartObjectSlotValidationParams) == 0x000070, "Wrong size on FSmartObjectSlotValidationParams");
...
static_assert(offsetof(FSmartObjectSlotValidationParams, TransitionTraceParameters) == 0x000040, "Member 'FSmartObjectSlotValidationParams::TransitionTraceParameters' has a wrong offset!");
static_assert(offsetof(FSmartObjectSlotValidationParams, bUseNavigationCapsuleSize) == 0x000060, "Member 'FSmartObjectSlotValidationParams::bUseNavigationCapsuleSize' has a wrong offset!");
static_assert(offsetof(FSmartObjectSlotValidationParams, UserCapsule) == 0x000064, "Member 'FSmartObjectSlotValidationParams::UserCapsule' has a wrong offset!");
