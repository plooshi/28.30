...
public:
	...
	uint8                                         Pad_2A8[0x120];                                    // 0x02A8(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAudioComponentGroup) == 0x0003D0, "Wrong size on UAudioComponentGroup");
static_assert(offsetof(UAudioComponentGroup, OnStopped) == 0x000228, "Member 'UAudioComponentGroup::OnStopped' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, OnKilled) == 0x000238, "Member 'UAudioComponentGroup::OnKilled' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, OnVirtualized) == 0x000248, "Member 'UAudioComponentGroup::OnVirtualized' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, OnUnvirtualized) == 0x000258, "Member 'UAudioComponentGroup::OnUnvirtualized' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, Components) == 0x000268, "Member 'UAudioComponentGroup::Components' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, ParamsToSet) == 0x000278, "Member 'UAudioComponentGroup::ParamsToSet' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, PersistentParams) == 0x000288, "Member 'UAudioComponentGroup::PersistentParams' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, Extensions) == 0x000298, "Member 'UAudioComponentGroup::Extensions' has a wrong offset!");
