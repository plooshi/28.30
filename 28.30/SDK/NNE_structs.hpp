...
public:
	...
	TArray<uint32>                                InTensors;                                         // 0x0010(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<uint32>                                OutTensors;                                        // 0x0020(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FNNEFormatAttributeDesc>        Attributes;                                        // 0x0030(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNNEFormatOperatorDesc) == 0x000008, "Wrong alignment on FNNEFormatOperatorDesc");
static_assert(sizeof(FNNEFormatOperatorDesc) == 0x000040, "Wrong size on FNNEFormatOperatorDesc");
...
static_assert(offsetof(FNNEFormatOperatorDesc, InTensors) == 0x000010, "Member 'FNNEFormatOperatorDesc::InTensors' has a wrong offset!");
static_assert(offsetof(FNNEFormatOperatorDesc, OutTensors) == 0x000020, "Member 'FNNEFormatOperatorDesc::OutTensors' has a wrong offset!");
static_assert(offsetof(FNNEFormatOperatorDesc, Attributes) == 0x000030, "Member 'FNNEFormatOperatorDesc::Attributes' has a wrong offset!");
