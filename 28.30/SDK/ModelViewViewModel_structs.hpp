...
static_assert(offsetof(FMVVMViewSource, RegisteredCount) == 0x00000C, "Member 'FMVVMViewSource::RegisteredCount' has a wrong offset!");
static_assert(offsetof(FMVVMViewSource, bCreatedSource) == 0x000010, "Member 'FMVVMViewSource::bCreatedSource' has a wrong offset!");
static_assert(offsetof(FMVVMViewSource, bBindingsInitialized) == 0x000011, "Member 'FMVVMViewSource::bBindingsInitialized' has a wrong offset!");
static_assert(offsetof(FMVVMViewSource, bSetManually) == 0x000012, "Member 'FMVVMViewSource::bSetManually' has a wrong offset!");
static_assert(offsetof(FMVVMViewSource, bAssignedToUserWidgetProperty) == 0x000013, "Member 'FMVVMViewSource::bAssignedToUserWidgetProperty' has a wrong offset!");
...
static_assert(offsetof(FMVVMViewClass_SourceCreator, ParentSourceName) == 0x000028, "Member 'FMVVMViewClass_SourceCreator::ParentSourceName' has a wrong offset!");
static_assert(offsetof(FMVVMViewClass_SourceCreator, Flags) == 0x00002C, "Member 'FMVVMViewClass_SourceCreator::Flags' has a wrong offset!");
...
static_assert(offsetof(FMVVMViewClass_CompiledBinding, ExecutionMode) == 0x000016, "Member 'FMVVMViewClass_CompiledBinding::ExecutionMode' has a wrong offset!");
static_assert(offsetof(FMVVMViewClass_CompiledBinding, EvaluateSourceCreatorIndex) == 0x000017, "Member 'FMVVMViewClass_CompiledBinding::EvaluateSourceCreatorIndex' has a wrong offset!");
static_assert(offsetof(FMVVMViewClass_CompiledBinding, Flags) == 0x000018, "Member 'FMVVMViewClass_CompiledBinding::Flags' has a wrong offset!");
...
static_assert(offsetof(FMVVMViewClass_CompiledEvent, SourceName) == 0x000008, "Member 'FMVVMViewClass_CompiledEvent::SourceName' has a wrong offset!");
