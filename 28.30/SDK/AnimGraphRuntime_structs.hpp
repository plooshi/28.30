...
static_assert(sizeof(FAnimNode_CopyPoseFromMesh) == 0x000150, "Wrong size on FAnimNode_CopyPoseFromMesh");
...
static_assert(sizeof(FAnimNode_PoseDriver) == 0x000198, "Wrong size on FAnimNode_PoseDriver");
...
static_assert(offsetof(FAnimNode_PoseDriver, bEvalFromRefPose) == 0x0000C4, "Member 'FAnimNode_PoseDriver::bEvalFromRefPose' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, LODThreshold) == 0x000164, "Member 'FAnimNode_PoseDriver::LODThreshold' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_SequenceEvaluator_Standalone, bUseExplicitFrame) == 0x000054, "Member 'FAnimNode_SequenceEvaluator_Standalone::bUseExplicitFrame' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator_Standalone, ExplicitFrame) == 0x000058, "Member 'FAnimNode_SequenceEvaluator_Standalone::ExplicitFrame' has a wrong offset!");
...
// 0x0450 (0x0B90 - 0x0740)
struct FAnimSequencerInstanceProxy final : public FAnimInstanceProxy
{
public:
	uint8                                         Pad_738[0x458];                                    // 0x0738(0x0458)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000B90, "Wrong size on FAnimSequencerInstanceProxy");
...
static_assert(sizeof(FAnimNode_BoneDrivenController) == 0x000120, "Wrong size on FAnimNode_BoneDrivenController");
...
static_assert(offsetof(FAnimNode_BoneDrivenController, TargetBone) == 0x00010C, "Member 'FAnimNode_BoneDrivenController::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, DestinationMode) == 0x000118, "Member 'FAnimNode_BoneDrivenController::DestinationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, ModificationMode) == 0x000119, "Member 'FAnimNode_BoneDrivenController::ModificationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceComponent) == 0x00011A, "Member 'FAnimNode_BoneDrivenController::SourceComponent' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_HandIKRetargeting) == 0x000128, "Wrong size on FAnimNode_HandIKRetargeting");
...
static_assert(offsetof(FAnimNode_HandIKRetargeting, PerAxisAlpha) == 0x000108, "Member 'FAnimNode_HandIKRetargeting::PerAxisAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_HandIKRetargeting, HandFKWeight) == 0x000120, "Member 'FAnimNode_HandIKRetargeting::HandFKWeight' has a wrong offset!");
...
static_assert(sizeof(FAnimLegIKDefinition) == 0x000028, "Wrong size on FAnimLegIKDefinition");
...
static_assert(offsetof(FAnimLegIKDefinition, TwistOffsetCurveName) == 0x000024, "Member 'FAnimLegIKDefinition::TwistOffsetCurveName' has a wrong offset!");
...
public:
	...
	struct FBoneReference                         BaseBoneRef;                                       // 0x02E4(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	ECollisionChannel                             OverlapChannel;                                    // 0x02F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESimulationSpace                              SimulationSpace;                                   // 0x02F1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceDisableCollisionBetweenConstraintBodies;     // 0x02F2(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseExternalClothCollision;                        // 0x02F3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F4[0x1];                                      // 0x02F4(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bEnableWorldGeometry : 1;                          // 0x02F5(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideWorldGravity : 1;                         // 0x02F5(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTransferBoneVelocities : 1;                       // 0x02F5(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bFreezeIncomingPoseOnStart : 1;                    // 0x02F5(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bClampLinearTranslationLimitToRefPose : 1;         // 0x02F5(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2F6[0x2];                                      // 0x02F6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WorldSpaceMinimumScale;                            // 0x02F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EvaluationResetTime;                               // 0x02FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_300[0x1];                                      // 0x0300(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	ESimulationTiming                             SimulationTiming;                                  // 0x0301(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_302[0x65E];                                    // 0x0302(0x065E)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x000960, "Wrong size on FAnimNode_RigidBody");
...
static_assert(offsetof(FAnimNode_RigidBody, OverrideWorldGravity) == 0x000208, "Member 'FAnimNode_RigidBody::OverrideWorldGravity' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, ExternalForce) == 0x000220, "Member 'FAnimNode_RigidBody::ExternalForce' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, ComponentLinearAccScale) == 0x000238, "Member 'FAnimNode_RigidBody::ComponentLinearAccScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, ComponentLinearVelScale) == 0x000250, "Member 'FAnimNode_RigidBody::ComponentLinearVelScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, ComponentAppliedLinearAccClamp) == 0x000268, "Member 'FAnimNode_RigidBody::ComponentAppliedLinearAccClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimSpaceSettings) == 0x000280, "Member 'FAnimNode_RigidBody::SimSpaceSettings' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, CachedBoundsScale) == 0x0002E0, "Member 'FAnimNode_RigidBody::CachedBoundsScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, BaseBoneRef) == 0x0002E4, "Member 'FAnimNode_RigidBody::BaseBoneRef' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, OverlapChannel) == 0x0002F0, "Member 'FAnimNode_RigidBody::OverlapChannel' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationSpace) == 0x0002F1, "Member 'FAnimNode_RigidBody::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bForceDisableCollisionBetweenConstraintBodies) == 0x0002F2, "Member 'FAnimNode_RigidBody::bForceDisableCollisionBetweenConstraintBodies' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bUseExternalClothCollision) == 0x0002F3, "Member 'FAnimNode_RigidBody::bUseExternalClothCollision' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, WorldSpaceMinimumScale) == 0x0002F8, "Member 'FAnimNode_RigidBody::WorldSpaceMinimumScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, EvaluationResetTime) == 0x0002FC, "Member 'FAnimNode_RigidBody::EvaluationResetTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationTiming) == 0x000301, "Member 'FAnimNode_RigidBody::SimulationTiming' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_TwistCorrectiveNode) == 0x000160, "Wrong size on FAnimNode_TwistCorrectiveNode");
...
static_assert(sizeof(FAnimNode_TwoBoneIK) == 0x000260, "Wrong size on FAnimNode_TwoBoneIK");
...
static_assert(offsetof(FAnimNode_TwoBoneIK, TwistAxis) == 0x000230, "Member 'FAnimNode_TwoBoneIK::TwistAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocationSpace) == 0x000250, "Member 'FAnimNode_TwoBoneIK::EffectorLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocationSpace) == 0x000251, "Member 'FAnimNode_TwoBoneIK::JointTargetLocationSpace' has a wrong offset!");
