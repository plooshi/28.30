...
void UCreatureBaseRidableComponent_C::Activate_Regen()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Activate Regen");
...
void UCreatureBaseRidableComponent_C::Added_FBD936634BCC61A726DA279226E2F4BE()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Added_FBD936634BCC61A726DA279226E2F4BE");
...
void UCreatureBaseRidableComponent_C::ApplyCollisionResponse(TArray<ECollisionChannel>& Channels, ECollisionResponse Response)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ApplyCollisionResponse");
...
void UCreatureBaseRidableComponent_C::ApplyGEToSelf(TSubclassOf<class UGameplayEffect> GameplayEffectClass, bool* IsValidClass)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ApplyGEToSelf");
...
void UCreatureBaseRidableComponent_C::CancelJumpExitAndJump()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CancelJumpExitAndJump");
...
void UCreatureBaseRidableComponent_C::CanJumpExit(bool* CanJumpExit_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CanJumpExit");
...
void UCreatureBaseRidableComponent_C::Check_Regen_on_Started_Riding()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Check Regen on Started Riding");
...
void UCreatureBaseRidableComponent_C::Check_Regen_on_Stopped_Riding()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Check Regen on Stopped Riding");
...
void UCreatureBaseRidableComponent_C::CommitEnergyCosts(bool RequireAllEnergy, double EnergyCost, bool* Success)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CommitEnergyCosts");
...
void UCreatureBaseRidableComponent_C::ConvertedDispatcher_Event_0(bool Converted, class AFortPawn* InstigatorPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ConvertedDispatcher_Event_0");
...
void UCreatureBaseRidableComponent_C::Deactivate_Regen()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Deactivate Regen");
...
void UCreatureBaseRidableComponent_C::DetermineRateOfChange(double* rateOfChange)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DetermineRateOfChange");
...
void UCreatureBaseRidableComponent_C::EnergyTrackingStart()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EnergyTrackingStart");
...
void UCreatureBaseRidableComponent_C::EnergyTrackingStop()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EnergyTrackingStop");
...
void UCreatureBaseRidableComponent_C::ExecuteBufferedJumpExit()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteBufferedJumpExit");
...
void UCreatureBaseRidableComponent_C::ExecuteUbergraph_CreatureBaseRidableComponent(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_CreatureBaseRidableComponent");
...
void UCreatureBaseRidableComponent_C::ForceTaming(class AActor* PlayerPawn, class AActor* CreaturePawn, bool* IsTamingEnabled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ForceTaming");
...
void UCreatureBaseRidableComponent_C::GetRiderLocation(struct FVector* Location)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRiderLocation");
...
void UCreatureBaseRidableComponent_C::HandleEnemyFoleySoundLibrary(class UActorComponent* Rider, bool bIsRiding)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleEnemyFoleySoundLibrary");
...
void UCreatureBaseRidableComponent_C::JumpFatigue_CheckApplyFatigue()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("JumpFatigue_CheckApplyFatigue");
...
void UCreatureBaseRidableComponent_C::JumpFatigue_CountJumps()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("JumpFatigue_CountJumps");
...
void UCreatureBaseRidableComponent_C::JumpFatigue_Landed()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("JumpFatigue_Landed");
...
void UCreatureBaseRidableComponent_C::JumpFatigue_LandTimeStamp()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("JumpFatigue_LandTimeStamp");
...
void UCreatureBaseRidableComponent_C::JumpFatigue_RemoveFatigue()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("JumpFatigue_RemoveFatigue");
...
void UCreatureBaseRidableComponent_C::KickRiderOffSelf()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("KickRiderOffSelf");
...
void UCreatureBaseRidableComponent_C::ManualEnergyDepleted()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ManualEnergyDepleted");
...
void UCreatureBaseRidableComponent_C::MountLandedClient(const struct FHitResult& Hit)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MountLandedClient");
...
void UCreatureBaseRidableComponent_C::MountLandedServer_JumpFatigue(const struct FHitResult& Hit)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MountLandedServer_JumpFatigue");
...
void UCreatureBaseRidableComponent_C::NPCPawnInteractWithDispatcher_Event_0(class AActor* AIPawn, class AFortPlayerPawn* InteractingPlayerPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("NPCPawnInteractWithDispatcher_Event_0");
...
void UCreatureBaseRidableComponent_C::OnEatToRefuel(double EnergyCost)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEatToRefuel");
...
void UCreatureBaseRidableComponent_C::OnEnergyDepletedClient()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEnergyDepletedClient");
...
void UCreatureBaseRidableComponent_C::OnEnergyUpdate(double Energy, bool bWarningActive)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEnergyUpdate");
...
void UCreatureBaseRidableComponent_C::OnJumping(double JumpPitchInterpSpeed)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnJumping");
...
void UCreatureBaseRidableComponent_C::OnJumpingApex()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnJumpingApex");
...
void UCreatureBaseRidableComponent_C::OnRep_currentEnergyValue()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRep_currentEnergyValue");
...
void UCreatureBaseRidableComponent_C::OnRep_IdleAnim_Add()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRep_IdleAnim_Add");
...
void UCreatureBaseRidableComponent_C::OnSprintStarted()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnSprintStarted");
...
void UCreatureBaseRidableComponent_C::Propagate_Immunity_Fall_Damage()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Propagate Immunity Fall Damage");
...
void UCreatureBaseRidableComponent_C::Removed_AD51144144164FD235EE5BA4F6E87456()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Removed_AD51144144164FD235EE5BA4F6E87456");
...
void UCreatureBaseRidableComponent_C::Removed_C4C6E29B4217C014B9DE0E80B7134D6E()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Removed_C4C6E29B4217C014B9DE0E80B7134D6E");
...
void UCreatureBaseRidableComponent_C::RemoveGEByTag(const struct FGameplayTagContainer& Tags)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RemoveGEByTag");
...
void UCreatureBaseRidableComponent_C::ReTryJumpExit()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ReTryJumpExit");
...
void UCreatureBaseRidableComponent_C::SetInfiniteStaminaBuff(bool Enabled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetInfiniteStaminaBuff");
...
void UCreatureBaseRidableComponent_C::SetWildlifeHealth()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetWildlifeHealth");
...
void UCreatureBaseRidableComponent_C::Should_Convert_Jump_Exit_to_Jump(bool* Out)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Should Convert Jump Exit to Jump");
...
void UCreatureBaseRidableComponent_C::ShouldBufferJumpExitToRetryJump(bool* Output)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldBufferJumpExitToRetryJump");
...
void UCreatureBaseRidableComponent_C::StopSprinting()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StopSprinting");
...
void UCreatureBaseRidableComponent_C::TestThreshold(bool isDecaying, double CurrentValue, double testTreshold, bool PreviousState, bool* crossedThreshold)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TestThreshold");
...
void UCreatureBaseRidableComponent_C::ToggleRiding(class AActor* PlayerPawn, class AActor* Target, bool ShouldRide, bool* bChangedRiding)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ToggleRiding");
...
void UCreatureBaseRidableComponent_C::TryConvertBufferedJumpExitToJump()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TryConvertBufferedJumpExitToJump");
...
void UCreatureBaseRidableComponent_C::UpdateAnimInputBool(class AFortPawn* FortPawn, bool IsBeingRidden_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateAnimInputBool");
...
void UCreatureBaseRidableComponent_C::UpdateDebug()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateDebug");
...
void UCreatureBaseRidableComponent_C::UpdateEnergy()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateEnergy");
...
void UCreatureBaseRidableComponent_C::UpdateLootAnimalGlow(double Scale)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateLootAnimalGlow");
...
void UCreatureBaseRidableComponent_C::UpdateValue(double TargetValue, double rateOfChange, double DeltaTime, double* updatedValue, bool* EnergyDepleted)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateValue");
...
void UCreatureBaseRidableComponent_C::UseEnergyAmountServer(double EnergyCost)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UseEnergyAmountServer");
...
void UCreatureBaseRidableComponent_C::GetRiderCapsuleSize(class URiderComponent* Rider, double* RiderCapsuleRadius, double* RiderCapsuleHH) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRiderCapsuleSize");
...
bool UCreatureBaseRidableComponent_C::ShouldSetAsViewTarget(const class URiderComponent* Rider) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldSetAsViewTarget");
