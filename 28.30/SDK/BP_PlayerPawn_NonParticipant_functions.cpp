...
void ABP_PlayerPawn_NonParticipant_C::AiTargetChanged(class AActor* OldTarget, class AActor* NewTarget)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("AiTargetChanged");
...
void ABP_PlayerPawn_NonParticipant_C::ClientOnTargetChanged(class AActor* NewTarget)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ClientOnTargetChanged");
...
void ABP_PlayerPawn_NonParticipant_C::OnRep_NewTargetActor()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnRep_NewTargetActor");
...
void ABP_PlayerPawn_NonParticipant_C::SetNPCAnimSpeedScalar(double SpeedScalar)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetNPCAnimSpeedScalar");
