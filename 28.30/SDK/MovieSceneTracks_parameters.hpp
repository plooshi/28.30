...
static_assert(sizeof(MovieSceneComponentMaterialParameterSection_AddColorParameterKey) == 0x000040, "Wrong size on MovieSceneComponentMaterialParameterSection_AddColorParameterKey");
...
static_assert(offsetof(MovieSceneComponentMaterialParameterSection_AddColorParameterKey, InTime) == 0x00000C, "Member 'MovieSceneComponentMaterialParameterSection_AddColorParameterKey::InTime' has a wrong offset!");
static_assert(offsetof(MovieSceneComponentMaterialParameterSection_AddColorParameterKey, InValue) == 0x000010, "Member 'MovieSceneComponentMaterialParameterSection_AddColorParameterKey::InValue' has a wrong offset!");
static_assert(offsetof(MovieSceneComponentMaterialParameterSection_AddColorParameterKey, InLayerName) == 0x000020, "Member 'MovieSceneComponentMaterialParameterSection_AddColorParameterKey::InLayerName' has a wrong offset!");
static_assert(offsetof(MovieSceneComponentMaterialParameterSection_AddColorParameterKey, InAssetName) == 0x000030, "Member 'MovieSceneComponentMaterialParameterSection_AddColorParameterKey::InAssetName' has a wrong offset!");
...
static_assert(offsetof(MovieSceneComponentMaterialParameterSection_AddScalarParameterKey, InTime) == 0x00000C, "Member 'MovieSceneComponentMaterialParameterSection_AddScalarParameterKey::InTime' has a wrong offset!");
static_assert(offsetof(MovieSceneComponentMaterialParameterSection_AddScalarParameterKey, InValue) == 0x000010, "Member 'MovieSceneComponentMaterialParameterSection_AddScalarParameterKey::InValue' has a wrong offset!");
...
static_assert(sizeof(MovieSceneComponentMaterialParameterSection_RemoveColorParameter) == 0x000010, "Wrong size on MovieSceneComponentMaterialParameterSection_RemoveColorParameter");
...
static_assert(offsetof(MovieSceneComponentMaterialParameterSection_RemoveColorParameter, ReturnValue) == 0x00000C, "Member 'MovieSceneComponentMaterialParameterSection_RemoveColorParameter::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MovieSceneComponentMaterialParameterSection_RemoveScalarParameter) == 0x000010, "Wrong size on MovieSceneComponentMaterialParameterSection_RemoveScalarParameter");
...
static_assert(offsetof(MovieSceneComponentMaterialParameterSection_RemoveScalarParameter, ReturnValue) == 0x00000C, "Member 'MovieSceneComponentMaterialParameterSection_RemoveScalarParameter::ReturnValue' has a wrong offset!");
