...
static_assert(offsetof(FStructSerializerObjectTestStruct, RawObject) == 0x000038, "Member 'FStructSerializerObjectTestStruct::RawObject' has a wrong offset!");
static_assert(offsetof(FStructSerializerObjectTestStruct, WrappedObject) == 0x000040, "Member 'FStructSerializerObjectTestStruct::WrappedObject' has a wrong offset!");
...
static_assert(sizeof(FStructSerializerTestStruct) == 0x0007F0, "Wrong size on FStructSerializerTestStruct");
...
static_assert(offsetof(FStructSerializerTestStruct, Arrays) == 0x0001B0, "Member 'FStructSerializerTestStruct::Arrays' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Maps) == 0x000210, "Member 'FStructSerializerTestStruct::Maps' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Sets) == 0x000350, "Member 'FStructSerializerTestStruct::Sets' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, LWCTypes) == 0x000490, "Member 'FStructSerializerTestStruct::LWCTypes' has a wrong offset!");
