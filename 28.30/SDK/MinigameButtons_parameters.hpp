...
static_assert(offsetof(MinigameButtons_C_UpdateButtons, Temp_byte_Variable_13) == 0x000016, "Member 'MinigameButtons_C_UpdateButtons::Temp_byte_Variable_13' has a wrong offset!");
static_assert(offsetof(MinigameButtons_C_UpdateButtons, Temp_bool_Variable) == 0x000017, "Member 'MinigameButtons_C_UpdateButtons::Temp_bool_Variable' has a wrong offset!");
