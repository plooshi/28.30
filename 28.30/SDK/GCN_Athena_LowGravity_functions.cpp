...
void AGCN_Athena_LowGravity_C::Activated(class AActor* PlayerPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Activated");
...
void AGCN_Athena_LowGravity_C::ExecuteUbergraph_GCN_Athena_LowGravity(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_GCN_Athena_LowGravity");
...
void AGCN_Athena_LowGravity_C::ExpireTell()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExpireTell");
...
void AGCN_Athena_LowGravity_C::PlayExpirationSound()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PlayExpirationSound");
