...
public:
	...
	class FName                                   TEDSIntegrationSelectionSetName;                   // 0x0008(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FTypedElementSelectionOptions) == 0x000004, "Wrong alignment on FTypedElementSelectionOptions");
static_assert(sizeof(FTypedElementSelectionOptions) == 0x00000C, "Wrong size on FTypedElementSelectionOptions");
...
static_assert(offsetof(FTypedElementSelectionOptions, TEDSIntegrationSelectionSetName) == 0x000008, "Member 'FTypedElementSelectionOptions::TEDSIntegrationSelectionSetName' has a wrong offset!");
