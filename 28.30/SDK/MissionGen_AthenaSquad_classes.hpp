...
static_assert(alignof(UMissionGen_AthenaSquad_C) == 0x000010, "Wrong alignment on UMissionGen_AthenaSquad_C");
static_assert(sizeof(UMissionGen_AthenaSquad_C) == 0x000830, "Wrong size on UMissionGen_AthenaSquad_C");
