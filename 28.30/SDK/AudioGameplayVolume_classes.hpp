...
static_assert(sizeof(AAudioGameplayVolume) == 0x0002F8, "Wrong size on AAudioGameplayVolume");
static_assert(offsetof(AAudioGameplayVolume, AGVComponent) == 0x0002C8, "Member 'AAudioGameplayVolume::AGVComponent' has a wrong offset!");
static_assert(offsetof(AAudioGameplayVolume, bEnabled) == 0x0002D0, "Member 'AAudioGameplayVolume::bEnabled' has a wrong offset!");
static_assert(offsetof(AAudioGameplayVolume, OnListenerEnterEvent) == 0x0002D8, "Member 'AAudioGameplayVolume::OnListenerEnterEvent' has a wrong offset!");
static_assert(offsetof(AAudioGameplayVolume, OnListenerExitEvent) == 0x0002E8, "Member 'AAudioGameplayVolume::OnListenerExitEvent' has a wrong offset!");
