...
static_assert(sizeof(FGeometryScriptSimpleCollision) == 0x000078, "Wrong size on FGeometryScriptSimpleCollision");
...
static_assert(sizeof(FGeometryScriptSimpleCollisionTriangulationOptions) == 0x00000C, "Wrong size on FGeometryScriptSimpleCollisionTriangulationOptions");
...
public:
	...
	struct FGeometryScriptSimpleCollisionTriangulationOptions ShapeToHullTriangulation;                          // 0x0060(0x000C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGeometryScriptBoneWeightProfile) == 0x000004, "Wrong size on FGeometryScriptBoneWeightProfile");
...
static_assert(sizeof(FGeometryScriptTransferBoneWeightsOptions) == 0x000030, "Wrong size on FGeometryScriptTransferBoneWeightsOptions");
...
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, TargetProfile) == 0x000008, "Member 'FGeometryScriptTransferBoneWeightsOptions::TargetProfile' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, RadiusPercentage) == 0x000010, "Member 'FGeometryScriptTransferBoneWeightsOptions::RadiusPercentage' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, NormalThreshold) == 0x000018, "Member 'FGeometryScriptTransferBoneWeightsOptions::NormalThreshold' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, LayeredMeshSupport) == 0x000020, "Member 'FGeometryScriptTransferBoneWeightsOptions::LayeredMeshSupport' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, NumSmoothingIterations) == 0x000024, "Member 'FGeometryScriptTransferBoneWeightsOptions::NumSmoothingIterations' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, SmoothingStrength) == 0x000028, "Member 'FGeometryScriptTransferBoneWeightsOptions::SmoothingStrength' has a wrong offset!");
static_assert(offsetof(FGeometryScriptTransferBoneWeightsOptions, InpaintMask) == 0x00002C, "Member 'FGeometryScriptTransferBoneWeightsOptions::InpaintMask' has a wrong offset!");
...
static_assert(offsetof(FGeometryScriptBoneInfo, ParentIndex) == 0x000008, "Member 'FGeometryScriptBoneInfo::ParentIndex' has a wrong offset!");
