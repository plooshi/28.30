...
static_assert(sizeof(UStateTreeSettings) == 0x000038, "Wrong size on UStateTreeSettings");
static_assert(offsetof(UStateTreeSettings, bAutoStartDebuggerTracesOnNonEditorTargets) == 0x000030, "Member 'UStateTreeSettings::bAutoStartDebuggerTracesOnNonEditorTargets' has a wrong offset!");
...
static_assert(offsetof(UStateTree, IDToStateMappings) == 0x000110, "Member 'UStateTree::IDToStateMappings' has a wrong offset!");
static_assert(offsetof(UStateTree, IDToNodeMappings) == 0x000120, "Member 'UStateTree::IDToNodeMappings' has a wrong offset!");
static_assert(offsetof(UStateTree, IDToTransitionMappings) == 0x000130, "Member 'UStateTree::IDToTransitionMappings' has a wrong offset!");
static_assert(offsetof(UStateTree, Parameters) == 0x000140, "Member 'UStateTree::Parameters' has a wrong offset!");
static_assert(offsetof(UStateTree, ParametersDataViewIndex) == 0x000150, "Member 'UStateTree::ParametersDataViewIndex' has a wrong offset!");
static_assert(offsetof(UStateTree, EvaluatorsBegin) == 0x000152, "Member 'UStateTree::EvaluatorsBegin' has a wrong offset!");
static_assert(offsetof(UStateTree, EvaluatorsNum) == 0x000154, "Member 'UStateTree::EvaluatorsNum' has a wrong offset!");
static_assert(offsetof(UStateTree, GlobalTasksBegin) == 0x000156, "Member 'UStateTree::GlobalTasksBegin' has a wrong offset!");
static_assert(offsetof(UStateTree, GlobalTasksNum) == 0x000158, "Member 'UStateTree::GlobalTasksNum' has a wrong offset!");
static_assert(offsetof(UStateTree, bHasGlobalTransitionTasks) == 0x00015A, "Member 'UStateTree::bHasGlobalTransitionTasks' has a wrong offset!");
static_assert(offsetof(UStateTree, ExternalDataDescs) == 0x000160, "Member 'UStateTree::ExternalDataDescs' has a wrong offset!");
static_assert(offsetof(UStateTree, ExternalDataBaseIndex) == 0x000170, "Member 'UStateTree::ExternalDataBaseIndex' has a wrong offset!");
static_assert(offsetof(UStateTree, NumDataViews) == 0x000174, "Member 'UStateTree::NumDataViews' has a wrong offset!");
