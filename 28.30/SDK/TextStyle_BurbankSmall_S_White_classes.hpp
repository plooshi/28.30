...
static_assert(alignof(TextStyle_BurbankSmall_S_White::UTextStyle_BurbankSmall_S_White_C) == 0x000010, "Wrong alignment on TextStyle_BurbankSmall_S_White::UTextStyle_BurbankSmall_S_White_C");
static_assert(sizeof(TextStyle_BurbankSmall_S_White::UTextStyle_BurbankSmall_S_White_C) == 0x0001A0, "Wrong size on TextStyle_BurbankSmall_S_White::UTextStyle_BurbankSmall_S_White_C");
