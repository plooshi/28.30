...
static_assert(sizeof(FGroomCacheImportSettings) == 0x000060, "Wrong size on FGroomCacheImportSettings");
...
static_assert(offsetof(FGroomCacheImportSettings, bOverrideConversionSettings) == 0x000028, "Member 'FGroomCacheImportSettings::bOverrideConversionSettings' has a wrong offset!");
static_assert(offsetof(FGroomCacheImportSettings, ConversionSettings) == 0x000030, "Member 'FGroomCacheImportSettings::ConversionSettings' has a wrong offset!");
...
public:
	...
	int32                                         GroupCardsID;                                      // 0x001C(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FHairGroupInfo, NumCurves) == 0x000008, "Member 'FHairGroupInfo::NumCurves' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, NumGuides) == 0x00000C, "Member 'FHairGroupInfo::NumGuides' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, NumCurveVertices) == 0x000010, "Member 'FHairGroupInfo::NumCurveVertices' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, NumGuideVertices) == 0x000014, "Member 'FHairGroupInfo::NumGuideVertices' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, MaxCurveLength) == 0x000018, "Member 'FHairGroupInfo::MaxCurveLength' has a wrong offset!");
static_assert(offsetof(FHairGroupInfo, GroupCardsID) == 0x00001C, "Member 'FHairGroupInfo::GroupCardsID' has a wrong offset!");
...
public:
	...
	struct FHairGroupCardsTextures                Textures;                                          // 0x0028(0x0038)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         GroupIndex;                                        // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LODIndex;                                          // 0x0064(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FHairGroupCardsInfo                    CardsInfo;                                         // 0x0068(0x0008)(Edit, Transient, EditConst, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FHairGroupsCardsSourceDescription) == 0x000080, "Wrong size on FHairGroupsCardsSourceDescription");
...
static_assert(offsetof(FHairGroupsCardsSourceDescription, SourceType) == 0x00000C, "Member 'FHairGroupsCardsSourceDescription::SourceType' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, ProceduralMesh) == 0x000010, "Member 'FHairGroupsCardsSourceDescription::ProceduralMesh' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, bInvertUV) == 0x000018, "Member 'FHairGroupsCardsSourceDescription::bInvertUV' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, GuideType) == 0x000019, "Member 'FHairGroupsCardsSourceDescription::GuideType' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, ImportedMesh) == 0x000020, "Member 'FHairGroupsCardsSourceDescription::ImportedMesh' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, Textures) == 0x000028, "Member 'FHairGroupsCardsSourceDescription::Textures' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, GroupIndex) == 0x000060, "Member 'FHairGroupsCardsSourceDescription::GroupIndex' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, LODIndex) == 0x000064, "Member 'FHairGroupsCardsSourceDescription::LODIndex' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, CardsInfo) == 0x000068, "Member 'FHairGroupsCardsSourceDescription::CardsInfo' has a wrong offset!");
static_assert(offsetof(FHairGroupsCardsSourceDescription, ImportedMeshKey) == 0x000070, "Member 'FHairGroupsCardsSourceDescription::ImportedMeshKey' has a wrong offset!");
...
static_assert(offsetof(FHairSolverSettings, GravityPreloading) == 0x000028, "Member 'FHairSolverSettings::GravityPreloading' has a wrong offset!");
static_assert(offsetof(FHairSolverSettings, SubSteps) == 0x00002C, "Member 'FHairSolverSettings::SubSteps' has a wrong offset!");
static_assert(offsetof(FHairSolverSettings, IterationCount) == 0x000030, "Member 'FHairSolverSettings::IterationCount' has a wrong offset!");
static_assert(offsetof(FHairSolverSettings, bForceVisible) == 0x000034, "Member 'FHairSolverSettings::bForceVisible' has a wrong offset!");
...
static_assert(sizeof(FGroomHairGroupPreview) == 0x000044, "Wrong size on FGroomHairGroupPreview");
...
static_assert(offsetof(FGroomHairGroupPreview, GroupId) == 0x000004, "Member 'FGroomHairGroupPreview::GroupId' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, CurveCount) == 0x000008, "Member 'FGroomHairGroupPreview::CurveCount' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, GuideCount) == 0x00000C, "Member 'FGroomHairGroupPreview::GuideCount' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, Attributes) == 0x000010, "Member 'FGroomHairGroupPreview::Attributes' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, AttributeFlags) == 0x000014, "Member 'FGroomHairGroupPreview::AttributeFlags' has a wrong offset!");
static_assert(offsetof(FGroomHairGroupPreview, Flags) == 0x000018, "Member 'FGroomHairGroupPreview::Flags' has a wrong offset!");
