...
// Parameters:
// struct VerseWorldPartition_0::Ftuple_L_R__verse_0xB2CDDD72_Argument                            (Parm, HasGetValueTypeHash)
// TOptional<class UVerseWorldPartition_data_layer_manager*, true>RetVal                                                 (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
...
TOptional<class UVerseWorldPartition_data_layer_manager*, true> UVerseWorldPartition::_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_N_RGetDataLayerManager(const struct VerseWorldPartition_0::Ftuple_L_R& __verse_0xB2CDDD72_Argument)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_N_RGetDataLayerManager");
...
EVerseWorldPartition_data_layer_runtime_state UVerseWorldPartition_data_layer_manager::_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_2fdata__layer__manager_N_RGetDataLayerEffectiveRuntimeState_L_Ndata__layer__asset_R(class UVerseWorldPartition_data_layer_asset* __verse_0xB2CDDD72_Argument)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_2fdata__layer__manager_N_RGetDataLayerEffectiveRuntimeState_L_Ndata__layer__asset_R");
...
uint8 UVerseWorldPartition_data_layer_manager::_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_2fdata__layer__manager_N_RSetDataLayerRuntimeState_L_Ndata__layer__asset_M_Ndata__layer__runtime__state_M_Nlogic_R(const struct Ftuple_Ldata__layer__asset_Mdata__layer__runtime__state_Mlogic_R& __verse_0xB2CDDD72_Argument)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_2fdata__layer__manager_N_RSetDataLayerRuntimeState_L_Ndata__layer__asset_M_Ndata__layer__runtime__state_M_Nlogic_R");
