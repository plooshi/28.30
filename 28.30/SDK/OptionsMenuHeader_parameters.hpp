...
static_assert(sizeof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader) == 0x000168, "Wrong size on OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader");
...
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, K2Node_Event_MouseEvent_1) == 0x0000D0, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::K2Node_Event_MouseEvent_1' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, K2Node_Event_bIsSelected) == 0x000148, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::K2Node_Event_bIsSelected' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, CallFunc_FTrunc_ReturnValue) == 0x00014C, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, CallFunc_GetContext_ReturnValue) == 0x000150, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, CallFunc_IsUsingGamepad_ReturnValue) == 0x000158, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::CallFunc_IsUsingGamepad_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, CallFunc_FTrunc_A_ImplicitCast) == 0x000160, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::CallFunc_FTrunc_A_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(OptionsMenuHeader_C_OnMouseEnter) == 0x0000B0, "Wrong size on OptionsMenuHeader_C_OnMouseEnter");
...
static_assert(sizeof(OptionsMenuHeader_C_OnMouseLeave) == 0x000078, "Wrong size on OptionsMenuHeader_C_OnMouseLeave");
...
static_assert(sizeof(OptionsMenuHeader_C_SetFontSize) == 0x000080, "Wrong size on OptionsMenuHeader_C_SetFontSize");
...
static_assert(offsetof(OptionsMenuHeader_C_SetFontSize, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000070, "Member 'OptionsMenuHeader_C_SetFontSize::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_SetFontSize, K2Node_SetFieldsInStruct_Size_ImplicitCast) == 0x000078, "Member 'OptionsMenuHeader_C_SetFontSize::K2Node_SetFieldsInStruct_Size_ImplicitCast' has a wrong offset!");
...
static_assert(alignof(OptionsMenuHeader_C_UpdateSize) == 0x000008, "Wrong alignment on OptionsMenuHeader_C_UpdateSize");
static_assert(sizeof(OptionsMenuHeader_C_UpdateSize) == 0x000060, "Wrong size on OptionsMenuHeader_C_UpdateSize");
...
static_assert(offsetof(OptionsMenuHeader_C_UpdateSize, SmallSize) == 0x000010, "Member 'OptionsMenuHeader_C_UpdateSize::SmallSize' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_UpdateSize, Temp_bool_Variable) == 0x000020, "Member 'OptionsMenuHeader_C_UpdateSize::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_UpdateSize, Temp_struct_Variable) == 0x000028, "Member 'OptionsMenuHeader_C_UpdateSize::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_UpdateSize, Temp_struct_Variable_1) == 0x000038, "Member 'OptionsMenuHeader_C_UpdateSize::Temp_struct_Variable_1' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_UpdateSize, CallFunc_IsBROnly_ReturnValue) == 0x000048, "Member 'OptionsMenuHeader_C_UpdateSize::CallFunc_IsBROnly_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_UpdateSize, K2Node_Select_Default) == 0x000050, "Member 'OptionsMenuHeader_C_UpdateSize::K2Node_Select_Default' has a wrong offset!");
