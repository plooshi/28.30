...
static_assert(sizeof(CrewScreenContentBlockingInterface_BlockScreenContent) == 0x000020, "Wrong size on CrewScreenContentBlockingInterface_BlockScreenContent");
static_assert(offsetof(CrewScreenContentBlockingInterface_BlockScreenContent, bBlockScreen) == 0x000000, "Member 'CrewScreenContentBlockingInterface_BlockScreenContent::bBlockScreen' has a wrong offset!");
static_assert(offsetof(CrewScreenContentBlockingInterface_BlockScreenContent, ContentBlockedText) == 0x000008, "Member 'CrewScreenContentBlockingInterface_BlockScreenContent::ContentBlockedText' has a wrong offset!");
...
static_assert(sizeof(FortTemporaryItemsRow_GetCategoryText) == 0x000020, "Wrong size on FortTemporaryItemsRow_GetCategoryText");
...
static_assert(offsetof(FortTemporaryItemsScreenItemInfo_OnDataSet, bValidItem) == 0x000000, "Member 'FortTemporaryItemsScreenItemInfo_OnDataSet::bValidItem' has a wrong offset!");
static_assert(offsetof(FortTemporaryItemsScreenItemInfo_OnDataSet, bIsSubscribed) == 0x000001, "Member 'FortTemporaryItemsScreenItemInfo_OnDataSet::bIsSubscribed' has a wrong offset!");
static_assert(offsetof(FortTemporaryItemsScreenItemInfo_OnDataSet, IsOwned) == 0x000002, "Member 'FortTemporaryItemsScreenItemInfo_OnDataSet::IsOwned' has a wrong offset!");
...
static_assert(offsetof(FortTemporaryItemsScreenItemInfo_SetData, SubscriptionVM) == 0x000000, "Member 'FortTemporaryItemsScreenItemInfo_SetData::SubscriptionVM' has a wrong offset!");
static_assert(offsetof(FortTemporaryItemsScreenItemInfo_SetData, RewardVM) == 0x000008, "Member 'FortTemporaryItemsScreenItemInfo_SetData::RewardVM' has a wrong offset!");
...
static_assert(sizeof(CrewPurchaseScreen_OnSetPaymentLegalText) == 0x000018, "Wrong size on CrewPurchaseScreen_OnSetPaymentLegalText");
static_assert(offsetof(CrewPurchaseScreen_OnSetPaymentLegalText, LegalText) == 0x000000, "Member 'CrewPurchaseScreen_OnSetPaymentLegalText::LegalText' has a wrong offset!");
...
static_assert(sizeof(FortProgressiveItemWidget_OnStageItemChanged) == 0x000068, "Wrong size on FortProgressiveItemWidget_OnStageItemChanged");
...
static_assert(sizeof(FortProgressiveSetTile_BP_OnInitializeSetInfo) == 0x000098, "Wrong size on FortProgressiveSetTile_BP_OnInitializeSetInfo");
...
static_assert(offsetof(FortProgressiveSetTile_BP_OnInitializeSetInfo, BottomText) == 0x000060, "Member 'FortProgressiveSetTile_BP_OnInitializeSetInfo::BottomText' has a wrong offset!");
static_assert(offsetof(FortProgressiveSetTile_BP_OnInitializeSetInfo, BottomSubtext) == 0x000078, "Member 'FortProgressiveSetTile_BP_OnInitializeSetInfo::BottomSubtext' has a wrong offset!");
static_assert(offsetof(FortProgressiveSetTile_BP_OnInitializeSetInfo, bSubscribed) == 0x000090, "Member 'FortProgressiveSetTile_BP_OnInitializeSetInfo::bSubscribed' has a wrong offset!");
...
static_assert(offsetof(FortTemporaryItemsScreen_BP_OnContainerTabVisibilityUpdated, bTabsVisible) == 0x000000, "Member 'FortTemporaryItemsScreen_BP_OnContainerTabVisibilityUpdated::bTabsVisible' has a wrong offset!");
static_assert(offsetof(FortTemporaryItemsScreen_BP_OnContainerTabVisibilityUpdated, SpacingAdjustmentForTabs) == 0x000004, "Member 'FortTemporaryItemsScreen_BP_OnContainerTabVisibilityUpdated::SpacingAdjustmentForTabs' has a wrong offset!");
...
static_assert(offsetof(FortTemporaryItemsScreen_GetSubscriptionVM, ReturnValue) == 0x000000, "Member 'FortTemporaryItemsScreen_GetSubscriptionVM::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FortTemporaryItemsScreen_SetupRowEntry, RewardRow) == 0x000000, "Member 'FortTemporaryItemsScreen_SetupRowEntry::RewardRow' has a wrong offset!");
...
static_assert(sizeof(FortTemporaryItemsScreen_GetRemainingDaysLabel) == 0x000020, "Wrong size on FortTemporaryItemsScreen_GetRemainingDaysLabel");
static_assert(offsetof(FortTemporaryItemsScreen_GetRemainingDaysLabel, TemporaryItemsVM) == 0x000000, "Member 'FortTemporaryItemsScreen_GetRemainingDaysLabel::TemporaryItemsVM' has a wrong offset!");
static_assert(offsetof(FortTemporaryItemsScreen_GetRemainingDaysLabel, ReturnValue) == 0x000008, "Member 'FortTemporaryItemsScreen_GetRemainingDaysLabel::ReturnValue' has a wrong offset!");
