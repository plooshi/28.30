...
static_assert(offsetof(FMotionWarpingTarget, LocationOffset) == 0x000048, "Member 'FMotionWarpingTarget::LocationOffset' has a wrong offset!");
static_assert(offsetof(FMotionWarpingTarget, RotationOffset) == 0x000060, "Member 'FMotionWarpingTarget::RotationOffset' has a wrong offset!");
