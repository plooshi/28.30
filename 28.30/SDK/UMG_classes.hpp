...
static_assert(offsetof(UUserWidget, ForegroundColor) == 0x00019C, "Member 'UUserWidget::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UUserWidget, ForegroundColorDelegate) == 0x0001B0, "Member 'UUserWidget::ForegroundColorDelegate' has a wrong offset!");
static_assert(offsetof(UUserWidget, OnVisibilityChanged) == 0x0001C0, "Member 'UUserWidget::OnVisibilityChanged' has a wrong offset!");
static_assert(offsetof(UUserWidget, Padding) == 0x000200, "Member 'UUserWidget::Padding' has a wrong offset!");
static_assert(offsetof(UUserWidget, Priority) == 0x000210, "Member 'UUserWidget::Priority' has a wrong offset!");
static_assert(offsetof(UUserWidget, ActiveSequencePlayers) == 0x000218, "Member 'UUserWidget::ActiveSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, AnimationTickManager) == 0x000228, "Member 'UUserWidget::AnimationTickManager' has a wrong offset!");
static_assert(offsetof(UUserWidget, StoppedSequencePlayers) == 0x000230, "Member 'UUserWidget::StoppedSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, NamedSlotBindings) == 0x000240, "Member 'UUserWidget::NamedSlotBindings' has a wrong offset!");
static_assert(offsetof(UUserWidget, Extensions) == 0x000250, "Member 'UUserWidget::Extensions' has a wrong offset!");
static_assert(offsetof(UUserWidget, WidgetTree) == 0x000260, "Member 'UUserWidget::WidgetTree' has a wrong offset!");
static_assert(offsetof(UUserWidget, TickFrequency) == 0x000280, "Member 'UUserWidget::TickFrequency' has a wrong offset!");
static_assert(offsetof(UUserWidget, DesiredFocusWidget) == 0x000284, "Member 'UUserWidget::DesiredFocusWidget' has a wrong offset!");
...
static_assert(sizeof(UCircularThrobber) == 0x000270, "Wrong size on UCircularThrobber");
...
static_assert(offsetof(UCircularThrobber, bEnableRadius) == 0x000250, "Member 'UCircularThrobber::bEnableRadius' has a wrong offset!");
...
static_assert(sizeof(UComboBox) == 0x000890, "Wrong size on UComboBox");
static_assert(offsetof(UComboBox, ScrollBarStyle) == 0x000180, "Member 'UComboBox::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UComboBox, Items) == 0x000860, "Member 'UComboBox::Items' has a wrong offset!");
static_assert(offsetof(UComboBox, OnGenerateWidgetEvent) == 0x000870, "Member 'UComboBox::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBox, bIsFocusable) == 0x00087C, "Member 'UComboBox::bIsFocusable' has a wrong offset!");
...
public:
	...
	bool                                          bEnableFixedLineOffset;                            // 0x01A9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UListViewBase, bEnableFixedLineOffset) == 0x0001A9, "Member 'UListViewBase::bEnableFixedLineOffset' has a wrong offset!");
...
static_assert(offsetof(UListView, ScrollBarStyle) == 0x000450, "Member 'UListView::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UListView, orientation) == 0x000B30, "Member 'UListView::orientation' has a wrong offset!");
static_assert(offsetof(UListView, SelectionMode) == 0x000B31, "Member 'UListView::SelectionMode' has a wrong offset!");
static_assert(offsetof(UListView, ConsumeMouseWheel) == 0x000B32, "Member 'UListView::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UListView, bClearSelectionOnClick) == 0x000B33, "Member 'UListView::bClearSelectionOnClick' has a wrong offset!");
static_assert(offsetof(UListView, bIsFocusable) == 0x000B34, "Member 'UListView::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UListView, bReturnFocusToSelection) == 0x000B35, "Member 'UListView::bReturnFocusToSelection' has a wrong offset!");
static_assert(offsetof(UListView, ListItems) == 0x000B38, "Member 'UListView::ListItems' has a wrong offset!");
static_assert(offsetof(UListView, HorizontalEntrySpacing) == 0x000B58, "Member 'UListView::HorizontalEntrySpacing' has a wrong offset!");
static_assert(offsetof(UListView, VerticalEntrySpacing) == 0x000B5C, "Member 'UListView::VerticalEntrySpacing' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnEntryInitialized) == 0x000B60, "Member 'UListView::BP_OnEntryInitialized' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemClicked) == 0x000B70, "Member 'UListView::BP_OnItemClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemDoubleClicked) == 0x000B80, "Member 'UListView::BP_OnItemDoubleClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemIsHoveredChanged) == 0x000B90, "Member 'UListView::BP_OnItemIsHoveredChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemSelectionChanged) == 0x000BA0, "Member 'UListView::BP_OnItemSelectionChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemScrolledIntoView) == 0x000BB0, "Member 'UListView::BP_OnItemScrolledIntoView' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnListViewScrolled) == 0x000BC0, "Member 'UListView::BP_OnListViewScrolled' has a wrong offset!");
...
public:
	...
	class UWidgetAnimation*                       Animation;                                         // 0x0238(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_240[0x8];                                      // 0x0240(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                              // 0x0248(0x0070)(NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UBorder, Padding) == 0x0001B0, "Member 'UBorder::Padding' has a wrong offset!");
static_assert(offsetof(UBorder, Background) == 0x0001C0, "Member 'UBorder::Background' has a wrong offset!");
static_assert(offsetof(UBorder, BackgroundDelegate) == 0x000280, "Member 'UBorder::BackgroundDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, BrushColor) == 0x00028C, "Member 'UBorder::BrushColor' has a wrong offset!");
static_assert(offsetof(UBorder, BrushColorDelegate) == 0x00029C, "Member 'UBorder::BrushColorDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, DesiredSizeScale) == 0x0002A8, "Member 'UBorder::DesiredSizeScale' has a wrong offset!");
static_assert(offsetof(UBorder, bFlipForRightToLeftFlowDirection) == 0x0002B8, "Member 'UBorder::bFlipForRightToLeftFlowDirection' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseButtonDownEvent) == 0x0002BC, "Member 'UBorder::OnMouseButtonDownEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseButtonUpEvent) == 0x0002C8, "Member 'UBorder::OnMouseButtonUpEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseMoveEvent) == 0x0002D4, "Member 'UBorder::OnMouseMoveEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseDoubleClickEvent) == 0x0002E0, "Member 'UBorder::OnMouseDoubleClickEvent' has a wrong offset!");
...
static_assert(offsetof(UCheckBox, HorizontalAlignment) == 0x000BB0, "Member 'UCheckBox::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UCheckBox, ClickMethod) == 0x000BB1, "Member 'UCheckBox::ClickMethod' has a wrong offset!");
static_assert(offsetof(UCheckBox, TouchMethod) == 0x000BB2, "Member 'UCheckBox::TouchMethod' has a wrong offset!");
static_assert(offsetof(UCheckBox, PressMethod) == 0x000BB3, "Member 'UCheckBox::PressMethod' has a wrong offset!");
static_assert(offsetof(UCheckBox, IsFocusable) == 0x000BB4, "Member 'UCheckBox::IsFocusable' has a wrong offset!");
static_assert(offsetof(UCheckBox, OnCheckStateChanged) == 0x000BB8, "Member 'UCheckBox::OnCheckStateChanged' has a wrong offset!");
...
static_assert(offsetof(UComboBoxKey, ItemStyle) == 0x000790, "Member 'UComboBoxKey::ItemStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, ScrollBarStyle) == 0x0013E0, "Member 'UComboBoxKey::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, ForegroundColor) == 0x001AC0, "Member 'UComboBoxKey::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, ContentPadding) == 0x001AD4, "Member 'UComboBoxKey::ContentPadding' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, MaxListHeight) == 0x001AE4, "Member 'UComboBoxKey::MaxListHeight' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, bHasDownArrow) == 0x001AE8, "Member 'UComboBoxKey::bHasDownArrow' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, bEnableGamepadNavigationMode) == 0x001AE9, "Member 'UComboBoxKey::bEnableGamepadNavigationMode' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, bIsFocusable) == 0x001AEA, "Member 'UComboBoxKey::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, OnGenerateContentWidget) == 0x001AEC, "Member 'UComboBoxKey::OnGenerateContentWidget' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, OnGenerateItemWidget) == 0x001AF8, "Member 'UComboBoxKey::OnGenerateItemWidget' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, OnSelectionChanged) == 0x001B08, "Member 'UComboBoxKey::OnSelectionChanged' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, OnOpening) == 0x001B18, "Member 'UComboBoxKey::OnOpening' has a wrong offset!");
...
static_assert(sizeof(UComboBoxString) == 0x001BE0, "Wrong size on UComboBoxString");
...
static_assert(offsetof(UComboBoxString, ItemStyle) == 0x0007A0, "Member 'UComboBoxString::ItemStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ScrollBarStyle) == 0x0013F0, "Member 'UComboBoxString::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ContentPadding) == 0x001AD0, "Member 'UComboBoxString::ContentPadding' has a wrong offset!");
static_assert(offsetof(UComboBoxString, MaxListHeight) == 0x001AE0, "Member 'UComboBoxString::MaxListHeight' has a wrong offset!");
static_assert(offsetof(UComboBoxString, HasDownArrow) == 0x001AE4, "Member 'UComboBoxString::HasDownArrow' has a wrong offset!");
static_assert(offsetof(UComboBoxString, EnableGamepadNavigationMode) == 0x001AE5, "Member 'UComboBoxString::EnableGamepadNavigationMode' has a wrong offset!");
static_assert(offsetof(UComboBoxString, Font) == 0x001AE8, "Member 'UComboBoxString::Font' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ForegroundColor) == 0x001B40, "Member 'UComboBoxString::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UComboBoxString, bIsFocusable) == 0x001B54, "Member 'UComboBoxString::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnGenerateWidgetEvent) == 0x001B58, "Member 'UComboBoxString::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnSelectionChanged) == 0x001B68, "Member 'UComboBoxString::OnSelectionChanged' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnOpening) == 0x001B78, "Member 'UComboBoxString::OnOpening' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class FText& Text)> OnTextChanged;                                     // 0x0F60(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FText& Text, ETextCommit CommitMethod)> OnTextCommitted;                                   // 0x0F70(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBox) == 0x000F90, "Wrong size on UEditableTextBox");
...
static_assert(offsetof(UEditableTextBox, HintText) == 0x000F20, "Member 'UEditableTextBox::HintText' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, HintTextDelegate) == 0x000F38, "Member 'UEditableTextBox::HintTextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsReadOnly) == 0x000F44, "Member 'UEditableTextBox::IsReadOnly' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsPassword) == 0x000F45, "Member 'UEditableTextBox::IsPassword' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, MinimumDesiredWidth) == 0x000F48, "Member 'UEditableTextBox::MinimumDesiredWidth' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsCaretMovedWhenGainFocus) == 0x000F4C, "Member 'UEditableTextBox::IsCaretMovedWhenGainFocus' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextWhenFocused) == 0x000F4D, "Member 'UEditableTextBox::SelectAllTextWhenFocused' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, RevertTextOnEscape) == 0x000F4E, "Member 'UEditableTextBox::RevertTextOnEscape' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ClearKeyboardFocusOnCommit) == 0x000F4F, "Member 'UEditableTextBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextOnCommit) == 0x000F50, "Member 'UEditableTextBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, AllowContextMenu) == 0x000F51, "Member 'UEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, KeyboardType) == 0x000F52, "Member 'UEditableTextBox::KeyboardType' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardOptions) == 0x000F53, "Member 'UEditableTextBox::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardTrigger) == 0x000F54, "Member 'UEditableTextBox::VirtualKeyboardTrigger' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardDismissAction) == 0x000F55, "Member 'UEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Justification) == 0x000F56, "Member 'UEditableTextBox::Justification' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OverflowPolicy) == 0x000F57, "Member 'UEditableTextBox::OverflowPolicy' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ShapedTextOptions) == 0x000F58, "Member 'UEditableTextBox::ShapedTextOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextChanged) == 0x000F60, "Member 'UEditableTextBox::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextCommitted) == 0x000F70, "Member 'UEditableTextBox::OnTextCommitted' has a wrong offset!");
...
static_assert(offsetof(UExpandableArea, BorderColor) == 0x0003E0, "Member 'UExpandableArea::BorderColor' has a wrong offset!");
static_assert(offsetof(UExpandableArea, bIsExpanded) == 0x0003F4, "Member 'UExpandableArea::bIsExpanded' has a wrong offset!");
static_assert(offsetof(UExpandableArea, MaxHeight) == 0x0003F8, "Member 'UExpandableArea::MaxHeight' has a wrong offset!");
static_assert(offsetof(UExpandableArea, HeaderPadding) == 0x0003FC, "Member 'UExpandableArea::HeaderPadding' has a wrong offset!");
static_assert(offsetof(UExpandableArea, AreaPadding) == 0x00040C, "Member 'UExpandableArea::AreaPadding' has a wrong offset!");
static_assert(offsetof(UExpandableArea, OnExpansionChanged) == 0x000420, "Member 'UExpandableArea::OnExpansionChanged' has a wrong offset!");
static_assert(offsetof(UExpandableArea, HeaderContent) == 0x000430, "Member 'UExpandableArea::HeaderContent' has a wrong offset!");
static_assert(offsetof(UExpandableArea, BodyContent) == 0x000438, "Member 'UExpandableArea::BodyContent' has a wrong offset!");
...
public:
	...
	TDelegate<void(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)> OnMouseButtonDownEvent;                            // 0x026C(0x000C)(Edit, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UImage, BrushDelegate) == 0x000240, "Member 'UImage::BrushDelegate' has a wrong offset!");
static_assert(offsetof(UImage, ColorAndOpacity) == 0x00024C, "Member 'UImage::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UImage, ColorAndOpacityDelegate) == 0x00025C, "Member 'UImage::ColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UImage, bFlipForRightToLeftFlowDirection) == 0x000268, "Member 'UImage::bFlipForRightToLeftFlowDirection' has a wrong offset!");
static_assert(offsetof(UImage, OnMouseButtonDownEvent) == 0x00026C, "Member 'UImage::OnMouseButtonDownEvent' has a wrong offset!");
...
static_assert(sizeof(UInputKeySelector) == 0x0008F0, "Wrong size on UInputKeySelector");
static_assert(offsetof(UInputKeySelector, WidgetStyle) == 0x000180, "Member 'UInputKeySelector::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, TextStyle) == 0x000530, "Member 'UInputKeySelector::TextStyle' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, SelectedKey) == 0x000840, "Member 'UInputKeySelector::SelectedKey' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, Margin) == 0x000860, "Member 'UInputKeySelector::Margin' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, KeySelectionText) == 0x000870, "Member 'UInputKeySelector::KeySelectionText' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, NoKeySpecifiedText) == 0x000888, "Member 'UInputKeySelector::NoKeySpecifiedText' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, bAllowModifierKeys) == 0x0008A0, "Member 'UInputKeySelector::bAllowModifierKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, bAllowGamepadKeys) == 0x0008A1, "Member 'UInputKeySelector::bAllowGamepadKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, EscapeKeys) == 0x0008A8, "Member 'UInputKeySelector::EscapeKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, OnKeySelected) == 0x0008B8, "Member 'UInputKeySelector::OnKeySelected' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, OnIsSelectingKeyChanged) == 0x0008C8, "Member 'UInputKeySelector::OnIsSelectingKeyChanged' has a wrong offset!");
...
public:
	...
	bool                                          b_CanAlwaysCache_HACK;                             // 0x0191(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_192[0x16];                                     // 0x0192(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UInvalidationBox, b_CanAlwaysCache_HACK) == 0x000191, "Member 'UInvalidationBox::b_CanAlwaysCache_HACK' has a wrong offset!");
...
static_assert(sizeof(UMenuAnchor) == 0x0001D8, "Wrong size on UMenuAnchor");
...
static_assert(offsetof(UMenuAnchor, OnGetUserMenuContentEvent) == 0x0001A4, "Member 'UMenuAnchor::OnGetUserMenuContentEvent' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, Placement) == 0x0001B0, "Member 'UMenuAnchor::Placement' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, bFitInWindow) == 0x0001B1, "Member 'UMenuAnchor::bFitInWindow' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, ShouldDeferPaintingAfterWindowContent) == 0x0001B2, "Member 'UMenuAnchor::ShouldDeferPaintingAfterWindowContent' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, UseApplicationMenuStack) == 0x0001B3, "Member 'UMenuAnchor::UseApplicationMenuStack' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, OnMenuOpenChanged) == 0x0001B8, "Member 'UMenuAnchor::OnMenuOpenChanged' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class FText& Text)> OnTextChanged;                                     // 0x04F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FText& Text, ETextCommit CommitMethod)> OnTextCommitted;                                   // 0x0508(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMultiLineEditableText, Text) == 0x000198, "Member 'UMultiLineEditableText::Text' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class FText& Text)> OnTextChanged;                                     // 0x0F68(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FText& Text, ETextCommit CommitMethod)> OnTextCommitted;                                   // 0x0F78(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMultiLineEditableTextBox) == 0x000FA0, "Wrong size on UMultiLineEditableTextBox");
static_assert(offsetof(UMultiLineEditableTextBox, Text) == 0x000198, "Member 'UMultiLineEditableTextBox::Text' has a wrong offset!");
...
static_assert(offsetof(UMultiLineEditableTextBox, bIsReadOnly) == 0x000F60, "Member 'UMultiLineEditableTextBox::bIsReadOnly' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, AllowContextMenu) == 0x000F61, "Member 'UMultiLineEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, VirtualKeyboardOptions) == 0x000F62, "Member 'UMultiLineEditableTextBox::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, VirtualKeyboardDismissAction) == 0x000F63, "Member 'UMultiLineEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, OnTextChanged) == 0x000F68, "Member 'UMultiLineEditableTextBox::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, OnTextCommitted) == 0x000F78, "Member 'UMultiLineEditableTextBox::OnTextCommitted' has a wrong offset!");
...
static_assert(sizeof(UProgressBar) == 0x000430, "Wrong size on UProgressBar");
...
static_assert(offsetof(UProgressBar, FillColorAndOpacity) == 0x000404, "Member 'UProgressBar::FillColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillColorAndOpacityDelegate) == 0x000414, "Member 'UProgressBar::FillColorAndOpacityDelegate' has a wrong offset!");
...
static_assert(offsetof(URichTextBlock, Text) == 0x000198, "Member 'URichTextBlock::Text' has a wrong offset!");
...
static_assert(offsetof(URichTextBlock, MinDesiredWidth) == 0x0004E0, "Member 'URichTextBlock::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(URichTextBlock, TextTransformPolicy) == 0x0004E4, "Member 'URichTextBlock::TextTransformPolicy' has a wrong offset!");
static_assert(offsetof(URichTextBlock, TextOverflowPolicy) == 0x0004E5, "Member 'URichTextBlock::TextOverflowPolicy' has a wrong offset!");
static_assert(offsetof(URichTextBlock, DefaultTextStyle) == 0x0004F0, "Member 'URichTextBlock::DefaultTextStyle' has a wrong offset!");
static_assert(offsetof(URichTextBlock, InstanceDecorators) == 0x000800, "Member 'URichTextBlock::InstanceDecorators' has a wrong offset!");
...
static_assert(sizeof(UScrollBar) == 0x0008A0, "Wrong size on UScrollBar");
static_assert(offsetof(UScrollBar, WidgetStyle) == 0x000180, "Member 'UScrollBar::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollbar) == 0x000860, "Member 'UScrollBar::bAlwaysShowScrollbar' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollbarTrack) == 0x000861, "Member 'UScrollBar::bAlwaysShowScrollbarTrack' has a wrong offset!");
static_assert(offsetof(UScrollBar, orientation) == 0x000862, "Member 'UScrollBar::orientation' has a wrong offset!");
static_assert(offsetof(UScrollBar, Thickness) == 0x000868, "Member 'UScrollBar::Thickness' has a wrong offset!");
static_assert(offsetof(UScrollBar, Padding) == 0x000878, "Member 'UScrollBar::Padding' has a wrong offset!");

// Class UMG.ScrollBox
// 0x0A90 (0x0C20 - 0x0190)
#pragma pack(push, 0x1)
...
public:
	...
	TMulticastInlineDelegate<void(ESlateVisibility NewVisibility)> OnScrollBarVisibilityChanged;                      // 0x0BF0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UScrollBox, orientation) == 0x000BA0, "Member 'UScrollBox::orientation' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollBarVisibility) == 0x000BA1, "Member 'UScrollBox::ScrollBarVisibility' has a wrong offset!");
static_assert(offsetof(UScrollBox, ConsumeMouseWheel) == 0x000BA2, "Member 'UScrollBox::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollbarThickness) == 0x000BA8, "Member 'UScrollBox::ScrollbarThickness' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollbarPadding) == 0x000BB8, "Member 'UScrollBox::ScrollbarPadding' has a wrong offset!");
static_assert(offsetof(UScrollBox, AlwaysShowScrollbar) == 0x000BC8, "Member 'UScrollBox::AlwaysShowScrollbar' has a wrong offset!");
static_assert(offsetof(UScrollBox, AlwaysShowScrollbarTrack) == 0x000BC9, "Member 'UScrollBox::AlwaysShowScrollbarTrack' has a wrong offset!");
static_assert(offsetof(UScrollBox, AllowOverscroll) == 0x000BCA, "Member 'UScrollBox::AllowOverscroll' has a wrong offset!");
static_assert(offsetof(UScrollBox, BackPadScrolling) == 0x000BCB, "Member 'UScrollBox::BackPadScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, FrontPadScrolling) == 0x000BCC, "Member 'UScrollBox::FrontPadScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, bAnimateWheelScrolling) == 0x000BCD, "Member 'UScrollBox::bAnimateWheelScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, NavigationDestination) == 0x000BCE, "Member 'UScrollBox::NavigationDestination' has a wrong offset!");
static_assert(offsetof(UScrollBox, NavigationScrollPadding) == 0x000BD0, "Member 'UScrollBox::NavigationScrollPadding' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollWhenFocusChanges) == 0x000BD4, "Member 'UScrollBox::ScrollWhenFocusChanges' has a wrong offset!");
static_assert(offsetof(UScrollBox, bAllowRightClickDragScrolling) == 0x000BD5, "Member 'UScrollBox::bAllowRightClickDragScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, WheelScrollMultiplier) == 0x000BD8, "Member 'UScrollBox::WheelScrollMultiplier' has a wrong offset!");
static_assert(offsetof(UScrollBox, OnUserScrolled) == 0x000BE0, "Member 'UScrollBox::OnUserScrolled' has a wrong offset!");
static_assert(offsetof(UScrollBox, OnScrollBarVisibilityChanged) == 0x000BF0, "Member 'UScrollBox::OnScrollBarVisibilityChanged' has a wrong offset!");
...
static_assert(offsetof(USlider, MinValue) == 0x000188, "Member 'USlider::MinValue' has a wrong offset!");
static_assert(offsetof(USlider, MaxValue) == 0x00018C, "Member 'USlider::MaxValue' has a wrong offset!");
static_assert(offsetof(USlider, WidgetStyle) == 0x000190, "Member 'USlider::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USlider, orientation) == 0x000630, "Member 'USlider::orientation' has a wrong offset!");
static_assert(offsetof(USlider, SliderBarColor) == 0x000634, "Member 'USlider::SliderBarColor' has a wrong offset!");
static_assert(offsetof(USlider, SliderHandleColor) == 0x000644, "Member 'USlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(USlider, IndentHandle) == 0x000654, "Member 'USlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(USlider, Locked) == 0x000655, "Member 'USlider::Locked' has a wrong offset!");
static_assert(offsetof(USlider, MouseUsesStep) == 0x000656, "Member 'USlider::MouseUsesStep' has a wrong offset!");
static_assert(offsetof(USlider, RequiresControllerLock) == 0x000657, "Member 'USlider::RequiresControllerLock' has a wrong offset!");
static_assert(offsetof(USlider, StepSize) == 0x000658, "Member 'USlider::StepSize' has a wrong offset!");
static_assert(offsetof(USlider, IsFocusable) == 0x00065C, "Member 'USlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(USlider, OnMouseCaptureBegin) == 0x000660, "Member 'USlider::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USlider, OnMouseCaptureEnd) == 0x000670, "Member 'USlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USlider, OnControllerCaptureBegin) == 0x000680, "Member 'USlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USlider, OnControllerCaptureEnd) == 0x000690, "Member 'USlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USlider, OnValueChanged) == 0x0006A0, "Member 'USlider::OnValueChanged' has a wrong offset!");
...
static_assert(sizeof(USpinBox) == 0x000820, "Wrong size on USpinBox");
...
static_assert(offsetof(USpinBox, MinFractionalDigits) == 0x000720, "Member 'USpinBox::MinFractionalDigits' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxFractionalDigits) == 0x000724, "Member 'USpinBox::MaxFractionalDigits' has a wrong offset!");
static_assert(offsetof(USpinBox, bAlwaysUsesDeltaSnap) == 0x000728, "Member 'USpinBox::bAlwaysUsesDeltaSnap' has a wrong offset!");
static_assert(offsetof(USpinBox, bEnableSlider) == 0x000729, "Member 'USpinBox::bEnableSlider' has a wrong offset!");
static_assert(offsetof(USpinBox, Delta) == 0x00072C, "Member 'USpinBox::Delta' has a wrong offset!");
static_assert(offsetof(USpinBox, SliderExponent) == 0x000730, "Member 'USpinBox::SliderExponent' has a wrong offset!");
static_assert(offsetof(USpinBox, Font) == 0x000738, "Member 'USpinBox::Font' has a wrong offset!");
static_assert(offsetof(USpinBox, Justification) == 0x000790, "Member 'USpinBox::Justification' has a wrong offset!");
static_assert(offsetof(USpinBox, MinDesiredWidth) == 0x000794, "Member 'USpinBox::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(USpinBox, KeyboardType) == 0x000798, "Member 'USpinBox::KeyboardType' has a wrong offset!");
static_assert(offsetof(USpinBox, ClearKeyboardFocusOnCommit) == 0x000799, "Member 'USpinBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(USpinBox, SelectAllTextOnCommit) == 0x00079A, "Member 'USpinBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(USpinBox, ForegroundColor) == 0x00079C, "Member 'USpinBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(USpinBox, OnValueChanged) == 0x0007B0, "Member 'USpinBox::OnValueChanged' has a wrong offset!");
static_assert(offsetof(USpinBox, OnValueCommitted) == 0x0007C0, "Member 'USpinBox::OnValueCommitted' has a wrong offset!");
static_assert(offsetof(USpinBox, OnBeginSliderMovement) == 0x0007D0, "Member 'USpinBox::OnBeginSliderMovement' has a wrong offset!");
static_assert(offsetof(USpinBox, OnEndSliderMovement) == 0x0007E0, "Member 'USpinBox::OnEndSliderMovement' has a wrong offset!");
static_assert(offsetof(USpinBox, MinValue) == 0x0007F4, "Member 'USpinBox::MinValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxValue) == 0x0007F8, "Member 'USpinBox::MaxValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MinSliderValue) == 0x0007FC, "Member 'USpinBox::MinSliderValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxSliderValue) == 0x000800, "Member 'USpinBox::MaxSliderValue' has a wrong offset!");
...
static_assert(offsetof(UTextBlock, Text) == 0x000198, "Member 'UTextBlock::Text' has a wrong offset!");
static_assert(offsetof(UTextBlock, TextDelegate) == 0x0001B0, "Member 'UTextBlock::TextDelegate' has a wrong offset!");
static_assert(offsetof(UTextBlock, ColorAndOpacity) == 0x0001BC, "Member 'UTextBlock::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UTextBlock, ColorAndOpacityDelegate) == 0x0001D0, "Member 'UTextBlock::ColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UTextBlock, Font) == 0x0001E0, "Member 'UTextBlock::Font' has a wrong offset!");
static_assert(offsetof(UTextBlock, StrikeBrush) == 0x000240, "Member 'UTextBlock::StrikeBrush' has a wrong offset!");
...
static_assert(offsetof(UTextBlock, MinDesiredWidth) == 0x00032C, "Member 'UTextBlock::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(UTextBlock, bWrapWithInvalidationPanel) == 0x000330, "Member 'UTextBlock::bWrapWithInvalidationPanel' has a wrong offset!");
static_assert(offsetof(UTextBlock, TextTransformPolicy) == 0x000331, "Member 'UTextBlock::TextTransformPolicy' has a wrong offset!");
static_assert(offsetof(UTextBlock, TextOverflowPolicy) == 0x000332, "Member 'UTextBlock::TextOverflowPolicy' has a wrong offset!");
static_assert(offsetof(UTextBlock, bSimpleTextMode) == 0x000333, "Member 'UTextBlock::bSimpleTextMode' has a wrong offset!");
...
static_assert(offsetof(UTileView, EntryHeight) == 0x000BD0, "Member 'UTileView::EntryHeight' has a wrong offset!");
static_assert(offsetof(UTileView, EntryWidth) == 0x000BD4, "Member 'UTileView::EntryWidth' has a wrong offset!");
static_assert(offsetof(UTileView, TileAlignment) == 0x000BD8, "Member 'UTileView::TileAlignment' has a wrong offset!");
static_assert(offsetof(UTileView, bWrapHorizontalNavigation) == 0x000BD9, "Member 'UTileView::bWrapHorizontalNavigation' has a wrong offset!");
static_assert(offsetof(UTileView, ScrollbarDisabledVisibility) == 0x000BDA, "Member 'UTileView::ScrollbarDisabledVisibility' has a wrong offset!");
static_assert(offsetof(UTileView, bEntrySizeIncludesEntrySpacing) == 0x000BF0, "Member 'UTileView::bEntrySizeIncludesEntrySpacing' has a wrong offset!");
...
static_assert(offsetof(UTreeView, BP_OnGetItemChildren) == 0x000BE0, "Member 'UTreeView::BP_OnGetItemChildren' has a wrong offset!");
static_assert(offsetof(UTreeView, BP_OnItemExpansionChanged) == 0x000BF0, "Member 'UTreeView::BP_OnItemExpansionChanged' has a wrong offset!");
...
static_assert(offsetof(UWidgetComponent, bUseInvalidationInWorldSpace) == 0x000568, "Member 'UWidgetComponent::bUseInvalidationInWorldSpace' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bDrawAtDesiredSize) == 0x000569, "Member 'UWidgetComponent::bDrawAtDesiredSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Pivot) == 0x000570, "Member 'UWidgetComponent::Pivot' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bReceiveHardwareInput) == 0x000580, "Member 'UWidgetComponent::bReceiveHardwareInput' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bWindowFocusable) == 0x000581, "Member 'UWidgetComponent::bWindowFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WindowVisibility) == 0x000582, "Member 'UWidgetComponent::WindowVisibility' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bApplyGammaCorrection) == 0x000583, "Member 'UWidgetComponent::bApplyGammaCorrection' has a wrong offset!");
...
static_assert(offsetof(UWidgetComponent, LayerZOrder) == 0x000608, "Member 'UWidgetComponent::LayerZOrder' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, GeometryMode) == 0x00060C, "Member 'UWidgetComponent::GeometryMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CylinderArcAngle) == 0x000610, "Member 'UWidgetComponent::CylinderArcAngle' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickMode) == 0x000614, "Member 'UWidgetComponent::TickMode' has a wrong offset!");
...
public:
	...
	struct FHitResult                             CustomHitResult;                                   // 0x02E8(0x00E8)(Transient, IsPlainOldData, NoDestructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FVector2D                              LocalHitLocation;                                  // 0x03D0(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector2D                              LastLocalHitLocation;                              // 0x03E0(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWidgetComponent*                       HoveredWidgetComponent;                            // 0x03F0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FHitResult                             LastHitResult;                                     // 0x03F8(0x00E8)(Transient, IsPlainOldData, NoDestructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetInteractable;                      // 0x04E0(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetFocusable;                         // 0x04E1(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetHitTestVisible;                    // 0x04E2(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4E3[0xD];                                      // 0x04E3(0x000D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UWidgetInteractionComponent, OnHoveredWidgetChanged) == 0x000220, "Member 'UWidgetInteractionComponent::OnHoveredWidgetChanged' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, VirtualUserIndex) == 0x000240, "Member 'UWidgetInteractionComponent::VirtualUserIndex' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, PointerIndex) == 0x000244, "Member 'UWidgetInteractionComponent::PointerIndex' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, TraceChannel) == 0x000248, "Member 'UWidgetInteractionComponent::TraceChannel' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, InteractionDistance) == 0x00024C, "Member 'UWidgetInteractionComponent::InteractionDistance' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, InteractionSource) == 0x000250, "Member 'UWidgetInteractionComponent::InteractionSource' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bEnableHitTesting) == 0x000251, "Member 'UWidgetInteractionComponent::bEnableHitTesting' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bShowDebug) == 0x000252, "Member 'UWidgetInteractionComponent::bShowDebug' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugSphereLineThickness) == 0x000254, "Member 'UWidgetInteractionComponent::DebugSphereLineThickness' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugLineThickness) == 0x000258, "Member 'UWidgetInteractionComponent::DebugLineThickness' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugColor) == 0x00025C, "Member 'UWidgetInteractionComponent::DebugColor' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, CustomHitResult) == 0x0002E8, "Member 'UWidgetInteractionComponent::CustomHitResult' has a wrong offset!");
...
static_assert(offsetof(UWidgetInteractionComponent, HoveredWidgetComponent) == 0x0003F0, "Member 'UWidgetInteractionComponent::HoveredWidgetComponent' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastHitResult) == 0x0003F8, "Member 'UWidgetInteractionComponent::LastHitResult' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetInteractable) == 0x0004E0, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetInteractable' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetFocusable) == 0x0004E1, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetHitTestVisible) == 0x0004E2, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetHitTestVisible' has a wrong offset!");
