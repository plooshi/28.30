...
void AGCN_Loop_SpookyMist_C::ExecuteUbergraph_GCN_Loop_SpookyMist(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_GCN_Loop_SpookyMist");
...
void AGCN_Loop_SpookyMist_C::Timeline_Interaction_Fade_In_Out__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Timeline Interaction Fade In Out__FinishedFunc");
...
void AGCN_Loop_SpookyMist_C::Timeline_Interaction_Fade_In_Out__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Timeline Interaction Fade In Out__UpdateFunc");
