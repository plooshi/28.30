...
static_assert(sizeof(ASimObject) == 0x000298, "Wrong size on ASimObject");
...
static_assert(sizeof(UEntityActorComponent) == 0x000088, "Wrong size on UEntityActorComponent");
static_assert(offsetof(UEntityActorComponent, ActorComponent) == 0x000060, "Member 'UEntityActorComponent::ActorComponent' has a wrong offset!");
static_assert(offsetof(UEntityActorComponent, bCreatedActorComponent) == 0x000068, "Member 'UEntityActorComponent::bCreatedActorComponent' has a wrong offset!");
...
static_assert(offsetof(UEntityActorCollisionComponent, ShadowVar_CollisionProfileName) == 0x0000C0, "Member 'UEntityActorCollisionComponent::ShadowVar_CollisionProfileName' has a wrong offset!");
static_assert(offsetof(UEntityActorCollisionComponent, PrimitiveComponentCache) == 0x0000C8, "Member 'UEntityActorCollisionComponent::PrimitiveComponentCache' has a wrong offset!");
static_assert(offsetof(UEntityActorCollisionComponent, CollisionShapeMode) == 0x0000EA, "Member 'UEntityActorCollisionComponent::CollisionShapeMode' has a wrong offset!");
...
static_assert(sizeof(UEntityActorPlayerComponent) == 0x0000D0, "Wrong size on UEntityActorPlayerComponent");
static_assert(offsetof(UEntityActorPlayerComponent, PlayerId) == 0x000060, "Member 'UEntityActorPlayerComponent::PlayerId' has a wrong offset!");
static_assert(offsetof(UEntityActorPlayerComponent, PlayerControllerCache) == 0x000090, "Member 'UEntityActorPlayerComponent::PlayerControllerCache' has a wrong offset!");
static_assert(offsetof(UEntityActorPlayerComponent, PlayerStateCache) == 0x0000B0, "Member 'UEntityActorPlayerComponent::PlayerStateCache' has a wrong offset!");
...
static_assert(offsetof(UEntityActorSkeletalMeshRenderComponent, bAddedMeshRenderComponent) == 0x000060, "Member 'UEntityActorSkeletalMeshRenderComponent::bAddedMeshRenderComponent' has a wrong offset!");
...
static_assert(sizeof(UEntityActorStaticMeshRenderComponent) == 0x0000A0, "Wrong size on UEntityActorStaticMeshRenderComponent");
static_assert(offsetof(UEntityActorStaticMeshRenderComponent, ShadowVar_MeshMaterials) == 0x000088, "Member 'UEntityActorStaticMeshRenderComponent::ShadowVar_MeshMaterials' has a wrong offset!");
static_assert(offsetof(UEntityActorStaticMeshRenderComponent, ShadowVar_EnableCollision) == 0x000098, "Member 'UEntityActorStaticMeshRenderComponent::ShadowVar_EnableCollision' has a wrong offset!");
static_assert(offsetof(UEntityActorStaticMeshRenderComponent, ShadowVar_MaxDrawDistance) == 0x00009C, "Member 'UEntityActorStaticMeshRenderComponent::ShadowVar_MaxDrawDistance' has a wrong offset!");
...
static_assert(sizeof(UEntityActorTextDisplayComponent) == 0x0000B0, "Wrong size on UEntityActorTextDisplayComponent");
static_assert(offsetof(UEntityActorTextDisplayComponent, DisplayText) == 0x000088, "Member 'UEntityActorTextDisplayComponent::DisplayText' has a wrong offset!");
static_assert(offsetof(UEntityActorTextDisplayComponent, ShadowVar_WorldSize) == 0x0000A0, "Member 'UEntityActorTextDisplayComponent::ShadowVar_WorldSize' has a wrong offset!");
static_assert(offsetof(UEntityActorTextDisplayComponent, ShadowVar_TextRenderColor) == 0x0000A4, "Member 'UEntityActorTextDisplayComponent::ShadowVar_TextRenderColor' has a wrong offset!");
static_assert(offsetof(UEntityActorTextDisplayComponent, bAddedTextRenderComponent) == 0x0000A8, "Member 'UEntityActorTextDisplayComponent::bAddedTextRenderComponent' has a wrong offset!");
...
static_assert(sizeof(UEntityActorRotationComponent) == 0x000088, "Wrong size on UEntityActorRotationComponent");
