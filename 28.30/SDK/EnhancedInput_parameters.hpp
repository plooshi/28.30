...
static_assert(sizeof(EnhancedPlayerMappableKeyProfile_DoesMappingPassQueryOptions) == 0x0000B8, "Wrong size on EnhancedPlayerMappableKeyProfile_DoesMappingPassQueryOptions");
...
static_assert(offsetof(EnhancedPlayerMappableKeyProfile_DoesMappingPassQueryOptions, Options) == 0x000088, "Member 'EnhancedPlayerMappableKeyProfile_DoesMappingPassQueryOptions::Options' has a wrong offset!");
static_assert(offsetof(EnhancedPlayerMappableKeyProfile_DoesMappingPassQueryOptions, ReturnValue) == 0x0000B0, "Member 'EnhancedPlayerMappableKeyProfile_DoesMappingPassQueryOptions::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(EnhancedPlayerMappableKeyProfile_K2_FindKeyMapping) == 0x0000B8, "Wrong size on EnhancedPlayerMappableKeyProfile_K2_FindKeyMapping");
...
static_assert(offsetof(EnhancedPlayerMappableKeyProfile_K2_FindKeyMapping, InArgs) == 0x000088, "Member 'EnhancedPlayerMappableKeyProfile_K2_FindKeyMapping::InArgs' has a wrong offset!");
...
static_assert(sizeof(EnhancedInputUserSettings_ResetAllPlayerKeysInRow) == 0x000050, "Wrong size on EnhancedInputUserSettings_ResetAllPlayerKeysInRow");
...
static_assert(offsetof(EnhancedInputUserSettings_ResetAllPlayerKeysInRow, FailureReason) == 0x000030, "Member 'EnhancedInputUserSettings_ResetAllPlayerKeysInRow::FailureReason' has a wrong offset!");
...
static_assert(sizeof(EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot) == 0x000010, "Wrong size on EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot");
...
static_assert(offsetof(EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot, KeySlot) == 0x000004, "Member 'EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot::KeySlot' has a wrong offset!");
static_assert(offsetof(EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot, Options) == 0x000008, "Member 'EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot::Options' has a wrong offset!");
static_assert(offsetof(EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot, ReturnValue) == 0x00000C, "Member 'EnhancedInputSubsystemInterface_K2_RemovePlayerMappedKeyInSlot::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(EnhancedInputSubsystemInterface_StopContinuousInputInjectionForPlayerMapping) == 0x000004, "Wrong size on EnhancedInputSubsystemInterface_StopContinuousInputInjectionForPlayerMapping");
...
static_assert(sizeof(EnhancedInputSubsystemInterface_K2_GetPlayerMappedKeyInSlot) == 0x000020, "Wrong size on EnhancedInputSubsystemInterface_K2_GetPlayerMappedKeyInSlot");
...
static_assert(offsetof(EnhancedInputSubsystemInterface_K2_GetPlayerMappedKeyInSlot, KeySlot) == 0x000004, "Member 'EnhancedInputSubsystemInterface_K2_GetPlayerMappedKeyInSlot::KeySlot' has a wrong offset!");
static_assert(offsetof(EnhancedInputSubsystemInterface_K2_GetPlayerMappedKeyInSlot, ReturnValue) == 0x000008, "Member 'EnhancedInputSubsystemInterface_K2_GetPlayerMappedKeyInSlot::ReturnValue' has a wrong offset!");
