...
static_assert(alignof(UTextStyle_Button_Feature_L_Disabled_C) == 0x000010, "Wrong alignment on UTextStyle_Button_Feature_L_Disabled_C");
static_assert(sizeof(UTextStyle_Button_Feature_L_Disabled_C) == 0x0001A0, "Wrong size on UTextStyle_Button_Feature_L_Disabled_C");
