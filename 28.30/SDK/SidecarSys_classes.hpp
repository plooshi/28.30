...
static_assert(offsetof(USidecarInventorySys, InventoryDownloadUrl) == 0x000030, "Member 'USidecarInventorySys::InventoryDownloadUrl' has a wrong offset!");
static_assert(offsetof(USidecarInventorySys, InventoryLockUrl) == 0x000040, "Member 'USidecarInventorySys::InventoryLockUrl' has a wrong offset!");
static_assert(offsetof(USidecarInventorySys, ItemUpdateUrl) == 0x000050, "Member 'USidecarInventorySys::ItemUpdateUrl' has a wrong offset!");
