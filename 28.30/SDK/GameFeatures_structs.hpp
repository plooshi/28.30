...
static_assert(sizeof(FGameFeatureComponentEntry) == 0x000048, "Wrong size on FGameFeatureComponentEntry");
...
static_assert(offsetof(FGameFeatureComponentEntry, ComponentClass) == 0x000020, "Member 'FGameFeatureComponentEntry::ComponentClass' has a wrong offset!");
...
static_assert(sizeof(FDataRegistrySourceToAdd) == 0x000050, "Wrong size on FDataRegistrySourceToAdd");
...
static_assert(offsetof(FDataRegistrySourceToAdd, CurveTableToAdd) == 0x000030, "Member 'FDataRegistrySourceToAdd::CurveTableToAdd' has a wrong offset!");
