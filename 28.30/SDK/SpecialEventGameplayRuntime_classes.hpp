...
static_assert(sizeof(AFortAthenaMutator_SpecialEventTODM) == 0x000378, "Wrong size on AFortAthenaMutator_SpecialEventTODM");
static_assert(offsetof(AFortAthenaMutator_SpecialEventTODM, PhaseDataArray) == 0x000338, "Member 'AFortAthenaMutator_SpecialEventTODM::PhaseDataArray' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEventTODM, SpecialEventScript) == 0x000348, "Member 'AFortAthenaMutator_SpecialEventTODM::SpecialEventScript' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEventTODM, PhaseIndexInProgress) == 0x000350, "Member 'AFortAthenaMutator_SpecialEventTODM::PhaseIndexInProgress' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEventTODM, SubphaseIndexInProgress) == 0x000354, "Member 'AFortAthenaMutator_SpecialEventTODM::SubphaseIndexInProgress' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEventTODM, SpawnedTODM) == 0x000360, "Member 'AFortAthenaMutator_SpecialEventTODM::SpawnedTODM' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEventTODM, bDebug) == 0x000370, "Member 'AFortAthenaMutator_SpecialEventTODM::bDebug' has a wrong offset!");
...
static_assert(sizeof(AFortAthenaMutator_DestroyActorsAndComponents) == 0x000368, "Wrong size on AFortAthenaMutator_DestroyActorsAndComponents");
static_assert(offsetof(AFortAthenaMutator_DestroyActorsAndComponents, ActorDefinitions) == 0x000338, "Member 'AFortAthenaMutator_DestroyActorsAndComponents::ActorDefinitions' has a wrong offset!");
...
static_assert(sizeof(AFortAthenaMutator_FakeKillRelevancy) == 0x0004A0, "Wrong size on AFortAthenaMutator_FakeKillRelevancy");
static_assert(offsetof(AFortAthenaMutator_FakeKillRelevancy, FakeKillControllerComponentClass) == 0x000440, "Member 'AFortAthenaMutator_FakeKillRelevancy::FakeKillControllerComponentClass' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_FakeKillRelevancy, RelevancyPhaseDataArray) == 0x000448, "Member 'AFortAthenaMutator_FakeKillRelevancy::RelevancyPhaseDataArray' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_FakeKillRelevancy, PhaseNum) == 0x000458, "Member 'AFortAthenaMutator_FakeKillRelevancy::PhaseNum' has a wrong offset!");
...
static_assert(sizeof(AFortAthenaMutator_LoadGameFeature) == 0x000348, "Wrong size on AFortAthenaMutator_LoadGameFeature");
static_assert(offsetof(AFortAthenaMutator_LoadGameFeature, GameFeatureToLoad) == 0x000338, "Member 'AFortAthenaMutator_LoadGameFeature::GameFeatureToLoad' has a wrong offset!");
...
static_assert(sizeof(AFortAthenaMutator_RemoveGameFeatures) == 0x000348, "Wrong size on AFortAthenaMutator_RemoveGameFeatures");
static_assert(offsetof(AFortAthenaMutator_RemoveGameFeatures, AllowedGameFeatures) == 0x000338, "Member 'AFortAthenaMutator_RemoveGameFeatures::AllowedGameFeatures' has a wrong offset!");
...
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, TeleportAllPlayersFinished) == 0x000338, "Member 'AFortAthenaMutator_SpecialEvent::TeleportAllPlayersFinished' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, OnPawnLoaded) == 0x000348, "Member 'AFortAthenaMutator_SpecialEvent::OnPawnLoaded' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, OnInitController) == 0x000358, "Member 'AFortAthenaMutator_SpecialEvent::OnInitController' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, OnResumeGame) == 0x000368, "Member 'AFortAthenaMutator_SpecialEvent::OnResumeGame' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, OnSpecialClientEvent) == 0x000378, "Member 'AFortAthenaMutator_SpecialEvent::OnSpecialClientEvent' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, OnHandleLogout) == 0x000388, "Member 'AFortAthenaMutator_SpecialEvent::OnHandleLogout' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, OnClientInitialLoadingFinished) == 0x000398, "Member 'AFortAthenaMutator_SpecialEvent::OnClientInitialLoadingFinished' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bPlayersAreInvincible) == 0x000410, "Member 'AFortAthenaMutator_SpecialEvent::bPlayersAreInvincible' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, MinimumScoreBumpForAutomadeGoal) == 0x000438, "Member 'AFortAthenaMutator_SpecialEvent::MinimumScoreBumpForAutomadeGoal' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, ScoreBrackets) == 0x000440, "Member 'AFortAthenaMutator_SpecialEvent::ScoreBrackets' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bEnforceInfiniteSafeZonePhase) == 0x000450, "Member 'AFortAthenaMutator_SpecialEvent::bEnforceInfiniteSafeZonePhase' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, WarmupIslandPlayerStartTag) == 0x000454, "Member 'AFortAthenaMutator_SpecialEvent::WarmupIslandPlayerStartTag' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bAllowInventoryOpen) == 0x000458, "Member 'AFortAthenaMutator_SpecialEvent::bAllowInventoryOpen' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bAllowFullScreenMap) == 0x000460, "Member 'AFortAthenaMutator_SpecialEvent::bAllowFullScreenMap' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bShouldClearFrontEndMapMarkers) == 0x000488, "Member 'AFortAthenaMutator_SpecialEvent::bShouldClearFrontEndMapMarkers' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bBlockTeamIndicators) == 0x000489, "Member 'AFortAthenaMutator_SpecialEvent::bBlockTeamIndicators' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, ForceDisplaySquadInfoDuringGamePhases) == 0x00048C, "Member 'AFortAthenaMutator_SpecialEvent::ForceDisplaySquadInfoDuringGamePhases' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bAllowSquadListLocalPlayerInSplitscreen) == 0x000490, "Member 'AFortAthenaMutator_SpecialEvent::bAllowSquadListLocalPlayerInSplitscreen' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, UIToHideDuringSpecialEvent) == 0x000498, "Member 'AFortAthenaMutator_SpecialEvent::UIToHideDuringSpecialEvent' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, UIToHideWhenInInfiniteWarmup) == 0x0004B8, "Member 'AFortAthenaMutator_SpecialEvent::UIToHideWhenInInfiniteWarmup' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, ClientEventsThatUnhideHiddenWhileLoadingHUDElements) == 0x0004D8, "Member 'AFortAthenaMutator_SpecialEvent::ClientEventsThatUnhideHiddenWhileLoadingHUDElements' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bSkipPostGameScreens) == 0x0004F8, "Member 'AFortAthenaMutator_SpecialEvent::bSkipPostGameScreens' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bForceGarbageCollectionAfterUnloadOnServer) == 0x0004F9, "Member 'AFortAthenaMutator_SpecialEvent::bForceGarbageCollectionAfterUnloadOnServer' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bForceGarbageCollectionAfterUnloadOnClient) == 0x0004FA, "Member 'AFortAthenaMutator_SpecialEvent::bForceGarbageCollectionAfterUnloadOnClient' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bFullPurgeGC) == 0x0004FB, "Member 'AFortAthenaMutator_SpecialEvent::bFullPurgeGC' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, EventAircraft) == 0x000500, "Member 'AFortAthenaMutator_SpecialEvent::EventAircraft' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, EventAircraftInfo) == 0x000508, "Member 'AFortAthenaMutator_SpecialEvent::EventAircraftInfo' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, EventAircraftClass) == 0x000550, "Member 'AFortAthenaMutator_SpecialEvent::EventAircraftClass' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, ScriptActor) == 0x000558, "Member 'AFortAthenaMutator_SpecialEvent::ScriptActor' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bDisableHUD) == 0x000560, "Member 'AFortAthenaMutator_SpecialEvent::bDisableHUD' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, GameResumed) == 0x000561, "Member 'AFortAthenaMutator_SpecialEvent::GameResumed' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, AdditionalViewpoint) == 0x000568, "Member 'AFortAthenaMutator_SpecialEvent::AdditionalViewpoint' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bParachutesDisabled) == 0x000580, "Member 'AFortAthenaMutator_SpecialEvent::bParachutesDisabled' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, LastCSVEventName) == 0x000588, "Member 'AFortAthenaMutator_SpecialEvent::LastCSVEventName' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bCanStreamBuildingFoundationsIn) == 0x000598, "Member 'AFortAthenaMutator_SpecialEvent::bCanStreamBuildingFoundationsIn' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, AllPlayerTeleportedCount) == 0x00059C, "Member 'AFortAthenaMutator_SpecialEvent::AllPlayerTeleportedCount' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, DelayPlayersFromReturningToLobbyData) == 0x0005A0, "Member 'AFortAthenaMutator_SpecialEvent::DelayPlayersFromReturningToLobbyData' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, NamedWeightForContainerLootRoll) == 0x0005B0, "Member 'AFortAthenaMutator_SpecialEvent::NamedWeightForContainerLootRoll' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, WeightForContainerLootRoll) == 0x0005B4, "Member 'AFortAthenaMutator_SpecialEvent::WeightForContainerLootRoll' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, SpecialEventEmoteData) == 0x0005E8, "Member 'AFortAthenaMutator_SpecialEvent::SpecialEventEmoteData' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, BlockedNativeActions) == 0x0005F8, "Member 'AFortAthenaMutator_SpecialEvent::BlockedNativeActions' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, DesiredQuickbarItemTypeAfterRemove) == 0x000618, "Member 'AFortAthenaMutator_SpecialEvent::DesiredQuickbarItemTypeAfterRemove' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, SpecialEventsInputComponent) == 0x000620, "Member 'AFortAthenaMutator_SpecialEvent::SpecialEventsInputComponent' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bLockingOnFocalPoint) == 0x000628, "Member 'AFortAthenaMutator_SpecialEvent::bLockingOnFocalPoint' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, SpecialEventOverrideParts) == 0x000630, "Member 'AFortAthenaMutator_SpecialEvent::SpecialEventOverrideParts' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, GameplayEffectToApplyOnSwapToDefault) == 0x000640, "Member 'AFortAthenaMutator_SpecialEvent::GameplayEffectToApplyOnSwapToDefault' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, OverridePartsArrayIndexMap) == 0x000650, "Member 'AFortAthenaMutator_SpecialEvent::OverridePartsArrayIndexMap' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, GameplayEffectsToApplyOnLogin) == 0x0006A0, "Member 'AFortAthenaMutator_SpecialEvent::GameplayEffectsToApplyOnLogin' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, ControllerComponentClassOverride) == 0x0006B0, "Member 'AFortAthenaMutator_SpecialEvent::ControllerComponentClassOverride' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, TerrainMapsToUnload) == 0x0006B8, "Member 'AFortAthenaMutator_SpecialEvent::TerrainMapsToUnload' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, UnhandledPlayerControllers) == 0x0006D8, "Member 'AFortAthenaMutator_SpecialEvent::UnhandledPlayerControllers' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, HLODActorsToHideNames) == 0x0006E8, "Member 'AFortAthenaMutator_SpecialEvent::HLODActorsToHideNames' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bForceAllowCloth) == 0x0006F8, "Member 'AFortAthenaMutator_SpecialEvent::bForceAllowCloth' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bManageBackfill) == 0x0006FA, "Member 'AFortAthenaMutator_SpecialEvent::bManageBackfill' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, PlayerCountToTriggerBackfill) == 0x0006FC, "Member 'AFortAthenaMutator_SpecialEvent::PlayerCountToTriggerBackfill' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bWaitForPlayerCountToTriggerBackfill) == 0x000700, "Member 'AFortAthenaMutator_SpecialEvent::bWaitForPlayerCountToTriggerBackfill' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, UpdateBackfillStatusTime) == 0x000704, "Member 'AFortAthenaMutator_SpecialEvent::UpdateBackfillStatusTime' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bServerHasBackfillActive) == 0x000718, "Member 'AFortAthenaMutator_SpecialEvent::bServerHasBackfillActive' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_SpecialEvent, bCanToggleCursorModeInStasis) == 0x000719, "Member 'AFortAthenaMutator_SpecialEvent::bCanToggleCursorModeInStasis' has a wrong offset!");
...
{
public:
	float                                         OverrideTransitionTime;                            // 0x1BA8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1BAC[0x4];                                     // 0x1BAC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFortCameraMode_SpecialEventFocalPoint) == 0x001BB0, "Wrong size on UFortCameraMode_SpecialEventFocalPoint");
static_assert(offsetof(UFortCameraMode_SpecialEventFocalPoint, OverrideTransitionTime) == 0x001BA8, "Member 'UFortCameraMode_SpecialEventFocalPoint::OverrideTransitionTime' has a wrong offset!");
...
static_assert(sizeof(AFortCharacterMovementMutator) == 0x000340, "Wrong size on AFortCharacterMovementMutator");
static_assert(offsetof(AFortCharacterMovementMutator, MovementMutatorComponentClass) == 0x000338, "Member 'AFortCharacterMovementMutator::MovementMutatorComponentClass' has a wrong offset!");
...
static_assert(offsetof(UFortControllerComponent_SpecialEvent, bForceBuildModeInputComponentToNotConsumeInputs) == 0x0000A8, "Member 'UFortControllerComponent_SpecialEvent::bForceBuildModeInputComponentToNotConsumeInputs' has a wrong offset!");
static_assert(offsetof(UFortControllerComponent_SpecialEvent, SpecialEventMutator) == 0x0000AC, "Member 'UFortControllerComponent_SpecialEvent::SpecialEventMutator' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class USpecialEventCursorPawnComponent* CursorPawnComponent, struct FVector2D& NormalizedLocation, struct FVector2D& ViewportLocation)> OnViewportLocationChanged;                         // 0x01C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_2B8[0xF1];                                     // 0x02B8(0x00F1)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bAdditiveRotationAllowedByDefault;                 // 0x03A9(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3AA[0x1];                                      // 0x03AA(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bZoomAllowedByDefault;                             // 0x03AB(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   ZoomActionName;                                    // 0x03AC(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3B0[0x8];                                      // 0x03B0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UCameraComponent*                       AdditiveOffsetCameraComponent;                     // 0x03B8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USpecialEventCursorPawnComponent) == 0x0003C8, "Wrong size on USpecialEventCursorPawnComponent");
...
static_assert(offsetof(USpecialEventCursorPawnComponent, OnViewportLocationChanged) == 0x0001C8, "Member 'USpecialEventCursorPawnComponent::OnViewportLocationChanged' has a wrong offset!");
static_assert(offsetof(USpecialEventCursorPawnComponent, NonOwningInterpSpeed) == 0x0001D8, "Member 'USpecialEventCursorPawnComponent::NonOwningInterpSpeed' has a wrong offset!");
static_assert(offsetof(USpecialEventCursorPawnComponent, MinDeltaToSendWorldLocationToServer) == 0x000200, "Member 'USpecialEventCursorPawnComponent::MinDeltaToSendWorldLocationToServer' has a wrong offset!");
static_assert(offsetof(USpecialEventCursorPawnComponent, ReplicatedWorldLocation) == 0x000230, "Member 'USpecialEventCursorPawnComponent::ReplicatedWorldLocation' has a wrong offset!");
static_assert(offsetof(USpecialEventCursorPawnComponent, Widgets) == 0x0002A8, "Member 'USpecialEventCursorPawnComponent::Widgets' has a wrong offset!");
static_assert(offsetof(USpecialEventCursorPawnComponent, bAdditiveRotationAllowedByDefault) == 0x0003A9, "Member 'USpecialEventCursorPawnComponent::bAdditiveRotationAllowedByDefault' has a wrong offset!");
static_assert(offsetof(USpecialEventCursorPawnComponent, bZoomAllowedByDefault) == 0x0003AB, "Member 'USpecialEventCursorPawnComponent::bZoomAllowedByDefault' has a wrong offset!");
static_assert(offsetof(USpecialEventCursorPawnComponent, ZoomActionName) == 0x0003AC, "Member 'USpecialEventCursorPawnComponent::ZoomActionName' has a wrong offset!");
static_assert(offsetof(USpecialEventCursorPawnComponent, AdditiveOffsetCameraComponent) == 0x0003B8, "Member 'USpecialEventCursorPawnComponent::AdditiveOffsetCameraComponent' has a wrong offset!");
...
static_assert(offsetof(ASpecialEventPhase, PhaseTag) == 0x0002A8, "Member 'ASpecialEventPhase::PhaseTag' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, LevelSequence) == 0x0002B0, "Member 'ASpecialEventPhase::LevelSequence' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, LevelSequenceTime) == 0x0002D0, "Member 'ASpecialEventPhase::LevelSequenceTime' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, bApplyGameplayEffects) == 0x0002D4, "Member 'ASpecialEventPhase::bApplyGameplayEffects' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, GameplayEffectsToApply) == 0x0002D8, "Member 'ASpecialEventPhase::GameplayEffectsToApply' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, ControllerComponentsToApplyInfoList) == 0x0002E8, "Member 'ASpecialEventPhase::ControllerComponentsToApplyInfoList' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, PawnComponentsToApplyInfoList) == 0x0002F8, "Member 'ASpecialEventPhase::PawnComponentsToApplyInfoList' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, CameraModifierToApply) == 0x000308, "Member 'ASpecialEventPhase::CameraModifierToApply' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, bRemoveModifierOnPhaseDeactivation) == 0x000310, "Member 'ASpecialEventPhase::bRemoveModifierOnPhaseDeactivation' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, bRemoveGameplayEffects) == 0x000311, "Member 'ASpecialEventPhase::bRemoveGameplayEffects' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, GameplayEffectsToRemove) == 0x000318, "Member 'ASpecialEventPhase::GameplayEffectsToRemove' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, ControllerComponentsToRemoveInfoList) == 0x000328, "Member 'ASpecialEventPhase::ControllerComponentsToRemoveInfoList' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, PawnComponentsToRemoveInfoList) == 0x000338, "Member 'ASpecialEventPhase::PawnComponentsToRemoveInfoList' has a wrong offset!");
static_assert(offsetof(ASpecialEventPhase, AppliedCameraModifier) == 0x000348, "Member 'ASpecialEventPhase::AppliedCameraModifier' has a wrong offset!");
...
{
public:
	uint8                                         bDisableCollisionOnBeginPlay : 1;                  // 0x0630(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bDisableComponentsTickOnServer : 1;                // 0x0630(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRegisterWithSpecialEventMutatorOnClient : 1;      // 0x0630(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bDestroyUnusedSkeletalMeshComponentsOnClientFirstInitialization : 1; // 0x0630(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(sizeof(ASpecialEventPlayerMannequin) == 0x000638, "Wrong size on ASpecialEventPlayerMannequin");
...
static_assert(offsetof(ASpecialEventScript, OnSpecialEventPhaseActivated) == 0x000290, "Member 'ASpecialEventScript::OnSpecialEventPhaseActivated' has a wrong offset!");
static_assert(offsetof(ASpecialEventScript, OnSpecialEventPhaseDeactivated) == 0x0002A0, "Member 'ASpecialEventScript::OnSpecialEventPhaseDeactivated' has a wrong offset!");
static_assert(offsetof(ASpecialEventScript, PhaseInfoArray) == 0x0002B0, "Member 'ASpecialEventScript::PhaseInfoArray' has a wrong offset!");
...
static_assert(sizeof(ASpecialEventScriptMeshActor) == 0x0002C0, "Wrong size on ASpecialEventScriptMeshActor");
static_assert(offsetof(ASpecialEventScriptMeshActor, RootStartTime) == 0x000290, "Member 'ASpecialEventScriptMeshActor::RootStartTime' has a wrong offset!");
static_assert(offsetof(ASpecialEventScriptMeshActor, CalendarEventName) == 0x000298, "Member 'ASpecialEventScriptMeshActor::CalendarEventName' has a wrong offset!");
static_assert(offsetof(ASpecialEventScriptMeshActor, CalenderEventOffsetInSeconds) == 0x0002A8, "Member 'ASpecialEventScriptMeshActor::CalenderEventOffsetInSeconds' has a wrong offset!");
static_assert(offsetof(ASpecialEventScriptMeshActor, EncryptionKeyDeliveryTimeOffset) == 0x0002AC, "Member 'ASpecialEventScriptMeshActor::EncryptionKeyDeliveryTimeOffset' has a wrong offset!");
static_assert(offsetof(ASpecialEventScriptMeshActor, MeshNetworkComponent) == 0x0002B8, "Member 'ASpecialEventScriptMeshActor::MeshNetworkComponent' has a wrong offset!");
