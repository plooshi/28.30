...
static_assert(sizeof(MainMenuButton_C_ExecuteUbergraph_MainMenuButton) == 0x000040, "Wrong size on MainMenuButton_C_ExecuteUbergraph_MainMenuButton");
...
static_assert(offsetof(MainMenuButton_C_ExecuteUbergraph_MainMenuButton, K2Node_Event_IsDesignTime) == 0x000028, "Member 'MainMenuButton_C_ExecuteUbergraph_MainMenuButton::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(MainMenuButton_C_ExecuteUbergraph_MainMenuButton, K2Node_CustomEvent_Color) == 0x00002C, "Member 'MainMenuButton_C_ExecuteUbergraph_MainMenuButton::K2Node_CustomEvent_Color' has a wrong offset!");
static_assert(offsetof(MainMenuButton_C_ExecuteUbergraph_MainMenuButton, K2Node_Select_Default) == 0x00003C, "Member 'MainMenuButton_C_ExecuteUbergraph_MainMenuButton::K2Node_Select_Default' has a wrong offset!");
...
static_assert(sizeof(MainMenuButton_C_UpdateRightSideIcon) == 0x000020, "Wrong size on MainMenuButton_C_UpdateRightSideIcon");
