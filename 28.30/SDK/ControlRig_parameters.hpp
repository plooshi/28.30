...
static_assert(offsetof(RigHierarchy_SetConnectorSettings, InSettings) == 0x000008, "Member 'RigHierarchy_SetConnectorSettings::InSettings' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetConnectorSettings, bSetupUndo) == 0x000030, "Member 'RigHierarchy_SetConnectorSettings::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetConnectorSettings, bForce) == 0x000031, "Member 'RigHierarchy_SetConnectorSettings::bForce' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetConnectorSettings, bPrintPythonCommands) == 0x000032, "Member 'RigHierarchy_SetConnectorSettings::bPrintPythonCommands' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_SetControlPreferredEulerAngles, InEulerAngles) == 0x000008, "Member 'RigHierarchy_SetControlPreferredEulerAngles::InEulerAngles' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlPreferredEulerAngles, InRotationOrder) == 0x000020, "Member 'RigHierarchy_SetControlPreferredEulerAngles::InRotationOrder' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlPreferredEulerAngles, bInitial) == 0x000021, "Member 'RigHierarchy_SetControlPreferredEulerAngles::bInitial' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlPreferredEulerAngles, bFixEulerFlips) == 0x000022, "Member 'RigHierarchy_SetControlPreferredEulerAngles::bFixEulerFlips' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_SetControlPreferredRotationOrder, InRotationOrder) == 0x000008, "Member 'RigHierarchy_SetControlPreferredRotationOrder::InRotationOrder' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_SetControlPreferredRotator, InRotator) == 0x000008, "Member 'RigHierarchy_SetControlPreferredRotator::InRotator' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_SetControlSettings, InSettings) == 0x000008, "Member 'RigHierarchy_SetControlSettings::InSettings' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlSettings, bSetupUndo) == 0x0001B8, "Member 'RigHierarchy_SetControlSettings::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlSettings, bForce) == 0x0001B9, "Member 'RigHierarchy_SetControlSettings::bForce' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlSettings, bPrintPythonCommands) == 0x0001BA, "Member 'RigHierarchy_SetControlSettings::bPrintPythonCommands' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_SetControlValue, InValue) == 0x000008, "Member 'RigHierarchy_SetControlValue::InValue' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlValue, InValueType) == 0x00008C, "Member 'RigHierarchy_SetControlValue::InValueType' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlValue, bSetupUndo) == 0x00008D, "Member 'RigHierarchy_SetControlValue::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchy_SetControlValue, bPrintPythonCommands) == 0x00008E, "Member 'RigHierarchy_SetControlValue::bPrintPythonCommands' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_GetControlPreferredEulerAngles, InRotationOrder) == 0x000008, "Member 'RigHierarchy_GetControlPreferredEulerAngles::InRotationOrder' has a wrong offset!");
static_assert(offsetof(RigHierarchy_GetControlPreferredEulerAngles, bInitial) == 0x000009, "Member 'RigHierarchy_GetControlPreferredEulerAngles::bInitial' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_GetControlPreferredEulerRotationOrder, bFromSettings) == 0x000008, "Member 'RigHierarchy_GetControlPreferredEulerRotationOrder::bFromSettings' has a wrong offset!");
static_assert(offsetof(RigHierarchy_GetControlPreferredEulerRotationOrder, ReturnValue) == 0x000009, "Member 'RigHierarchy_GetControlPreferredEulerRotationOrder::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_GetControlValue, ReturnValue) == 0x00000C, "Member 'RigHierarchy_GetControlValue::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_GetLocalIndex_ForBlueprint, ReturnValue) == 0x000008, "Member 'RigHierarchy_GetLocalIndex_ForBlueprint::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_GetModulePath, ReturnValue) == 0x000008, "Member 'RigHierarchy_GetModulePath::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_GetModulePathFName, ReturnValue) == 0x000008, "Member 'RigHierarchy_GetModulePathFName::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_GetNameSpace, ReturnValue) == 0x000008, "Member 'RigHierarchy_GetNameSpace::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchy_GetNameSpaceFName, ReturnValue) == 0x000008, "Member 'RigHierarchy_GetNameSpaceFName::ReturnValue' has a wrong offset!");
...
public:
	...
	class FText                                   OutErrorMessage;                                   // 0x0010(0x0018)(Parm, OutParm, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0028(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(ModularRigController_CanConnectConnectorToElement, InTargetKey) == 0x000008, "Member 'ModularRigController_CanConnectConnectorToElement::InTargetKey' has a wrong offset!");
static_assert(offsetof(ModularRigController_CanConnectConnectorToElement, OutErrorMessage) == 0x000010, "Member 'ModularRigController_CanConnectConnectorToElement::OutErrorMessage' has a wrong offset!");
...
static_assert(offsetof(ModularRigController_ConnectConnectorToElement, InTargetKey) == 0x000008, "Member 'ModularRigController_ConnectConnectorToElement::InTargetKey' has a wrong offset!");
static_assert(offsetof(ModularRigController_ConnectConnectorToElement, bSetupUndo) == 0x000010, "Member 'ModularRigController_ConnectConnectorToElement::bSetupUndo' has a wrong offset!");
static_assert(offsetof(ModularRigController_ConnectConnectorToElement, bAutoResolveOtherConnectors) == 0x000011, "Member 'ModularRigController_ConnectConnectorToElement::bAutoResolveOtherConnectors' has a wrong offset!");
static_assert(offsetof(ModularRigController_ConnectConnectorToElement, ReturnValue) == 0x000012, "Member 'ModularRigController_ConnectConnectorToElement::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ModularRigController_DisconnectConnector, bSetupUndo) == 0x000008, "Member 'ModularRigController_DisconnectConnector::bSetupUndo' has a wrong offset!");
static_assert(offsetof(ModularRigController_DisconnectConnector, ReturnValue) == 0x000009, "Member 'ModularRigController_DisconnectConnector::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ModularRigController_RenameModule, bSetupUndo) == 0x000014, "Member 'ModularRigController_RenameModule::bSetupUndo' has a wrong offset!");
static_assert(offsetof(ModularRigController_RenameModule, ReturnValue) == 0x000018, "Member 'ModularRigController_RenameModule::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ModularRigController_UnBindModuleVariable, bSetupUndo) == 0x000014, "Member 'ModularRigController_UnBindModuleVariable::bSetupUndo' has a wrong offset!");
static_assert(offsetof(ModularRigController_UnBindModuleVariable, ReturnValue) == 0x000015, "Member 'ModularRigController_UnBindModuleVariable::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchyController_AddAnimationChannel_ForBlueprint, bSetupUndo) == 0x0001C0, "Member 'RigHierarchyController_AddAnimationChannel_ForBlueprint::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddAnimationChannel_ForBlueprint, bPrintPythonCommand) == 0x0001C1, "Member 'RigHierarchyController_AddAnimationChannel_ForBlueprint::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddAnimationChannel_ForBlueprint, ReturnValue) == 0x0001C4, "Member 'RigHierarchyController_AddAnimationChannel_ForBlueprint::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchyController_AddControl_ForBlueprint, InValue) == 0x0001C0, "Member 'RigHierarchyController_AddControl_ForBlueprint::InValue' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddControl_ForBlueprint, bSetupUndo) == 0x000244, "Member 'RigHierarchyController_AddControl_ForBlueprint::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddControl_ForBlueprint, bPrintPythonCommand) == 0x000245, "Member 'RigHierarchyController_AddControl_ForBlueprint::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddControl_ForBlueprint, ReturnValue) == 0x000248, "Member 'RigHierarchyController_AddControl_ForBlueprint::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchyController_AddSocket, InParent) == 0x000004, "Member 'RigHierarchyController_AddSocket::InParent' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddSocket, InTransform) == 0x000010, "Member 'RigHierarchyController_AddSocket::InTransform' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddSocket, bTransformInGlobal) == 0x000070, "Member 'RigHierarchyController_AddSocket::bTransformInGlobal' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddSocket, InColor) == 0x000074, "Member 'RigHierarchyController_AddSocket::InColor' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddSocket, InDescription) == 0x000088, "Member 'RigHierarchyController_AddSocket::InDescription' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddSocket, bSetupUndo) == 0x000098, "Member 'RigHierarchyController_AddSocket::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddSocket, bPrintPythonCommand) == 0x000099, "Member 'RigHierarchyController_AddSocket::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddSocket, ReturnValue) == 0x00009C, "Member 'RigHierarchyController_AddSocket::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchyController_ReorderElement, InIndex) == 0x000008, "Member 'RigHierarchyController_ReorderElement::InIndex' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_ReorderElement, bSetupUndo) == 0x00000C, "Member 'RigHierarchyController_ReorderElement::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_ReorderElement, bPrintPythonCommand) == 0x00000D, "Member 'RigHierarchyController_ReorderElement::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_ReorderElement, ReturnValue) == 0x00000E, "Member 'RigHierarchyController_ReorderElement::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchyController_GetControlSettings, ReturnValue) == 0x000008, "Member 'RigHierarchyController_GetControlSettings::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RigHierarchyController_SetControlSettings, InSettings) == 0x000008, "Member 'RigHierarchyController_SetControlSettings::InSettings' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_SetControlSettings, bSetupUndo) == 0x0001B8, "Member 'RigHierarchyController_SetControlSettings::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_SetControlSettings, ReturnValue) == 0x0001B9, "Member 'RigHierarchyController_SetControlSettings::ReturnValue' has a wrong offset!");
