...
{
public:
	uint8                                         Pad_F8[0xD8];                                      // 0x00F8(0x00D8)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPlayspaceComponent_SidewaysDimension) == 0x0001D8, "Wrong size on UPlayspaceComponent_SidewaysDimension");
static_assert(offsetof(UPlayspaceComponent_SidewaysDimension, CachedAIServiceLoot) == 0x0001D0, "Member 'UPlayspaceComponent_SidewaysDimension::CachedAIServiceLoot' has a wrong offset!");
...
static_assert(sizeof(USidewaysStateComponent_Player) == 0x000110, "Wrong size on USidewaysStateComponent_Player");
...
static_assert(offsetof(USidewaysStateComponent_Player, SidewaysBubbleLocationParameterNamesForLocalPlayers) == 0x0000E8, "Member 'USidewaysStateComponent_Player::SidewaysBubbleLocationParameterNamesForLocalPlayers' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, SidewaysBubbleRadiusParameterNamesForLocalPlayers) == 0x0000F0, "Member 'USidewaysStateComponent_Player::SidewaysBubbleRadiusParameterNamesForLocalPlayers' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, ExtraCorruptionRadius) == 0x0000F8, "Member 'USidewaysStateComponent_Player::ExtraCorruptionRadius' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, MinRadiusToHaveAnyCorruption) == 0x0000FC, "Member 'USidewaysStateComponent_Player::MinRadiusToHaveAnyCorruption' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, MaxRadiusForScalingExtraCorruptionRadius) == 0x000100, "Member 'USidewaysStateComponent_Player::MaxRadiusForScalingExtraCorruptionRadius' has a wrong offset!");
static_assert(offsetof(USidewaysStateComponent_Player, UpdateFrequency) == 0x000104, "Member 'USidewaysStateComponent_Player::UpdateFrequency' has a wrong offset!");
...
static_assert(sizeof(USidewaysFeatureAction_HoldGlobalData) == 0x000058, "Wrong size on USidewaysFeatureAction_HoldGlobalData");
...
static_assert(offsetof(USidewaysFeatureAction_HoldGlobalData, SidewaysBubbleLocationParameterNamesForLocalPlayers) == 0x000048, "Member 'USidewaysFeatureAction_HoldGlobalData::SidewaysBubbleLocationParameterNamesForLocalPlayers' has a wrong offset!");
static_assert(offsetof(USidewaysFeatureAction_HoldGlobalData, SidewaysBubbleRadiusParameterNamesForLocalPlayers) == 0x000050, "Member 'USidewaysFeatureAction_HoldGlobalData::SidewaysBubbleRadiusParameterNamesForLocalPlayers' has a wrong offset!");
...
static_assert(sizeof(ASidewaysPlayspace) == 0x0006E8, "Wrong size on ASidewaysPlayspace");
...
static_assert(sizeof(ASidewaysVolume) == 0x000330, "Wrong size on ASidewaysVolume");
