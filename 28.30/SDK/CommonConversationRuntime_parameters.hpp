...
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, ConversationEntryTag) == 0x000000, "Member 'ConversationLibrary_StartConversationFromGraph::ConversationEntryTag' has a wrong offset!");
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, Instigator) == 0x000008, "Member 'ConversationLibrary_StartConversationFromGraph::Instigator' has a wrong offset!");
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, InstigatorTag) == 0x000010, "Member 'ConversationLibrary_StartConversationFromGraph::InstigatorTag' has a wrong offset!");
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, Target) == 0x000018, "Member 'ConversationLibrary_StartConversationFromGraph::Target' has a wrong offset!");
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, TargetTag) == 0x000020, "Member 'ConversationLibrary_StartConversationFromGraph::TargetTag' has a wrong offset!");
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, Graph) == 0x000028, "Member 'ConversationLibrary_StartConversationFromGraph::Graph' has a wrong offset!");
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, ReturnValue) == 0x000030, "Member 'ConversationLibrary_StartConversationFromGraph::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ConversationParticipantComponent_ClientExecuteTaskAndSideEffects, Graph) == 0x000010, "Member 'ConversationParticipantComponent_ClientExecuteTaskAndSideEffects::Graph' has a wrong offset!");
...
static_assert(offsetof(ConversationParticipantComponent_ClientExitConversation, InParticipants) == 0x000000, "Member 'ConversationParticipantComponent_ClientExitConversation::InParticipants' has a wrong offset!");
...
static_assert(offsetof(ConversationParticipantComponent_ClientStartConversation, InParticipants) == 0x000000, "Member 'ConversationParticipantComponent_ClientStartConversation::InParticipants' has a wrong offset!");
...
static_assert(offsetof(ConversationParticipantComponent_GetParticipantActor, ParticipantTag) == 0x000000, "Member 'ConversationParticipantComponent_GetParticipantActor::ParticipantTag' has a wrong offset!");
static_assert(offsetof(ConversationParticipantComponent_GetParticipantActor, ReturnValue) == 0x000008, "Member 'ConversationParticipantComponent_GetParticipantActor::ReturnValue' has a wrong offset!");
