...
static_assert(sizeof(FAddAction) == 0x0000B0, "Wrong size on FAddAction");
static_assert(offsetof(FAddAction, ActorClass) == 0x000020, "Member 'FAddAction::ActorClass' has a wrong offset!");
static_assert(offsetof(FAddAction, JsonStringObjectForPropertyData) == 0x000040, "Member 'FAddAction::JsonStringObjectForPropertyData' has a wrong offset!");
static_assert(offsetof(FAddAction, Transform) == 0x000050, "Member 'FAddAction::Transform' has a wrong offset!");
