...
public:
	...
	float                                         MaxCorrectionDegrees;                              // 0x011C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxRootMotionDeltaToCompensateDegrees;             // 0x0120(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCounterCompenstateInterpolationByRootMotion;      // 0x0124(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bScaleByGlobalBlendWeight;                         // 0x0125(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseManualRootMotionVelocity;                      // 0x0126(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_127[0x1];                                      // 0x0127(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                ManualRootMotionVelocity;                          // 0x0128(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAnimNode_OrientationWarping) == 0x0001A0, "Wrong size on FAnimNode_OrientationWarping");
...
static_assert(offsetof(FAnimNode_OrientationWarping, MaxCorrectionDegrees) == 0x00011C, "Member 'FAnimNode_OrientationWarping::MaxCorrectionDegrees' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, MaxRootMotionDeltaToCompensateDegrees) == 0x000120, "Member 'FAnimNode_OrientationWarping::MaxRootMotionDeltaToCompensateDegrees' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, bCounterCompenstateInterpolationByRootMotion) == 0x000124, "Member 'FAnimNode_OrientationWarping::bCounterCompenstateInterpolationByRootMotion' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, bScaleByGlobalBlendWeight) == 0x000125, "Member 'FAnimNode_OrientationWarping::bScaleByGlobalBlendWeight' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, bUseManualRootMotionVelocity) == 0x000126, "Member 'FAnimNode_OrientationWarping::bUseManualRootMotionVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, ManualRootMotionVelocity) == 0x000128, "Member 'FAnimNode_OrientationWarping::ManualRootMotionVelocity' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1FC[0x44];                                     // 0x01FC(0x0044)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_StrideWarping) == 0x000008, "Wrong alignment on FAnimNode_StrideWarping");
static_assert(sizeof(FAnimNode_StrideWarping) == 0x000240, "Wrong size on FAnimNode_StrideWarping");
...
static_assert(offsetof(FAnimNode_StrideWarping, bOrientStrideDirectionUsingFloorNormal) == 0x0001F8, "Member 'FAnimNode_StrideWarping::bOrientStrideDirectionUsingFloorNormal' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, bCompensateIKUsingFKThighRotation) == 0x0001F9, "Member 'FAnimNode_StrideWarping::bCompensateIKUsingFKThighRotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, bClampIKUsingFKLimits) == 0x0001FA, "Member 'FAnimNode_StrideWarping::bClampIKUsingFKLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_StrideWarping, bDisableIfMissingRootMotion) == 0x0001FB, "Member 'FAnimNode_StrideWarping::bDisableIfMissingRootMotion' has a wrong offset!");
