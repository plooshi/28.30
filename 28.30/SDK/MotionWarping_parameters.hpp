...
static_assert(sizeof(MotionWarpingComponent_AddOrUpdateWarpTarget) == 0x000078, "Wrong size on MotionWarpingComponent_AddOrUpdateWarpTarget");
...
static_assert(sizeof(MotionWarpingComponent_AddOrUpdateWarpTargetFromComponent) == 0x000048, "Wrong size on MotionWarpingComponent_AddOrUpdateWarpTargetFromComponent");
...
static_assert(offsetof(MotionWarpingComponent_AddOrUpdateWarpTargetFromComponent, LocationOffset) == 0x000018, "Member 'MotionWarpingComponent_AddOrUpdateWarpTargetFromComponent::LocationOffset' has a wrong offset!");
static_assert(offsetof(MotionWarpingComponent_AddOrUpdateWarpTargetFromComponent, RotationOffset) == 0x000030, "Member 'MotionWarpingComponent_AddOrUpdateWarpTargetFromComponent::RotationOffset' has a wrong offset!");
...
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, InRotationMethod) == 0x000088, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::InRotationMethod' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, InWarpRotationTimeMultiplier) == 0x00008C, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::InWarpRotationTimeMultiplier' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, InWarpMaxRotationRate) == 0x000090, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::InWarpMaxRotationRate' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp, ReturnValue) == 0x000098, "Member 'RootMotionModifier_SkewWarp_AddRootMotionModifierSkewWarp::ReturnValue' has a wrong offset!");
