...
// Enum IKRig.ERetargetRootLockMode
// NumValues: 0x0003
...
static_assert(offsetof(FCurveRemapPair, TargetCurve) == 0x000004, "Member 'FCurveRemapPair::TargetCurve' has a wrong offset!");
...
static_assert(offsetof(FPinBoneData, BoneToPinTo) == 0x000004, "Member 'FPinBoneData::BoneToPinTo' has a wrong offset!");
...
public:
	...
	struct FRetargetProfile                       CustomRetargetProfile;                             // 0x0028(0x0100)(Edit, BlueprintVisible, Transient, NativeAccessSpecifierPublic)
	...
	class UIKRetargetProcessor*                   Processor;                                         // 0x0130(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FAnimNode_RetargetPoseFromMesh) == 0x0001D0, "Wrong size on FAnimNode_RetargetPoseFromMesh");
...
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, bSuppressWarnings) == 0x000128, "Member 'FAnimNode_RetargetPoseFromMesh::bSuppressWarnings' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, bCopyCurves) == 0x000129, "Member 'FAnimNode_RetargetPoseFromMesh::bCopyCurves' has a wrong offset!");
static_assert(offsetof(FAnimNode_RetargetPoseFromMesh, Processor) == 0x000130, "Member 'FAnimNode_RetargetPoseFromMesh::Processor' has a wrong offset!");
