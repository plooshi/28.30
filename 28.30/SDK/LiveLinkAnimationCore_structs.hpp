...
{
public:
	struct FAnimNode_LiveLinkPose                 PoseNode;                                          // 0x0738(0x0048)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLiveLinkInstanceProxy) == 0x000010, "Wrong alignment on FLiveLinkInstanceProxy");
static_assert(sizeof(FLiveLinkInstanceProxy) == 0x000780, "Wrong size on FLiveLinkInstanceProxy");
