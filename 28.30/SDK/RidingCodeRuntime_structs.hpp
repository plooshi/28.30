...
static_assert(offsetof(FRidingPettingData, bIsPettableCreature) == 0x000000, "Member 'FRidingPettingData::bIsPettableCreature' has a wrong offset!");
static_assert(offsetof(FRidingPettingData, RiderMalePettingMontageInfo) == 0x000008, "Member 'FRidingPettingData::RiderMalePettingMontageInfo' has a wrong offset!");
static_assert(offsetof(FRidingPettingData, RiderFemalePettingMontageInfo) == 0x000060, "Member 'FRidingPettingData::RiderFemalePettingMontageInfo' has a wrong offset!");
static_assert(offsetof(FRidingPettingData, RidablePettingMontageInfo) == 0x0000B8, "Member 'FRidingPettingData::RidablePettingMontageInfo' has a wrong offset!");
...
static_assert(offsetof(FRidingAnalyticsData_Base, Ridable) == 0x000028, "Member 'FRidingAnalyticsData_Base::Ridable' has a wrong offset!");
...
static_assert(offsetof(FRidingAnalyticsData_Stopped, TotalRidingTime) == 0x000048, "Member 'FRidingAnalyticsData_Stopped::TotalRidingTime' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, RiderStartHealth) == 0x00004C, "Member 'FRidingAnalyticsData_Stopped::RiderStartHealth' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, RiderStartShield) == 0x000050, "Member 'FRidingAnalyticsData_Stopped::RiderStartShield' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, RiderEndHealth) == 0x000054, "Member 'FRidingAnalyticsData_Stopped::RiderEndHealth' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, RiderEndShield) == 0x000058, "Member 'FRidingAnalyticsData_Stopped::RiderEndShield' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, TotalDistanceTraveled) == 0x00005C, "Member 'FRidingAnalyticsData_Stopped::TotalDistanceTraveled' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, JumpUseCount) == 0x000060, "Member 'FRidingAnalyticsData_Stopped::JumpUseCount' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, AbilityUseCount) == 0x000064, "Member 'FRidingAnalyticsData_Stopped::AbilityUseCount' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, RiderDamageDealt) == 0x000068, "Member 'FRidingAnalyticsData_Stopped::RiderDamageDealt' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, RiderDamageTaken) == 0x00006C, "Member 'FRidingAnalyticsData_Stopped::RiderDamageTaken' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, RiderHealingReceived) == 0x000070, "Member 'FRidingAnalyticsData_Stopped::RiderHealingReceived' has a wrong offset!");
static_assert(offsetof(FRidingAnalyticsData_Stopped, RiderShieldGained) == 0x000074, "Member 'FRidingAnalyticsData_Stopped::RiderShieldGained' has a wrong offset!");
