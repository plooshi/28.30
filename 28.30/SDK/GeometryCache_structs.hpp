...
static_assert(sizeof(FNiagaraGeometryCacheReference) == 0x000040, "Wrong size on FNiagaraGeometryCacheReference");
...
static_assert(offsetof(FNiagaraGeometryCacheReference, MICOverrideMaterials) == 0x000030, "Member 'FNiagaraGeometryCacheReference::MICOverrideMaterials' has a wrong offset!");
