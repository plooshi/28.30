...
static_assert(sizeof(FAudioCaptureDeviceInfo) == 0x00000C, "Wrong size on FAudioCaptureDeviceInfo");
...
static_assert(offsetof(FAudioCaptureDeviceInfo, NumInputChannels) == 0x000004, "Member 'FAudioCaptureDeviceInfo::NumInputChannels' has a wrong offset!");
static_assert(offsetof(FAudioCaptureDeviceInfo, SampleRate) == 0x000008, "Member 'FAudioCaptureDeviceInfo::SampleRate' has a wrong offset!");
