...
public:
	...
	struct FSmartObjectRequestFilter              SmartObjectRequestFilter;                          // 0x0060(0x0100)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FVector                                QueryBoxExtent;                                    // 0x0160(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bOnlyClaimable;                                    // 0x0178(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UEnvQueryGenerator_SmartObjects) == 0x000180, "Wrong size on UEnvQueryGenerator_SmartObjects");
...
static_assert(offsetof(UEnvQueryGenerator_SmartObjects, QueryBoxExtent) == 0x000160, "Member 'UEnvQueryGenerator_SmartObjects::QueryBoxExtent' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_SmartObjects, bOnlyClaimable) == 0x000178, "Member 'UEnvQueryGenerator_SmartObjects::bOnlyClaimable' has a wrong offset!");
...
static_assert(sizeof(USmartObjectSettings) == 0x000048, "Wrong size on USmartObjectSettings");
...
static_assert(offsetof(USmartObjectSettings, bShouldExcludePreConditionsOnDedicatedClient) == 0x000040, "Member 'USmartObjectSettings::bShouldExcludePreConditionsOnDedicatedClient' has a wrong offset!");
...
static_assert(sizeof(AGenericSmartObject) == 0x000298, "Wrong size on AGenericSmartObject");
static_assert(offsetof(AGenericSmartObject, SOComponent) == 0x000290, "Member 'AGenericSmartObject::SOComponent' has a wrong offset!");
...
static_assert(sizeof(ASmartObjectCollection) == 0x000340, "Wrong size on ASmartObjectCollection");
static_assert(offsetof(ASmartObjectCollection, Bounds) == 0x000290, "Member 'ASmartObjectCollection::Bounds' has a wrong offset!");
static_assert(offsetof(ASmartObjectCollection, CollectionEntries) == 0x0002C8, "Member 'ASmartObjectCollection::CollectionEntries' has a wrong offset!");
static_assert(offsetof(ASmartObjectCollection, RegisteredIdToObjectMap) == 0x0002D8, "Member 'ASmartObjectCollection::RegisteredIdToObjectMap' has a wrong offset!");
static_assert(offsetof(ASmartObjectCollection, Definitions) == 0x000328, "Member 'ASmartObjectCollection::Definitions' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(struct FSmartObjectEventData& EventData, class AActor* Interactor)> OnSmartObjectEvent;                                // 0x0220(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_230[0x18];                                     // 0x0230(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class USmartObjectDefinition*                 DefinitionAsset;                                   // 0x0248(0x0008)(Edit, BlueprintVisible, Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FSmartObjectHandle                     RegisteredHandle;                                  // 0x0250(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, Net, Transient, EditConst, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_258[0x10];                                     // 0x0258(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bCanBePartOfCollection;                            // 0x0268(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USmartObjectComponent) == 0x000270, "Wrong size on USmartObjectComponent");
static_assert(offsetof(USmartObjectComponent, OnSmartObjectEvent) == 0x000220, "Member 'USmartObjectComponent::OnSmartObjectEvent' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, DefinitionAsset) == 0x000248, "Member 'USmartObjectComponent::DefinitionAsset' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, RegisteredHandle) == 0x000250, "Member 'USmartObjectComponent::RegisteredHandle' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, bCanBePartOfCollection) == 0x000268, "Member 'USmartObjectComponent::bCanBePartOfCollection' has a wrong offset!");
...
static_assert(sizeof(USmartObjectContainerRenderingComponent) == 0x000500, "Wrong size on USmartObjectContainerRenderingComponent");
...
static_assert(sizeof(USmartObjectDebugRenderingComponent) == 0x000550, "Wrong size on USmartObjectDebugRenderingComponent");
...
public:
	...
	TArray<struct FSmartObjectDefinitionDataProxy> DefinitionData;                                    // 0x00D0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TSubclassOf<class USmartObjectWorldConditionSchema> WorldConditionSchemaClass;                         // 0x00E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ESmartObjectTagMergingPolicy                  ActivityTagsMergingPolicy;                         // 0x00E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ESmartObjectTagFilteringPolicy                UserTagsFilteringPolicy;                           // 0x00E9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USmartObjectDefinition) == 0x0000F0, "Wrong size on USmartObjectDefinition");
...
static_assert(offsetof(USmartObjectDefinition, DefinitionData) == 0x0000D0, "Member 'USmartObjectDefinition::DefinitionData' has a wrong offset!");
static_assert(offsetof(USmartObjectDefinition, WorldConditionSchemaClass) == 0x0000E0, "Member 'USmartObjectDefinition::WorldConditionSchemaClass' has a wrong offset!");
static_assert(offsetof(USmartObjectDefinition, ActivityTagsMergingPolicy) == 0x0000E8, "Member 'USmartObjectDefinition::ActivityTagsMergingPolicy' has a wrong offset!");
static_assert(offsetof(USmartObjectDefinition, UserTagsFilteringPolicy) == 0x0000E9, "Member 'USmartObjectDefinition::UserTagsFilteringPolicy' has a wrong offset!");
...
static_assert(sizeof(ASmartObjectPersistentCollection) == 0x000348, "Wrong size on ASmartObjectPersistentCollection");
static_assert(offsetof(ASmartObjectPersistentCollection, SmartObjectContainer) == 0x000290, "Member 'ASmartObjectPersistentCollection::SmartObjectContainer' has a wrong offset!");
...
static_assert(sizeof(USmartObjectRenderingComponent) == 0x000500, "Wrong size on USmartObjectRenderingComponent");
...
static_assert(sizeof(USmartObjectSubsystem) == 0x000198, "Wrong size on USmartObjectSubsystem");
...
static_assert(offsetof(USmartObjectSubsystem, RuntimeSmartObjects) == 0x000120, "Member 'USmartObjectSubsystem::RuntimeSmartObjects' has a wrong offset!");
static_assert(offsetof(USmartObjectSubsystem, RegisteredSOComponents) == 0x000170, "Member 'USmartObjectSubsystem::RegisteredSOComponents' has a wrong offset!");
static_assert(offsetof(USmartObjectSubsystem, PendingSmartObjectRegistration) == 0x000180, "Member 'USmartObjectSubsystem::PendingSmartObjectRegistration' has a wrong offset!");
...
static_assert(sizeof(USmartObjectSubsystemRenderingComponent) == 0x000550, "Wrong size on USmartObjectSubsystemRenderingComponent");
...
static_assert(sizeof(ASmartObjectSubsystemRenderingActor) == 0x000298, "Wrong size on ASmartObjectSubsystemRenderingActor");
static_assert(offsetof(ASmartObjectSubsystemRenderingActor, RenderingComponent) == 0x000290, "Member 'ASmartObjectSubsystemRenderingActor::RenderingComponent' has a wrong offset!");
...
{
public:
	struct FSmartObjectRequest                    Request;                                           // 0x0030(0x0140)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FSmartObjectRequestResult>      Results;                                           // 0x0170(0x0010)(Edit, ZeroConstructor, Transient, EditConst, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USmartObjectSimpleQueryTest) == 0x000180, "Wrong size on USmartObjectSimpleQueryTest");
...
static_assert(offsetof(USmartObjectSimpleQueryTest, Results) == 0x000170, "Member 'USmartObjectSimpleQueryTest::Results' has a wrong offset!");
...
static_assert(sizeof(USmartObjectTestRenderingComponent) == 0x000550, "Wrong size on USmartObjectTestRenderingComponent");
...
static_assert(sizeof(ASmartObjectTestingActor) == 0x0002B8, "Wrong size on ASmartObjectTestingActor");
static_assert(offsetof(ASmartObjectTestingActor, Tests) == 0x000290, "Member 'ASmartObjectTestingActor::Tests' has a wrong offset!");
static_assert(offsetof(ASmartObjectTestingActor, RenderingComponent) == 0x0002A0, "Member 'ASmartObjectTestingActor::RenderingComponent' has a wrong offset!");
static_assert(offsetof(ASmartObjectTestingActor, SmartObjectSubsystem) == 0x0002A8, "Member 'ASmartObjectTestingActor::SmartObjectSubsystem' has a wrong offset!");
static_assert(offsetof(ASmartObjectTestingActor, bRunTestsEachFrame) == 0x0002B0, "Member 'ASmartObjectTestingActor::bRunTestsEachFrame' has a wrong offset!");
...
static_assert(sizeof(USmartObjectSlotValidationFilter) == 0x000110, "Wrong size on USmartObjectSlotValidationFilter");
...
static_assert(offsetof(USmartObjectSlotValidationFilter, bUseEntryParametersForExit) == 0x000098, "Member 'USmartObjectSlotValidationFilter::bUseEntryParametersForExit' has a wrong offset!");
static_assert(offsetof(USmartObjectSlotValidationFilter, ExitParameters) == 0x0000A0, "Member 'USmartObjectSlotValidationFilter::ExitParameters' has a wrong offset!");
