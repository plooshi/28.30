...
static_assert(sizeof(AnimDistanceMatchingLibrary_AdvanceTimeByDistanceMatching) == 0x000048, "Wrong size on AnimDistanceMatchingLibrary_AdvanceTimeByDistanceMatching");
...
static_assert(offsetof(AnimDistanceMatchingLibrary_AdvanceTimeByDistanceMatching, PlayRateClamp) == 0x000028, "Member 'AnimDistanceMatchingLibrary_AdvanceTimeByDistanceMatching::PlayRateClamp' has a wrong offset!");
static_assert(offsetof(AnimDistanceMatchingLibrary_AdvanceTimeByDistanceMatching, ReturnValue) == 0x000038, "Member 'AnimDistanceMatchingLibrary_AdvanceTimeByDistanceMatching::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AnimDistanceMatchingLibrary_DistanceMatchToTarget) == 0x000028, "Wrong size on AnimDistanceMatchingLibrary_DistanceMatchToTarget");
...
static_assert(offsetof(AnimDistanceMatchingLibrary_DistanceMatchToTarget, ReturnValue) == 0x000018, "Member 'AnimDistanceMatchingLibrary_DistanceMatchToTarget::ReturnValue' has a wrong offset!");
