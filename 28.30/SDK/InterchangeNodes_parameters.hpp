...
static_assert(offsetof(InterchangeShaderPortsAPI_HasInput, ReturnValue) == 0x00000C, "Member 'InterchangeShaderPortsAPI_HasInput::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(InterchangeShaderPortsAPI_HasParameter, ReturnValue) == 0x00000C, "Member 'InterchangeShaderPortsAPI_HasParameter::ReturnValue' has a wrong offset!");
