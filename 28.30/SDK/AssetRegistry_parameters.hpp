...
static_assert(offsetof(AssetRegistry_K2_GetAssetByObjectPath, bSkipARFilteredAssets) == 0x000019, "Member 'AssetRegistry_K2_GetAssetByObjectPath::bSkipARFilteredAssets' has a wrong offset!");
