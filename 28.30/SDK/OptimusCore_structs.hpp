...
static_assert(offsetof(FOptimusParameterBinding, bSupportAtomicIfCompatibleDataType) == 0x000050, "Member 'FOptimusParameterBinding::bSupportAtomicIfCompatibleDataType' has a wrong offset!");
static_assert(offsetof(FOptimusParameterBinding, bSupportRead) == 0x000051, "Member 'FOptimusParameterBinding::bSupportRead' has a wrong offset!");
...
static_assert(offsetof(FOptimusConstantIdentifier, GroupName) == 0x000004, "Member 'FOptimusConstantIdentifier::GroupName' has a wrong offset!");
static_assert(offsetof(FOptimusConstantIdentifier, ConstantName) == 0x000008, "Member 'FOptimusConstantIdentifier::ConstantName' has a wrong offset!");
...
static_assert(offsetof(FOptimusConstantDefinition, Expression) == 0x000010, "Member 'FOptimusConstantDefinition::Expression' has a wrong offset!");
...
static_assert(offsetof(FOptimusConstant, Definition) == 0x000010, "Member 'FOptimusConstant::Definition' has a wrong offset!");
static_assert(offsetof(FOptimusConstant, ComponentBindingIndex) == 0x000030, "Member 'FOptimusConstant::ComponentBindingIndex' has a wrong offset!");
static_assert(offsetof(FOptimusConstant, Type) == 0x000034, "Member 'FOptimusConstant::Type' has a wrong offset!");
...
static_assert(offsetof(FOptimusExecutionDomain, Expression) == 0x000008, "Member 'FOptimusExecutionDomain::Expression' has a wrong offset!");
