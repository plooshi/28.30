...
static_assert(sizeof(UMetasoundOfflinePlayerComponent) == 0x0000E8, "Wrong size on UMetasoundOfflinePlayerComponent");
static_assert(offsetof(UMetasoundOfflinePlayerComponent, MetaSoundSource) == 0x0000B0, "Member 'UMetasoundOfflinePlayerComponent::MetaSoundSource' has a wrong offset!");
...
static_assert(sizeof(UMidiClockUpdateSubsystem) == 0x000090, "Wrong size on UMidiClockUpdateSubsystem");
...
public:
	...
	uint8                                         Pad_1F8[0x210];                                    // 0x01F8(0x0210)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMusicClockComponent) == 0x000408, "Wrong size on UMusicClockComponent");
static_assert(offsetof(UMusicClockComponent, DriveMethod) == 0x0000A0, "Member 'UMusicClockComponent::DriveMethod' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, MetasoundOutputName) == 0x0000A4, "Member 'UMusicClockComponent::MetasoundOutputName' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, MetasoundsAudioComponent) == 0x0000A8, "Member 'UMusicClockComponent::MetasoundsAudioComponent' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, TempoMap) == 0x0000B0, "Member 'UMusicClockComponent::TempoMap' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, Tempo) == 0x0000B8, "Member 'UMusicClockComponent::Tempo' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, TimeSignatureNum) == 0x0000BC, "Member 'UMusicClockComponent::TimeSignatureNum' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, TimeSignatureDenom) == 0x0000C0, "Member 'UMusicClockComponent::TimeSignatureDenom' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, CurrentBeatDurationSec) == 0x0000C4, "Member 'UMusicClockComponent::CurrentBeatDurationSec' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, CurrentBarDurationSec) == 0x0000C8, "Member 'UMusicClockComponent::CurrentBarDurationSec' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, CurrentClockAdvanceRate) == 0x0000CC, "Member 'UMusicClockComponent::CurrentClockAdvanceRate' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, RunPastMusicEnd) == 0x0000D0, "Member 'UMusicClockComponent::RunPastMusicEnd' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, TimebaseForBarAndBeatEvents) == 0x0000D1, "Member 'UMusicClockComponent::TimebaseForBarAndBeatEvents' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, PlayStateEvent) == 0x0000D8, "Member 'UMusicClockComponent::PlayStateEvent' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, BeatEvent) == 0x0000E8, "Member 'UMusicClockComponent::BeatEvent' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, BarEvent) == 0x0000F8, "Member 'UMusicClockComponent::BarEvent' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, SectionEvent) == 0x000108, "Member 'UMusicClockComponent::SectionEvent' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, MusicClockConnectedEvent) == 0x000118, "Member 'UMusicClockComponent::MusicClockConnectedEvent' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, MusicClockDisconnectedEvent) == 0x000128, "Member 'UMusicClockComponent::MusicClockDisconnectedEvent' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, CurrentSmoothedAudioRenderSongPos) == 0x000138, "Member 'UMusicClockComponent::CurrentSmoothedAudioRenderSongPos' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, CurrentVideoRenderSongPos) == 0x000178, "Member 'UMusicClockComponent::CurrentVideoRenderSongPos' has a wrong offset!");
static_assert(offsetof(UMusicClockComponent, CurrentPlayerExperiencedSongPos) == 0x0001B8, "Member 'UMusicClockComponent::CurrentPlayerExperiencedSongPos' has a wrong offset!");
...
static_assert(sizeof(UMusicTempometerComponent) == 0x000158, "Wrong size on UMusicTempometerComponent");
static_assert(offsetof(UMusicTempometerComponent, SecondsIncludingCountInParameterName) == 0x0000A0, "Member 'UMusicTempometerComponent::SecondsIncludingCountInParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, BarsIncludingCountInParameterName) == 0x0000A4, "Member 'UMusicTempometerComponent::BarsIncludingCountInParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, BeatsIncludingCountInParameterName) == 0x0000A8, "Member 'UMusicTempometerComponent::BeatsIncludingCountInParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, SecondsFromBarOneParameterName) == 0x0000AC, "Member 'UMusicTempometerComponent::SecondsFromBarOneParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, TimestampBarParameterName) == 0x0000B0, "Member 'UMusicTempometerComponent::TimestampBarParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, TimestampBeatInBarParameterName) == 0x0000B4, "Member 'UMusicTempometerComponent::TimestampBeatInBarParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, BarProgressParameterName) == 0x0000B8, "Member 'UMusicTempometerComponent::BarProgressParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, BeatProgressParameterName) == 0x0000BC, "Member 'UMusicTempometerComponent::BeatProgressParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, TimeSignatureNumeratorParameterName) == 0x0000C0, "Member 'UMusicTempometerComponent::TimeSignatureNumeratorParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, TimeSignatureDenominatorParameterName) == 0x0000C4, "Member 'UMusicTempometerComponent::TimeSignatureDenominatorParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, TempoParameterName) == 0x0000C8, "Member 'UMusicTempometerComponent::TempoParameterName' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, SongPos) == 0x0000D0, "Member 'UMusicTempometerComponent::SongPos' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, MusicClock) == 0x000140, "Member 'UMusicTempometerComponent::MusicClock' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, MaterialParameterCollection) == 0x000148, "Member 'UMusicTempometerComponent::MaterialParameterCollection' has a wrong offset!");
static_assert(offsetof(UMusicTempometerComponent, MaterialParameterCollectionInstance) == 0x000150, "Member 'UMusicTempometerComponent::MaterialParameterCollectionInstance' has a wrong offset!");
