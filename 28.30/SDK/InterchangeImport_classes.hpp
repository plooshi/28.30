...
static_assert(sizeof(UMaterialExpressionMaterialXTextureSampleParameterBlur) == 0x000248, "Wrong size on UMaterialExpressionMaterialXTextureSampleParameterBlur");
static_assert(offsetof(UMaterialExpressionMaterialXTextureSampleParameterBlur, KernelSize) == 0x000238, "Member 'UMaterialExpressionMaterialXTextureSampleParameterBlur::KernelSize' has a wrong offset!");
static_assert(offsetof(UMaterialExpressionMaterialXTextureSampleParameterBlur, FilterSize) == 0x00023C, "Member 'UMaterialExpressionMaterialXTextureSampleParameterBlur::FilterSize' has a wrong offset!");
static_assert(offsetof(UMaterialExpressionMaterialXTextureSampleParameterBlur, FilterOffset) == 0x000240, "Member 'UMaterialExpressionMaterialXTextureSampleParameterBlur::FilterOffset' has a wrong offset!");
static_assert(offsetof(UMaterialExpressionMaterialXTextureSampleParameterBlur, Filter) == 0x000244, "Member 'UMaterialExpressionMaterialXTextureSampleParameterBlur::Filter' has a wrong offset!");
...
// Class InterchangeImport.InterchangeOOJPGTranslator
// 0x0008 (0x0040 - 0x0038)
class UInterchangeOOJPGTranslator final : public UInterchangeTranslatorBase
{
public:
	uint8                                         Pad_38[0x8];                                       // 0x0038(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"InterchangeOOJPGTranslator">();
	}
	static class UInterchangeOOJPGTranslator* GetDefaultObj()
	{
		return GetDefaultObjImpl<UInterchangeOOJPGTranslator>();
	}
};
static_assert(alignof(UInterchangeOOJPGTranslator) == 0x000008, "Wrong alignment on UInterchangeOOJPGTranslator");
static_assert(sizeof(UInterchangeOOJPGTranslator) == 0x000040, "Wrong size on UInterchangeOOJPGTranslator");
