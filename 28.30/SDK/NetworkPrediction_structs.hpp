...
static_assert(sizeof(FSharedPackageMapItem) == 0x000020, "Wrong size on FSharedPackageMapItem");
...
static_assert(sizeof(FNetworkPredictionSettings) == 0x000030, "Wrong size on FNetworkPredictionSettings");
...
static_assert(offsetof(FNetworkPredictionSettings, FixedTickInputSendCount) == 0x000024, "Member 'FNetworkPredictionSettings::FixedTickInputSendCount' has a wrong offset!");
static_assert(offsetof(FNetworkPredictionSettings, IndependentTickInputSendCount) == 0x000028, "Member 'FNetworkPredictionSettings::IndependentTickInputSendCount' has a wrong offset!");
static_assert(offsetof(FNetworkPredictionSettings, MaximumRemoteInputFaultLimit) == 0x00002C, "Member 'FNetworkPredictionSettings::MaximumRemoteInputFaultLimit' has a wrong offset!");
