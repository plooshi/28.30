...
public:
	...
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0138(0x00A0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D8[0x8];                                      // 0x01D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMInstructionArray                 Instructions;                                      // 0x01E0(0x0010)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F0[0x8];                                      // 0x01F0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           FunctionNamesStorage;                              // 0x01F8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_208[0x38];                                     // 0x0208(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRigVMParameter>                Parameters;                                        // 0x0240(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_250[0xD8];                                     // 0x0250(0x00D8)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        CachedVMHash;                                      // 0x0328(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_32C[0x54];                                     // 0x032C(0x0054)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URigVM) == 0x000380, "Wrong size on URigVM");
...
static_assert(offsetof(URigVM, Instructions) == 0x0001E0, "Member 'URigVM::Instructions' has a wrong offset!");
static_assert(offsetof(URigVM, FunctionNamesStorage) == 0x0001F8, "Member 'URigVM::FunctionNamesStorage' has a wrong offset!");
static_assert(offsetof(URigVM, Parameters) == 0x000240, "Member 'URigVM::Parameters' has a wrong offset!");
static_assert(offsetof(URigVM, CachedVMHash) == 0x000328, "Member 'URigVM::CachedVMHash' has a wrong offset!");
...
static_assert(sizeof(URigVMNativized) == 0x0003A8, "Wrong size on URigVMNativized");
...
static_assert(sizeof(URigVMEditorSettings) == 0x000030, "Wrong size on URigVMEditorSettings");
