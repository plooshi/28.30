...
static_assert(sizeof(AnimNotifyState_TeleportFinished_C_Received_NotifyEnd) == 0x000048, "Wrong size on AnimNotifyState_TeleportFinished_C_Received_NotifyEnd");
...
static_assert(offsetof(AnimNotifyState_TeleportFinished_C_Received_NotifyEnd, ReturnValue) == 0x000040, "Member 'AnimNotifyState_TeleportFinished_C_Received_NotifyEnd::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AnimNotifyState_TeleportFinished_C_Received_NotifyBegin) == 0x000068, "Wrong size on AnimNotifyState_TeleportFinished_C_Received_NotifyBegin");
...
static_assert(offsetof(AnimNotifyState_TeleportFinished_C_Received_NotifyBegin, ReturnValue) == 0x000048, "Member 'AnimNotifyState_TeleportFinished_C_Received_NotifyBegin::ReturnValue' has a wrong offset!");
static_assert(offsetof(AnimNotifyState_TeleportFinished_C_Received_NotifyBegin, CallFunc_GetOwner_ReturnValue) == 0x000050, "Member 'AnimNotifyState_TeleportFinished_C_Received_NotifyBegin::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(AnimNotifyState_TeleportFinished_C_Received_NotifyBegin, K2Node_DynamicCast_AsBP_Victory_Drone) == 0x000058, "Member 'AnimNotifyState_TeleportFinished_C_Received_NotifyBegin::K2Node_DynamicCast_AsBP_Victory_Drone' has a wrong offset!");
static_assert(offsetof(AnimNotifyState_TeleportFinished_C_Received_NotifyBegin, K2Node_DynamicCast_bSuccess) == 0x000060, "Member 'AnimNotifyState_TeleportFinished_C_Received_NotifyBegin::K2Node_DynamicCast_bSuccess' has a wrong offset!");
