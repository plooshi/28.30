...
static_assert(offsetof(StreamingRadioPlayerComponent_GetBaseStreamingVideo, ReturnValue) == 0x000000, "Member 'StreamingRadioPlayerComponent_GetBaseStreamingVideo::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(StreamingRadioPlayerComponent_GetMediaMetadata, ReturnValue) == 0x000000, "Member 'StreamingRadioPlayerComponent_GetMediaMetadata::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(StreamingRadioPlayerComponent_HandleLicensedAudioTreatmentChanged, UCPType) == 0x000000, "Member 'StreamingRadioPlayerComponent_HandleLicensedAudioTreatmentChanged::UCPType' has a wrong offset!");
...
static_assert(offsetof(StreamingRadioPlayerComponent_MediaTerminalError, Reason) == 0x000000, "Member 'StreamingRadioPlayerComponent_MediaTerminalError::Reason' has a wrong offset!");
...
static_assert(offsetof(StreamingRadioPlayerComponent_MetadataChanged, MetaData) == 0x000000, "Member 'StreamingRadioPlayerComponent_MetadataChanged::MetaData' has a wrong offset!");
...
static_assert(offsetof(StreamingRadioPlayerComponent_OnOwnerDisabledChanged, bDisabled) == 0x000000, "Member 'StreamingRadioPlayerComponent_OnOwnerDisabledChanged::bDisabled' has a wrong offset!");
...
static_assert(sizeof(StreamingRadioPlayerComponent_ServerSavedSource) == 0x000058, "Wrong size on StreamingRadioPlayerComponent_ServerSavedSource");
...
static_assert(sizeof(StreamingRadioPlayerComponent_GetOptionAt) == 0x000060, "Wrong size on StreamingRadioPlayerComponent_GetOptionAt");
...
static_assert(offsetof(StreamingRadioPlayerComponent_IsRadioOn, ReturnValue) == 0x000000, "Member 'StreamingRadioPlayerComponent_IsRadioOn::ReturnValue' has a wrong offset!");
