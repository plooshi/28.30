...
static_assert(sizeof(UNetObjectGridFilterConfig) == 0x000080, "Wrong size on UNetObjectGridFilterConfig");
...
static_assert(sizeof(UObjectReplicationBridgeConfig) == 0x0000A8, "Wrong size on UObjectReplicationBridgeConfig");
...
static_assert(offsetof(UObjectReplicationBridgeConfig, RequiredNetDriverChannelClassName) == 0x000094, "Member 'UObjectReplicationBridgeConfig::RequiredNetDriverChannelClassName' has a wrong offset!");
static_assert(offsetof(UObjectReplicationBridgeConfig, CriticalActorClasses) == 0x000098, "Member 'UObjectReplicationBridgeConfig::CriticalActorClasses' has a wrong offset!");
