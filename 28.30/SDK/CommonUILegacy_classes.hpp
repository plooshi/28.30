...
static_assert(sizeof(UCommonActivatablePanelLegacy) == 0x000538, "Wrong size on UCommonActivatablePanelLegacy");
static_assert(offsetof(UCommonActivatablePanelLegacy, OnWidgetActivated) == 0x000408, "Member 'UCommonActivatablePanelLegacy::OnWidgetActivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, OnWidgetDeactivated) == 0x000418, "Member 'UCommonActivatablePanelLegacy::OnWidgetDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bConsumeAllActions) == 0x000428, "Member 'UCommonActivatablePanelLegacy::bConsumeAllActions' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bExposeActionsExternally) == 0x000429, "Member 'UCommonActivatablePanelLegacy::bExposeActionsExternally' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bShouldBypassStack) == 0x00042A, "Member 'UCommonActivatablePanelLegacy::bShouldBypassStack' has a wrong offset!");
...
static_assert(sizeof(UCommonButtonLegacy) == 0x0014E0, "Wrong size on UCommonButtonLegacy");
static_assert(offsetof(UCommonButtonLegacy, OnSelectedChanged) == 0x001490, "Member 'UCommonButtonLegacy::OnSelectedChanged' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonClicked) == 0x0014A0, "Member 'UCommonButtonLegacy::OnButtonClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonDoubleClicked) == 0x0014B0, "Member 'UCommonButtonLegacy::OnButtonDoubleClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonHovered) == 0x0014C0, "Member 'UCommonButtonLegacy::OnButtonHovered' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonUnhovered) == 0x0014D0, "Member 'UCommonButtonLegacy::OnButtonUnhovered' has a wrong offset!");
...
static_assert(sizeof(UCommonInputReflectorLegacy) == 0x000318, "Wrong size on UCommonInputReflectorLegacy");
static_assert(offsetof(UCommonInputReflectorLegacy, ButtonType) == 0x0002E8, "Member 'UCommonInputReflectorLegacy::ButtonType' has a wrong offset!");
static_assert(offsetof(UCommonInputReflectorLegacy, ActiveButtons) == 0x0002F0, "Member 'UCommonInputReflectorLegacy::ActiveButtons' has a wrong offset!");
static_assert(offsetof(UCommonInputReflectorLegacy, InactiveButtons) == 0x000300, "Member 'UCommonInputReflectorLegacy::InactiveButtons' has a wrong offset!");
...
static_assert(sizeof(UCommonPopupButtonLegacy) == 0x0014F0, "Wrong size on UCommonPopupButtonLegacy");
static_assert(offsetof(UCommonPopupButtonLegacy, PopupMenuAnchor) == 0x0014E0, "Member 'UCommonPopupButtonLegacy::PopupMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupButtonLegacy, PopupMenu) == 0x0014E8, "Member 'UCommonPopupButtonLegacy::PopupMenu' has a wrong offset!");
...
static_assert(sizeof(UCommonPopupMenuLegacy) == 0x000550, "Wrong size on UCommonPopupMenuLegacy");
static_assert(offsetof(UCommonPopupMenuLegacy, bUseInputStack) == 0x000538, "Member 'UCommonPopupMenuLegacy::bUseInputStack' has a wrong offset!");
static_assert(offsetof(UCommonPopupMenuLegacy, OwningMenuAnchor) == 0x00053C, "Member 'UCommonPopupMenuLegacy::OwningMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupMenuLegacy, ContextProvidingObject) == 0x000544, "Member 'UCommonPopupMenuLegacy::ContextProvidingObject' has a wrong offset!");
...
static_assert(sizeof(UCommonTabListWidgetLegacy) == 0x0003F8, "Wrong size on UCommonTabListWidgetLegacy");
static_assert(offsetof(UCommonTabListWidgetLegacy, OnTabButtonCreated) == 0x0003D8, "Member 'UCommonTabListWidgetLegacy::OnTabButtonCreated' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidgetLegacy, OnTabButtonRemoved) == 0x0003E8, "Member 'UCommonTabListWidgetLegacy::OnTabButtonRemoved' has a wrong offset!");
...
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForGamepad) == 0x000320, "Member 'UCommonVisibilityWidgetLegacy::bShowForGamepad' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForMouseAndKeyboard) == 0x000321, "Member 'UCommonVisibilityWidgetLegacy::bShowForMouseAndKeyboard' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForTouch) == 0x000322, "Member 'UCommonVisibilityWidgetLegacy::bShowForTouch' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForPC) == 0x000323, "Member 'UCommonVisibilityWidgetLegacy::bShowForPC' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForMac) == 0x000324, "Member 'UCommonVisibilityWidgetLegacy::bShowForMac' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForPS4) == 0x000325, "Member 'UCommonVisibilityWidgetLegacy::bShowForPS4' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForPS5) == 0x000326, "Member 'UCommonVisibilityWidgetLegacy::bShowForPS5' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForXBox) == 0x000327, "Member 'UCommonVisibilityWidgetLegacy::bShowForXBox' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForXSX) == 0x000328, "Member 'UCommonVisibilityWidgetLegacy::bShowForXSX' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForIOS) == 0x000329, "Member 'UCommonVisibilityWidgetLegacy::bShowForIOS' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForAndroid) == 0x00032A, "Member 'UCommonVisibilityWidgetLegacy::bShowForAndroid' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForErebus) == 0x00032B, "Member 'UCommonVisibilityWidgetLegacy::bShowForErebus' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, VisibleType) == 0x00032C, "Member 'UCommonVisibilityWidgetLegacy::VisibleType' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, HiddenType) == 0x00032D, "Member 'UCommonVisibilityWidgetLegacy::HiddenType' has a wrong offset!");
...
static_assert(sizeof(UCommonWidgetStackLegacy) == 0x0001D8, "Wrong size on UCommonWidgetStackLegacy");
static_assert(offsetof(UCommonWidgetStackLegacy, OnActiveWidgetChangedLegacyEvent) == 0x0001C8, "Member 'UCommonWidgetStackLegacy::OnActiveWidgetChangedLegacyEvent' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(class UCommonActivatablePanelLegacy* DeactivatedWidget)> OnActiveWidgetDeactivated;                         // 0x0228(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UWidget* ActiveWidget, int32 ActiveWidgetIndex)> OnActiveWidgetChanged;                             // 0x0238(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UCommonWidgetSwitcherLegacy, OnActiveWidgetDeactivated) == 0x000228, "Member 'UCommonWidgetSwitcherLegacy::OnActiveWidgetDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, OnActiveWidgetChanged) == 0x000238, "Member 'UCommonWidgetSwitcherLegacy::OnActiveWidgetChanged' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, bWidgetActivationEnabled) == 0x000248, "Member 'UCommonWidgetSwitcherLegacy::bWidgetActivationEnabled' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, bOutroPanelBelow) == 0x000249, "Member 'UCommonWidgetSwitcherLegacy::bOutroPanelBelow' has a wrong offset!");
