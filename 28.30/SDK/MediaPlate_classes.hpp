...
public:
	...
	struct FMediaTextureResourceSettings          MediaTextureSettings;                              // 0x0128(0x0002)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMediaPlateComponent) == 0x000170, "Wrong size on UMediaPlateComponent");
...
static_assert(offsetof(UMediaPlateComponent, MediaTextureSettings) == 0x000128, "Member 'UMediaPlateComponent::MediaTextureSettings' has a wrong offset!");
static_assert(offsetof(UMediaPlateComponent, MediaPlayer) == 0x000130, "Member 'UMediaPlateComponent::MediaPlayer' has a wrong offset!");
