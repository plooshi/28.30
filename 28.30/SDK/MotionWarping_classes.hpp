...
static_assert(offsetof(URootMotionModifier_Warp, RotationMethod) == 0x000162, "Member 'URootMotionModifier_Warp::RotationMethod' has a wrong offset!");
...
static_assert(offsetof(URootMotionModifier_Warp, WarpMaxRotationRate) == 0x000168, "Member 'URootMotionModifier_Warp::WarpMaxRotationRate' has a wrong offset!");
