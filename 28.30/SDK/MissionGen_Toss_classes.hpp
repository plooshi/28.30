...
static_assert(alignof(UMissionGen_Toss_C) == 0x000010, "Wrong alignment on UMissionGen_Toss_C");
static_assert(sizeof(UMissionGen_Toss_C) == 0x000830, "Wrong size on UMissionGen_Toss_C");
