...
public:
	...
	class FString                                 ProjectName;                                       // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVerseDigestVariant                           Variant;                                           // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_69[0x3];                                       // 0x0069(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        VerseVersion;                                      // 0x006C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UVerseDigest) == 0x000070, "Wrong size on UVerseDigest");
static_assert(offsetof(UVerseDigest, DigestCode) == 0x000028, "Member 'UVerseDigest::DigestCode' has a wrong offset!");
static_assert(offsetof(UVerseDigest, ManifestCode) == 0x000038, "Member 'UVerseDigest::ManifestCode' has a wrong offset!");
static_assert(offsetof(UVerseDigest, DependencyPackages) == 0x000048, "Member 'UVerseDigest::DependencyPackages' has a wrong offset!");
static_assert(offsetof(UVerseDigest, ProjectName) == 0x000058, "Member 'UVerseDigest::ProjectName' has a wrong offset!");
static_assert(offsetof(UVerseDigest, Variant) == 0x000068, "Member 'UVerseDigest::Variant' has a wrong offset!");
static_assert(offsetof(UVerseDigest, VerseVersion) == 0x00006C, "Member 'UVerseDigest::VerseVersion' has a wrong offset!");
...
public:
	...
	struct FVerseEffectSet                        ConstructorEffects;                                // 0x02E0(0x0004)(NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UVerseClass) == 0x0002E8, "Wrong size on UVerseClass");
...
static_assert(offsetof(UVerseClass, PersistentVars) == 0x0002C0, "Member 'UVerseClass::PersistentVars' has a wrong offset!");
static_assert(offsetof(UVerseClass, SessionVars) == 0x0002D0, "Member 'UVerseClass::SessionVars' has a wrong offset!");
static_assert(offsetof(UVerseClass, ConstructorEffects) == 0x0002E0, "Member 'UVerseClass::ConstructorEffects' has a wrong offset!");
