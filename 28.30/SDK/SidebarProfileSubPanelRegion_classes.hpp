...
static_assert(sizeof(USidebarProfileSubPanelRegion_C) == 0x000358, "Wrong size on USidebarProfileSubPanelRegion_C");
static_assert(offsetof(USidebarProfileSubPanelRegion_C, Image_63) == 0x000350, "Member 'USidebarProfileSubPanelRegion_C::Image_63' has a wrong offset!");
