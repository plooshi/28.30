...
static_assert(sizeof(AB_PlayerHealthDamage_CameraLensEffect_C) == 0x000390, "Wrong size on AB_PlayerHealthDamage_CameraLensEffect_C");
static_assert(offsetof(AB_PlayerHealthDamage_CameraLensEffect_C, UberGraphFrame) == 0x000380, "Member 'AB_PlayerHealthDamage_CameraLensEffect_C::UberGraphFrame' has a wrong offset!");
