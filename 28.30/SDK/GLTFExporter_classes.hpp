...
public:
	...
	bool                                          bExportClothMaterials;                             // 0x0032(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bExportThinTranslucentMaterials;                   // 0x0033(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bExportEmissiveStrength;                           // 0x0034(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGLTFMaterialBakeMode                         BakeMaterialInputs;                                // 0x0035(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGLTFExportOptions, bExportClothMaterials) == 0x000032, "Member 'UGLTFExportOptions::bExportClothMaterials' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportThinTranslucentMaterials) == 0x000033, "Member 'UGLTFExportOptions::bExportThinTranslucentMaterials' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportEmissiveStrength) == 0x000034, "Member 'UGLTFExportOptions::bExportEmissiveStrength' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, BakeMaterialInputs) == 0x000035, "Member 'UGLTFExportOptions::BakeMaterialInputs' has a wrong offset!");
