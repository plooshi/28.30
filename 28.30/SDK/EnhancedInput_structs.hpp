...
static_assert(sizeof(FPlayerKeyMapping) == 0x000088, "Wrong size on FPlayerKeyMapping");
...
static_assert(offsetof(FPlayerKeyMapping, AssociatedInputAction) == 0x000080, "Member 'FPlayerKeyMapping::AssociatedInputAction' has a wrong offset!");
...
static_assert(sizeof(FDefaultContextSetting) == 0x000028, "Wrong size on FDefaultContextSetting");
...
static_assert(offsetof(FDefaultContextSetting, Priority) == 0x000020, "Member 'FDefaultContextSetting::Priority' has a wrong offset!");
static_assert(offsetof(FDefaultContextSetting, bAddImmediately) == 0x000024, "Member 'FDefaultContextSetting::bAddImmediately' has a wrong offset!");
static_assert(offsetof(FDefaultContextSetting, bRegisterWithUserSettings) == 0x000025, "Member 'FDefaultContextSetting::bRegisterWithUserSettings' has a wrong offset!");
