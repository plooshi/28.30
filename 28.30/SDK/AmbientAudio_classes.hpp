...
static_assert(sizeof(AAmbientAudioParameterActor) == 0x000298, "Wrong size on AAmbientAudioParameterActor");
static_assert(offsetof(AAmbientAudioParameterActor, Parameters) == 0x000290, "Member 'AAmbientAudioParameterActor::Parameters' has a wrong offset!");
