...
static_assert(sizeof(FDownloadCacheEntry) == 0x000030, "Wrong size on FDownloadCacheEntry");
...
static_assert(offsetof(FDownloadCacheEntry, LifetimeInDays) == 0x000028, "Member 'FDownloadCacheEntry::LifetimeInDays' has a wrong offset!");
