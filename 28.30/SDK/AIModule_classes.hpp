...
static_assert(offsetof(UEnvQueryGenerator_OnCircle, PointOnCircleSpacingMethod) == 0x0000C0, "Member 'UEnvQueryGenerator_OnCircle::PointOnCircleSpacingMethod' has a wrong offset!");
...
static_assert(sizeof(UAISystem) == 0x000178, "Wrong size on UAISystem");
...
static_assert(offsetof(UAISystem, bAllowControllersAsEQSQuerier) == 0x0000AF, "Member 'UAISystem::bAllowControllersAsEQSQuerier' has a wrong offset!");
static_assert(offsetof(UAISystem, bEnableDebuggerPlugin) == 0x0000B0, "Member 'UAISystem::bEnableDebuggerPlugin' has a wrong offset!");
static_assert(offsetof(UAISystem, bForgetStaleActors) == 0x0000B1, "Member 'UAISystem::bForgetStaleActors' has a wrong offset!");
static_assert(offsetof(UAISystem, bAddBlackboardSelfKey) == 0x0000B2, "Member 'UAISystem::bAddBlackboardSelfKey' has a wrong offset!");
static_assert(offsetof(UAISystem, bClearBBEntryOnBTEQSFail) == 0x0000B3, "Member 'UAISystem::bClearBBEntryOnBTEQSFail' has a wrong offset!");
static_assert(offsetof(UAISystem, bBlackboardKeyDecoratorAllowsNoneAsValue) == 0x0000B4, "Member 'UAISystem::bBlackboardKeyDecoratorAllowsNoneAsValue' has a wrong offset!");
static_assert(offsetof(UAISystem, DefaultBlackboard) == 0x0000B8, "Member 'UAISystem::DefaultBlackboard' has a wrong offset!");
static_assert(offsetof(UAISystem, DefaultSightCollisionChannel) == 0x0000D8, "Member 'UAISystem::DefaultSightCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAISystem, BehaviorTreeManager) == 0x0000E0, "Member 'UAISystem::BehaviorTreeManager' has a wrong offset!");
static_assert(offsetof(UAISystem, EnvironmentQueryManager) == 0x0000E8, "Member 'UAISystem::EnvironmentQueryManager' has a wrong offset!");
static_assert(offsetof(UAISystem, PerceptionSystem) == 0x0000F0, "Member 'UAISystem::PerceptionSystem' has a wrong offset!");
static_assert(offsetof(UAISystem, AllProxyObjects) == 0x0000F8, "Member 'UAISystem::AllProxyObjects' has a wrong offset!");
static_assert(offsetof(UAISystem, HotSpotManager) == 0x000108, "Member 'UAISystem::HotSpotManager' has a wrong offset!");
static_assert(offsetof(UAISystem, NavLocalGrids) == 0x000110, "Member 'UAISystem::NavLocalGrids' has a wrong offset!");
...
static_assert(sizeof(AEQSTestingPawn) == 0x000700, "Wrong size on AEQSTestingPawn");
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x000668, "Member 'AEQSTestingPawn::QueryTemplate' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x000670, "Member 'AEQSTestingPawn::QueryParams' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x000680, "Member 'AEQSTestingPawn::QueryConfig' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, TimeLimitPerStep) == 0x000690, "Member 'AEQSTestingPawn::TimeLimitPerStep' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, StepToDebugDraw) == 0x000694, "Member 'AEQSTestingPawn::StepToDebugDraw' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x000698, "Member 'AEQSTestingPawn::HighlightMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x0006A0, "Member 'AEQSTestingPawn::QueryingMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x0006A8, "Member 'AEQSTestingPawn::NavAgentProperties' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(struct FActorPerceptionUpdateInfo& UpdateInfo)> OnTargetPerceptionInfoUpdated;                     // 0x0178(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAIPerceptionComponent) == 0x000188, "Wrong size on UAIPerceptionComponent");
...
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionForgotten) == 0x000158, "Member 'UAIPerceptionComponent::OnTargetPerceptionForgotten' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionUpdated) == 0x000168, "Member 'UAIPerceptionComponent::OnTargetPerceptionUpdated' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionInfoUpdated) == 0x000178, "Member 'UAIPerceptionComponent::OnTargetPerceptionInfoUpdated' has a wrong offset!");
