...
static_assert(sizeof(PanelButton_C_UpdateInputActionLayout) == 0x0001A0, "Wrong size on PanelButton_C_UpdateInputActionLayout");
...
static_assert(offsetof(PanelButton_C_UpdateInputActionLayout, K2Node_SetFieldsInStruct_ImageSize_ImplicitCast) == 0x00018C, "Member 'PanelButton_C_UpdateInputActionLayout::K2Node_SetFieldsInStruct_ImageSize_ImplicitCast' has a wrong offset!");
