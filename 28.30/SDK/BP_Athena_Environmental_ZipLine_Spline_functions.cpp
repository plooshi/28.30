...
void ABP_Athena_Environmental_ZipLine_Spline_C::CreateSplineMesh(int32 FirstPoint, int32 SecondPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CreateSplineMesh");
...
void ABP_Athena_Environmental_ZipLine_Spline_C::ExecuteUbergraph_BP_Athena_Environmental_ZipLine_Spline(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BP_Athena_Environmental_ZipLine_Spline");
...
void ABP_Athena_Environmental_ZipLine_Spline_C::GetMIDForSplineMeshComp(class USplineMeshComponent* SplineMeshComp, int32 ElementIndex, class UMaterialInstanceDynamic** Mid)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetMIDForSplineMeshComp");
...
void ABP_Athena_Environmental_ZipLine_Spline_C::HandlePoleDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandlePoleDied");
...
void ABP_Athena_Environmental_ZipLine_Spline_C::SetInteractionCollision()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetInteractionCollision");
...
void ABP_Athena_Environmental_ZipLine_Spline_C::UpdateSplineMeshMaterials(class USplineMeshComponent* SplineMeshComp, int32 SplineIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateSplineMeshMaterials");
