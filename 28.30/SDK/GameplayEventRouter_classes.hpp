...
static_assert(sizeof(UAsyncAction_StartListeningToEvent) == 0x0000B8, "Wrong size on UAsyncAction_StartListeningToEvent");
...
static_assert(sizeof(UAsyncAction_StartListeningToStatefulEvent) == 0x0000D8, "Wrong size on UAsyncAction_StartListeningToStatefulEvent");
...
static_assert(sizeof(UGameplayEventRouterComponent) == 0x0002D8, "Wrong size on UGameplayEventRouterComponent");
...
static_assert(alignof(UGameplayEventRouterSubsystem) == 0x000008, "Wrong alignment on UGameplayEventRouterSubsystem");
static_assert(sizeof(UGameplayEventRouterSubsystem) == 0x000198, "Wrong size on UGameplayEventRouterSubsystem");
static_assert(offsetof(UGameplayEventRouterSubsystem, PendingGlobalRouterListenerDatas) == 0x000188, "Member 'UGameplayEventRouterSubsystem::PendingGlobalRouterListenerDatas' has a wrong offset!");
