...
static_assert(sizeof(FTestUndeclaredScriptStructObjectReferencesTest) == 0x000048, "Wrong size on FTestUndeclaredScriptStructObjectReferencesTest");
...
static_assert(offsetof(FTestUndeclaredScriptStructObjectReferencesTest, SoftObjectPath) == 0x000028, "Member 'FTestUndeclaredScriptStructObjectReferencesTest::SoftObjectPath' has a wrong offset!");
static_assert(offsetof(FTestUndeclaredScriptStructObjectReferencesTest, WeakObjectPointer) == 0x000040, "Member 'FTestUndeclaredScriptStructObjectReferencesTest::WeakObjectPointer' has a wrong offset!");
