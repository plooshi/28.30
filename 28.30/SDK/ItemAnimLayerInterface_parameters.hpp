...
static_assert(sizeof(ItemAnimLayerInterface_C_ItemFallAdditive) == 0x000020, "Wrong size on ItemAnimLayerInterface_C_ItemFallAdditive");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemFallAdditive, InPoseItemFallAdditive) == 0x000000, "Member 'ItemAnimLayerInterface_C_ItemFallAdditive::InPoseItemFallAdditive' has a wrong offset!");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemFallAdditive, ItemFallAdditive_0) == 0x000010, "Member 'ItemAnimLayerInterface_C_ItemFallAdditive::ItemFallAdditive_0' has a wrong offset!");
...
static_assert(sizeof(ItemAnimLayerInterface_C_ItemFallLandAdditive) == 0x000020, "Wrong size on ItemAnimLayerInterface_C_ItemFallLandAdditive");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemFallLandAdditive, InPoseItemFallLandAdditive) == 0x000000, "Member 'ItemAnimLayerInterface_C_ItemFallLandAdditive::InPoseItemFallLandAdditive' has a wrong offset!");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemFallLandAdditive, ItemFallLandAdditive_0) == 0x000010, "Member 'ItemAnimLayerInterface_C_ItemFallLandAdditive::ItemFallLandAdditive_0' has a wrong offset!");
...
static_assert(sizeof(ItemAnimLayerInterface_C_ItemJumpLoopAdditive) == 0x000020, "Wrong size on ItemAnimLayerInterface_C_ItemJumpLoopAdditive");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemJumpLoopAdditive, InPoseItemJumpLoopAdditive) == 0x000000, "Member 'ItemAnimLayerInterface_C_ItemJumpLoopAdditive::InPoseItemJumpLoopAdditive' has a wrong offset!");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemJumpLoopAdditive, ItemJumpLoopAdditive_0) == 0x000010, "Member 'ItemAnimLayerInterface_C_ItemJumpLoopAdditive::ItemJumpLoopAdditive_0' has a wrong offset!");
...
static_assert(sizeof(ItemAnimLayerInterface_C_ItemJumpUpAdditive) == 0x000020, "Wrong size on ItemAnimLayerInterface_C_ItemJumpUpAdditive");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemJumpUpAdditive, InPoseItemJumpUpAdditive) == 0x000000, "Member 'ItemAnimLayerInterface_C_ItemJumpUpAdditive::InPoseItemJumpUpAdditive' has a wrong offset!");
static_assert(offsetof(ItemAnimLayerInterface_C_ItemJumpUpAdditive, ItemJumpUpAdditive_0) == 0x000010, "Member 'ItemAnimLayerInterface_C_ItemJumpUpAdditive::ItemJumpUpAdditive_0' has a wrong offset!");
...
static_assert(sizeof(ItemAnimLayerInterface_C_ItemUpperBody) == 0x000288, "Wrong size on ItemAnimLayerInterface_C_ItemUpperBody");
...
static_assert(offsetof(ItemAnimLayerInterface_C_ItemUpperBody, ItemUpperBody_0) == 0x000278, "Member 'ItemAnimLayerInterface_C_ItemUpperBody::ItemUpperBody_0' has a wrong offset!");
