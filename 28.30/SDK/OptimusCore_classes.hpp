...
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UOptimusComponentSourceBinding> ComponentSourceBinding;                            // 0x0030(0x0008)(BlueprintReadOnly, ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 NumThreadsExpression;                              // 0x0038(0x0010)(BlueprintReadOnly, ZeroConstructor, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FOptimusConstantIdentifier             ExecutionDomainConstantIdentifier;                 // 0x0048(0x000C)(BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusCustomComputeKernelDataInterface) == 0x000058, "Wrong size on UOptimusCustomComputeKernelDataInterface");
...
public:
	...
	class UOptimusDeformerInstance*               DeformerInstance;                                  // 0x0040(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOptimusCustomComputeKernelDataProvider) == 0x000048, "Wrong size on UOptimusCustomComputeKernelDataProvider");
static_assert(offsetof(UOptimusCustomComputeKernelDataProvider, DeformerInstance) == 0x000040, "Member 'UOptimusCustomComputeKernelDataProvider::DeformerInstance' has a wrong offset!");
...
public:
	...
	struct FOptimusConstantIdentifier             DomainConstantIdentifier;                          // 0x0078(0x000C)(BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusRawBufferDataInterface) == 0x000088, "Wrong size on UOptimusRawBufferDataInterface");
...
static_assert(sizeof(UOptimusTransientBufferDataInterface) == 0x000090, "Wrong size on UOptimusTransientBufferDataInterface");
static_assert(offsetof(UOptimusTransientBufferDataInterface, bZeroInitForAtomicWrites) == 0x000088, "Member 'UOptimusTransientBufferDataInterface::bZeroInitForAtomicWrites' has a wrong offset!");
...
static_assert(sizeof(UOptimusImplicitPersistentBufferDataInterface) == 0x000090, "Wrong size on UOptimusImplicitPersistentBufferDataInterface");
static_assert(offsetof(UOptimusImplicitPersistentBufferDataInterface, bZeroInitForAtomicWrites) == 0x000088, "Member 'UOptimusImplicitPersistentBufferDataInterface::bZeroInitForAtomicWrites' has a wrong offset!");
...
static_assert(offsetof(UOptimusPersistentBufferDataInterface, ResourceName) == 0x000088, "Member 'UOptimusPersistentBufferDataInterface::ResourceName' has a wrong offset!");
...
static_assert(sizeof(UOptimusRawBufferDataProvider) == 0x0000A0, "Wrong size on UOptimusRawBufferDataProvider");
...
static_assert(sizeof(UOptimusTransientBufferDataProvider) == 0x0000A8, "Wrong size on UOptimusTransientBufferDataProvider");
...
static_assert(sizeof(UOptimusImplicitPersistentBufferDataProvider) == 0x0000C0, "Wrong size on UOptimusImplicitPersistentBufferDataProvider");
...
static_assert(sizeof(UOptimusPersistentBufferDataProvider) == 0x0000C0, "Wrong size on UOptimusPersistentBufferDataProvider");
...
static_assert(sizeof(UOptimusNode_ComputeKernelFunctionGeneratorClass) == 0x000260, "Wrong size on UOptimusNode_ComputeKernelFunctionGeneratorClass");
...
static_assert(offsetof(UOptimusNode_ComputeKernelFunctionGeneratorClass, GroupSize) == 0x000220, "Member 'UOptimusNode_ComputeKernelFunctionGeneratorClass::GroupSize' has a wrong offset!");
static_assert(offsetof(UOptimusNode_ComputeKernelFunctionGeneratorClass, InputBindings) == 0x000230, "Member 'UOptimusNode_ComputeKernelFunctionGeneratorClass::InputBindings' has a wrong offset!");
static_assert(offsetof(UOptimusNode_ComputeKernelFunctionGeneratorClass, OutputBindings) == 0x000240, "Member 'UOptimusNode_ComputeKernelFunctionGeneratorClass::OutputBindings' has a wrong offset!");
static_assert(offsetof(UOptimusNode_ComputeKernelFunctionGeneratorClass, ShaderSource) == 0x000250, "Member 'UOptimusNode_ComputeKernelFunctionGeneratorClass::ShaderSource' has a wrong offset!");
...
public:
	...
	struct FOptimusExecutionDomain                ExecutionDomain;                                   // 0x0140(0x0018)(Edit, NativeAccessSpecifierPublic)
	struct FIntVector                             GroupSize;                                         // 0x0158(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_164[0x4];                                      // 0x0164(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FOptimus_ShaderBinding>         Parameters;                                        // 0x0168(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	TArray<struct FOptimusParameterBinding>       InputBindings;                                     // 0x0178(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	TArray<struct FOptimusParameterBinding>       OutputBindings;                                    // 0x0188(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	struct FOptimusParameterBindingArray          InputBindingArray;                                 // 0x0198(0x0010)(Edit, NativeAccessSpecifierPublic)
	struct FOptimusParameterBindingArray          OutputBindingArray;                                // 0x01A8(0x0010)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FOptimusSecondaryInputBindingsGroup> SecondaryInputBindingGroups;                       // 0x01B8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class UComputeSource*>                 AdditionalSources;                                 // 0x01C8(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	struct FOptimusShaderText                     ShaderSource;                                      // 0x01D8(0x0020)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusNode_CustomComputeKernel) == 0x0001F8, "Wrong size on UOptimusNode_CustomComputeKernel");
...
static_assert(offsetof(UOptimusNode_CustomComputeKernel, GroupSize) == 0x000158, "Member 'UOptimusNode_CustomComputeKernel::GroupSize' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, Parameters) == 0x000168, "Member 'UOptimusNode_CustomComputeKernel::Parameters' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, InputBindings) == 0x000178, "Member 'UOptimusNode_CustomComputeKernel::InputBindings' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, OutputBindings) == 0x000188, "Member 'UOptimusNode_CustomComputeKernel::OutputBindings' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, InputBindingArray) == 0x000198, "Member 'UOptimusNode_CustomComputeKernel::InputBindingArray' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, OutputBindingArray) == 0x0001A8, "Member 'UOptimusNode_CustomComputeKernel::OutputBindingArray' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, SecondaryInputBindingGroups) == 0x0001B8, "Member 'UOptimusNode_CustomComputeKernel::SecondaryInputBindingGroups' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, AdditionalSources) == 0x0001C8, "Member 'UOptimusNode_CustomComputeKernel::AdditionalSources' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, ShaderSource) == 0x0001D8, "Member 'UOptimusNode_CustomComputeKernel::ShaderSource' has a wrong offset!");
...
public:
	...
	struct FOptimusConstantContainer              ConstantContainer;                                 // 0x0060(0x0010)(Protected, NativeAccessSpecifierProtected)
	class UOptimusActionStack*                    ActionStack;                                       // 0x0070(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EOptimusDeformerStatus                        Status;                                            // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_7C[0x4];                                       // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UOptimusNodeGraph*>              Graphs;                                            // 0x0080(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UOptimusComponentSourceBindingContainer* Bindings;                                          // 0x0090(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UOptimusVariableContainer*              Variables;                                         // 0x0098(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UOptimusResourceContainer*              Resources;                                         // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOptimusDeformer) == 0x000138, "Wrong size on UOptimusDeformer");
...
static_assert(offsetof(UOptimusDeformer, ConstantContainer) == 0x000060, "Member 'UOptimusDeformer::ConstantContainer' has a wrong offset!");
static_assert(offsetof(UOptimusDeformer, ActionStack) == 0x000070, "Member 'UOptimusDeformer::ActionStack' has a wrong offset!");
static_assert(offsetof(UOptimusDeformer, Status) == 0x000078, "Member 'UOptimusDeformer::Status' has a wrong offset!");
static_assert(offsetof(UOptimusDeformer, Graphs) == 0x000080, "Member 'UOptimusDeformer::Graphs' has a wrong offset!");
static_assert(offsetof(UOptimusDeformer, Bindings) == 0x000090, "Member 'UOptimusDeformer::Bindings' has a wrong offset!");
static_assert(offsetof(UOptimusDeformer, Variables) == 0x000098, "Member 'UOptimusDeformer::Variables' has a wrong offset!");
static_assert(offsetof(UOptimusDeformer, Resources) == 0x0000A0, "Member 'UOptimusDeformer::Resources' has a wrong offset!");
...
public:
	...
	struct FOptimusConstantContainer              ConstantContainer;                                 // 0x0070(0x0010)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_80[0xE8];                                      // 0x0080(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOptimusDeformerInstance) == 0x000168, "Wrong size on UOptimusDeformerInstance");
...
static_assert(offsetof(UOptimusDeformerInstance, ConstantContainer) == 0x000070, "Member 'UOptimusDeformerInstance::ConstantContainer' has a wrong offset!");
