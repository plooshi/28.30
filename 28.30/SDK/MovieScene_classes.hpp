...
public:
	...
	uint8                                         Pad_430[0x310];                                    // 0x0430(0x0310)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneEntitySystemLinker) == 0x000740, "Wrong size on UMovieSceneEntitySystemLinker");
...
public:
	...
	TScriptInterface<class IMovieSceneSequencePlayerObserver> Observer;                                          // 0x0240(0x0010)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnPlay;                                            // 0x0250(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnPlayReverse;                                     // 0x0260(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnStop;                                            // 0x0270(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnPause;                                           // 0x0280(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnFinished;                                        // 0x0290(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	struct FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                              // 0x0300(0x0070)(Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_370[0x94];                                     // 0x0370(0x0094)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequenceReplProperties      NetSyncProps;                                      // 0x0404(0x0014)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UMovieSceneSequencePlayer, Observer) == 0x000240, "Member 'UMovieSceneSequencePlayer::Observer' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPlay) == 0x000250, "Member 'UMovieSceneSequencePlayer::OnPlay' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPlayReverse) == 0x000260, "Member 'UMovieSceneSequencePlayer::OnPlayReverse' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnStop) == 0x000270, "Member 'UMovieSceneSequencePlayer::OnStop' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPause) == 0x000280, "Member 'UMovieSceneSequencePlayer::OnPause' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnFinished) == 0x000290, "Member 'UMovieSceneSequencePlayer::OnFinished' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSequencePlayer, SerialNumber) == 0x0002D0, "Member 'UMovieSceneSequencePlayer::SerialNumber' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackSettings) == 0x0002D4, "Member 'UMovieSceneSequencePlayer::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, RootTemplateInstance) == 0x000300, "Member 'UMovieSceneSequencePlayer::RootTemplateInstance' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x000404, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
