...
static_assert(sizeof(UAudioComponentBase) == 0x000098, "Wrong size on UAudioComponentBase");
static_assert(offsetof(UAudioComponentBase, SoundAsset) == 0x000088, "Member 'UAudioComponentBase::SoundAsset' has a wrong offset!");
static_assert(offsetof(UAudioComponentBase, ActiveSoundInfo) == 0x000090, "Member 'UAudioComponentBase::ActiveSoundInfo' has a wrong offset!");
...
static_assert(sizeof(UDatastoreComponentBase) == 0x000210, "Wrong size on UDatastoreComponentBase");
static_assert(offsetof(UDatastoreComponentBase, ReplicatedDatastoreState) == 0x0000D0, "Member 'UDatastoreComponentBase::ReplicatedDatastoreState' has a wrong offset!");
...
static_assert(sizeof(UVerseLevelStreamingComponentBase) == 0x000130, "Wrong size on UVerseLevelStreamingComponentBase");
static_assert(offsetof(UVerseLevelStreamingComponentBase, NewLevel) == 0x000088, "Member 'UVerseLevelStreamingComponentBase::NewLevel' has a wrong offset!");
static_assert(offsetof(UVerseLevelStreamingComponentBase, LevelStatus) == 0x0000B0, "Member 'UVerseLevelStreamingComponentBase::LevelStatus' has a wrong offset!");
...
static_assert(sizeof(UPointLightComponentBase) == 0x000090, "Wrong size on UPointLightComponentBase");
static_assert(offsetof(UPointLightComponentBase, ReplicatedLightProperties) == 0x000088, "Member 'UPointLightComponentBase::ReplicatedLightProperties' has a wrong offset!");
...
static_assert(sizeof(USpotLightComponentBase) == 0x000090, "Wrong size on USpotLightComponentBase");
static_assert(offsetof(USpotLightComponentBase, ReplicatedLightProperties) == 0x000088, "Member 'USpotLightComponentBase::ReplicatedLightProperties' has a wrong offset!");
...
static_assert(sizeof(UParticleSystemComponentBase) == 0x000098, "Wrong size on UParticleSystemComponentBase");
static_assert(offsetof(UParticleSystemComponentBase, ParticleSystemAsset) == 0x000088, "Member 'UParticleSystemComponentBase::ParticleSystemAsset' has a wrong offset!");
static_assert(offsetof(UParticleSystemComponentBase, bActive) == 0x000090, "Member 'UParticleSystemComponentBase::bActive' has a wrong offset!");
