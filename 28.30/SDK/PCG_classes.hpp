...
public:
	...
	struct FPCGAttributePropertyInputSelector     CachedLastSelector;                                // 0x0058(0x0028)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UPCGLandscapeSplineData) == 0x0000D8, "Wrong size on UPCGLandscapeSplineData");
...
static_assert(sizeof(UPCGAddTagSettings) == 0x000160, "Wrong size on UPCGAddTagSettings");
static_assert(offsetof(UPCGAddTagSettings, TagsToAdd) == 0x000150, "Member 'UPCGAddTagSettings::TagsToAdd' has a wrong offset!");
...
static_assert(sizeof(UPCGVolumeData) == 0x000160, "Wrong size on UPCGVolumeData");
...
static_assert(sizeof(UPCGSplineSamplerSettings) == 0x000218, "Wrong size on UPCGSplineSamplerSettings");
...
{
public:
	EPCGAttributeFilterOperator                   Operator;                                          // 0x0150(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGAttributeFilteringSettings) == 0x000320, "Wrong size on UPCGAttributeFilteringSettings");
static_assert(offsetof(UPCGAttributeFilteringSettings, Operator) == 0x000150, "Member 'UPCGAttributeFilteringSettings::Operator' has a wrong offset!");
static_assert(offsetof(UPCGAttributeFilteringSettings, TargetAttribute) == 0x000158, "Member 'UPCGAttributeFilteringSettings::TargetAttribute' has a wrong offset!");
static_assert(offsetof(UPCGAttributeFilteringSettings, bUseConstantThreshold) == 0x000180, "Member 'UPCGAttributeFilteringSettings::bUseConstantThreshold' has a wrong offset!");
static_assert(offsetof(UPCGAttributeFilteringSettings, ThresholdAttribute) == 0x000188, "Member 'UPCGAttributeFilteringSettings::ThresholdAttribute' has a wrong offset!");
static_assert(offsetof(UPCGAttributeFilteringSettings, bUseSpatialQuery) == 0x0001B0, "Member 'UPCGAttributeFilteringSettings::bUseSpatialQuery' has a wrong offset!");
static_assert(offsetof(UPCGAttributeFilteringSettings, AttributeTypes) == 0x0001C0, "Member 'UPCGAttributeFilteringSettings::AttributeTypes' has a wrong offset!");
...
public:
	...
	struct FPCGAttributeFilterThresholdSettings   MinThreshold;                                      // 0x0180(0x01A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FPCGAttributeFilterThresholdSettings   MaxThreshold;                                      // 0x0320(0x01A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGAttributeFilteringRangeSettings) == 0x0004C0, "Wrong size on UPCGAttributeFilteringRangeSettings");
static_assert(offsetof(UPCGAttributeFilteringRangeSettings, TargetAttribute) == 0x000150, "Member 'UPCGAttributeFilteringRangeSettings::TargetAttribute' has a wrong offset!");
static_assert(offsetof(UPCGAttributeFilteringRangeSettings, MinThreshold) == 0x000180, "Member 'UPCGAttributeFilteringRangeSettings::MinThreshold' has a wrong offset!");
static_assert(offsetof(UPCGAttributeFilteringRangeSettings, MaxThreshold) == 0x000320, "Member 'UPCGAttributeFilteringRangeSettings::MaxThreshold' has a wrong offset!");

// Class PCG.PCGAttributeFilterNamesSettings
// 0x0018 (0x0168 - 0x0150)
class UPCGAttributeFilterNamesSettings final : public UPCGSettings
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"PCGAttributeFilterNamesSettings">();
	}
	static class UPCGAttributeFilterNamesSettings* GetDefaultObj()
	{
		return GetDefaultObjImpl<UPCGAttributeFilterNamesSettings>();
	}
};
static_assert(alignof(UPCGAttributeFilterNamesSettings) == 0x000008, "Wrong alignment on UPCGAttributeFilterNamesSettings");
static_assert(sizeof(UPCGAttributeFilterNamesSettings) == 0x000168, "Wrong size on UPCGAttributeFilterNamesSettings");
static_assert(offsetof(UPCGAttributeFilterNamesSettings, Operation) == 0x000150, "Member 'UPCGAttributeFilterNamesSettings::Operation' has a wrong offset!");
static_assert(offsetof(UPCGAttributeFilterNamesSettings, SelectedAttributes) == 0x000158, "Member 'UPCGAttributeFilterNamesSettings::SelectedAttributes' has a wrong offset!");
...
static_assert(sizeof(UPCGTransformPointsSettings) == 0x000200, "Wrong size on UPCGTransformPointsSettings");
...
static_assert(offsetof(UPCGTransformPointsSettings, OffsetMin) == 0x000158, "Member 'UPCGTransformPointsSettings::OffsetMin' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, OffsetMax) == 0x000170, "Member 'UPCGTransformPointsSettings::OffsetMax' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bAbsoluteOffset) == 0x000188, "Member 'UPCGTransformPointsSettings::bAbsoluteOffset' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, RotationMin) == 0x000190, "Member 'UPCGTransformPointsSettings::RotationMin' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, RotationMax) == 0x0001A8, "Member 'UPCGTransformPointsSettings::RotationMax' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bAbsoluteRotation) == 0x0001C0, "Member 'UPCGTransformPointsSettings::bAbsoluteRotation' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, ScaleMin) == 0x0001C8, "Member 'UPCGTransformPointsSettings::ScaleMin' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, ScaleMax) == 0x0001E0, "Member 'UPCGTransformPointsSettings::ScaleMax' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bAbsoluteScale) == 0x0001F8, "Member 'UPCGTransformPointsSettings::bAbsoluteScale' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bUniformScale) == 0x0001F9, "Member 'UPCGTransformPointsSettings::bUniformScale' has a wrong offset!");
static_assert(offsetof(UPCGTransformPointsSettings, bRecomputeSeed) == 0x0001FA, "Member 'UPCGTransformPointsSettings::bRecomputeSeed' has a wrong offset!");
...
static_assert(offsetof(UPCGDataFromActorSettings, bAlsoOutputSinglePointData) == 0x000171, "Member 'UPCGDataFromActorSettings::bAlsoOutputSinglePointData' has a wrong offset!");
static_assert(offsetof(UPCGDataFromActorSettings, bMergeSinglePointData) == 0x000172, "Member 'UPCGDataFromActorSettings::bMergeSinglePointData' has a wrong offset!");
static_assert(offsetof(UPCGDataFromActorSettings, bDisplayModeSettings) == 0x000173, "Member 'UPCGDataFromActorSettings::bDisplayModeSettings' has a wrong offset!");
...
static_assert(sizeof(UPCGConvexHull2DSettings) == 0x000150, "Wrong size on UPCGConvexHull2DSettings");
...
public:
	...
	EPCGLocalGridPivot                            GridPivot;                                         // 0x0160(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGCreatePointsSettings) == 0x000168, "Wrong size on UPCGCreatePointsSettings");
static_assert(offsetof(UPCGCreatePointsSettings, PointsToCreate) == 0x000150, "Member 'UPCGCreatePointsSettings::PointsToCreate' has a wrong offset!");
static_assert(offsetof(UPCGCreatePointsSettings, GridPivot) == 0x000160, "Member 'UPCGCreatePointsSettings::GridPivot' has a wrong offset!");
static_assert(offsetof(UPCGCreatePointsSettings, bCullPointsOutsideVolume) == 0x000161, "Member 'UPCGCreatePointsSettings::bCullPointsOutsideVolume' has a wrong offset!");
...
{
public:
	struct FVector                                GridExtents;                                       // 0x0150(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                CellSize;                                          // 0x0168(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGGridPivot                                 GridPivot;                                         // 0x0180(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSetPointsBounds;                                  // 0x0181(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCullPointsOutsideVolume;                          // 0x0182(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGPointPosition                             PointPosition;                                     // 0x0183(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGCreatePointsGridSettings) == 0x000188, "Wrong size on UPCGCreatePointsGridSettings");
static_assert(offsetof(UPCGCreatePointsGridSettings, GridExtents) == 0x000150, "Member 'UPCGCreatePointsGridSettings::GridExtents' has a wrong offset!");
static_assert(offsetof(UPCGCreatePointsGridSettings, CellSize) == 0x000168, "Member 'UPCGCreatePointsGridSettings::CellSize' has a wrong offset!");
static_assert(offsetof(UPCGCreatePointsGridSettings, GridPivot) == 0x000180, "Member 'UPCGCreatePointsGridSettings::GridPivot' has a wrong offset!");
static_assert(offsetof(UPCGCreatePointsGridSettings, bSetPointsBounds) == 0x000181, "Member 'UPCGCreatePointsGridSettings::bSetPointsBounds' has a wrong offset!");
static_assert(offsetof(UPCGCreatePointsGridSettings, bCullPointsOutsideVolume) == 0x000182, "Member 'UPCGCreatePointsGridSettings::bCullPointsOutsideVolume' has a wrong offset!");
static_assert(offsetof(UPCGCreatePointsGridSettings, PointPosition) == 0x000183, "Member 'UPCGCreatePointsGridSettings::PointPosition' has a wrong offset!");
...
{
public:
	float                                         BoundsExpansion;                                   // 0x0150(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGCullPointsOutsideActorBoundsSettings) == 0x000158, "Wrong size on UPCGCullPointsOutsideActorBoundsSettings");
static_assert(offsetof(UPCGCullPointsOutsideActorBoundsSettings, BoundsExpansion) == 0x000150, "Member 'UPCGCullPointsOutsideActorBoundsSettings::BoundsExpansion' has a wrong offset!");
...
static_assert(offsetof(UPCGLoadDataTableSettings, OutputType) == 0x0001C0, "Member 'UPCGLoadDataTableSettings::OutputType' has a wrong offset!");
...
static_assert(sizeof(UPCGDistanceSettings) == 0x000168, "Wrong size on UPCGDistanceSettings");
...
static_assert(offsetof(UPCGDistanceSettings, bOutputDistanceVector) == 0x000154, "Member 'UPCGDistanceSettings::bOutputDistanceVector' has a wrong offset!");
static_assert(offsetof(UPCGDistanceSettings, bSetDensity) == 0x000155, "Member 'UPCGDistanceSettings::bSetDensity' has a wrong offset!");
static_assert(offsetof(UPCGDistanceSettings, MaximumDistance) == 0x000158, "Member 'UPCGDistanceSettings::MaximumDistance' has a wrong offset!");
static_assert(offsetof(UPCGDistanceSettings, SourceShape) == 0x000160, "Member 'UPCGDistanceSettings::SourceShape' has a wrong offset!");
static_assert(offsetof(UPCGDistanceSettings, TargetShape) == 0x000164, "Member 'UPCGDistanceSettings::TargetShape' has a wrong offset!");
...
static_assert(offsetof(UPCGEngineSettings, VolumeScale) == 0x000030, "Member 'UPCGEngineSettings::VolumeScale' has a wrong offset!");
static_assert(offsetof(UPCGEngineSettings, bGenerateOnDrop) == 0x000048, "Member 'UPCGEngineSettings::bGenerateOnDrop' has a wrong offset!");
...
static_assert(sizeof(UPCGGetBoundsSettings) == 0x000150, "Wrong size on UPCGGetBoundsSettings");
...
static_assert(sizeof(UPCGMergeAttributesSettings) == 0x000150, "Wrong size on UPCGMergeAttributesSettings");
...
static_assert(sizeof(UPCGMutateSeedSettings) == 0x000150, "Wrong size on UPCGMutateSeedSettings");
...
static_assert(sizeof(UPCGNumberOfElementsBaseSettings) == 0x000158, "Wrong size on UPCGNumberOfElementsBaseSettings");
static_assert(offsetof(UPCGNumberOfElementsBaseSettings, OutputAttributeName) == 0x000150, "Member 'UPCGNumberOfElementsBaseSettings::OutputAttributeName' has a wrong offset!");
...
static_assert(sizeof(UPCGNumberOfEntriesSettings) == 0x000158, "Wrong size on UPCGNumberOfEntriesSettings");
...
public:
	...
	bool                                          bKeepZeroDensityPoints;                            // 0x0162(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGOuterIntersectionSettings, bKeepZeroDensityPoints) == 0x000162, "Member 'UPCGOuterIntersectionSettings::bKeepZeroDensityPoints' has a wrong offset!");
...
static_assert(alignof(UPCGSortPointsSettings) == 0x000008, "Wrong alignment on UPCGSortPointsSettings");
static_assert(sizeof(UPCGSortPointsSettings) == 0x000180, "Wrong size on UPCGSortPointsSettings");
static_assert(offsetof(UPCGSortPointsSettings, InputSource) == 0x000150, "Member 'UPCGSortPointsSettings::InputSource' has a wrong offset!");
static_assert(offsetof(UPCGSortPointsSettings, SortMethod) == 0x000178, "Member 'UPCGSortPointsSettings::SortMethod' has a wrong offset!");
...
public:
	...
	bool                                          bForceObjectAndStructExtraction;                   // 0x0164(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGUserParameterGetSettings, bForceObjectAndStructExtraction) == 0x000164, "Member 'UPCGUserParameterGetSettings::bForceObjectAndStructExtraction' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_17D[0x23];                                     // 0x017D(0x0023)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	TWeakObjectPtr<class UWorld>                  World;                                             // 0x0160(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UPCGComponent>           OriginatingComponent;                              // 0x0168(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPCGWorldVolumetricQueryParams         QueryParams;                                       // 0x0170(0x0078)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGWorldVolumetricData) == 0x0001E8, "Wrong size on UPCGWorldVolumetricData");
static_assert(offsetof(UPCGWorldVolumetricData, World) == 0x000160, "Member 'UPCGWorldVolumetricData::World' has a wrong offset!");
static_assert(offsetof(UPCGWorldVolumetricData, OriginatingComponent) == 0x000168, "Member 'UPCGWorldVolumetricData::OriginatingComponent' has a wrong offset!");
static_assert(offsetof(UPCGWorldVolumetricData, QueryParams) == 0x000170, "Member 'UPCGWorldVolumetricData::QueryParams' has a wrong offset!");
...
public:
	...
	bool                                          bForceRoundingOpToInt;                             // 0x0182(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceOpToDouble;                                  // 0x0183(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGMetadataMathsSettings, bForceRoundingOpToInt) == 0x000182, "Member 'UPCGMetadataMathsSettings::bForceRoundingOpToInt' has a wrong offset!");
static_assert(offsetof(UPCGMetadataMathsSettings, bForceOpToDouble) == 0x000183, "Member 'UPCGMetadataMathsSettings::bForceOpToDouble' has a wrong offset!");
...
{
public:
	struct FPCGAttributePropertyInputSelector     PartitionAttributeSource;                          // 0x0150(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGMetadataPartitionSettings) == 0x000178, "Wrong size on UPCGMetadataPartitionSettings");
static_assert(offsetof(UPCGMetadataPartitionSettings, PartitionAttributeSource) == 0x000150, "Member 'UPCGMetadataPartitionSettings::PartitionAttributeSource' has a wrong offset!");
...
static_assert(sizeof(UPCGMetadataRenameSettings) == 0x000158, "Wrong size on UPCGMetadataRenameSettings");
...
static_assert(offsetof(UPCGMetadataRenameSettings, NewAttributeName) == 0x000154, "Member 'UPCGMetadataRenameSettings::NewAttributeName' has a wrong offset!");
...
static_assert(sizeof(UPCGAttributeGetFromIndexSettings) == 0x000158, "Wrong size on UPCGAttributeGetFromIndexSettings");
static_assert(offsetof(UPCGAttributeGetFromIndexSettings, Index_0) == 0x000150, "Member 'UPCGAttributeGetFromIndexSettings::Index_0' has a wrong offset!");
...
static_assert(sizeof(UPCGAttributeGetFromPointIndexSettings) == 0x000180, "Wrong size on UPCGAttributeGetFromPointIndexSettings");
...
static_assert(offsetof(UPCGAttributeReduceSettings, Operation) == 0x00017C, "Member 'UPCGAttributeReduceSettings::Operation' has a wrong offset!");
static_assert(offsetof(UPCGAttributeReduceSettings, bMergeOutputAttributes) == 0x000180, "Member 'UPCGAttributeReduceSettings::bMergeOutputAttributes' has a wrong offset!");
...
static_assert(offsetof(UPCGAttributeSelectSettings, Operation) == 0x00017C, "Member 'UPCGAttributeSelectSettings::Operation' has a wrong offset!");
static_assert(offsetof(UPCGAttributeSelectSettings, Axis) == 0x000180, "Member 'UPCGAttributeSelectSettings::Axis' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_184[0x4];                                      // 0x0184(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           PostProcessFunctionNames;                          // 0x0188(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGCreateSplineSettings, LeaveTangentAttribute) == 0x000158, "Member 'UPCGCreateSplineSettings::LeaveTangentAttribute' has a wrong offset!");
static_assert(offsetof(UPCGCreateSplineSettings, TargetActor) == 0x000160, "Member 'UPCGCreateSplineSettings::TargetActor' has a wrong offset!");
static_assert(offsetof(UPCGCreateSplineSettings, AttachOptions) == 0x000180, "Member 'UPCGCreateSplineSettings::AttachOptions' has a wrong offset!");
static_assert(offsetof(UPCGCreateSplineSettings, PostProcessFunctionNames) == 0x000188, "Member 'UPCGCreateSplineSettings::PostProcessFunctionNames' has a wrong offset!");
...
public:
	...
	TArray<struct FPCGActorPropertyOverrideDescription> PropertyOverrideDescriptions;                      // 0x0200(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           PostProcessFunctionNames;                          // 0x0210(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGCreateTargetActor) == 0x000220, "Wrong size on UPCGCreateTargetActor");
...
static_assert(offsetof(UPCGCreateTargetActor, ActorLabel) == 0x000188, "Member 'UPCGCreateTargetActor::ActorLabel' has a wrong offset!");
...
static_assert(offsetof(UPCGCreateTargetActor, PropertyOverrideDescriptions) == 0x000200, "Member 'UPCGCreateTargetActor::PropertyOverrideDescriptions' has a wrong offset!");
static_assert(offsetof(UPCGCreateTargetActor, PostProcessFunctionNames) == 0x000210, "Member 'UPCGCreateTargetActor::PostProcessFunctionNames' has a wrong offset!");
...
static_assert(sizeof(UPCGDataTableRowToParamDataSettings) == 0x000188, "Wrong size on UPCGDataTableRowToParamDataSettings");
...
static_assert(sizeof(UPCGDebugSettings) == 0x000170, "Wrong size on UPCGDebugSettings");
...
public:
	...
	bool                                          bKeepZeroDensityPoints;                            // 0x0153(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_154[0x4];                                      // 0x0154(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UPCGDifferenceSettings, bKeepZeroDensityPoints) == 0x000153, "Member 'UPCGDifferenceSettings::bKeepZeroDensityPoints' has a wrong offset!");
...
{
public:
	EPCGProxyInterfaceMode                        ProxyInterfaceMode;                                // 0x0150(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_151[0x7];                                      // 0x0151(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UPCGSettings>               SettingsClass;                                     // 0x0158(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class UPCGBlueprintElement>       BlueprintElementClass;                             // 0x0160(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UPCGSettings>            Settings;                                          // 0x0168(0x0020)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTagOutputsBasedOnOutputPins;                      // 0x0188(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGIndirectionSettings) == 0x000190, "Wrong size on UPCGIndirectionSettings");
static_assert(offsetof(UPCGIndirectionSettings, ProxyInterfaceMode) == 0x000150, "Member 'UPCGIndirectionSettings::ProxyInterfaceMode' has a wrong offset!");
static_assert(offsetof(UPCGIndirectionSettings, SettingsClass) == 0x000158, "Member 'UPCGIndirectionSettings::SettingsClass' has a wrong offset!");
static_assert(offsetof(UPCGIndirectionSettings, BlueprintElementClass) == 0x000160, "Member 'UPCGIndirectionSettings::BlueprintElementClass' has a wrong offset!");
static_assert(offsetof(UPCGIndirectionSettings, Settings) == 0x000168, "Member 'UPCGIndirectionSettings::Settings' has a wrong offset!");
static_assert(offsetof(UPCGIndirectionSettings, bTagOutputsBasedOnOutputPins) == 0x000188, "Member 'UPCGIndirectionSettings::bTagOutputsBasedOnOutputPins' has a wrong offset!");
...
public:
	...
	bool                                          bKeepZeroDensityPoints;                            // 0x0151(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGInnerIntersectionSettings, bKeepZeroDensityPoints) == 0x000151, "Member 'UPCGInnerIntersectionSettings::bKeepZeroDensityPoints' has a wrong offset!");
...
static_assert(sizeof(UPCGMatchAndSetAttributesSettings) == 0x0001B8, "Wrong size on UPCGMatchAndSetAttributesSettings");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bMatchAttributes) == 0x000150, "Member 'UPCGMatchAndSetAttributesSettings::bMatchAttributes' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, InputAttribute) == 0x000158, "Member 'UPCGMatchAndSetAttributesSettings::InputAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, MatchAttribute) == 0x000180, "Member 'UPCGMatchAndSetAttributesSettings::MatchAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bKeepUnmatched) == 0x000184, "Member 'UPCGMatchAndSetAttributesSettings::bKeepUnmatched' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bUseInputWeightAttribute) == 0x000185, "Member 'UPCGMatchAndSetAttributesSettings::bUseInputWeightAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, InputWeightAttribute) == 0x000188, "Member 'UPCGMatchAndSetAttributesSettings::InputWeightAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, bUseWeightAttribute) == 0x0001B0, "Member 'UPCGMatchAndSetAttributesSettings::bUseWeightAttribute' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetAttributesSettings, WeightAttribute) == 0x0001B4, "Member 'UPCGMatchAndSetAttributesSettings::WeightAttribute' has a wrong offset!");
...
static_assert(sizeof(UPCGPointFromMeshSettings) == 0x000178, "Wrong size on UPCGPointFromMeshSettings");
...
static_assert(offsetof(UPCGPointFromMeshSettings, MeshPathAttributeName) == 0x000170, "Member 'UPCGPointFromMeshSettings::MeshPathAttributeName' has a wrong offset!");
...
public:
	...
	bool                                          bKeepZeroDensityPoints;                            // 0x0170(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGProjectionSettings) == 0x000178, "Wrong size on UPCGProjectionSettings");
...
static_assert(offsetof(UPCGProjectionSettings, bKeepZeroDensityPoints) == 0x000170, "Member 'UPCGProjectionSettings::bKeepZeroDensityPoints' has a wrong offset!");
...
public:
	...
	bool                                          bForceObjectAndStructExtraction;                   // 0x0184(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGPropertyToParamDataSettings) == 0x0001A8, "Wrong size on UPCGPropertyToParamDataSettings");
...
static_assert(offsetof(UPCGPropertyToParamDataSettings, bForceObjectAndStructExtraction) == 0x000184, "Member 'UPCGPropertyToParamDataSettings::bForceObjectAndStructExtraction' has a wrong offset!");
static_assert(offsetof(UPCGPropertyToParamDataSettings, OutputAttributeName) == 0x000188, "Member 'UPCGPropertyToParamDataSettings::OutputAttributeName' has a wrong offset!");
static_assert(offsetof(UPCGPropertyToParamDataSettings, bAlwaysRequeryActors) == 0x00018C, "Member 'UPCGPropertyToParamDataSettings::bAlwaysRequeryActors' has a wrong offset!");
static_assert(offsetof(UPCGPropertyToParamDataSettings, ActorSelection) == 0x00018D, "Member 'UPCGPropertyToParamDataSettings::ActorSelection' has a wrong offset!");
static_assert(offsetof(UPCGPropertyToParamDataSettings, ActorSelectionTag) == 0x000190, "Member 'UPCGPropertyToParamDataSettings::ActorSelectionTag' has a wrong offset!");
static_assert(offsetof(UPCGPropertyToParamDataSettings, ActorSelectionName) == 0x000194, "Member 'UPCGPropertyToParamDataSettings::ActorSelectionName' has a wrong offset!");
static_assert(offsetof(UPCGPropertyToParamDataSettings, ActorSelectionClass) == 0x000198, "Member 'UPCGPropertyToParamDataSettings::ActorSelectionClass' has a wrong offset!");
static_assert(offsetof(UPCGPropertyToParamDataSettings, ActorFilter) == 0x0001A0, "Member 'UPCGPropertyToParamDataSettings::ActorFilter' has a wrong offset!");
static_assert(offsetof(UPCGPropertyToParamDataSettings, bIncludeChildren) == 0x0001A1, "Member 'UPCGPropertyToParamDataSettings::bIncludeChildren' has a wrong offset!");
...
public:
	...
	TArray<struct FPCGActorPropertyOverrideDescription> SpawnedActorPropertyOverrideDescriptions;          // 0x0190(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGSpawnActorSettings) == 0x0001D0, "Wrong size on UPCGSpawnActorSettings");
...
static_assert(offsetof(UPCGSpawnActorSettings, SpawnedActorPropertyOverrideDescriptions) == 0x000190, "Member 'UPCGSpawnActorSettings::SpawnedActorPropertyOverrideDescriptions' has a wrong offset!");
...
static_assert(offsetof(UPCGSpawnActorSettings, AttachOptions) == 0x0001C0, "Member 'UPCGSpawnActorSettings::AttachOptions' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, bSpawnByAttribute) == 0x0001C4, "Member 'UPCGSpawnActorSettings::bSpawnByAttribute' has a wrong offset!");
static_assert(offsetof(UPCGSpawnActorSettings, SpawnAttribute) == 0x0001C8, "Member 'UPCGSpawnActorSettings::SpawnAttribute' has a wrong offset!");
...
public:
	...
	TArray<class FName>                           PostProcessFunctionNames;                          // 0x0198(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UPCGStaticMeshSpawnerSettings, bApplyMeshBoundsToPoints) == 0x000174, "Member 'UPCGStaticMeshSpawnerSettings::bApplyMeshBoundsToPoints' has a wrong offset!");
static_assert(offsetof(UPCGStaticMeshSpawnerSettings, TargetActor) == 0x000178, "Member 'UPCGStaticMeshSpawnerSettings::TargetActor' has a wrong offset!");
static_assert(offsetof(UPCGStaticMeshSpawnerSettings, PostProcessFunctionNames) == 0x000198, "Member 'UPCGStaticMeshSpawnerSettings::PostProcessFunctionNames' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UTexture>                Texture;                                           // 0x01B8(0x0020)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TextureArrayIndex;                                 // 0x01D8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGTextureDensityFunction                    DensityFunction;                                   // 0x01DC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPCGTextureColorChannel                       ColorChannel;                                      // 0x01DD(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DE[0x2];                                      // 0x01DE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TexelSize;                                         // 0x01E0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseAdvancedTiling;                                // 0x01E4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPCGTextureSamplerSettings) == 0x000230, "Wrong size on UPCGTextureSamplerSettings");
...
static_assert(offsetof(UPCGTextureSamplerSettings, TextureArrayIndex) == 0x0001D8, "Member 'UPCGTextureSamplerSettings::TextureArrayIndex' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, DensityFunction) == 0x0001DC, "Member 'UPCGTextureSamplerSettings::DensityFunction' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, ColorChannel) == 0x0001DD, "Member 'UPCGTextureSamplerSettings::ColorChannel' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, TexelSize) == 0x0001E0, "Member 'UPCGTextureSamplerSettings::TexelSize' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, bUseAdvancedTiling) == 0x0001E4, "Member 'UPCGTextureSamplerSettings::bUseAdvancedTiling' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, Tiling) == 0x0001E8, "Member 'UPCGTextureSamplerSettings::Tiling' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, CenterOffset) == 0x0001F8, "Member 'UPCGTextureSamplerSettings::CenterOffset' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, Rotation) == 0x000208, "Member 'UPCGTextureSamplerSettings::Rotation' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, bUseTileBounds) == 0x00020C, "Member 'UPCGTextureSamplerSettings::bUseTileBounds' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, TileBoundsMin) == 0x000210, "Member 'UPCGTextureSamplerSettings::TileBoundsMin' has a wrong offset!");
static_assert(offsetof(UPCGTextureSamplerSettings, TileBoundsMax) == 0x000220, "Member 'UPCGTextureSamplerSettings::TileBoundsMax' has a wrong offset!");
...
static_assert(offsetof(UPCGGetLandscapeSettings, SamplingProperties) == 0x000190, "Member 'UPCGGetLandscapeSettings::SamplingProperties' has a wrong offset!");
...
static_assert(offsetof(UPCGMatchAndSetByAttribute, MatchSourceType) == 0x000034, "Member 'UPCGMatchAndSetByAttribute::MatchSourceType' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetByAttribute, MatchSourceStringMode) == 0x000038, "Member 'UPCGMatchAndSetByAttribute::MatchSourceStringMode' has a wrong offset!");
...
static_assert(offsetof(UPCGMatchAndSetWeightedByCategory, CategoryType) == 0x000034, "Member 'UPCGMatchAndSetWeightedByCategory::CategoryType' has a wrong offset!");
static_assert(offsetof(UPCGMatchAndSetWeightedByCategory, CategoryStringMode) == 0x000038, "Member 'UPCGMatchAndSetWeightedByCategory::CategoryStringMode' has a wrong offset!");
...
public:
	...
	bool                                          bOverrideGenerationRadii;                          // 0x00A7(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPCGRuntimeGenerationRadii             GenerationRadii;                                   // 0x00A8(0x0060)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	TSubclassOf<class UPCGSchedulingPolicyBase>   SchedulingPolicyClass;                             // 0x0108(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPCGSchedulingPolicyBase*               SchedulingPolicy;                                  // 0x0110(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bGenerated;                                        // 0x0118(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRuntimeGenerated;                                 // 0x0119(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, NonPIEDuplicateTransient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11A[0x6];                                      // 0x011A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           PostGenerateFunctionNames;                         // 0x0120(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	class UPCGGraphInstance*                      GraphInstance;                                     // 0x0130(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint32                                        GenerationGridSize;                                // 0x0138(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EPCGEditorDirtyMode                           CurrentEditingMode;                                // 0x013C(0x0001)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EPCGEditorDirtyMode                           SerializedEditingMode;                             // 0x013D(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EPCGComponentInput                            InputType;                                         // 0x013E(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bParseActorComponents;                             // 0x013F(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPCGData*                               CachedPCGData;                                     // 0x0140(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPCGData*                               CachedInputData;                                   // 0x0148(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPCGData*                               CachedActorData;                                   // 0x0150(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPCGData*                               CachedLandscapeData;                               // 0x0158(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPCGData*                               CachedLandscapeHeightData;                         // 0x0160(0x0008)(ZeroConstructor, Transient, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UPCGManagedResource*>            GeneratedResources;                                // 0x0168(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_178[0x8];                                      // 0x0178(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBox                                   LastGeneratedBounds;                               // 0x0180(0x0038)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	struct FPCGDataCollection                     GeneratedGraphOutput;                              // 0x01B8(0x0020)(Edit, DisableEditOnTemplate, EditConst, NativeAccessSpecifierPrivate)
	TMap<class FString, struct FPCGDataCollection> PerPinGeneratedOutput;                             // 0x01D8(0x0050)(Edit, Transient, EditConst, NativeAccessSpecifierPrivate)
	uint8                                         Pad_228[0x18];                                     // 0x0228(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bIsComponentLocal;                                 // 0x0240(0x0001)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UPCGComponent) == 0x000270, "Wrong size on UPCGComponent");
...
static_assert(offsetof(UPCGComponent, bOverrideGenerationRadii) == 0x0000A7, "Member 'UPCGComponent::bOverrideGenerationRadii' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GenerationRadii) == 0x0000A8, "Member 'UPCGComponent::GenerationRadii' has a wrong offset!");
static_assert(offsetof(UPCGComponent, SchedulingPolicyClass) == 0x000108, "Member 'UPCGComponent::SchedulingPolicyClass' has a wrong offset!");
static_assert(offsetof(UPCGComponent, SchedulingPolicy) == 0x000110, "Member 'UPCGComponent::SchedulingPolicy' has a wrong offset!");
static_assert(offsetof(UPCGComponent, bGenerated) == 0x000118, "Member 'UPCGComponent::bGenerated' has a wrong offset!");
static_assert(offsetof(UPCGComponent, bRuntimeGenerated) == 0x000119, "Member 'UPCGComponent::bRuntimeGenerated' has a wrong offset!");
static_assert(offsetof(UPCGComponent, PostGenerateFunctionNames) == 0x000120, "Member 'UPCGComponent::PostGenerateFunctionNames' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GraphInstance) == 0x000130, "Member 'UPCGComponent::GraphInstance' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GenerationGridSize) == 0x000138, "Member 'UPCGComponent::GenerationGridSize' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CurrentEditingMode) == 0x00013C, "Member 'UPCGComponent::CurrentEditingMode' has a wrong offset!");
static_assert(offsetof(UPCGComponent, SerializedEditingMode) == 0x00013D, "Member 'UPCGComponent::SerializedEditingMode' has a wrong offset!");
static_assert(offsetof(UPCGComponent, InputType) == 0x00013E, "Member 'UPCGComponent::InputType' has a wrong offset!");
static_assert(offsetof(UPCGComponent, bParseActorComponents) == 0x00013F, "Member 'UPCGComponent::bParseActorComponents' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedPCGData) == 0x000140, "Member 'UPCGComponent::CachedPCGData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedInputData) == 0x000148, "Member 'UPCGComponent::CachedInputData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedActorData) == 0x000150, "Member 'UPCGComponent::CachedActorData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedLandscapeData) == 0x000158, "Member 'UPCGComponent::CachedLandscapeData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, CachedLandscapeHeightData) == 0x000160, "Member 'UPCGComponent::CachedLandscapeHeightData' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GeneratedResources) == 0x000168, "Member 'UPCGComponent::GeneratedResources' has a wrong offset!");
static_assert(offsetof(UPCGComponent, LastGeneratedBounds) == 0x000180, "Member 'UPCGComponent::LastGeneratedBounds' has a wrong offset!");
static_assert(offsetof(UPCGComponent, GeneratedGraphOutput) == 0x0001B8, "Member 'UPCGComponent::GeneratedGraphOutput' has a wrong offset!");
static_assert(offsetof(UPCGComponent, PerPinGeneratedOutput) == 0x0001D8, "Member 'UPCGComponent::PerPinGeneratedOutput' has a wrong offset!");
static_assert(offsetof(UPCGComponent, bIsComponentLocal) == 0x000240, "Member 'UPCGComponent::bIsComponentLocal' has a wrong offset!");
...
static_assert(offsetof(UPCGManagedISMComponent, bHasDescriptor) == 0x000058, "Member 'UPCGManagedISMComponent::bHasDescriptor' has a wrong offset!");
static_assert(offsetof(UPCGManagedISMComponent, Descriptor) == 0x000060, "Member 'UPCGManagedISMComponent::Descriptor' has a wrong offset!");
static_assert(offsetof(UPCGManagedISMComponent, bHasRootLocation) == 0x000270, "Member 'UPCGManagedISMComponent::bHasRootLocation' has a wrong offset!");
static_assert(offsetof(UPCGManagedISMComponent, RootLocation) == 0x000278, "Member 'UPCGManagedISMComponent::RootLocation' has a wrong offset!");
static_assert(offsetof(UPCGManagedISMComponent, SettingsUID) == 0x000290, "Member 'UPCGManagedISMComponent::SettingsUID' has a wrong offset!");
...
// 0x0670 (0x06B0 - 0x0040)
class UPCGSubsystem final : public UTickableWorldSubsystem
{
public:
	uint8                                         Pad_40[0x670];                                     // 0x0040(0x0670)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPCGSubsystem) == 0x0006B0, "Wrong size on UPCGSubsystem");
...
static_assert(sizeof(APCGWorldActor) == 0x000300, "Wrong size on APCGWorldActor");
...
public:
	...
	struct FPCGDummyGetPropertyStruct             DummyStruct;                                       // 0x0438(0x0028)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APCGUnitTestDummyActor) == 0x000460, "Wrong size on APCGUnitTestDummyActor");
...
static_assert(offsetof(APCGUnitTestDummyActor, StringProperty) == 0x0002B0, "Member 'APCGUnitTestDummyActor::StringProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, EnumProperty) == 0x0002C0, "Member 'APCGUnitTestDummyActor::EnumProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, VectorProperty) == 0x0002C8, "Member 'APCGUnitTestDummyActor::VectorProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, Vector4Property) == 0x0002E0, "Member 'APCGUnitTestDummyActor::Vector4Property' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, TransformProperty) == 0x000300, "Member 'APCGUnitTestDummyActor::TransformProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, RotatorProperty) == 0x000360, "Member 'APCGUnitTestDummyActor::RotatorProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, QuatProperty) == 0x000380, "Member 'APCGUnitTestDummyActor::QuatProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, SoftObjectPathProperty) == 0x0003A0, "Member 'APCGUnitTestDummyActor::SoftObjectPathProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, SoftClassPathProperty) == 0x0003B8, "Member 'APCGUnitTestDummyActor::SoftClassPathProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ClassProperty) == 0x0003D0, "Member 'APCGUnitTestDummyActor::ClassProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ObjectProperty) == 0x0003D8, "Member 'APCGUnitTestDummyActor::ObjectProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, Vector2Property) == 0x0003E0, "Member 'APCGUnitTestDummyActor::Vector2Property' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ColorProperty) == 0x0003F0, "Member 'APCGUnitTestDummyActor::ColorProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ArrayOfIntsProperty) == 0x0003F8, "Member 'APCGUnitTestDummyActor::ArrayOfIntsProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ArrayOfVectorsProperty) == 0x000408, "Member 'APCGUnitTestDummyActor::ArrayOfVectorsProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ArrayOfStructsProperty) == 0x000418, "Member 'APCGUnitTestDummyActor::ArrayOfStructsProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, ArrayOfObjectsProperty) == 0x000428, "Member 'APCGUnitTestDummyActor::ArrayOfObjectsProperty' has a wrong offset!");
static_assert(offsetof(APCGUnitTestDummyActor, DummyStruct) == 0x000438, "Member 'APCGUnitTestDummyActor::DummyStruct' has a wrong offset!");
