...
static_assert(offsetof(FMovieSceneEventPayloadVariable, Value) == 0x000018, "Member 'FMovieSceneEventPayloadVariable::Value' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneCameraShakeInstanceData) == 0x000018, "Wrong size on FMovieSceneCameraShakeInstanceData");
...
static_assert(offsetof(FMovieSceneAudioInputData, StringInput) == 0x000024, "Member 'FMovieSceneAudioInputData::StringInput' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioInputData, BoolInput) == 0x000028, "Member 'FMovieSceneAudioInputData::BoolInput' has a wrong offset!");
static_assert(offsetof(FMovieSceneAudioInputData, IntInput) == 0x00002C, "Member 'FMovieSceneAudioInputData::IntInput' has a wrong offset!");
...
static_assert(offsetof(FComponentMaterialInfo, MaterialSlotIndex) == 0x000004, "Member 'FComponentMaterialInfo::MaterialSlotIndex' has a wrong offset!");
static_assert(offsetof(FComponentMaterialInfo, MaterialType) == 0x000008, "Member 'FComponentMaterialInfo::MaterialType' has a wrong offset!");
