...
static_assert(offsetof(InterchangePipelineBase_FindOrAddPropertyStates, ReturnValue) == 0x000004, "Member 'InterchangePipelineBase_FindOrAddPropertyStates::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(InterchangePipelineBase_DoesPropertyStatesExist, ReturnValue) == 0x000004, "Member 'InterchangePipelineBase_DoesPropertyStatesExist::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(InterchangeFactoryBaseNode_SetCustomReferenceObject, ReturnValue) == 0x000018, "Member 'InterchangeFactoryBaseNode_SetCustomReferenceObject::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(InterchangeFactoryBaseNode_GetCustomReferenceObject, ReturnValue) == 0x000018, "Member 'InterchangeFactoryBaseNode_GetCustomReferenceObject::ReturnValue' has a wrong offset!");
