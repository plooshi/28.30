...
void AGCN_Loop_GhostMode_C::ExecuteUbergraph_GCN_Loop_GhostMode(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_GCN_Loop_GhostMode");
...
void AGCN_Loop_GhostMode_C::FadeMaterialsIn()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FadeMaterialsIn");
...
void AGCN_Loop_GhostMode_C::FadeMaterialsOut()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FadeMaterialsOut");
...
void AGCN_Loop_GhostMode_C::FadeMaterialsTL__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FadeMaterialsTL__FinishedFunc");
...
void AGCN_Loop_GhostMode_C::FadeMaterialsTL__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FadeMaterialsTL__UpdateFunc");
...
void AGCN_Loop_GhostMode_C::Highlight_Lerp(double Alpha, struct FPawnHighlight* Highlight)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Highlight Lerp");
