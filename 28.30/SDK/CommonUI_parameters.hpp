...
static_assert(sizeof(CommonLazyWidget_SetLazyContent) == 0x000020, "Wrong size on CommonLazyWidget_SetLazyContent");
...
static_assert(sizeof(CommonUISubsystemBase_GetEnhancedInputActionButtonIcon) == 0x0000D0, "Wrong size on CommonUISubsystemBase_GetEnhancedInputActionButtonIcon");
