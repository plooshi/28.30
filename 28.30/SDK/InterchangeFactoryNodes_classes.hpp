...
static_assert(sizeof(UInterchangeDecalMaterialFactoryNode) == 0x000160, "Wrong size on UInterchangeDecalMaterialFactoryNode");
...
static_assert(sizeof(UInterchangeLightFactoryNode) == 0x0001F0, "Wrong size on UInterchangeLightFactoryNode");
...
static_assert(sizeof(UInterchangeRectLightFactoryNode) == 0x000210, "Wrong size on UInterchangeRectLightFactoryNode");
...
static_assert(sizeof(UInterchangePointLightFactoryNode) == 0x000210, "Wrong size on UInterchangePointLightFactoryNode");
...
static_assert(sizeof(UInterchangeSpotLightFactoryNode) == 0x000230, "Wrong size on UInterchangeSpotLightFactoryNode");
...
static_assert(sizeof(UInterchangeSkeletalMeshFactoryNode) == 0x000388, "Wrong size on UInterchangeSkeletalMeshFactoryNode");
