...
static_assert(offsetof(FStoreOfferInfo, Storefront) == 0x000000, "Member 'FStoreOfferInfo::Storefront' has a wrong offset!");
static_assert(offsetof(FStoreOfferInfo, StoreId) == 0x000010, "Member 'FStoreOfferInfo::StoreId' has a wrong offset!");
static_assert(offsetof(FStoreOfferInfo, GroupId) == 0x000020, "Member 'FStoreOfferInfo::GroupId' has a wrong offset!");
...
static_assert(offsetof(FCatalogPurchaseAdditionalData, IslandId) == 0x000030, "Member 'FCatalogPurchaseAdditionalData::IslandId' has a wrong offset!");
static_assert(offsetof(FCatalogPurchaseAdditionalData, IslandTitle) == 0x000040, "Member 'FCatalogPurchaseAdditionalData::IslandTitle' has a wrong offset!");
static_assert(offsetof(FCatalogPurchaseAdditionalData, ProductTag) == 0x000050, "Member 'FCatalogPurchaseAdditionalData::ProductTag' has a wrong offset!");
static_assert(offsetof(FCatalogPurchaseAdditionalData, StoreContext) == 0x000060, "Member 'FCatalogPurchaseAdditionalData::StoreContext' has a wrong offset!");
static_assert(offsetof(FCatalogPurchaseAdditionalData, CheckoutProperties) == 0x000070, "Member 'FCatalogPurchaseAdditionalData::CheckoutProperties' has a wrong offset!");
...
static_assert(offsetof(FCatalogPurchaseInfoGift, AdditionalData) == 0x000070, "Member 'FCatalogPurchaseInfoGift::AdditionalData' has a wrong offset!");
...
static_assert(offsetof(FAdditionalCheckoutProperty, Key) == 0x000000, "Member 'FAdditionalCheckoutProperty::Key' has a wrong offset!");
static_assert(offsetof(FAdditionalCheckoutProperty, Value) == 0x000010, "Member 'FAdditionalCheckoutProperty::Value' has a wrong offset!");
...
static_assert(offsetof(FCatalogCheckoutOptions, AdditionalCheckoutProperties) == 0x000000, "Member 'FCatalogCheckoutOptions::AdditionalCheckoutProperties' has a wrong offset!");
static_assert(offsetof(FCatalogCheckoutOptions, bSkipCheckingEntitlementCount) == 0x000010, "Member 'FCatalogCheckoutOptions::bSkipCheckingEntitlementCount' has a wrong offset!");
...
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, ReceiptRefactorVersionOverride) == 0x00002C, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::ReceiptRefactorVersionOverride' has a wrong offset!");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, CatalogItems) == 0x000030, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::CatalogItems' has a wrong offset!");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, PurchaseCorrelationId) == 0x000040, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::PurchaseCorrelationId' has a wrong offset!");
static_assert(offsetof(FCatalogRedeemRealMoneyPurchasesInfo, AdditionalData) == 0x000050, "Member 'FCatalogRedeemRealMoneyPurchasesInfo::AdditionalData' has a wrong offset!");
...
static_assert(offsetof(FCatalogPurchaseInfo, AdditionalData) == 0x000040, "Member 'FCatalogPurchaseInfo::AdditionalData' has a wrong offset!");
...
static_assert(offsetof(FMcpProcessedConsumables, AppStore) == 0x000000, "Member 'FMcpProcessedConsumables::AppStore' has a wrong offset!");
static_assert(offsetof(FMcpProcessedConsumables, IDs) == 0x000008, "Member 'FMcpProcessedConsumables::IDs' has a wrong offset!");
...
static_assert(offsetof(FMcpInAppPurchases, ProcessedConsumables) == 0x0000D0, "Member 'FMcpInAppPurchases::ProcessedConsumables' has a wrong offset!");
