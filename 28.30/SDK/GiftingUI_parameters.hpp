...
static_assert(offsetof(AthenaGiftingScreen_OnHandlePreviewItem, bUseWidePreview) == 0x000000, "Member 'AthenaGiftingScreen_OnHandlePreviewItem::bUseWidePreview' has a wrong offset!");
